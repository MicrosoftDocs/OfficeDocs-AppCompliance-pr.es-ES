...
ms.locfileid: "52548750"
---
# <a name="officeatwork--content-chooser-for-office"></a>| Selector de contenido para Office
...
|:----------------|:-------------|
| Nombre de la aplicación | officeatwork - Selector de contenido para Office |
| ID | WA104380602 |
| Office 365 clientes compatibles | Excel en iPad, Excel 2016 o posterior en Mac, Excel Service Pack 1 o posterior en Windows, Excel en la Web, Word en iPad, Word 2016 o posterior en Mac, Word en la Web, Word 2013 Service Pack 1 o posterior en Windows, PowerPoint en iPad, PowerPoint 2016 o posterior en Mac, PowerPoint en la Web, PowerPoint Service Pack 1 o posterior el Windows, OneNote en la Web |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Files.ReadWrite.All | Delegado | No se almacenan datos. | Favoritos: poder leer y escribir datos a los usuarios OneDrive. | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| Files.ReadWrite.All | Delegado | No se almacenan datos. | OneDrive: poder leer y escribir datos a los usuarios OneDrive. | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| Group.ReadWrite.All | Delegado | No se almacenan datos. | Teams: poder leer y escribir datos en un grupo. | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| GroupMember.Read.All | Delegado | No se almacenan datos. | SharePoint En línea: compatibilidad con grupos de seguridad: para permitir que la aplicación enumere grupos, lea las propiedades básicas del grupo y lea las pertenencias de todos los grupos a los que el usuario que ha iniciado sesión tiene acceso | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| Sites.Read.All | Delegado | No se almacenan datos. | SharePoint En línea: para habilitar la lectura de datos de SharePoint Online. | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| User.Read | Delegado | No se almacenan datos. | Sing-In: para permitir que la aplicación officeatwork lea las propiedades básicas del usuario. | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| User.Read.All | Delegado | No se almacenan datos. | Teams: para averiguar a qué grupos pertenece un usuario. | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| offline_access | Delegado | No se almacenan datos. | Sing-In: para habilitar el inicio de sesión automático a través de tokens de actualización, como sin, los usuarios tendrían que iniciar sesión manualmente cada vez que inicien la aplicación officeatwork. Este ámbito solo es necesario para aplicaciones host no habilitadas para SSO. | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| OpenID | Delegado | No se almacenan datos. | Sing-In: para permitir que los usuarios inicien sesión en la aplicación officeatwork con su organización y/o cuenta Microsoft. | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| perfil | Delegado | No se almacenan datos. | Sing-In: para mostrar al usuario que ha iniciado sesión en la aplicación officeatwork. Esto ayuda a asegurar/confirmar al usuario qué cuenta se usó para iniciar sesión en la aplicación officeatwork. | edb24f8f-38af-4b3e-9475-0da243678d5a |
