...
| ¿Qué datos se almacenan en las bases de datos? | Metadatos de hoja de cálculo como el tamaño del archivo, el propietario de la hoja de cálculo, los usuarios de la hoja de cálculo, la fecha de última modificación, el nombre del archivo, etc. NO ALMACENAMOS DATOS DE HOJA DE CÁLCULO |
...
| Dirección URL de la directiva de privacidad | https://www.sheetgo.com/legal/privacy |
