...
* <a href="https://appsource.microsoft.com/product/office/WA104381807" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Supermetrics a Microsoft:
...
| Funcionalidad principal de la aplicación | Con Supermetrics, las empresas pueden agregar datos siloed de más de 70 plataformas de marketing y ventas, como Facebook Ads, Google Analytics, Instagram y más, así como transferir los datos directamente a Excel para fines de informes. Esto le permite: - Automatizar tareas manuales de importación de datos; - Use las fórmulas y herramientas ya disponibles en Excel para analizar y visualizar los datos de marketing; - Obtener la imagen general al ver varios orígenes de datos directamente en Excel. |
...
Supermetrics ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Nombre, Dirección de correo electrónico, Información de contacto |
...
| Dirección URL de la directiva de privacidad | https://supermetrics.com/privacy-policy |
