---
title: Información de solicitud para Indicadores Económicos Chile por Birdie
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Indicadores Economicos Chile, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65818519"
---
# <a name="indicadores-economicos-chile"></a>Indicadores económicos chilenos
...
* <a href="https://appsource.microsoft.com/product/office/WA104381100" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Birdie a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Indicadores económicos chilenos |
| ID | WA104381100 |
| Office 365 clientes admitidos | Excel 2013 Service Pack 1 o posterior en Windows, Excel en la Web, Excel 2016 o posterior en Mac |
| Nombre de la empresa asociada | Birdie |
| Sitio web de la empresa | [https://www.birdie.cl](https://www.birdie.cl) |
| Términos de uso de la aplicación | [https://www.birdie.cl/software/privacidad](https://www.birdie.cl/software/privacidad) |
| Funcionalidad básica de la aplicación | Obt&#233;n el valor de la Unidad de Fomento (UF), Euro, D&#243;lar y UTM de Chile de forma sencilla |
| Ubicación de la sede central de la empresa | Chile |
...
Birdie ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
