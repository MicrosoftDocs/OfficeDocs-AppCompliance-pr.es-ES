...
* <a href="https://appsource.microsoft.com/product/office/WA200001574" target="_blank">Ver en AppSource</a>
...
| URL de la Política de Privacidad | [https://quickcells.co/legal/privacy](https://quickcells.co/legal/privacy) |
| URL de los Términos de uso | [https://quickcells.co/legal/tos](https://quickcells.co/legal/tos) |
...
CC-1C ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos organizativos y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>a través de l'application Firebase li&#233; &#224; Google Cloud
...
CC-1C ha proporcionado esta información sobre cómo esta aplicación controla la autenticación, la autorización, las prácticas recomendadas de registro de aplicaciones y otros criterios de identidad.
...
| ¿La aplicación solicita permisos de privilegios mínimos para su escenario? | No |
