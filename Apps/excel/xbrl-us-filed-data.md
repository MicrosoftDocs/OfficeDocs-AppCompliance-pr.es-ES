---
title: Información de la aplicación para datos archivados de XBRL por XBRL US
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Toda la información de seguridad y cumplimiento disponible para los datos archivados de XBRL, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
---
# <a name="xbrl-filed-data"></a>Datos archivados de XBRL
...
* <a href="https://appsource.microsoft.com/product/office/WA200002591" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por XBRL US a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Datos archivados de XBRL |
| Id. | WA200002591 |
| Office 365 clientes admitidos | Excel 2016 o posterior en Mac, Excel 2016 o posterior en Windows, Excel en la Web |
| Nombre de la empresa asociada | XBRL US |
| Sitio web de la empresa | [https://xbrl.us](https://xbrl.us) |
| Términos de uso de la aplicación | [https://xbrl.us/terms-of-agreement](https://xbrl.us/terms-of-agreement) |
| Funcionalidad básica de la aplicación | XBRL US es el consorcio sin fines de lucro que crea y apoya estándares de informes empresariales libres, abiertos y no apropiados en los EE. UU. XBRL US ha dirigido el desarrollo y la implementación de estándares de datos para agencias gubernamentales - la Comisión de Valores y Exchange (SEC), la Comisión Federal de Reglamentación de Energía (FERC) y el Departamento de Energía. XBRL US supervisa los datos y ayuda a crear estándares de calidad de datos utilizados por la SEC para ayudar a las empresas públicas a crear estados financieros XBRL de buena calidad.  |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://xbrl.us/xbrl-api-community](https://xbrl.us/xbrl-api-community) |
| ¿Cuál es el entorno de hospedaje o el modelo de servicio que se usa para ejecutar la aplicación? |  |
| ¿Qué proveedores de nube de hospedaje usa la aplicación? | GitHub |
...
XBRL US ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
