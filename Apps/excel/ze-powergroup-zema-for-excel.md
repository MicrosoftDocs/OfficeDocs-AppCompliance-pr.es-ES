---
title: Información de la aplicación para ZEMA para Excel por ZE PowerGroup
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/17/2022
...
description: Toda la información de seguridad y cumplimiento disponible para ZEMA para Excel, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el Registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002229" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por ZE PowerGroup a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | ZEMA para Excel |
| ID | WA200002229 |
| Office 365 clientes compatibles | Excel 2016 o posterior en Mac, Excel 2016 o posterior en Windows, Excel en la Web |
| Nombre de la compañía asociada | ZE PowerGroup |
| Sitio web de la compañía | [https://www.ze.com](https://www.ze.com) |
| Términos de uso de la aplicación | [https://www.ze.com/terms-of-use/](https://www.ze.com/terms-of-use/) |
| Funcionalidad principal de la aplicación | Importe datos y análisis de ZEMA de forma rápida y sencilla en su Excel de datos. |
...
ZE PowerGroup ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
