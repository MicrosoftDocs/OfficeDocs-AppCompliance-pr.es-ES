---
title: Información de la aplicación para el selector de contenido
ms.author: elmalova
author: elenamalova
ms.date: 06/23/2021
ms.topic: article
...
description: Toda la información de seguridad y cumplimiento disponible para Content Chooser, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65225026"
---
# <a name="application-information-for-content-chooser-by-officeatwork"></a>Información de la aplicación para Content Chooser by officeatwork
...
* <a href="https://appsource.microsoft.com/product/web-apps/officeatwork-ag.content-chooser" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Selector de contenido |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Files.ReadWrite.All | Delegado | No se almacenan datos. | Favoritos: para poder leer y escribir datos en los usuarios OneDrive. | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| Files.ReadWrite.All | Delegado | No se almacenan datos. | OneDrive: para poder leer y escribir datos en los usuarios OneDrive. | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| Group.ReadWrite.All | Delegado | No se almacenan datos. | Teams: para poder leer y escribir datos en un grupo. | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| GroupMember.Read.All | Delegado | No se almacenan datos. | SharePoint en línea: compatibilidad con grupos de seguridad: para permitir que la aplicación muestre grupos, lea las propiedades básicas del grupo y lea las pertenencias de todos los grupos a los que el usuario que ha iniciado sesión tenga acceso. | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| Sites.Read.All | Delegado | No se almacenan datos. | SharePoint Online: para habilitar la lectura de datos de SharePoint Online. | edb24f8f-38af-4b3e-9475-0da243678d5a |
...
>| OpenID | Delegado | No se almacenan datos. | Sing-In: para permitir que los usuarios inicien sesión en la aplicación officeatwork con su organización o cuenta microsoft. | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| perfil | Delegado | No se almacenan datos. | Sing-In: para mostrar el usuario que ha iniciado sesión en la aplicación officeatwork. Esto ayuda a garantizar o confirmar al usuario qué cuenta se usó para iniciar sesión en la aplicación officeatwork. | edb24f8f-38af-4b3e-9475-0da243678d5a |
...
<iframe height='1020' title='información de Microsoft Cloud App Security' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35751' frameborder='no'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/35751" target="_blank">Ver en una nueva pestaña</a>
