---
title: Información de la aplicación para Dynamo by Dynamo Software
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/09/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Dynamo, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro de CSA STAR.
...
ms.locfileid: "65312294"
---
# <a name="dynamo"></a>Dinamo

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 9 de mayo de 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004007" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Dynamo Software a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Dinamo |
| ID | WA200004007 |
| Office 365 clientes admitidos | Outlook 2013 o posterior en Windows, Outlook 2016 o posterior en Mac, Outlook en la Web |
| Nombre de la empresa asociada | Dynamo Software |
| Sitio web de la empresa | [https://www.dynamosoftware.com](https://www.dynamosoftware.com) |
| Términos de uso de la aplicación | [https://www.dynamosoftware.com/End-User-Terms](https://www.dynamosoftware.com/End-User-Terms) |
| Funcionalidad básica de la aplicación | El complemento de Office de Dynamo&#8217;para Outlook es un programa auxiliar que permite a los usuarios existentes de Dynamo trabajar con Dynamo a través de aplicaciones de Outlook de escritorio para Windows y Outlook en la Web (Office 365 y Outlook.com). Puede enviar borradores de combinación de correspondencia, agregar citas y actividades junto con sus datos adjuntos a Dynamo y crear nuevos elementos de tipo Contacto, Compañía, Oferta y Fondo sin abrir Dynamo.  |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://help.dynamosoftware.com/about-dynamo-web-add-in-for...](https://help.dynamosoftware.com/about-dynamo-web-add-in-for-outlook/) |
...
Dynamo Software ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC1 más reciente | 2020-06-30 |
...
| Dirección URL de la directiva de privacidad | https://www.dynamosoftware.com/privacy-policy/ |
