---
title: Información de la aplicación para firmas de impresión para Outlook por firmas de impresión
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/04/2021
...
description: Toda la información de seguridad y cumplimiento disponible para las firmas de impresión para Outlook, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64879877"
---
# <a name="impression-signatures-for-outlook"></a>Firmas de impresión para Outlook

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 2 de julio de 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003199" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por las firmas de impresiones a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Firmas de impresión para Outlook |
| Id. | WA200003199 |
| Office 365 clientes admitidos | Outlook 2016 o posterior en Windows, Outlook 2016 o posterior en Mac, Outlook en la Web |
| Nombre de la empresa asociada | Firmas de impresión |
| Sitio web de la empresa | [https://www.impression-signatures.com](https://www.impression-signatures.com) |
| Términos de uso de la aplicación | [https://www.iubenda.com/terms-and-conditions/8039352](https://www.iubenda.com/terms-and-conditions/8039352) |
| Funcionalidad básica de la aplicación | Impression Signatures proporciona eSignatures y entrega segura de documentos conformes a la Ley ECT. Administrar el flujo de trabajo de firma y devolver una cadena de custodia segura anexada al documento firmado.  |
...
Las firmas de impresiones han proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2021-06-09 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| OpenID | Ambos | Autenticación de datos y datos de directorio. | [be181d9c-9060-40a0-a692-b29f2e314d16](../azure/be181d9c-9060-40a0-a692-b29f2e314d16.md) |
