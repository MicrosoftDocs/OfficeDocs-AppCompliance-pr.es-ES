...
description: Toda la información de seguridad y cumplimiento disponible para XQ Secure Email, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el registro CSA STAR.
...
| Sitio web de la compañía | [https://xqmsg.co](https://xqmsg.co) |
| Términos de uso de la aplicación | [https://xqmsg.com/terms.html](https://xqmsg.com/terms.html) |
| Funcionalidad principal de la aplicación | Proteja todas las comunicaciones &#8212; mensajes de correo electrónico a archivos. |
