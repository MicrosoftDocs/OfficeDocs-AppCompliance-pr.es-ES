---
title: Información de la aplicación para el correo electrónico seguro de XQ por mensaje XQ
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/10/2021
...
description: Toda la información de seguridad y cumplimiento disponible para XQ Secure Email, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64876607"
---
# <a name="xq-secure-email"></a>Correo electrónico seguro de XQ

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador el 4 de julio de 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200000090" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Correo electrónico seguro de XQ |
| Id. | WA200000090 |
| Office 365 clientes admitidos | Outlook 2016 o posterior en Windows, Outlook 2016 o versiones posteriores en Mac, Outlook en iOS, Outlook en Android, Outlook en la Web |
| Nombre de la empresa asociada | Mensaje XQ |
| Sitio web de la empresa | [https://xqmsg.co](https://xqmsg.co) |
| Términos de uso de la aplicación | [https://xqmsg.com/terms.html](https://xqmsg.com/terms.html) |
| Funcionalidad básica de la aplicación | Proteja todas las comunicaciones &#8212; de correos electrónicos a archivos. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://xqmsg.co/about](https://xqmsg.co/about) |
...
XQ Message ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
