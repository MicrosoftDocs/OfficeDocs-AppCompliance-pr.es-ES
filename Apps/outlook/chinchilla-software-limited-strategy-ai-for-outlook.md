---
title: Información de aplicación para Strategy-AI para Outlook por Chinchilla Software Limited
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/14/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Strategy-AI para Outlook, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el registro CSA STAR.
...
|:----------------|:-------------|
| Nombre de la aplicación | Strategy-AI para Outlook |
| ID | WA200003576 |
