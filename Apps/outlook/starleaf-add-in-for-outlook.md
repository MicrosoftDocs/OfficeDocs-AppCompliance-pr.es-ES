...
| Dirección URL de la directiva de privacidad | [https://www.starleaf.com/privacy-policy](https://www.starleaf.com/privacy-policy) |
| DIRECCIÓN URL de términos de uso | [https://support.starleaf.com/legal-information/end-user-lic...](https://support.starleaf.com/legal-information/end-user-license-agreement-for-starleaf-applications) |
...
>|:-------------------|:--------------------------|:--------------------------|
>| Si surgen problemas de soporte técnico, los datos organizacionales se pueden transferir a SalesForce para la administración de casos. Si el usuario usa la característica de acceso telefónico RTC, la llamada fluirá a través de Twilio, Plivo o Voxbone |  | N/A |
