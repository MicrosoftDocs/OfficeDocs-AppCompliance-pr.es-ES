...
description: Toda la información de seguridad y cumplimiento disponible de Pexip One para Outlook, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003137" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Pexip One para Outlook |
| Id. | WA200003137 |
| Office 365 clientes admitidos | Outlook 2013 o posterior en Windows, Outlook 2016 o posterior en Mac, Outlook en la Web |
| Nombre de la empresa asociada | PexipAS |
| Sitio web de la empresa | [https://www.pexip.com](https://www.pexip.com) |
| Términos de uso de la aplicación | [https://www.pexip.com/terms](https://www.pexip.com/terms) |
| Funcionalidad básica de la aplicación | Pexip One permite a los usuarios crear reuniones seguras fácilmente mientras usan sus flujos de trabajo de organización de reuniones existentes. Pexip one ofrece funcionalidades de uso compartido de pantalla, voz y chat de vídeo. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Delegado | Los datos de eventos de los usuarios se usan para programar reuniones en la plataforma y realizar un seguimiento de los cambios en los metadatos de la reunión. | [69609b5a-e416-4d72-b10b-8903e84780c3](../azure/69609b5a-e416-4d72-b10b-8903e84780c3.md) |
