---
title: Información de la aplicación para DocuSign para Outlook por DocuSign, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/18/2022
...
description: Toda la información de seguridad y cumplimiento disponible para DocuSign para Outlook, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA104218067" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | DocuSign para Outlook |
| ID | WA104218067 |
...
| Funcionalidad básica de la aplicación | Firmar u obtener firmas para los datos adjuntos de correo electrónico en Outlook |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.docusign.com/solutions/microsoft/outlook](https://www.docusign.com/solutions/microsoft/outlook) |
