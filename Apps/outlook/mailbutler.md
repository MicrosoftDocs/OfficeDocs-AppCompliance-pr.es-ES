---
title: Información de la aplicación para Mailbutler por Mailbutler
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/09/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Mailbutler, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el Registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200001031" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Mailbutler a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Mailbutler |
| ID | WA200001031 |
| Office 365 clientes compatibles | Outlook 2016 o posterior en Windows, Outlook 2016 o posterior en Mac, Outlook en la Web |
| Nombre de la compañía asociada | Mailbutler |
| Sitio web de la compañía | [https://www.mailbutler.io](https://www.mailbutler.io) |
| Términos de uso de la aplicación | [https://www.mailbutler.io/terms-and-conditions](https://www.mailbutler.io/terms-and-conditions) |
| Funcionalidad principal de la aplicación | Mailbutler es el complemento de correo electrónico que te ofrece todo lo que necesitas para maximizar tu productividad y mantener el correo electrónico en el punto. Mailbutler ofrece una gran variedad de características útiles que aumentan la productividad a las que puedes acceder directamente en la bandeja de entrada. Sus características te ayudan a mejorar la comunicación de los clientes, mantenerte en la marca, optimizar el juego de correo electrónico y mucho más. |
| Ubicación central de la empresa | Alemania |
| Página de información de la aplicación | [https://www.mailbutler.io](https://www.mailbutler.io) |
...
Mailbutler ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Identificadores de correo electrónico, metadatos de correo electrónico (asunto, remitente/destinatarios, si el cliente lo autoriza), datos de contacto (si los usuarios importan) |
...
| Dirección URL de la directiva de privacidad | https://www.mailbutler.io/privacy-policy-mailbutler/ |
