---
title: Información de la aplicación para CI-Signature por ci solution GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2021
...
description: Toda la información de seguridad y cumplimiento disponible para CI-Signature, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002458" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | CI-Signature |
| Id. | WA200002458 |
...
| Funcionalidad básica de la aplicación | Agregue firmas visibles en Outlook y OWA generadas en el servidor por CI-Sign, así como una versión preliminar si las firmas se agregan en el lado del servidor por CI-Disclaimer para cumplir los requisitos de identidad corporativa y los requisitos legalmente necesarios.  |
| Ubicación de la sede central de la empresa | Alemania |
| Página de información de la aplicación | [https://www.ci-solution.com/support/de/](https://www.ci-solution.com/support/de/) |
