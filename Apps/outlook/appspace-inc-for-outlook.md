---
title: Información de la aplicación para Appspace para Outlook por Appspace, Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/25/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Appspace para Outlook, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65692421"
---
# <a name="appspace-for-outlook"></a>Espacio de aplicaciones para Outlook
...
* <a href="https://appsource.microsoft.com/product/office/WA200004102" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Espacio de aplicaciones para Outlook |
| ID | WA200004102 |
...
| ¿Qué datos procesa la aplicación? | Nombre de usuario |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Nombre de usuario |
...
| Dirección URL de la directiva de privacidad | https://www.appspace.com/legal/privacy-policy/ |
