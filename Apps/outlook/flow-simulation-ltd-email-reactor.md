---
title: Información de la aplicación para Email Reactor por Flow Simulation Ltd.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/04/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Email Reactor, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65229413"
---
# <a name="email-reactor"></a>Reactor de correo electrónico
...
* <a href="https://appsource.microsoft.com/product/office/WA104379506" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Reactor de correo electrónico |
| ID | WA104379506 |
...
| Términos de uso de la aplicación | [https://www.flosim.com/reactor/EULA.html](https://www.flosim.com/reactor/EULA.html) |
| Funcionalidad básica de la aplicación | Herramienta de borrador de respuesta de correo electrónico que ahorra tiempo |
| Ubicación de la sede central de la empresa | Reino Unido de Gran Bretaña e Irlanda del Norte (el) |
| Página de información de la aplicación | [https://www.flosim.com/reactor/Email_Reactor.html](https://www.flosim.com/reactor/Email_Reactor.html) |
