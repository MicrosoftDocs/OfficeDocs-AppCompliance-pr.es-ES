---
title: Información de aplicación de Evernote
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/24/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Evernote, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64784009"
---
# <a name="evernote-application-information"></a>Información de aplicación de Evernote

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 15 de septiembre de 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA104379617" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Evernote a Microsoft:
...
| Nombre de la empresa asociada | Evernote |
| Sitio web de la empresa | [https://evernote.com](https://evernote.com) |
| Términos de uso de la aplicación | [https://evernote.com/legal/terms-of-service](https://evernote.com/legal/terms-of-service) |
| Funcionalidad básica de la aplicación | Domar la bandeja de entrada. Guardar correo electrónico importante en Evernote  |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://evernote.com/about-us](https://evernote.com/about-us) |
...
Evernote ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
