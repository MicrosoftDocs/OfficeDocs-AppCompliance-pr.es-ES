---
title: Información de la aplicación para Jira Cloud para Outlook (oficial) por Atlassian.com
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/26/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Jira Cloud for Outlook (Oficial), sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200000056" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Jira Cloud para Outlook (oficial) |
| Id. | WA200000056 |
...
| Funcionalidad básica de la aplicación | Planear, realizar un seguimiento, liberar software. Administre el soporte técnico, el servicio al cliente y los proyectos. |
...
Esta información la ha proporcionado Atlassian.com sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Los datos de correo electrónico de usuario se procesan como parte de la función de aplicaciones de mostrar vínculos de Jira. |
