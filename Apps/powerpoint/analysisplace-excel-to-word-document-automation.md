---
title: Introducción a la automatización de documentos de Excel a Word
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/28/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Excel a Word Document Automation, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65229214"
---
# <a name="excel-to-word-document-automation-overview"></a>Introducción a la automatización de documentos de Excel a Word

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 25 de febrero de 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA104380955" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Automatización de documentos de Excel a Word |
| ID | WA104380955 |
| Office 365 clientes admitidos | Excel 2016 o posterior en Mac, Excel 2016 o versiones posteriores en Windows, Word 2016 o versiones posteriores en Mac, Word 2016 o versiones posteriores en Windows, PowerPoint 2016 o versiones posteriores en Mac, PowerPoint 2016 o versiones posteriores en Mac Windows, Excel en la Web, Word en la Web, PowerPoint en la Web |
| Nombre de la empresa asociada | AnalysisPlace |
| Sitio web de la empresa | [https://analysisplace.com](https://analysisplace.com) |
| Términos de uso de la aplicación | [https://analysisplace.com/Terms](https://analysisplace.com/Terms) |
| Funcionalidad básica de la aplicación | AnalysisPlace proporciona servicios para automatizar la actualización de documentos Microsoft Office |
...
AnalysisPlace ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Nombre de usuario, dirección de correo electrónico de usuario, identificador de inquilino de la organización |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Nombre de usuario, dirección de correo electrónico de usuario, identificador de inquilino de la organización |
...
| Dirección URL de la directiva de privacidad | https://analysisplace.com/Privacy |
