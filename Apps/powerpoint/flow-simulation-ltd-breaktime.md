---
title: Información de la aplicación para breaktime por Flow Simulation Ltd.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/04/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Breaktime, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro de CSA STAR.
...
ms.locfileid: "65229412"
---
# <a name="breaktime"></a>Tiempo de interrupción
...
* <a href="https://appsource.microsoft.com/product/office/WA200001661" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Flow Simulation Ltd. a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Tiempo de interrupción |
| ID | WA200001661 |
...
| Nombre de la empresa asociada | Flow Simulation Ltd. |
| Sitio web de la empresa | [https://www.flosim.com](https://www.flosim.com) |
| Términos de uso de la aplicación | [https://www.flosim.com/breaktime/EULA.html](https://www.flosim.com/breaktime/EULA.html) |
| Funcionalidad básica de la aplicación | Una forma rápida de decirle a todos cuándo volverás, porque es hora de descanso. |
| Ubicación de la sede central de la empresa | Reino Unido de Gran Bretaña e Irlanda del Norte (el) |
| Página de información de la aplicación | [https://www.flosim.com/breaktime/Breaktime.html](https://www.flosim.com/breaktime/Breaktime.html) |
...
Esta información ha sido proporcionada por Flow Simulation Ltd. sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
