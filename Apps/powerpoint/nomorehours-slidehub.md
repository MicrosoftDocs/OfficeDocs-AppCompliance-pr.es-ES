---
title: Información de la aplicación para SlideHub de nomorehours
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Toda la información de seguridad y cumplimiento disponible para SlideHub, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200001625" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por nomorehours a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | SlideHub |
| Id. | WA200001625 |
| Office 365 clientes admitidos | PowerPoint 2016 o posterior en Mac, PowerPoint en la Web, PowerPoint 2013 o posterior en Windows |
| Nombre de la empresa asociada | nomorehours |
| Sitio web de la empresa | [https://nomorehours.com](https://nomorehours.com) |
| Términos de uso de la aplicación | [https://nomorehours.com/eula](https://nomorehours.com/eula) |
| Funcionalidad básica de la aplicación | NoMore proporciona a los usuarios empresariales PowerPoint servicios de diseño y un complemento de PowerPoint destinado a que sean más eficientes en PowerPoint. Como parte del servicio de diseño, NoMore convierte borradores aproximados en diapositivas listas para el cliente en tan solo 8 horas. El complemento ayuda a acceder al servicio más rápido, pero también permite a los usuarios acceder a diseños de diapositivas pre-hechos y a una biblioteca de diapositivas específica de la empresa, así como a un kit de herramientas de consultoría &#8220;&#8221; que contiene diferentes herramientas de productividad. |
...
Esta información la han proporcionado ya los inquilinos sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
