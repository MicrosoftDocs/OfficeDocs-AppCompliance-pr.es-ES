...
description: Toda la información de seguridad y cumplimiento disponible para HelloSign para SharePoint, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64876557"
---
# <a name="hellosign-for-sharepoint"></a>HelloSign para SharePoint

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 22 de noviembre de 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003245" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Dropbox Inc. |
| Sitio web de la empresa | [https://hellosign.com](https://hellosign.com) |
| Términos de uso de la aplicación | [https://hellosign.com/terms](https://hellosign.com/terms) |
| Funcionalidad básica de la aplicación | La plataforma de flujo de trabajo digital de HelloSign&#8217;&#8211; que incluye soluciones de eSignature, flujo de trabajo digital y fax electrónico &#8212; ayuda a más de 80 000 clientes y a millones de personas a hacer negocios más rápido. Ayudamos a nuestros clientes a cerrar ofertas más rápido, incorporar nuevos empleados con facilidad, completar documentos sin errores y mucho, mucho más. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.hellosign.com/integrations](https://www.hellosign.com/integrations) |
...
Esta información ha sido proporcionada por Dropbox Inc. sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | id. de inquilino, id. de sitio, correo electrónico, id. de unidad, id. de elemento de unidad |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | id. de inquilino, id. de sitio, correo electrónico, id. de unidad, id. de elemento de unidad |
...
| Fecha de certificación de SOC2 más reciente | 2020-10-01 |
...
| Dirección URL de la directiva de privacidad | https://www.hellosign.com/privacy |
...
| Si la aplicación no usa una de las bibliotecas anteriores, ¿qué biblioteca o bibliotecas de autenticación usa? | Se usa el flujo de código de autorización Plataforma de identidad de Microsoft y OAuth 2.0,https://docs.microsoft.com/en-us/azure/active-directory/develop/v2-oauth2-auth-code-flow |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | aplicación | Para volver a cargar archivos firmados electrónicamente en SharePoint | [6fcff87e-0f86-49c3-81eb-bc028d1ccfe6](../azure/6fcff87e-0f86-49c3-81eb-bc028d1ccfe6.md) |
>| Sites.ReadWrite.All | aplicación | Para volver a cargar archivos firmados electrónicamente en SharePoint | [6fcff87e-0f86-49c3-81eb-bc028d1ccfe6](../azure/6fcff87e-0f86-49c3-81eb-bc028d1ccfe6.md) |
>| User.Read | Delegado | Para obtener el correo electrónico del usuario | [6fcff87e-0f86-49c3-81eb-bc028d1ccfe6](../azure/6fcff87e-0f86-49c3-81eb-bc028d1ccfe6.md) |
