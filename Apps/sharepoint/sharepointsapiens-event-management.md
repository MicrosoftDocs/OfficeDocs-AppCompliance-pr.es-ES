---
title: Información de la aplicación SharePoint|sapiens Event Management de SharePointSapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Toda la información de seguridad y cumplimiento disponible para SharePoint|sapiens Event Management, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "63778440"
---
# <a name="sharepointsapiens-event-management"></a>SharePoint| de eventos de SharePoint|sapiens

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: March 22, 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA104380834" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por SharePointSapiens a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | SharePoint de eventos de sapiens |
| Id. | WA104380834 |
| Office 365 clientes compatibles | SharePoint 2016 o posterior |
| Nombre de la compañía asociada | SharePointSapiens |
| Sitio web de la compañía | [https://www.sharepointsapiens.com](https://www.sharepointsapiens.com) |
...
| Funcionalidad principal de la aplicación | El complemento Administración de eventos le ayuda a organizar varios tipos de eventos. Los eventos se pueden programar en poco tiempo en unos sencillos pasos. Los participantes pueden registrarse en línea con un solo clic. Como organizador también puede inscribir usuarios internos o externos en nombre o enviar invitaciones por correo electrónico. Los participantes reciben solicitudes de reunión y actualizaciones por correo electrónico para asegurarse de que siempre tienen la información más reciente en su Outlook calendario. El complemento realiza un seguimiento de todos los asistentes en un solo lugar. |
| Ubicación central de la empresa | Austria |
| Página de información de la aplicación | [https://www.sharepointsapiens.com/event-management-office36...](https://www.sharepointsapiens.com/event-management-office365/) |
...
SharePointSapiens ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadBasic.All | delegado | Leer información básica del usuario para habilitar la Exchange de sala | [9e8e113c-8a08-4606-b08a-de4decc7252f](../azure/9e8e113c-8a08-4606-b08a-de4decc7252f.md) |
