---
title: Información de la aplicación para Konnect eMail Parser by Konnect eMail
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/01/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Konnect eMail Parser, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64877347"
---
# <a name="konnect-email-parser"></a>Konnect eMail Parser

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador el 1 de febrero de 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001893" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://www.konnectemail.com](https://www.konnectemail.com) |
| Términos de uso de la aplicación | [https://www.konnectemail.com/eula](https://www.konnectemail.com/eula) |
| Funcionalidad básica de la aplicación | Capture automáticamente los atributos de correo electrónico como metadatos. |
| Ubicación de la sede central de la empresa | Australia |
| Página de información de la aplicación | [https://www.konnectemail.com/sharepoint-email-management](https://www.konnectemail.com/sharepoint-email-management) |
...
Konnect eMail ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Datos de correo de usuario |
