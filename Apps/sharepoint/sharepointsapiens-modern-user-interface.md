---
title: Información de la aplicación SharePoint|sapiens Modern User Interface by SharePointSapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
ms.locfileid: "64602671"
---
# <a name="sharepointsapiens-modern-user-interface"></a>SharePoint| de usuario moderna de SharePoint|sapiens

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: March 30, 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003529" target="_blank">Ver en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | SharePoint de usuario moderna de SharePoint-sapiens |
| ID | WA200003529 |
...
| Funcionalidad principal de la aplicación | Esta aplicación debe usarse junto con nuestra SharePoint|Aplicación de administración de eventos sapiens (WA104380834) o SharePoint|aplicación sapiens Employee Training Management (WA104380833).  Esta aplicación proporciona una interfaz de usuario intuitiva que permite crear y administrar eventos, temas, cursos y currículos en SharePoint, inscribir usuarios o permitirles inscribirse y realizar un seguimiento de todos los asistentes, tareas y logros. |
