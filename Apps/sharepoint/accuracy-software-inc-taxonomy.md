---
title: Información de la aplicación para taxonomía por Accuracy Software Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/18/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Taxonomía, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64870958"
---
# <a name="taxonomy"></a>Taxonomía

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 18 de febrero de 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003006" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Accuracy Software Inc. |
| Sitio web de la empresa | [https://accuracysoftware.ca](https://accuracysoftware.ca) |
...
| Funcionalidad básica de la aplicación | Taxonomía le proporciona una manera eficaz de administrar el plan de clasificación de archivos, ya que permite la colaboración de los profesionales de mensajería instantánea con las distintas partes interesadas para crear, revisar y publicar el plan de archivos en toda la organización. Además, Taxonomía permite generar la exportación de etiquetas de retención M365 que puede importar al Centro de cumplimiento de Microsoft y exportar el plan de archivos en un formato de conjunto de términos que puede importar al almacén de términos de SharePoint. |
| Ubicación de la sede central de la empresa | Canadá |
| Página de información de la aplicación | [https://www.accuracysoftware.ca/taxonomy-sharepoint-webpart/](https://www.accuracysoftware.ca/taxonomy-sharepoint-webpart/) |
| ¿Cuál es el entorno de hospedaje o el modelo de servicio que se usa para ejecutar la aplicación? | Paas |
| ¿Qué proveedores de nube de hospedaje usa la aplicación? | Inquilino de SharePoint cliente |
...
Precisiony Software Inc. ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
