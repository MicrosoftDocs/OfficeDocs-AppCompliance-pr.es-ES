---
title: Información de aplicaciones para el sistema de administración de ofertas de Beyond Technologies
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/03/2022
...
description: Toda la información de seguridad y cumplimiento disponible para el Sistema de administración de ofertas, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security y la información de seguridad y cumplimiento en el Registro CSA STAR.
...
---
# <a name="bid-management-system"></a>Sistema de administración de ofertas

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: November 16, 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001787" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Beyond Technologies a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Sistema de administración de ofertas |
| ID | WA200001787 |
| Office 365 clientes compatibles | SharePoint 2013 o posterior |
| Nombre de la compañía asociada | Beyond Technologies |
| Sitio web de la compañía | [https://www.beyondintranet.com](https://www.beyondintranet.com) |
| Términos de uso de la aplicación | [https://www.beyondintranet.com/eula](https://www.beyondintranet.com/eula) |
| Funcionalidad principal de la aplicación | Un SharePoint de administración de propuestas/software de administración de ofertas para digitalizar las actividades de las ofertas. |
| Ubicación central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.beyondintranet.com/bid-management-software](https://www.beyondintranet.com/bid-management-software) |
...
Beyond Technologies ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Correo electrónico del usuario y dirección url SharePoint sitio |
...
| Dirección URL de la directiva de privacidad | https://www.beyondintranet.com/privacypolicy |
