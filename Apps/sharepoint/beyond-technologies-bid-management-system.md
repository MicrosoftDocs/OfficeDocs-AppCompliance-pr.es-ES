...
| Funcionalidad principal de la aplicación | Un SharePoint de administración de propuestas/software de administración de ofertas para digitalizar las actividades de la oferta. |
...
| ¿Qué datos se almacenan en las bases de datos? | Correo electrónico del usuario y SharePoint url del sitio |
