---
title: 'Información de la aplicación para 4Mata: Diseñador de formato de lista de CLOUDIGNITE LLC'
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Toda la información de seguridad y cumplimiento disponible para 4Mata - Diseñador de formato de lista, sus directivas de control de datos, su Microsoft Cloud App Security información de catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
---
# <a name="4mata---list-formatting-designer"></a>4Mata: Diseñador de formato de lista
...
* <a href="https://appsource.microsoft.com/product/office/WA200002892" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por CLOUDIGNITE LLC a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | 4Mata: Diseñador de formato de lista |
| ID | WA200002892 |
| Office 365 clientes admitidos | SharePoint 2016 o posterior |
| Nombre de la empresa asociada | CLOUDIGNITE LLC |
| Sitio web de la empresa | [https://4mata.com](https://4mata.com) |
| Términos de uso de la aplicación | [https://docs.4mata.com/legal/terms-of-service](https://docs.4mata.com/legal/terms-of-service) |
| Funcionalidad básica de la aplicación | 4Mata by CloudIgnite es un conjunto de herramientas que permiten a las empresas visualizar datos mediante el diseño y el formato SharePoint listas y formularios.  Con esta aplicación, los usuarios pueden configurar intuitivamente formularios y listas de SharePoint complejos y altamente personalizados para informes, facturas, publicación de detalles del producto y recopilación de información de contacto para integrarse con los requisitos del proceso empresarial de forma cómoda.  |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://4mata.com](https://4mata.com) |
...
CLOUDIGNITE LLC ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
