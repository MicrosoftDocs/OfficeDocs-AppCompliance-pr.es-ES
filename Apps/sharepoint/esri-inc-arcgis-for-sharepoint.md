---
title: Información de la aplicación para ArcGIS for SharePoint por Esri, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/04/2021
...
description: Toda la información de seguridad y cumplimiento disponible para ArcGIS for SharePoint, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
