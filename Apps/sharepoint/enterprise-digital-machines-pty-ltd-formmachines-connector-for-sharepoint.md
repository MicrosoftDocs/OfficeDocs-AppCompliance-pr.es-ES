...
ms.locfileid: "61596837"
---
# <a name="formmachines-connector-for-sharepoint"></a>FormMachines Connector para SharePoint

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: December 22, 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200000357" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por ENTERPRISE DIGITAL MACHINES PTY LTD a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | FormMachines Connector para SharePoint |
| Id. | WA200000357 |
| Office 365 clientes compatibles | SharePoint 2016 o posterior |
| Nombre de la compañía asociada | MÁQUINAS DIGITALES DE EMPRESA PTY LTD |
...
| Funcionalidad principal de la aplicación | Proporciona FormMachines para Teams la capacidad de leer y escribir en SharePoint listas |
...
ESTA información ha sido proporcionada por ENTERPRISE DIGITAL MACHINES PTY LTD sobre cómo esta aplicación recopila y almacena datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Plantillas de formulario diseñadas por el cliente y envíos de formulario |
...
| Dirección URL de la directiva de privacidad | https://www.formmachines.com/dist/docs#/statements_and_agreements/privacy |
