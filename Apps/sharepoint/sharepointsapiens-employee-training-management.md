---
title: Información de la aplicación SharePoint|sapiens Employee Training Management by SharePointSapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
ms.locfileid: "63778430"
---
# <a name="sharepointsapiens-employee-training-management"></a>SharePoint| de formación de empleados de SharePoint|sapiens

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: March 22, 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA104380833" target="_blank">Ver en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | SharePoint de formación de empleados de SharePoint-sapiens |
| Id. | WA104380833 |
...
| Funcionalidad principal de la aplicación | El complemento Administración de formación de empleados facilita la organización y administración del desarrollo profesional continuo de los empleados para todos. Desde la configuración y programación de eventos de aprendizaje, la administración de alumnos y sus asignaciones e inscripciones, hasta el seguimiento de logros y comentarios, todo está cubierto. El complemento le ayuda a cumplir las normativas de cumplimiento y las directivas de seguridad. Le permite asignar la formación necesaria, realizar un seguimiento de los logros, administrar expiraciones y mucho más. |
| Ubicación central de la empresa | Austria |
| Página de información de la aplicación | [https://www.sharepointsapiens.com/employee-training-managem...](https://www.sharepointsapiens.com/employee-training-management-office365/) |
