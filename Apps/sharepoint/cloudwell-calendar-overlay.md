---
title: Información de la aplicación para la superposición de calendario por Cloudwell
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/10/2022
...
| Funcionalidad básica de la aplicación | El elemento web Superposición de calendario le permite ver todos los eventos de Microsoft SharePoint, Planner y Exchange en un solo lugar. |
...
Cloudwell ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
