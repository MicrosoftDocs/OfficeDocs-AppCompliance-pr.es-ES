---
title: Información de la aplicación para los logrontes de Conexiones Viva por parte de los logrontes
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/06/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Achievers para Conexiones Viva, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66656400"
---
# <a name="achievers-for-viva-connections"></a>Logradores para Conexiones Viva
...
* <a href="https://appsource.microsoft.com/product/office/WA200004313" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Logradores para Conexiones Viva |
| ID | WA200004313 |
...
| Funcionalidad básica de la aplicación | Tarjetas de acción rápida para los miembros que usan la plataforma Achievers para firmar una tarjeta de celebración, ver reconocimientos propios y reconocimientos de tendencias |
...
| ¿Qué datos se almacenan en las bases de datos? | Id. de inquilino, Id. de usuario |
