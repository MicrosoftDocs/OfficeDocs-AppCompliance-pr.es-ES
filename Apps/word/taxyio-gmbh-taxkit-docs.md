...
| Sitio web de la compañía | [https://www.taxy.io](https://www.taxy.io) |
| Términos de uso de la aplicación | [https://go.microsoft.com](https://go.microsoft.com) |
| Funcionalidad principal de la aplicación | TaxKit Docs ayuda a los asesores fiscales a encontrar documentación legal relevante para el documento y el caso en el que están trabajando. Esto les ayuda a aconsejar a sus clientes de forma más eficaz. |
