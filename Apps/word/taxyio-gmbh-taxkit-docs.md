---
title: Información de la aplicación para TaxKit Docs by Taxy.io GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toda la información de seguridad y cumplimiento disponible para TaxKit Docs, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64880857"
---
# <a name="taxkit-docs"></a>Documentación de TaxKit
...
* <a href="https://appsource.microsoft.com/product/office/WA200002849" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Documentación de TaxKit |
| Id. | WA200002849 |
| Office 365 clientes admitidos | Word 2016 o posterior en Mac, Word en la Web, Word 2013 o posterior en Windows |
| Nombre de la empresa asociada | Taxy.io GmbH |
| Sitio web de la empresa | [https://www.taxy.io](https://www.taxy.io) |
| Términos de uso de la aplicación | [https://go.microsoft.com](https://go.microsoft.com) |
| Funcionalidad básica de la aplicación | TaxKit Docs ayuda a los asesores fiscales a encontrar documentación legal pertinente para el documento y el caso en el que están trabajando. Esto les ayuda a asesorar a sus clientes de forma más eficaz. |
...
Esta información ha sido proporcionada por Taxy.io GmbH sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
