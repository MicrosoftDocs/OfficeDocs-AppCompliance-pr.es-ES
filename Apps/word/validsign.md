---
title: Información de la aplicación para ValidSign by ValidSign
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Toda la información de seguridad y cumplimiento disponible para ValidSign, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200001890" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por ValidSign a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | ValidSign |
| ID | WA200001890 |
| Office 365 clientes admitidos | Word 2016 o posterior en Mac, Word en la web, Word 2013 o versiones posteriores en Windows |
| Nombre de la empresa asociada | ValidSign |
| Sitio web de la empresa | [https://www.validsign.eu](https://www.validsign.eu) |
| Términos de uso de la aplicación | [https://www.validsign.eu/word-license-terms/](https://www.validsign.eu/word-license-terms/) |
| Funcionalidad básica de la aplicación | Trabaje de forma más inteligente y eficaz con el complemento De Word ValidSign |
| Ubicación de la sede central de la empresa | Países Bajos (el) |
| Página de información de la aplicación | [https://www.validsign.eu/connectors/word/](https://www.validsign.eu/connectors/word/) |
...
ValidSign ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://www.validsign.eu/validsign-privacy-statement/ |
