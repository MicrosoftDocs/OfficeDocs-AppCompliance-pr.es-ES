...
ms.locfileid: "65269961"
---
# <a name="document-drafter"></a>Borrador de documentos

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 10 de diciembre de 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003634" target="_blank">Vista en AppSource</a>
...
| Funcionalidad básica de la aplicación | Este complemento le permite acceder a las plantillas de Document Drafter directamente en MS Word. |
| Ubicación de la sede central de la empresa | Dinamarca |
| Página de información de la aplicación | [https://gmeadow.com/addin-support/](https://gmeadow.com/addin-support/) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Ambos | Para leer las bibliotecas de personas en los canales necesarios para que los usuarios examinen las carpetas al almacenar los documentos generados en nuestra aplicación. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
