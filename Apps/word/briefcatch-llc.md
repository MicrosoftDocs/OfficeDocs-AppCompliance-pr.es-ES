---
title: Información de la aplicación para BriefCatch por BriefCatch LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/04/2022
...
description: Toda la información de seguridad y cumplimiento disponible para BriefCatch, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003725" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por BriefCatch LLC a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | BriefCatch |
| ID | WA200003725 |
| Office 365 clientes admitidos | Word 2016 o posterior en Mac, Word en la Web, Word 2013 o posterior en Windows |
| Nombre de la empresa asociada | BriefCatch LLC |
| Sitio web de la empresa | [https://briefcatch.com](https://briefcatch.com) |
| Términos de uso de la aplicación | [https://briefcatch.com/briefcatch-end-user-license-agreemen...](https://briefcatch.com/briefcatch-end-user-license-agreement/) |
| Funcionalidad básica de la aplicación | Edición legal experta a su lado. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://briefcatch.com/version-3/](https://briefcatch.com/version-3/) |
...
Esta información ha sido proporcionada por BriefCatch LLC sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
