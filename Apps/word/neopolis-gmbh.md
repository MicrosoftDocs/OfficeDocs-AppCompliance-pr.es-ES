---
title: Información de la aplicación para neopolios de neopolis GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/28/2021
...
description: Toda la información de seguridad y cumplimiento disponible para neópolio, sus directivas de tratamiento de datos, su Microsoft Cloud App Security de catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002920" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por neopolis GmbH a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | neopolis |
| ID | WA200002920 |
| Office 365 clientes compatibles | Word 2016 o posterior en Mac, Word en la Web, Word 2013 o posterior en Windows |
| Nombre de la compañía asociada | neopolis GmbH |
| Sitio web de la compañía | [https://neopol.is](https://neopol.is) |
| Términos de uso de la aplicación | [https://app.termly.io/document/terms-of-use-for-saas/655330...](https://app.termly.io/document/terms-of-use-for-saas/655330e8-5787-47b4-8957-90006db46c80) |
| Funcionalidad principal de la aplicación | Professionelle Textdokumente parallel schreiben, &#252;berarbeiten und versionieren. Wir wenden das in der Softwareentwicklung etablierte Git-Prinzip auf die kollaborative Bearbeitung professioneller Textdokumente an. Unser Word Plug-in erm&#246;glicht parallele und kontrollierte Zusammenarbeit, ohne dass bestehende Prozesse oder Software umgestellt werden m&#252;ssen. |
| Ubicación central de la empresa | Alemania |
| Página de información de la aplicación | [https://neopol.is](https://neopol.is) |
...
Neopolis GmbH ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://neopol.is/gdpr/ |
