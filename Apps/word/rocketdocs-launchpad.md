---
title: Información de la aplicación para LaunchPad de RocketDocs de RocketDocs
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Toda la información de seguridad y cumplimiento disponible para LaunchPad de RocketDocs, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el Registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003648" target="_blank">Ver en AppSource</a>
...
| Id. | WA200003648 |
| Office 365 clientes compatibles | Excel 2016 o posterior en Mac, Excel 2016 o posterior en Windows, Excel en la Web, Word 2016 o posterior en Mac, Word en la Web, Word 2016 o posterior en Windows |
| Nombre de la compañía asociada | RocketDocs |
| Sitio web de la compañía | [https://rocketdocs.com](https://rocketdocs.com) |
...
| Funcionalidad principal de la aplicación | Permite a los usuarios buscar contenido en la plataforma RocketDocs e insertarlo en un documento. |
...
Esta información ha sido proporcionada por RocketDocs sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
