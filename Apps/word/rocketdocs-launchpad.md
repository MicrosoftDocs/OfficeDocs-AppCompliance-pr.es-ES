---
title: Información de la aplicación para RocketDocs LaunchPad de RocketDocs
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Toda la información de seguridad y cumplimiento disponible para RocketDocs LaunchPad, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64877037"
---
# <a name="rocketdocs-launchpad"></a>RocketDocs LaunchPad

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 27 de octubre de 2021</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003648" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por RocketDocs a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | RocketDocs LaunchPad |
| Id. | WA200003648 |
| Office 365 clientes admitidos | Excel 2016 o posterior en Mac, Excel 2016 o versiones posteriores en Windows, Excel en la Web, Word 2016 o versiones posteriores en Mac, Word en la Web, Word 2016 o versiones posteriores en Windows |
| Nombre de la empresa asociada | RocketDocs |
| Sitio web de la empresa | [https://rocketdocs.com](https://rocketdocs.com) |
| Términos de uso de la aplicación | [https://rocketdocs.com/end-user-license-agreement/](https://rocketdocs.com/end-user-license-agreement/) |
| Funcionalidad básica de la aplicación | Permite a los usuarios buscar contenido en la plataforma RocketDocs e insertarlo en un documento. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://rocketdocs.com/platform/](https://rocketdocs.com/platform/) |
...
RocketDocs ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
