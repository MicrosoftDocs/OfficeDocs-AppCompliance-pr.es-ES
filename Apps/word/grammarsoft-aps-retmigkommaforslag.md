---
title: Información de la aplicación para RetMig &amp; Kommaforslag by GrammarSoft ApS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toda la información de seguridad y cumplimiento disponible para RetMig &amp; Kommaforslag, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA104382003" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | GrammarSoft ApS |
| Sitio web de la empresa | [https://retmig.dk](https://retmig.dk) |
| Términos de uso de la aplicación | [https://retmig.dk/terms](https://retmig.dk/terms) |
| Funcionalidad básica de la aplicación | RetMig er en avanceret stave- og grammatikkontrol for dansk, mens Kommaforslag retter kommafejl. |
| Ubicación de la sede central de la empresa | Dinamarca |
| Página de información de la aplicación | [https://retmig.dk](https://retmig.dk) |
...
GrammarSoft ApS ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
