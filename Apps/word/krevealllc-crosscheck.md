...
description: Toda la información de seguridad y cumplimiento disponible para CrossCheck, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003198" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | kRevealLLC |
| Sitio web de la empresa | [https://kreveal.com](https://kreveal.com) |
| Términos de uso de la aplicación | [https://crosscheck.krevealaddins.com/docs/license.htm](https://crosscheck.krevealaddins.com/docs/license.htm) |
| Funcionalidad básica de la aplicación | CrossCheck simplifica la revisión de documentos y detecta errores comunes de redacción. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://admin.krevealaddins.com/help](https://admin.krevealaddins.com/help) |
...
kRevealLLC ha proporcionado esta información sobre cómo recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| OpenID | aplicación | No se recopilan ni usan datos. | [5edad654-f2d5-41d8-bfc0-92c2735252e1](../azure/5edad654-f2d5-41d8-bfc0-92c2735252e1.md) |
