---
title: Información de la aplicación para Jus2vec by N2VEC TECNOLOGIA
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/18/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Jus2vec, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64906462"
---
# <a name="jus2vec"></a>Jus2vec

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 18 de abril de 2022</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002506" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por N2VEC TECNOLOGIA a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Jus2vec |
| Id. | WA200002506 |
| Office 365 clientes admitidos | Word 2016 o posterior en Mac, Word en la Web, Word 2013 o posterior en Windows |
| Nombre de la empresa asociada | N2VEC TECNOLOGIA |
| Sitio web de la empresa | [https://info.jus2vec.com](https://info.jus2vec.com) |
| Términos de uso de la aplicación | [https://info.jus2vec.com/termos-de-uso.html](https://info.jus2vec.com/termos-de-uso.html) |
| Funcionalidad básica de la aplicación | Busca por Jurisprud&#234;ncias usando Intelig&#234;ncia Artificial |
| Ubicación de la sede central de la empresa | Brasil |
...
Esta información ha sido proporcionada por N2VEC TECNOLOGIA sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
