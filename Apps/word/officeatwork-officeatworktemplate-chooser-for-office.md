---
title: Información de la aplicación para el selector de plantillas para Office por officeatwork
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: Toda la información de seguridad y cumplimiento disponible para officeatwork | Selector de plantillas para Office, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
---
# <a name="application-information-for-officeatwork--template-chooser-for-office"></a>Información de la aplicación para officeatwork | Selector de plantillas para Office
...
|:----------------|:-------------|
| Nombre de la aplicación | officeatwork: selector de plantillas para Office |
| ID | WA104380050 |
| Office 365 clientes admitidos | Excel en iPad, Excel 2016 o versiones posteriores en Mac, Excel 2013 o posterior en Windows, Excel en la Web, Word en iPad, Word 2016 o posterior en Mac, Word en la Web, Word 2013 o versiones posteriores Windows, PowerPoint en iPad, PowerPoint 2016 o versiones posteriores en Mac, PowerPoint en la Web, PowerPoint 2013 o posterior en Windows, Project 2016 o posterior en Windows |
