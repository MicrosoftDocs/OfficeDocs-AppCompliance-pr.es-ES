...
description: Toda la información de seguridad y cumplimiento disponible para las firmas de impresión, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security y la información de seguridad y cumplimiento en el Registro CSA STAR.
...
>|   **Permiso de Graph**  | **Tipo de permiso** |          **Justificación**          | **Id. de aplicación de Azure AD** |
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
