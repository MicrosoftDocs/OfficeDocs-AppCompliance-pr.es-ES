---
title: Información de la aplicación para el cuaderno de cláusulas de LeasePilot
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Clausebook, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66247398"
---
# <a name="clausebook"></a>Libreta de cláusulas
...
* <a href="https://appsource.microsoft.com/product/office/WA200004044" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por LeasePilot a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Libreta de cláusulas |
| Id. | WA200004044 |
| Office 365 clientes admitidos | Word 2016 o posterior en Mac, Word en la web, Word 2016 o posterior en Windows |
| Nombre de la empresa asociada | LeasePilot |
| Sitio web de la empresa | [https://clausebook.com](https://clausebook.com) |
| Términos de uso de la aplicación | [https://clausebook.com/terms](https://clausebook.com/terms) |
| Funcionalidad básica de la aplicación | ¡Clausebook es tu compañero de redacción de documentos! Ayuda a los equipos a capturar, organizar, redactar y compartir formularios y bibliotecas de cláusulas para redactar e institucionalizar rápidamente las prácticas de la organización. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | |
| ¿Cuál es el entorno de hospedaje o el modelo de servicio que se usa para ejecutar la aplicación? | Paas |
| ¿Qué proveedores de nube de hospedaje usa la aplicación? | Otro, Vercel |
...
LeasePilot ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
