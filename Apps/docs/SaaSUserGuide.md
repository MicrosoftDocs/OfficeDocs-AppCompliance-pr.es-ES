...
ms.author: legerrar
manager: tonybal
description: Guía del usuario de ISV para Microsoft 365 Programa de cumplimiento de aplicaciones SaaS
keywords: Guía del usuario de ISV para Microsoft 365 Programa de cumplimiento de aplicaciones SaaS
ms.topic: conceptual
...
ms.locfileid: "64752869"
---
# <a name="partners-user-guide-for-microsoft-365-app-compliance-program---saas"></a>Guía del usuario del asociado para Microsoft 365 programa de cumplimiento de aplicaciones: SaaS
...
## <a name="3-publisher-attestation-workflow"></a>3. flujo de trabajo de atestación de Publisher
...
![Marketplace comercial en el Centro de partners](../media/NewPChomepage.png)

  
**Paso 2**: Después de seleccionar "Ofertas de Marketplace", cambie a "Marketplace comercial".

![Selección de una aplicación en Marketplace comercial](../media/NewPCOffersOffice.png)
...
![Cumplimiento de aplicaciones en Marketplace comercial](../media/PCappcompliance3.png)
...
**Paso 5**: Una vez completado, haga clic en "Enviar", la evaluación será ahora "En revisión".
 ...
 ![Enviar Publisher confirmación de envío de atestación](../media/UserGuidePhotos/07.png) ![](../media/UserGuidePhotos/08.png)
...
- Tras la aprobación, el asociado puede:
 ...
 ![Inicio de la certificación de Microsoft 365](../media/UserGuidePhotos/11.png)
...
![Iniciar certificación Microsoft 365](../media/UserGuidePhotos/13.png) 
  
**Paso 1**: Envío inicial de documentos

Rellene todos los detalles, cargue los documentos pertinentes y haga clic en "Enviar".
  
![Envío inicial de](../media/UserGuidePhotos/14.png) 
![ documentosSubmit Envío inicial de documentos](../media/UserGuidePhotos/15.png)
...
![Requisitos de control de Upload](../media/UserGuidePhotos/19.png)
...
![Necesidades de evidencia actualizadas](../media/UserGuidePhotos/22.png)

![Qué controles necesitan actualizarse](../media/UserGuidePhotos/23.png)
...
![Microsoft 365 aprobación de la certificación de aplicaciones](../media/UserGuidePhotos/26.png)
...
## <a name="5---microsoft-365-renewal-workflow"></a>5. flujo de trabajo de renovación de Microsoft 365:
...
![Renovación a atestación](../media/UserGuidePhotos/29.png)
  
**Publisher Renovación de atestación aprobada:**
  
![Enviar para la renovación](../media/UserGuidePhotos/30.png)
...
![Atestación Renewel](../media/UserGuidePhotos/32.png) 
...
![Renovación de certificación](../media/UserGuidePhotos/33.png) 
