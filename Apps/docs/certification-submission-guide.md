...
### <a name="read-the-microsoft-365-certification-specification"></a>Leer la especificación Microsoft 365 certificación de datos
...
Cuando IaaS y/o PaaS se usen para admitir la infraestructura de la aplicación o la entrega de código de complemento en revisión, el proveedor de la plataforma en la nube será responsable de algunos de los controles de seguridad evaluados durante todo el proceso de certificación. Por lo tanto, los analistas de certificación tendrán que obtener la comprobación externa independiente de los procedimientos recomendados de seguridad por parte del proveedor de la plataforma en la nube a través de informes de cumplimiento externos, como los informes  [DSSAttestation](bookmark://pci-dss)  of Compliance (AOC), ISO27001  [oSOC 2Type](bookmark://soc-2)  II. 
...
Antes de iniciar el proceso de certificación, deberá haber completado correctamente su Publisher certificación. Una vez completado, el Microsoft 365 de certificación continuará de la siguiente manera:

### <a name="preparation"></a>Preparación
1. Vaya al centro de partners y revise la documentación [Publisher atestación completa](../docs/attestation.md). Si es necesario, puede editar y actualizar las respuestas; sin embargo, si lo hace, tendrá que volver a enviar la documentación de atestación para su aprobación. Si el envío tiene más de tres meses, se requiere que vuelva a enviar Publisher atestación para su revisión y validación. 
1. Lea atentamente la guía [Microsoft 365 envío de](../docs/certification-submission-guide.md) certificación para comprender lo que se le va a requerido. Asegúrese de que podrá cumplir los requisitos de [control](../docs/certification-submission-guide.md#app-certification-criteria) especificados en la Guía Microsoft 365 envío de certificación.
...
>[!NOTE]
>Para todas las aplicaciones de Office, puede hacer referencia a [nuestra guía Office de usuario de aplicaciones.](../docs/userguide.md) Para todas las WebApps, puede hacer referencia a nuestra Guía del usuario [de la aplicación SaaS](../docs/saasuserguide.md).
...
||&#x2713; flujos de datos M365 dentro de la infraestructura de soporte (cuando corresponda)|
||&#x2713; diagramas que destacan dónde y qué datos se almacenan, cómo se pasan los datos a terceros externos (incluidos los detalles de qué terceros) y cómo se protegen los datos en tránsito a través de redes abiertas/públicas y en reposo.|
...
||&#x2713; [informes SOC 2](#soc-2) tipo I/Type II.|
||&#x2713; [ISMSIEC](#isms) / - 1S0/IEC 27001 Declaración de aplicabilidad (SoA) y certificación.[](#iec)|
...
Las técnicas de recolección de evidencias usadas se determinarán durante el proceso de evaluación. Para obtener ejemplos concretos del tipo de evidencia necesaria en el envío, consulte la [Guía de pruebas de ejemplo](../docs/certification-sample-evidence-guide.md).

**Actividades de evaluación**

Los analistas de certificación revisarán la evidencia que proporciones para determinar si has cumplido adecuadamente los controles dentro de esta especificación Microsoft 365 certificación. 

Siempre que sea posible y para reducir la cantidad de tiempo necesaria para completar la evaluación,  cualquier o toda la documentación detallada en los  [envíos de](#initial-document-submission) documentación iniciales debe proporcionarse con antelación.
...
Cada uno de estos dominios de seguridad incluye controles clave específicos que abarcan uno o más requisitos específicos que se evaluarán como parte del proceso de evaluación. Para asegurarse de que Microsoft 365 certificación es inclusiva para desarrolladores de todos los tamaños, cada uno de los dominios de seguridad se evalúa mediante un sistema de puntuación para determinar una puntuación general de cada uno de los dominios. Las puntuaciones para cada uno de los controles de certificación Microsoft 365 se asignan entre 1 (bajo) y 3 (alto) en función del riesgo percibido de que ese control no se cumple. Cada uno de los dominios de seguridad tendrá una marca de porcentaje mínima que se considerará un pase. Algunos elementos de esta especificación incluyen algunos criterios de error automáticos:
...
Aunque no es necesario, si actualmente cumple con iso 27001, PCI DSS o SOC2, puede optar por usar estas certificaciones para satisfacer algunos de los controles de certificación de Microsoft 365. Los analistas de certificación intentarán alinear los marcos de seguridad externos existentes con la Microsoft 365 de certificación. Sin embargo, si la documentación complementaria no puede proporcionar garantías de que los controles de certificación Microsoft 365 se evaluaron como parte de la auditoría o evaluación de los marcos de seguridad externos, deberá proporcionar pruebas adicionales de la implementación de estos controles.
...
&#x2713; El entorno de soporte técnico de aplicaciones o complementos Y los procesos  empresariales compatibles DEBEN incluirse  en el ámbito de los marcos de cumplimiento de seguridad externos admitidos y deben indicarse claramente en la documentación proporcionada.
...
&#x2713; los marcos de cumplimiento de seguridad externa admitidos **deben** ser realizados por una empresa independiente acreditada.
...
&emsp;&#x2713; no se permite el uso de MD5, MD4, MD2 y otras funciones hash, incluso para aplicaciones no criptográficas.
...
Cuando ya haya alcanzado el cumplimiento de la norma ISO27001, los siguientes deltas (vacíos) que no están totalmente cubiertos por iso 27001 tendrán que revisarse, como mínimo, como parte de esta certificación Microsoft 365.

> [!NOTE]
> Como parte de la evaluación de certificación de Microsoft 365, el analista de certificación determinará si alguno de los controles iso 27001 asignados no se incluyó como parte de la evaluación ISO 27001 y también puede decidir si se incluyeron controles de ejemplo que se encontraron para proporcionar más garantías. Los requisitos que falte en la ISO 27001 tendrán que incluirse en las Microsoft 365 de evaluación de certificación.
...
* Demostrar que antivirus está configurado en todos los componentes del sistema muestreados para bloquear automáticamente malware, poner en cuarentena & alerta o alertar.
...
* Confirme que la documentación de soporte técnico está en su lugar para la corrección de vulnerabilidades en función de la clasificación de riesgos y en línea con la especificación siguiente:
 ...
 &#x2713; solucionar todos los problemas de riesgo críticos y altos en línea con la clasificación de riesgos para el examen interno.
 
 &#x2713; solucionar todos los problemas de riesgo crítico, máximo y medio en línea con la clasificación de riesgos para el examen externo.
...
&#x2713; de encabezado, el contrabando de solicitudes y la división de respuesta.
...
&#x2713; procedimientos de respuesta específicos para modelos de amenazas esperados.
...
Cuando ya haya alcanzado el cumplimiento de PCI DSS, las siguientes diferencias no cubiertas totalmente por PCI DSS tendrán que revisarse como parte de esta certificación de Microsoft 365.
...
&emsp;&#x2713; ataques de recorrido de archivo y ruta de acceso.
...
*Estándar de seguridad de datos de* la industria de tarjetas de pago, una organización que mantiene estándares para la seguridad de los datos de los titulares de tarjetas en todo el mundo.
