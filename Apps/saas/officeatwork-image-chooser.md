---
title: OneNote información de la aplicación para el selector de imágenes por officeatwork
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: OneNote microsoft ha revisado los estándares y controles del sector para las prácticas de seguridad, cumplimiento y control de datos.
...
ms.locfileid: "64783999"
---
# <a name="image-chooser"></a>Selector de imágenes
...
* <a href="https://appsource.microsoft.com/product/web-apps/officeatwork-ag.image-chooser" target="_blank">Vista en AppSource</a>
...
|---|---|
| Nombre de la aplicación | Selector de imágenes |
