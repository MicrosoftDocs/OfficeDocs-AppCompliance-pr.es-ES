---
title: Información de la aplicación para anywhere365 Contact Center for Teams by WORKSTREAMPEOPLE BV
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Toda la información de seguridad y cumplimiento disponible del Centro de contactos de Anywhere365 para Teams, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro de CSA STAR.
...
---
# <a name="anywhere365-contact-center-for-teams"></a>Centro de contactos de Anywhere365 para Teams

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 14 de marzo de 2022</p>

* <a href="https://appsource.microsoft.com/product/web-apps/workstreampeople.anywhere365contactcenterforteams" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por WORKSTREAMPEOPLE BV a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Centro de contactos de Anywhere365 para Teams |
| ID | workstreampeople.anywhere365contactcenterforteams |
| Nombre de la empresa asociada | WORKSTREAMPEOPLE BV |
| Sitio web de la empresa | [https://anywhere365.io](https://anywhere365.io) |
| Términos de uso de la aplicación | [https://anywhere365.io/wspstorage/2022/02/Anywhere365-Dialo...](https://anywhere365.io/wspstorage/2022/02/Anywhere365-Dialogue-Cloud-Agreement_202112_V3.6.pdf) |
| Funcionalidad básica de la aplicación | Anywhere365&#174; Dialogue Cloud platform for Omnichannel Communications, el primer centro de contactos certificado por Microsoft del mundo para Teams, totalmente integrado con microsoft eocystem: desde Azure, Sharepoint y Teams a Dynamics 365, PowerApps y PowerBI. Con la adición de nuestra plataforma de automatización de la comunicación de código bajo Dialog Studio, podemos integrar con cualquier marco de bot basado en API, capas de comunicación y sistemas de inteligencia. |
| Ubicación de la sede central de la empresa | Países Bajos (el) |
| Página de información de la aplicación | [https://anywhere365.io/category/anywhere365-dialogue-cloud/](https://anywhere365.io/category/anywhere365-dialogue-cloud/) |
