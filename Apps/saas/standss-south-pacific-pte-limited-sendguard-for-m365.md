---
title: Información de la aplicación para SendGuard para M365 by Standss (Pacífico sur) PTE Limited
ms.author: elmalova
author: elenamalova
ms.date: 12/10/2021
ms.topic: article
...
description: Toda la información de seguridad y cumplimiento disponible para SendGuard para M365, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el registro CSA STAR.
...
---
# <a name="sendguard-for-m365"></a>SendGuard para M365
...
|:----------------|:-------------|
| Nombre de la aplicación | SendGuard para M365 |
