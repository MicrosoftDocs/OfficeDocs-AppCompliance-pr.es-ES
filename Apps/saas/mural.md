...
description: Toda la información de seguridad y cumplimiento disponible para MURAL, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro de CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/web-apps/tactivosincdbamural1608253315049.sol-43803-aek" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | MURAL |
| Sitio web de la empresa | [https://www.mural.co](https://www.mural.co) |
| Términos de uso de la aplicación | [https://www.mural.co/terms/terms-of-use](https://www.mural.co/terms/terms-of-use) |
| Funcionalidad básica de la aplicación | Pensar y colaborar visualmente |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://support.mural.co](https://support.mural.co) |
...
MURAL ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | MURAL solo requiere nombre, apellidos y dirección de correo electrónico con fines de inicio de sesión. El tipo de datos que se procesarán o almacenarán dependerá del cliente. |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | MURAL solo almacena el nombre, el apellido y el correo electrónico del usuario con fines de inicio de sesión. Cualquier otra información almacenada depende de la información que los clientes almacenen en sus murales. |
...
| Fecha de certificación de SOC2 más reciente | 2021-04-01 |
| ¿La aplicación cumple con los controles de organización de servicio (SOC 3)? | Sí |
| Fecha de certificación de SOC3 más reciente | 2021-04-01 |
...
| Dirección URL de la directiva de privacidad | https://www.mural.co/terms/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read | Delegado | Files.read necesario para cargar documentos en MURAL. | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
>| User.Read | Delegado | User.read porque el mural necesita nombre, apellidos y correo electrónico para la creación de la cuenta. | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
