---
title: Información de la aplicación para Adobe Acrobat Sign for Microsoft 365 by Adobe
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/20/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Adobe Acrobat Sign para Microsoft 365, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/web-apps/adobe.adobe_sign_msft_saas_offer" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Adobe Acrobat Sign para Microsoft 365 |
| Id. | adobe.adobe_sign_msft_saas_offer |
| Nombre de la empresa asociada | Adobe |
| Sitio web de la empresa | [https://acrobat.adobe.com/us/en/sign.html](https://acrobat.adobe.com/us/en/sign.html) |
...
| Funcionalidad básica de la aplicación | Mantenga los flujos de trabajo de firma de documentos moviéndose rápidamente al agregar Adobe Sign a Office-Outlook-Team. Desde estos productos, puede enviar y firmar documentos para firmas electrónicas y aprobaciones legalmente vinculantes &#8212; todo con la solución de firma electrónica preferida de Microsoft. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://helpx.adobe.com/sign/using/microsoft-teams-integrat...](https://helpx.adobe.com/sign/using/microsoft-teams-integration-user-guide.html) |
...
| ¿Qué datos procesa la aplicación? | Para actualizar el token de acceso, cuando el actual ha expirado. Por ejemplo, cuando el usuario está en una &quot;ventana de envío de firma&quot; y la deja inactiva durante demasiado tiempo, es necesario actualizar un nuevo token cuando el usuario está activo. |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Para actualizar el token de acceso, cuando el actual ha expirado. Por ejemplo, cuando el usuario está en una &quot;ventana de envío de firma&quot; y la deja inactiva durante demasiado tiempo, es necesario actualizar un nuevo token cuando el usuario está activo. |
...
| Fecha de certificación de SOC2 más reciente | 2020-11-24 |
...
| Dirección URL de la directiva de privacidad | https://helpx.adobe.com/sign/help/adobesign_gdpr_compliance.html |
...
| Si la aplicación no usa una de las bibliotecas anteriores, ¿qué biblioteca o bibliotecas de autenticación usa? | adal (con plan para pasar a MSAL) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Mail.ReadWrite | Delegado | Para rellenar el documento adjunto, los correos electrónicos del remitente y el receptor, y el contenido del mensaje de los correos electrónicos a Adobe Sign para enviarlos para su firma. Esto permite ahorrar tiempo al usuario para volver a escribir esos campos en Adobe Sign. Una vez firmado un contrato, redactamos automáticamente un nuevo correo electrónico para que el usuario envíe un correo electrónico para informar a sus destinatarios de que la transacción se ha realizado. Adobe Sign guardará los datos adjuntos como archivos temporales, que tienen una expiración de 24 horas. | [ea36b867-ca67-45fd-a61b-d2be86273167](../azure/ea36b867-ca67-45fd-a61b-d2be86273167.md) |
>| People.Read | Delegado | Para rellenar automáticamente la dirección de correo electrónico en la &quot;experiencia Enviar para firma&quot; , escribiendo algunas letras iniciales, no es necesario que los usuarios escriban todos los correos electrónicos. Adobe Sign solo almacenará el correo electrónico de los destinatarios y displayName en los contratos. | [ea36b867-ca67-45fd-a61b-d2be86273167](../azure/ea36b867-ca67-45fd-a61b-d2be86273167.md) |
>| User.Read | Delegado | Para leer el perfil del usuario y hacer coincidir su perfil (básicamente, su correo electrónico y userId) con nuestra base de datos para que pueda usar Adobe Sign. Para leer el perfil del usuario y hacer coincidir su perfil (básicamente, su correo electrónico y userId) con nuestra base de datos para que pueda usar Adobe Sign. | [ea36b867-ca67-45fd-a61b-d2be86273167](../azure/ea36b867-ca67-45fd-a61b-d2be86273167.md) |
>| offline_access | Delegado | Para actualizar el token de acceso, cuando el actual ha expirado. Por ejemplo, cuando el usuario está en una &quot;ventana de envío de firma&quot; y la deja inactiva durante demasiado tiempo, es necesario actualizar un nuevo token cuando el usuario está activo. Para actualizar el token de acceso, cuando el actual ha expirado. Por ejemplo, cuando el usuario está en una &quot;ventana de envío de firma&quot; y la deja inactiva durante demasiado tiempo, es necesario actualizar un nuevo token cuando el usuario está activo. | [ea36b867-ca67-45fd-a61b-d2be86273167](../azure/ea36b867-ca67-45fd-a61b-d2be86273167.md) |
>| OpenID | Delegado | Correo electrónico y UserId. Para iniciar sesión del usuario para garantizar su consentimiento para el permiso de uso de la aplicación Adobe Sign. El correo electrónico es el identificador único para los usuarios de Adobe Sign. Almacenamos el id. de correo electrónico para que podamos asignar todas las actividades de ese usuario a su registro de Adobe Sign. | [ea36b867-ca67-45fd-a61b-d2be86273167](../azure/ea36b867-ca67-45fd-a61b-d2be86273167.md) |
