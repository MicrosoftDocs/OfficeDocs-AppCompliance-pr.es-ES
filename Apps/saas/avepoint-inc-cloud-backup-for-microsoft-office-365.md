---
title: Información de la aplicación para Cloud Backup para Microsoft Office 365 por AvePoint Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/27/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Cloud Backup para Microsoft Office 365, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64876587"
---
# <a name="cloud-backup-for-microsoft-office-365"></a>Cloud Backup para Microsoft Office 365

<p></p><a href="https://aka.ms/appcertification" alt="This Microsoft 365 Certified app has been reviewed by Microsoft against industry standards and controls for security, compliance, and data handling practices. Where applicable, Microsoft has verified the developer's claims of compliance with reasonable and effective practices." target="_blank"><img alt="Click here for more information on the Microsoft Certified app program." src="../media/certified.png" width="650" /></a>
<p>Última actualización del desarrollador: 29 de septiembre de 2021</p>

* <a href="https://appsource.microsoft.com/product/web-apps/avepoint.cloudbackup_o365_transact" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Cloud Backup para Microsoft Office 365 |
...
| Funcionalidad básica de la aplicación | AvePoint Cloud Backup es la solución de copia de seguridad de nube a nube más completa del sector&#8217;para Microsoft 365. Con copias de seguridad ilimitadas y automatizadas y almacenamiento seguro en AvePoint&#8217;almacenamiento de Azure o su propia nube, solo tiene que decidir cuánto recuperar y cuándo. La restauración a petición y pormenorizada de nivel de elemento proporciona acceso en cualquier momento a los correos electrónicos, archivos, conversaciones, grabaciones, proyectos, tareas, grupos, Teams, Planner y sitios críticos para la empresa. |
...
| ¿Qué datos procesa la aplicación? | SharePoint site/ODFB site/Microsoft 365 group/Team id, name, url; |
...
| Fecha de certificación de SOC2 más reciente | 2/19/2021 |
...
>| ChannelSettings.ReadWrite.All | aplicación | Leer y escribir los nombres, las descripciones y la configuración de todos los canales | [4d69a8e1-9c38-4b33-b76f-9d59b5ae051b](../azure/4d69a8e1-9c38-4b33-b76f-9d59b5ae051b.md) |
