---
title: Información de la aplicación para firmas de correo electrónico de CodeTwo para Office 365 por CodeTwo
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Toda la información de seguridad y cumplimiento disponible para CodeTwo Email Signatures for Office 365, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66784994"
---
# <a name="codetwo-email-signatures-for-office-365"></a>Firmas de correo electrónico de CodeTwo para Office 365
...
* <a href="https://appsource.microsoft.com/product/web-apps/codetwo.3d2daeb9-a008-4070-a35c-cda39bd30a69" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Firmas de correo electrónico de CodeTwo para Office 365 |
| ID | codetwo.3d2daeb9-a008-4070-a35c-cda39bd30a69 |
| Nombre de la empresa asociada | CodeTwo |
| Sitio web de la empresa | [https://www.codetwo.com](https://www.codetwo.com) |
| Términos de uso de la aplicación | [https://www.codetwo.com/license-agreement](https://www.codetwo.com/license-agreement) |
| Funcionalidad básica de la aplicación | CodeTwo Email Signatures for Office 365 es un servicio en la nube basado en Azure que agrega firmas de correo electrónico automáticas, declinaciones de responsabilidades legales y personalización de marca a los mensajes enviados desde cualquier dispositivo cliente &amp; de correo electrónico. Permite a una persona (un administrador o un usuario delegado) o un equipo administrar de forma centralizada las firmas de correo electrónico en una organización de Microsoft 365 (Office 365). Las firmas se pueden agregar en la nube (después de enviar correos electrónicos) o directamente en Outlook a medida que los usuarios escriben. |
...
CodeTwo ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Datos de perfil de usuario, datos de correo de usuario |
...
| Dirección URL de la directiva de privacidad | https://www.codetwo.com/regulations/dpa/ |
...
>| Directory.Read.All | ambas | Permite que la aplicación lea los datos de la organización&#8217;directorio, como usuarios, grupos y aplicaciones. | [cb657bc2-9910-4b9c-82a0-6f4f3a47006b](../azure/cb657bc2-9910-4b9c-82a0-6f4f3a47006b.md) |
