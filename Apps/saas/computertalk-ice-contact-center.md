---
title: Información de la aplicación para ice Contact Center de ComputerTalk
ms.author: elmalova
author: elenamalova
ms.date: 02/01/2022
ms.topic: article
...
description: Toda la información de seguridad y cumplimiento disponible para ice Contact Center, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el Registro CSA STAR.
...
ms.locfileid: "62316191"
---
# <a name="ice-contact-center"></a>Centro de contacto de ice

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: January 31, 2022</p>

* <a href="https://appsource.microsoft.com/product/web-apps/computertalk.ice-contact-center" target="_blank">Ver en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Centro de contacto de ice |
| ID | computertalk.ice-contact-center |
| Nombre de la compañía asociada | ComputerTalk |
| Sitio web de la compañía | [https://www.computer-talk.com](https://www.computer-talk.com) |
...
| Funcionalidad principal de la aplicación | Ice proporciona el centro de contacto como una funcionalidad de servicio, incluido el enrutamiento de llamadas, el registro, la supervisión y la presentación de informes. |
...
ComputerTalk ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | AzureADGuid (vinculación de cuentas).  La dirección de correo electrónico y el número de teléfono se pueden importar desde AAD. |
...
| Fecha de certificación SOC2 más reciente |  2021-10-15 |
