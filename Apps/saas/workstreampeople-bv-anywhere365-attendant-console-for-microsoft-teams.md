---
title: Información de la aplicación para consola de operador de Anywhere365 para Microsoft Teams por WORKSTREAMPEOPLE BV
ms.author: elmalova
author: elenamalova
ms.date: 02/22/2022
ms.topic: article
...
ms.locfileid: "63081488"
---
# <a name="anywhere365-attendant-console-for-microsoft-teams"></a>Consola de operador anywhere365 para Microsoft Teams

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: January 17, 2022</p>

* <a href="https://appsource.microsoft.com/product/web-apps/workstreampeople.attendantconsoleformsftteams" target="_blank">Ver en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Consola de operador anywhere365 para Microsoft Teams |
...
| Funcionalidad principal de la aplicación | La consola de operador más eficaz y fácil de usar del mercado, nativa de Microsoft Teams |
...
WORKSTREAMPEOPLE BV ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://delivery.anywhere365.io/deployment/msteams/Anywhere365-Attendant-Console-Compliance.pdf |
