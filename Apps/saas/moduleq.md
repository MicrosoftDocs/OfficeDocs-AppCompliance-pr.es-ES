---
title: Información de la aplicación para ModuleQ por ModuleQ
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Toda la información de seguridad y cumplimiento disponible para ModuleQ, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro de CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/web-apps/moduleq.modules-platform" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | ModuleQ |
...
| Funcionalidad básica de la aplicación | ModuleQ proporciona a los profesionales de primera línea información empresarial crítica personalizada.  |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://moduleq.com/product](https://moduleq.com/product) |
...
ModuleQ ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Datos de perfil de usuario, metadatos de correo electrónico de usuario, metadatos del calendario de usuario |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Datos de perfil de usuario, metadatos de correo electrónico de usuario, metadatos del calendario de usuario |
...
| Dirección URL de la directiva de privacidad | https://www.moduleq.com/privacy-policy |
...
| Si la aplicación no usa una de las bibliotecas anteriores, ¿qué biblioteca o bibliotecas de autenticación usa? | Microsoft.AspNetCore.Authentication.MicrosoftAccount |
