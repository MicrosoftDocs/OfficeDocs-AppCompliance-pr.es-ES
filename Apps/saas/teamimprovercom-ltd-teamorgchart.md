---
title: Información de la aplicación para TeamOrgChart de TeamImprover.Com Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/14/2022
...
description: Toda la información de seguridad y cumplimiento disponible para TeamOrgChart, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://appsource.microsoft.com/product/web-apps/teamorgchart.66763c6e-79ef-434a-b4b5-8c64c980ac13" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por TeamImprover.Com Ltd a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | TeamOrgChart |
| Id. | teamorgchart.66763c6e-79ef-434a-b4b5-8c64c980ac13 |
| Nombre de la empresa asociada | TeamImprover.Com Ltd |
| Sitio web de la empresa | [https://teamimprover.com](https://teamimprover.com) |
| Términos de uso de la aplicación | [https://teamorgchart.com/termsofservice](https://teamorgchart.com/termsofservice) |
| Funcionalidad básica de la aplicación | Crear, compartir, buscar e imprimir gráficos de organización |
| Ubicación de la sede central de la empresa | Reino Unido de Gran Bretaña e Irlanda del Norte (el) |
| Página de información de la aplicación | [https://teamorgchart.com/website/features.cshtml](https://teamorgchart.com/website/features.cshtml) |
...
Esta información ha sido proporcionada por TeamImprover.Com Ltd sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | La aplicación procesa la información de jerarquía de la organización.   |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | TeamOrgChart almacena los metadatos que describen el gráfico, por ejemplo, el nombre del gráfico, las reglas, los marcadores, el número de niveles de visualización, etc. |
...
| Dirección URL de la directiva de privacidad | https://teamorgchart.com/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Delegado | La aplicación compila y muestra un organigrama a partir de Azure AD.  Debe poder leer la información del usuario de Azure AD  | [b12699ab-e60a-46b1-8c9e-231d489947aaa](../azure/b12699ab-e60a-46b1-8c9e-231d489947aa.md) |
>| User.Read.All | Delegado | La aplicación compila y muestra un organigrama a partir de Azure AD.  Debe poder leer la información del usuario de Azure AD  | [b12699ab-e60a-46b1-8c9e-231d489947aaa](../azure/b12699ab-e60a-46b1-8c9e-231d489947aa.md) |
