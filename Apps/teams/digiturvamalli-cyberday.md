---
title: Información de la aplicación para Cyberday by Digiturvamalli
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Cyberday, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/a8e43ae4-a97b-4d1a-b364-b27794da19a4" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001774" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Digiturvamalli |
| Sitio web de la empresa | [https://cyberday.ai](https://cyberday.ai) |
| Términos de uso de la aplicación | [https://cyberday.ai/terms-of-use](https://cyberday.ai/terms-of-use) |
| Funcionalidad básica de la aplicación | Cyberday es un sistema de administración de seguridad de la información que guía al cliente hacia el cumplimiento de los marcos de seguridad que han seleccionado. |
| Ubicación de la sede central de la empresa | Finlandia |
| Página de información de la aplicación | [https://cyberday.ai](https://cyberday.ai) |
...
Digiturvamalli ha proporcionado esta información sobre cómo recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | Use el correo electrónico para identificar al usuario y mostrar a los administradores de aplicaciones quién es este usuario. | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](../azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941.md) |
>| OpenID | Delegado | Uso del identificador de usuario para identificar al usuario | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](../azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941.md) |
