---
title: Información de la aplicación para Zesavi por Zesavi GmbH
ms.author: elmalova
author: elenamalova
ms.date: 01/03/2022
ms.topic: article
...
description: Toda la información de seguridad y cumplimiento disponible para Zesavi, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el Registro CSA STAR.
...
|:----------------|:-------------|
| Nombre de la aplicación | Zesavi |
| Id. | WA200003621 |
