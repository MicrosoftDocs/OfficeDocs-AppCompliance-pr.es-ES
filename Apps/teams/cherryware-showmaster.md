---
title: Información de la aplicación para Showmaster by cherryware
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/19/2022
...
ms.locfileid: "66892071"
---
# <a name="showmaster"></a>Showmaster

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador el 5 de julio de 2022</p>

* <a href="https://teams.microsoft.com/l/app/8c9f8e8e-fe2d-4542-84ab-1d30c4a735fc" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004411" target="_blank">Vista en AppSource</a>
...
| Funcionalidad básica de la aplicación | Showmaster crea un marco emocionante alrededor de su charla durante el tiempo de espera y rompe con titulares, cuenta atrás, música y mucho más. |
