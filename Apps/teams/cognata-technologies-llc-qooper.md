---
title: Información de la aplicación para Qooper de COGNATA TECHNOLOGIES, LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Qooper, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64878737"
---
# <a name="qooper"></a>Qooper

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 11 de junio de 2021</p>

* <a href="https://teams.microsoft.com/l/app/fadca663-cc96-4756-8a3b-271000082238" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002964" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | COGNATA TECHNOLOGIES, LLC |
| Sitio web de la empresa | [https://qooper.io](https://qooper.io) |
| Términos de uso de la aplicación | [https://qooper.io/terms-of-use](https://qooper.io/terms-of-use) |
| Funcionalidad básica de la aplicación | Lograr objetivos con contenido de conexiones &amp; significativas. Envuelve a sus personas con conexiones y contenido significativos a través de la mentoría, el entrenamiento entre pares, el aprendizaje comunitario y las redes. Qooper se asocia con empresas, universidades y organizaciones sin fines de lucro de todos los tamaños para automatizar el trabajo de administración de programas de mentoría, conectar a las personas en una plataforma interactiva de mentoring-aprendizaje y mostrar el análisis de programas. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://qooper.io](https://qooper.io) |
...
Esta información ha sido proporcionada por COGNATA TECHNOLOGIES, LLC sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
