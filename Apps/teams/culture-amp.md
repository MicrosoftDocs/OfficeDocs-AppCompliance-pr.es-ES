---
title: Información de la aplicación para el amplificador de referencia cultural por amplificador de referencia cultural
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/06/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Culture Amp, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64698984"
---
# <a name="culture-amp"></a>Amplificador de referencia cultural
...
* <a href="https://teams.microsoft.com/l/app/13a11229-3c3e-49d5-843b-71d204a5b5ee" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001744" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Culture Amp a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Amplificador de referencia cultural |
| ID | WA200001744 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Amplificador de referencia cultural |
| Sitio web de la empresa | [https://www.cultureamp.com](https://www.cultureamp.com) |
| Términos de uso de la aplicación | [https://www.cultureamp.com/terms/](https://www.cultureamp.com/terms/) |
| Funcionalidad básica de la aplicación | Ayudar a los empleados a compartir comentarios y acceder a información de Culture Amp desde dentro de Microsoft Teams |
...
Esta información ha sido proporcionada por Culture Amp sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | direcciones de correo electrónico de referencia de conversación |
| Si la inestructura subyacente procesa o almacena datos de clientes de Microsoft, ¿dónde se almacenan geográficamente estos datos? | Irlanda, Estados Unidos de América |
...
| Dirección URL de la directiva de privacidad | https://www.cultureamp.com/terms/ |
...
| ¿Ha revisado y cumplido todos los procedimientos recomendados aplicables descritos en la lista de comprobación de integración de la plataforma de identidad de Microsoft? | No |
