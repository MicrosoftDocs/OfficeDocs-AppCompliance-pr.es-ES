---
title: Información de la aplicación para In Case of Crisis by RockDove Solutions, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/08/2022
...
description: Toda la información de seguridad y cumplimiento disponible para En caso de crisis, sus directivas de control de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/cf430644-447e-4572-8467-3892596d05c7" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003194" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | RockDove Solutions, Inc. |
| Sitio web de la empresa | [https://www.rockdovesolutions.com](https://www.rockdovesolutions.com) |
...
| Funcionalidad básica de la aplicación | En caso de crisis es la plataforma diseñada específicamente para el ciclo de vida dinámico de la gestión de problemas y crisis. Nuestra aplicación permite a las organizaciones compartir y activar fácilmente cuadernos de estrategias accionables que incluyen los protocolos de respuesta y los procedimientos recomendados a medida que se desarrolla una situación.  También puede administrar y capturar el ciclo de vida completo de los problemas que afectan a su negocio, desde los informes iniciales hasta la resolución.   |
...
>| Files.ReadWrite.All | Delegado | Para problemas de calendario de administración y cambios y notificaciones de archivos | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
