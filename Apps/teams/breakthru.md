---
title: Información de la aplicación para Breakthru by Breakthru
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Breakthru, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65152097"
---
# <a name="breakthru"></a>Breakthru

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 28 de abril de 2022</p>

* <a href="https://teams.microsoft.com/l/app/693aa4f0-e16c-11ea-ab9b-11514b3de7ae" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002243" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Breakthru |
| Sitio web de la empresa | [https://breakthru.me](https://breakthru.me) |
| Términos de uso de la aplicación | [https://breakthru.me/terms](https://breakthru.me/terms) |
| Funcionalidad básica de la aplicación | Diminutas pausas para compartir y jugar, integradas en tu día. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://breakthru.me](https://breakthru.me) |
...
| ¿Qué datos se almacenan en las bases de datos? | Dirección de correo electrónico. Microsoft Teams identificador de inquilino. Microsoft Teams id. Mantenemos un historial de los saltos que ha seleccionado y le permiten establecer recordatorios para participar en una interrupción. |
| Si la inestructura subyacente procesa o almacena datos de clientes de Microsoft, ¿dónde se almacenan geográficamente estos datos? | Estados Unidos de América, Alemania, Reino Unido de Gran Bretaña e Irlanda del Norte (el) |
...
| Dirección URL de la directiva de privacidad | https://breakthru.me/privacy#h.wc7yv5k6csnq |
