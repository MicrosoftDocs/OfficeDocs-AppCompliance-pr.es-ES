---
title: Información de la aplicación para el héroe de salud de Health Hero
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Health Hero, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro de CSA STAR.
...
ms.locfileid: "64875417"
---
# <a name="health-hero"></a>Health Hero

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador el 1 de agosto de 2021</p>

* <a href="https://teams.microsoft.com/l/app/1394c825-0026-4f33-bcc9-abaa9ae5d83b" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001405" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Health Hero a Microsoft:
...
| Nombre de la empresa asociada | Health Hero |
| Sitio web de la empresa | [https://gohealthhero.com](https://gohealthhero.com) |
| Términos de uso de la aplicación | [https://www.gohealthhero.com/terms](https://www.gohealthhero.com/terms) |
| Funcionalidad básica de la aplicación | Health Hero permite a los usuarios capturar actividades en buen estado y recibir puntos de actividad. |
...
Health Hero ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC1 más reciente | 2021-01-01 |
...
| Fecha de certificación de SOC3 más reciente | 2021-01-01 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | aplicación | Solo información de usuario para crear una cuenta. | [5f1f4eb7-479e-42f3-b86f-4c1f53e1c222](../azure/5f1f4eb7-479e-42f3-b86f-4c1f53e1c222.md) |
