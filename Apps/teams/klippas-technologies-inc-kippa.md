---
title: Información de la aplicación para Kippa by KLIPPAS Technologies inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/13/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Kippa, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64881297"
---
# <a name="kippa"></a>Kippa

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 13 de octubre de 2021</p>

* <a href="https://teams.microsoft.com/l/app/49d0e480-ede2-11ea-85fc-27f7e2c29730" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003327" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | KLIPPAS Technologies inc. |
| Sitio web de la empresa | [https://www.kippa.app](https://www.kippa.app) |
| Términos de uso de la aplicación | [https://www.kippa.app/terms-of-service/](https://www.kippa.app/terms-of-service/) |
| Funcionalidad básica de la aplicación | Establezca rápidamente recordatorios personales, compartidos o de canal de un solo uso o periódicos desde dentro de Microsoft Teams |
| Ubicación de la sede central de la empresa | Canadá |
| Página de información de la aplicación | [https://www.kippa.app/kippa-app/](https://www.kippa.app/kippa-app/) |
...
Esta información ha sido proporcionada por KLIPPAS Technologies inc. sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Enumerar los tipos de directivas admitidas | Igual que Microsoft Teams, ya que los usuarios tienen que iniciar sesión en Teams para obtener acceso a Kippa. |
