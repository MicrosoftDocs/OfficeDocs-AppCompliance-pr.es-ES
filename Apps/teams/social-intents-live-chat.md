---
title: Información de la aplicación para chat en vivo por intenciones sociales
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/09/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Live Chat, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro de CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/a55635a5-8def-48e7-bcff-230cd43d3405" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000440" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Intenciones sociales a Microsoft:
...
| Nombre de la empresa asociada | Social Intents |
| Sitio web de la empresa | [https://www.socialintents.com](https://www.socialintents.com) |
| Términos de uso de la aplicación | [https://www.socialintents.com/tos.html](https://www.socialintents.com/tos.html) |
| Funcionalidad básica de la aplicación | Chat en vivo permite Microsoft Teams chatear con los visitantes del sitio web directamente desde su equipo. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.socialintents.com/teams-live-chat.jsp](https://www.socialintents.com/teams-live-chat.jsp) |
...
Esta información la ha proporcionado Social Intents sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
