---
title: Información de la aplicación para YAROOMS de YAROOMS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/15/2021
...
description: Toda la información de seguridad y cumplimiento disponible para YAROOMS, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/495f8194-bdf2-41a3-8292-3f53b004c2e6" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001225" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | YAROOMS |
| Sitio web de la empresa | [https://yarooms.com](https://yarooms.com) |
| Términos de uso de la aplicación | [https://www.yarooms.com/legal/terms-conditions/](https://www.yarooms.com/legal/terms-conditions/) |
| Funcionalidad básica de la aplicación | Room &amp; Desk Booking Software |
| Ubicación de la sede central de la empresa | Rumania |
| Página de información de la aplicación | [https://yarooms.com/help](https://yarooms.com/help) |
| ¿Cuál es el entorno de hospedaje o el modelo de servicio que se usa para ejecutar la aplicación? | Iaas |
| ¿Qué proveedores de nube de hospedaje usa la aplicación? | Aws, Azure, GCP |
...
YAROOMS ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://www.yarooms.com/legal/privacy-policy |
