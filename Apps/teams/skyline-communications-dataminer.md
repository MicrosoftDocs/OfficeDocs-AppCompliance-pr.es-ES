---
title: Información de la aplicación para DataMiner de Skyline Communications
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/22/2021
...
description: Toda la información de seguridad y cumplimiento disponible para DataMiner, sus directivas de tratamiento de datos, su Microsoft Cloud App Security de catálogo de aplicaciones e información de seguridad y cumplimiento en el Registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/9a09d087-5d07-4481-b34f-cd053eab7925" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003501" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Las comunicaciones de Horizonte a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | DataMiner |
| ID | WA200003501 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | Skyline Communications |
| Sitio web de la compañía | [https://www.skyline.be](https://www.skyline.be) |
| Términos de uso de la aplicación | [https://dataminer.services/terms/terms-of-service.html](https://dataminer.services/terms/terms-of-service.html) |
| Funcionalidad principal de la aplicación | Skyline Communications es el proveedor líder global de soluciones de software de orquestación, NMS y OSS de varios proveedores integrales para el sector de medios y banda ancha de TIC. Nuestra plataforma de administración de red DataMiner insignia, que recibió varios reconocimientos de gran prestigio, permite la integración de un extremo a otro de los ecosistemas técnicos más complejos y ha sido implementada por operadores líderes en todo el mundo. |
| Ubicación central de la empresa | Bélgica |
| Página de información de la aplicación | [https://www.skyline.be/dataminer/cloud-services](https://www.skyline.be/dataminer/cloud-services) |
...
Esta información ha sido proporcionada por Horizonte Comunicaciones acerca de cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://dataminer.services/terms/privacy.html |
