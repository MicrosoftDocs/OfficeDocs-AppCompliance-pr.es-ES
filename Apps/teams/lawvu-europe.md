---
title: Información de la aplicación para LawVu Europa por LawVu
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: Toda la información de seguridad y cumplimiento disponible para LawVu Europe, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64769154"
---
# <a name="lawvu-europe"></a>LawVu Europa

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 22 de febrero de 2022</p>

* <a href="https://teams.microsoft.com/l/app/ce6fa59d-9c48-492c-b0e2-434abe99c355" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003931" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por LawVu a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | LawVu Europa |
| ID | WA200003931 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | LawVu |
| Sitio web de la empresa | [https://lawvu.com](https://lawvu.com) |
...
| Funcionalidad básica de la aplicación | Los usuarios empresariales pueden generar solicitudes legales directamente desde Teams.  La integración captura todos los campos pertinentes, incluido el contenido y los datos adjuntos del mensaje original, y crea el asunto en LawVu para que&#8217;parte del equipo legal&#8217;sistema de registro. |
...
Esta información ha sido proporcionada por LawVu sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | El archivo adjunto de MS Teams. |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | El archivo adjunto de los equipos de MS se extrae en nuestro almacén de datos. |
...
| Dirección URL de la directiva de privacidad | https://lawvu.com/trust-center/privacy/gdpr |
