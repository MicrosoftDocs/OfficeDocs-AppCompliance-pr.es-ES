---
title: Información de la aplicación para Semplisio e-commerce Manager by HQuadro
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/22/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Semplisio e-commerce Manager, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
<p>Última actualización del desarrollador el 4 de mayo de 2022</p>

* <a href="https://teams.microsoft.com/l/app/9aa7a790-c743-4436-a4ba-1d540cbad3fe" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004286" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Semplisio e-commerce Manager |
| Id. | WA200004286 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | HQuadro |
| Sitio web de la empresa | [https://www.hquadro.it](https://www.hquadro.it) |
| Términos de uso de la aplicación | [https://www.semplisio.it/tc](https://www.semplisio.it/tc) |
| Funcionalidad básica de la aplicación | Gestisci il tuo ecommerce su Microsoft Teams: automatizza i processi, integrando i tuoi software e Microsoft 365 |
| Ubicación de la sede central de la empresa | Italia |
| Página de información de la aplicación | [https://www.semplisio.it/ecommerce-manager](https://www.semplisio.it/ecommerce-manager) |
...
| ¿Qué datos procesa la aplicación? | perfil de correo electrónico Channel.ReadBasic.All Files.ReadWrite.AppFolder Files.ReadWrite.All Files.Read.All User.Read Team.ReadBasic.All Sites.Read.All openid offline_access Contacts.ReadWrite |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | id Team, id channel |
| Si la inestructura subyacente procesa o almacena datos de clientes de Microsoft, ¿dónde se almacenan geográficamente estos datos? | Países Bajos (el), Finlandia |
...
| Dirección URL de la directiva de privacidad | https://www.semplisio.it/privacy-policy/ |
...
| Si la aplicación no usa una de las bibliotecas anteriores, ¿qué biblioteca o bibliotecas de autenticación usa? | @microsoft/teamsfx |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Delegado | lo usamos para mostrar en la aplicación la lista de canales | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| Contacts.ReadWrite | Delegado | lo usamos para escribir contactos en Outlook | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| Files.Read.All | Delegado | lo usamos para leer archivos en la unidad one del cliente | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| Files.ReadWrite.All | Delegado | lo usamos para escribir o crear un archivo en one drive del cliente | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| Files.ReadWrite.AppFolder | Delegado | lo usamos para leer y escribir o crear una carpeta en one drive del cliente | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| Sites.Read.All | Delegado | permitir que la aplicación lea documentos y una lista de elementos de one drive del cliente | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| Team.ReadBasic.All | Delegado | lo usamos para mostrar en la aplicación la lista de equipos | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| User.Read | Delegado | lo usamos para generar tokens en nombre de | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| correo electrónico | Delegado | lo usamos para el inicio de sesión único | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| offline_access | Delegado | lo usamos para generar tokens en nombre de | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| OpenID | Delegado | lo usamos para generar tokens en nombre de | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| perfil | Delegado | lo usamos para dar la bienvenida al cliente | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
