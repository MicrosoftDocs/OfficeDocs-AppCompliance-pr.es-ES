---
title: Información de la aplicación para administrador de archivos de Solutions2Share GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Toda la información de seguridad y cumplimiento disponible para el Administrador de archivos, sus directivas de tratamiento de datos, su Microsoft Cloud App Security de catálogo de aplicaciones e información de seguridad y cumplimiento en el Registro CSA STAR.
...
ms.locfileid: "64463996"
---
# <a name="file-manager"></a>Administrador de archivos

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: December 30, 2021</p>

* <a href="https://teams.microsoft.com/l/app/4946e155-584a-412d-aac1-48975e073587" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003770" target="_blank">Ver en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Administrador de archivos |
| Id. | WA200003770 |
...
| Funcionalidad principal de la aplicación | Administrar archivos a través de todos los equipos de Microsoft Teams |
| Ubicación central de la empresa | Alemania |
| Página de información de la aplicación | [https://www.solutions2share.com/file-manager/](https://www.solutions2share.com/file-manager/) |
...
| ¿Qué datos se almacenan en las bases de datos? | TenantID,User Principal Name |
