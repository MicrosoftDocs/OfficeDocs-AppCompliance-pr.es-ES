---
title: Información de la aplicación para el moderador de CT por customertimes
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Toda la información de seguridad y cumplimiento disponible para CT Presenter, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66817721"
---
# <a name="ct-presenter"></a>Moderador de CT
...
* <a href="https://teams.microsoft.com/l/app/f33e9d75-e765-49f9-b7b2-d4bfa89066a0" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004401" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Customertimes a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Moderador de CT |
| ID | WA200004401 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Customertimes |
| Sitio web de la empresa | [https://customertimes.com](https://customertimes.com) |
| Términos de uso de la aplicación | [https://rd.ctclm.com/eula](https://rd.ctclm.com/eula) |
| Funcionalidad básica de la aplicación | Presentación remota |
| Ubicación de la sede central de la empresa | Francia |
| Página de información de la aplicación | [https://help.customertimes.com/articles/](https://help.customertimes.com/articles/) |
...
Esta información ha sido proporcionada por Customertimes sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
