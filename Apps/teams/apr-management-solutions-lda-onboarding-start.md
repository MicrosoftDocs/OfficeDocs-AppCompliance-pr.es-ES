---
title: Información de la aplicación para la incorporación de Start by APR - Management Solutions Lda.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/17/2022
...
description: Toda la información de seguridad y cumplimiento disponible para El inicio de incorporación, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65455031"
---
# <a name="onboarding-start"></a>Inicio de incorporación
...
* <a href="https://teams.microsoft.com/l/app/35729029-db8c-4cf5-b71f-9dc9511e0563" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004025" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por APR - Management Solutions Lda. a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Inicio de incorporación |
| ID | WA200004025 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | APR - Soluciones de administración Lda. |
| Sitio web de la empresa | [https://www.apr.pt](https://www.apr.pt) |
| Términos de uso de la aplicación | [https://www.apr.pt/terms-and-conditions/](https://www.apr.pt/terms-and-conditions/) |
| Funcionalidad básica de la aplicación | Automatice el proceso de incorporación de la organización y comunique a los nuevos empleados fácilmente. |
...
Esta información ha sido proporcionada por APR - Management Solutions Lda. acerca de cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://www.apr.pt/privacy-statement/ |
