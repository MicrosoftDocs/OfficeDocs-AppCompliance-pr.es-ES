---
title: Información de la aplicación para Kami by Kami
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Kami, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/95b82c84-8994-45f6-946a-dda105f9d5df" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004148" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Kami a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Kami |
| ID | WA200004148 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Kami |
| Sitio web de la empresa | [https://kamiapp.com](https://kamiapp.com) |
| Términos de uso de la aplicación | [https://kamiapp.com/terms-of-service/](https://kamiapp.com/terms-of-service/) |
| Funcionalidad básica de la aplicación | Empodera a todos a amar el aprendizaje con Kami &#8211; ahora por Microsoft Teams. |
| Ubicación de la sede central de la empresa | Nueva Zelanda |
...
Kami ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Perfil de usuario (nombre, correo electrónico). OneDrive archivos y metadatos. |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Datos de perfil de usuario (nombre, correo electrónico, identificador). OneDrive metadatos de archivo (nombre de archivo, id. de elemento, id. de unidad). Anotaciones de documento. |
...
| Dirección URL de la directiva de privacidad | https://www.kamiapp.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | Delegado | Para permitir que el usuario abra, actualice y exporte archivos OneDrive y SharePoint en Kami. | [5fb90a92-665c-4ec3-863e-e37572074eb2](../azure/5fb90a92-665c-4ec3-863e-e37572074eb2.md) |
>| User.Read | Delegado | Para acceder a los datos de perfil de usuario para rellenar el perfil de Kami, por ejemplo: correo electrónico y nombre. | [5fb90a92-665c-4ec3-863e-e37572074eb2](../azure/5fb90a92-665c-4ec3-863e-e37572074eb2.md) |
