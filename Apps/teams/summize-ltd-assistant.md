---
title: Información de la aplicación para sumar asistente por Summize (Ltd)
ms.author: elmalova
author: elenamalova
ms.date: 01/11/2022
ms.topic: article
...
description: Toda la información de seguridad y cumplimiento disponible para Summize Assistant, sus directivas de control de datos, su información de catálogo de aplicaciones Microsoft Cloud App Security y la información de seguridad y cumplimiento en el Registro CSA STAR.
...
---
# <a name="summize-assistant"></a>Asistente para sumar

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: November 17, 2021</p>

* <a href="https://teams.microsoft.com/l/app/24d7e745-c1ed-4f60-a843-ba1629ef3ed4" target="_blank">Ver en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003577" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Summize (Ltd) a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Asistente para sumar |
| Id. | WA200003577 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | Summize (Ltd) |
| Sitio web de la compañía | [https://www.summize.com](https://www.summize.com) |
| Términos de uso de la aplicación | [https://www.summize.com/terms-and-conditions](https://www.summize.com/terms-and-conditions) |
| Funcionalidad principal de la aplicación | Summize facilita la revisión y creación de contratos. Summize es cambiar la forma en que las empresas comprenden e interactúan con los contratos. Con nuestro software inteligente y conversacional, se sobrecargan los procesos de contrato y se desbloquean los conocimientos contractuales.  Summize Assistant app within Teams helps users to upload contracts (PDF and docx formats) for review.  Los usuarios también pueden crear contratos con plantillas creadas en la aplicación Summize.   |
...
Summize (Ltd) ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Documentos originales y revisiones de clientes de documentos |
...
| Dirección URL de la directiva de privacidad | https://app.summize.com/assets/documents/SummizePrivacyPolicy.pdf |
