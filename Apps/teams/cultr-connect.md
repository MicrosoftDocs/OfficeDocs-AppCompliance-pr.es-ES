---
title: Información de la aplicación de Cultr Conectar por Cultr
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Cultr Conectar, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64879387"
---
# <a name="cultr-connect"></a>Cultr Connect

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 28 de junio de 2021</p>

* <a href="https://teams.microsoft.com/l/app/3b1655d0-505a-4b03-a01f-519a91f77625" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003008" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Cultr a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Cultr Connect |
| Id. | WA200003008 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Cultr |
| Sitio web de la empresa | [https://cultr.works](https://cultr.works) |
| Términos de uso de la aplicación | [https://cultr.works/terms-of-use/](https://cultr.works/terms-of-use/) |
| Funcionalidad básica de la aplicación | Ver lo que hacen sus compañeros en Cultr |
| Ubicación de la sede central de la empresa | Luxemburgo |
| Página de información de la aplicación | [https://cultr.works/how-it-works/](https://cultr.works/how-it-works/) |
...
Esta información ha sido proporcionada por Cultr sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | aplicación | Identifique al usuario para actualizar la información del usuario y enviar los datos pertinentes. | [3b1655d0-505a-4b03-a01f-519a91f77625](../azure/3b1655d0-505a-4b03-a01f-519a91f77625.md) |
>| GroupMember.Read.All | aplicación | Identifique al usuario para actualizar la información del usuario y enviar los datos pertinentes. | [3b1655d0-505a-4b03-a01f-519a91f77625](../azure/3b1655d0-505a-4b03-a01f-519a91f77625.md) |
>| Organization.Read.All | aplicación | Identifique al usuario para actualizar la información del usuario y enviar los datos pertinentes. | [3b1655d0-505a-4b03-a01f-519a91f77625](../azure/3b1655d0-505a-4b03-a01f-519a91f77625.md) |
>| TeamMember.Read.All | aplicación | Identifique al usuario para actualizar la información del usuario y enviar los datos pertinentes. | [3b1655d0-505a-4b03-a01f-519a91f77625](../azure/3b1655d0-505a-4b03-a01f-519a91f77625.md) |
>| User.Read | aplicación | Identifique al usuario para actualizar la información del usuario y enviar los datos pertinentes. | [3b1655d0-505a-4b03-a01f-519a91f77625](../azure/3b1655d0-505a-4b03-a01f-519a91f77625.md) |
>| User.Read.All | aplicación | Identifique al usuario para actualizar la información del usuario y enviar los datos pertinentes. | [3b1655d0-505a-4b03-a01f-519a91f77625](../azure/3b1655d0-505a-4b03-a01f-519a91f77625.md) |
>| User.ReadBasic.All | aplicación | Identifique al usuario para enviar los datos pertinentes. | [3b1655d0-505a-4b03-a01f-519a91f77625](../azure/3b1655d0-505a-4b03-a01f-519a91f77625.md) |
>| OpenID | aplicación | Identifique al usuario para actualizar la información del usuario y enviar los datos pertinentes. | [3b1655d0-505a-4b03-a01f-519a91f77625](../azure/3b1655d0-505a-4b03-a01f-519a91f77625.md) |
