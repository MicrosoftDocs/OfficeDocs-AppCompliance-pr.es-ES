---
title: Información de la aplicación para cerebros más grandes eLearning de Biggerbrains
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toda la información de seguridad y cumplimiento disponible para el eLearning de Bigger Brains, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/12345514-afee-abcd-acde-c5b34109abcd" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002366" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://getbiggerbrains.com](https://getbiggerbrains.com) |
| Términos de uso de la aplicación | [https://getbiggerbrains.com/privacy-legal/](https://getbiggerbrains.com/privacy-legal/) |
| Funcionalidad básica de la aplicación | Nuestra galardonada biblioteca de cursos de formación en línea ya está disponible directamente dentro de Microsoft Teams.  Accede fácilmente a más de 180 cursos de eLearning y más de 3000 lecciones de vídeo agregando una pestaña Cerebros más grandes en cualquier canal. Los temas disponibles incluyen: temas Microsoft Teams &amp; Office 365Microsoft Excel, Word, Outlook, PowerPoint, Power BI y Business. |
...
Biggerbrains ha proporcionado esta información sobre cómo recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC1 más reciente | 2021-05-13 |
| ¿La aplicación cumple con los controles de organización de servicio (SOC 2)? | Sí |
| Fecha de certificación de SOC2 más reciente | 2021-05-13 |
| ¿La aplicación cumple con los controles de organización de servicio (SOC 3)? | Sí |
| Fecha de certificación de SOC3 más reciente | 2021-05-13 |
