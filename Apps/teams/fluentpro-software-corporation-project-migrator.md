...
* <a href="https://teams.microsoft.com/l/app/8cd35615-e306-4b3d-8e93-17520129b60a" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003160" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://projectmigrator.com](https://projectmigrator.com) |
| Términos de uso de la aplicación | [https://projectmigrator.com/terms-of-use](https://projectmigrator.com/terms-of-use) |
| Funcionalidad básica de la aplicación | Project Migrator es un software de migración de datos automatizado. Admite varios escenarios de migración con los sistemas de administración de proyectos más populares, como Microsoft Planner, Trello, Asana, Microsoft Project Online, Project para la migración web, Monday.com y Smartsheets. Project Migrator es un software totalmente automatizado, fácil de usar, basado en la nube y rápido que ayuda a las empresas a migrar proyectos entre las herramientas de administración de proyectos más populares. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://help.fluentpro.com/147404-project-migrator](https://help.fluentpro.com/147404-project-migrator) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Delegado | Lea los grupos y su pertenencia para migrar al otro inquilino. | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| Group.ReadWrite.All | Delegado | Nombre del grupo, miembros, planes y tareas. Use la información de grupos, planes y tareas para la migración de datos de Planner. | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| Sites.ReadWrite.All | Delegado | Migre SharePoint documentos para los datos adjuntos de tareas de MS Planner. | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| User.Read | Delegado | UPN para almacenar la información de resumen de migración de MS Planner vinculada a la cuenta. | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| User.ReadBasic.All | Delegado | Use la información de usuario para migrar las asignaciones de tareas de MS Planner y la pertenencia a grupos. | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| offline_access | Delegado | Los tokens de actualización y acceso se usan para acceder a los datos de MS Planner. | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| User.Read | Delegado | Nombre, Apellidos, Nombre de la empresa, Teléfono, Correo electrónico corporativo. Estos datos se usan para los procesos de registro y autenticación. | [c36d31a2-8de1-4eb5-9e7d-01da45244c04](../azure/c36d31a2-8de1-4eb5-9e7d-01da45244c04.md) |
