---
title: Introducción a la colaboración de Power BI
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
---
# <a name="power-bi-collaboration-overview"></a>Introducción a la colaboración de Power BI
...
* <a href="https://teams.microsoft.com/l/app/90381cb0-998f-4ba3-9699-130201de5ddb" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381384" target="_blank">Vista en AppSource</a>
...
| Términos de uso de la aplicación | [https://www.ataira.com/TermsofUse](https://www.ataira.com/TermsofUse) |
| Funcionalidad básica de la aplicación | El complemento de Ataira le permite ver los paneles e informes de Power BI. Envíe notificaciones a los grupos y equipos corporativos, agregue acciones de seguimiento, inserte Power BI vínculos públicos, agregue comentarios a los puntos de datos de los informes y agregue archivos de datos como orígenes de datos a los informes de Power BI y actualice en tiempo real. Permitir que el equipo de inteligencia empresarial colabore más estrechamente en los esfuerzos de inteligencia empresarial en una sola ubicación. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.ataira.com/Microsoft/PowerBI/Collaboration](https://www.ataira.com/Microsoft/PowerBI/Collaboration) |
...
Ataira ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Enumerar los tipos de directivas admitidas | Autenticación multifactor Permite solo Intune dispositivos inscritos acceder a servicios específicos Restricción de ubicaciones de usuario e intervalos IP |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | También permisos para ChannelMessage.Send Team.ReadBasic.All User.Read. Se usan para permitir que el usuario seleccione el grupo de Teams y el canal para notificaciones. | [00738e07-f9a4-4bf5-b6f9-851ec7ea31d5](../azure/00738e07-f9a4-4bf5-b6f9-851ec7ea31d5.md) |
