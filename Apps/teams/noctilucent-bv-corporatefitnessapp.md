---
title: Información de la aplicación para CorporateFitness.app por Noctilucent BV
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/19/2022
...
description: Toda la información de seguridad y cumplimiento disponible para CorporateFitness.app, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65587020"
---
# <a name="corporatefitnessapp"></a>CorporateFitness.app

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 17 de mayo de 2022</p>

* <a href="https://teams.microsoft.com/l/app/3b51162a-9157-40b8-91b5-0f29efeaf1ec" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004093" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Noctilucent BV a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | CorporateFitness.app |
| ID | WA200004093 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Noctilucent BV |
| Sitio web de la empresa | [https://corporatefitness.app](https://corporatefitness.app) |
| Términos de uso de la aplicación | [https://corporatefitness.app/termsofservice](https://corporatefitness.app/termsofservice) |
| Funcionalidad básica de la aplicación | ¡Desafía a tu equipo! Desafíos de paso a paso y de fitness para impulsar el bienestar. Más de 10 integraciones de aplicaciones y inspección |
| Ubicación de la sede central de la empresa | Países Bajos (el) |
| Página de información de la aplicación | [https://corporatefitness.app/microsoft-teams](https://corporatefitness.app/microsoft-teams) |
...
Noctilucent BV ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Usar datos de perfil |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Información del empleado |
...
| Dirección URL de la directiva de privacidad | https://corporatefitness.app/privacypolicy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | Obtención de datos de perfil de usuario | [5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d](../azure/5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d.md) |
>| correo electrónico | Delegado | Obtener correo electrónico del usuario | [5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d](../azure/5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d.md) |
>| offline_access | Delegado | Obtención de datos de perfil de usuario | [5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d](../azure/5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d.md) |
>| OpenID | Delegado | Obtención de datos de perfil de usuario | [5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d](../azure/5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d.md) |
>| perfil | Delegado | Obtención de datos de perfil de usuario | [5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d](../azure/5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d.md) |
