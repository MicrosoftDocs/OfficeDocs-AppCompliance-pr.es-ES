---
title: Información de la aplicación para Cuckoo by Cuckoo Networks Oy
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/22/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Cuckoo, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66547419"
---
# <a name="cuckoo"></a>Cuckoo

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 20 de junio de 2022</p>

* <a href="https://teams.microsoft.com/l/app/71138876-8738-4935-95b6-ae7c2fbe4e54" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002750" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Cuckoo |
| ID | WA200002750 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Cuckoo Networks Oy |
| Sitio web de la empresa | [https://cuckoo.fi](https://cuckoo.fi) |
| Términos de uso de la aplicación | [https://cuckoo.fi/terms-of-use/](https://cuckoo.fi/terms-of-use/) |
| Funcionalidad básica de la aplicación | Ejercicios de micro break divertidos y fáciles y gamificados para potenciar tu energía y tu cerebro. |
| Ubicación de la sede central de la empresa | Finlandia |
| Página de información de la aplicación | [https://cuckoo.fi](https://cuckoo.fi) |
...
Cuckoo Networks Oy ha proporcionado esta información sobre cómo recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Datos de perfil de usuario, identificador de inquilino, nombre del inquilino |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Actividad de usuario e información de identificación de usuarios |
...
| Dirección URL de la directiva de privacidad | https://cuckoo.fi/en/privacy-policy/ |
...
| ¿La aplicación procesa los datos del cliente para un propósito secundario no descrito en el aviso de privacidad (es decir, marketing, análisis)? | Sí |
...
| Si la aplicación no usa una de las bibliotecas anteriores, ¿qué biblioteca o bibliotecas de autenticación usa? | passport-azure-ad, adal |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | Autenticación de usuario en el servicio a través del inicio de sesión de Microsoft | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| correo electrónico | Delegado | Ponerse en contacto con los clientes con información sobre eventos de aplicación, concursos disponibles y soporte técnico al cliente | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| offline_access | Delegado | Autenticación de usuario en el servicio a través del inicio de sesión de Microsoft | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| OpenID | Delegado | Autenticación de usuario en el servicio a través del inicio de sesión de Microsoft | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| perfil | Delegado | Autenticación de usuario en el servicio a través del inicio de sesión de Microsoft | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
