---
title: Información de la aplicación para Klaxoon by Klaxoon
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/02/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Klaxoon, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64876357"
---
# <a name="klaxoon"></a>Klaxoon

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 31 de agosto de 2021</p>

* <a href="https://teams.microsoft.com/l/app/6adc8d55-eb37-4537-a66d-743b3cd4511b" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA104382058" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://klaxoon.com](https://klaxoon.com) |
| Términos de uso de la aplicación | [https://static.klaxoon.com/website/pdf/eula.pdf](https://static.klaxoon.com/website/pdf/eula.pdf) |
| Funcionalidad básica de la aplicación | Klaxoon proporciona acceso a un conjunto completo de herramientas de colaboración (pizarra, encuesta, cuestionario, sondeo en vivo, etc.) diseñadas para aumentar la eficiencia del trabajo en equipo. La suite Klaxoon es accesible como una aplicación web, aplicaciones móviles (Apple/Android) o directamente desde Microsoft Teams (a través de una integración tab) |
| Ubicación de la sede central de la empresa | Francia |
| Página de información de la aplicación | [https://klaxoon.com](https://klaxoon.com) |
| ¿Cuál es el entorno de hospedaje o el modelo de servicio que se usa para ejecutar la aplicación? |  |
| ¿Qué proveedores de nube de hospedaje usa la aplicación? | AWS, Azure, claranet |
...
Klaxoon ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2019-10-28 |
