...
| Sitio web de la compañía | [https://klaxoon.com](https://klaxoon.com) |
...
| Funcionalidad principal de la aplicación | Klaxoon proporciona acceso a un conjunto completo de herramientas de colaboración (pizarra, encuesta, cuestionarios, sondeos en directo, etc.) diseñadas para aumentar la eficacia del trabajo en equipo. Se puede acceder a la suite Klaxoon como una aplicación web, aplicaciones móviles (Apple/Android) o directamente desde Microsoft Teams (a través de una integración de pestañas) |
...
| Fecha de certificación SOC2 más reciente |  2019-10-28 |
