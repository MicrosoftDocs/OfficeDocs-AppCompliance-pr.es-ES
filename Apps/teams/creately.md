---
title: Información de la aplicación para Creately by Creately
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Creately, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66656460"
---
# <a name="creately"></a>Crear
...
* <a href="https://teams.microsoft.com/l/app/dddf988d-00af-480f-b419-76a357a72460" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004335" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Creately a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Crear |
| ID | WA200004335 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Crear |
| Sitio web de la empresa | [https://creately.com](https://creately.com) |
| Términos de uso de la aplicación | [https://creately.com/tos](https://creately.com/tos) |
| Funcionalidad básica de la aplicación | Con Creately puede experimentar la colaboración visual como nunca antes. Ahora planee, analice y ejecute todo el trabajo sin salir de Microsoft Teams. Creately ofrece un lienzo visual infinito de forma libre para organizar pensamientos, soluciones de lluvia de ideas, procesos de diseño y colaborar con compañeros de equipo en tiempo real. |
...
Creately ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Correo electrónico de usuario, nombre completo del usuario |
...
| Dirección URL de la directiva de privacidad | https://creately.com/privacy/ |
