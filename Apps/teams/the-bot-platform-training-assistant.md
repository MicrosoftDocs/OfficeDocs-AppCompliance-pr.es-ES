---
title: Información de la aplicación para el asistente de aprendizaje de la plataforma bot
ms.author: elmalova
author: elenamalova
ms.date: 12/07/2021
ms.topic: article
...
description: Toda la información de seguridad y cumplimiento disponible para el Asistente de aprendizaje, sus directivas de tratamiento de datos, su Microsoft Cloud App Security de catálogo de aplicaciones e información de seguridad y cumplimiento en el Registro CSA STAR.
...
ms.locfileid: "62149132"
---
# <a name="training-assistant"></a>Asistente de aprendizaje

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: August 2, 2021</p>

* <a href="https://teams.microsoft.com/l/app/40049dbc-3781-491d-ad2e-d59009538e45" target="_blank">Ver en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003547" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por the Bot Platform a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Asistente de aprendizaje |
| Id. | WA200003547 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | La plataforma de bots |
| Sitio web de la compañía | [https://thebotplatform.com](https://thebotplatform.com) |
| Términos de uso de la aplicación | [https://thebotplatform.com/wp-content/uploads/2021/11/TBP-T...](https://thebotplatform.com/wp-content/uploads/2021/11/TBP-Training-Assistant-Customer-Terms-of-Use.pdf) |
| Funcionalidad principal de la aplicación | Este asistente digital te lleva a una serie de módulos de aprendizaje que cubren todo lo que necesitas saber para configurarte y trabajar en Teams. Cada módulo contiene vídeos de tutoriales específicos y contenido de aprendizaje para garantizar que el personal conozca completamente la amplitud de características disponibles en Microsoft Teams y cómo usarlas. |
...
The Bot Platform ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Nombre |
...
| Dirección URL de la directiva de privacidad | https://thebotplatform.com/wp-content/uploads/2021/11/TBP-Training-Assistant-Privacy-Statement.pdf |
