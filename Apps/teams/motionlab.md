---
title: Información de la aplicación para Motionlab by Motionlab
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Motionlab, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/8ad5fc1b-251b-4d14-aceb-2624bcab0e85" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004250" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Motionlab a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Motionlab |
| ID | WA200004250 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Motionlab |
| Sitio web de la empresa | [https://www.motionlab.io](https://www.motionlab.io) |
| Términos de uso de la aplicación | [https://www.motionlab.io/term-of-use](https://www.motionlab.io/term-of-use) |
| Funcionalidad básica de la aplicación | Cree fácilmente vídeos personalizados directamente en Microsoft Teams. |
...
Motionlab ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Información necesaria para crear un vídeo personalizado. |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Información necesaria para crear un vídeo personalizado. |
