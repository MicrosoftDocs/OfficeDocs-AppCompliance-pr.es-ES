---
title: Información de la aplicación para Go1 by Go1
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/23/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Go1, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro de CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c859de61-8a6b-42e6-ba88-f639df33bc72" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001484" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://www.go1.com/user/login](https://www.go1.com/user/login) |
| Términos de uso de la aplicación | [https://www.go1.com/en-au/terms/user-terms](https://www.go1.com/en-au/terms/user-terms) |
| Funcionalidad básica de la aplicación | GO1 Teams aplicación ayuda a usar para buscar, consumir, compartir y analizar recursos de aprendizaje desde dentro de Microsoft Teams |
...
Go1 ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿La aplicación solicita permisos con privilegios mínimos para su escenario? | No |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | aplicación | la aplicación no almacena datos de archivos | [c859de61-8a6b-42e6-ba88-f639df33bc72](../azure/c859de61-8a6b-42e6-ba88-f639df33bc72.md) |
>| Group.ReadWrite.All | aplicación | Teams y el nombre del canal y los identificadores únicos almacenados para admitir el entorno de aprendizaje de administración de aplicaciones | [c859de61-8a6b-42e6-ba88-f639df33bc72](../azure/c859de61-8a6b-42e6-ba88-f639df33bc72.md) |
>| User.Read.All | aplicación | nombre y correo electrónico de los usuarios y UPN almacenados para proporcionar una experiencia de aprendizaje personal directa | [c859de61-8a6b-42e6-ba88-f639df33bc72](../azure/c859de61-8a6b-42e6-ba88-f639df33bc72.md) |
