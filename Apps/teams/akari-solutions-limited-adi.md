...
description: Toda la información de seguridad y cumplimiento disponible para ADI, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro de CSA STAR.
...
ms.locfileid: "64879837"
---
# <a name="adi"></a>ADI

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 28 de abril de 2021</p>

* <a href="https://teams.microsoft.com/l/app/de5717a1-6884-4b96-8b1e-ee17b5d778f3" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002615" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Akari Solutions Limited to Microsoft:
...
| Nombre de la empresa asociada | Akari Solutions Limited |
| Sitio web de la empresa | [https://akari.io](https://akari.io) |
| Términos de uso de la aplicación | [https://akari.io/adi-terms-and-conditions/](https://akari.io/adi-terms-and-conditions/) |
| Funcionalidad básica de la aplicación | ADI está aquí para ayudarle con todas sus necesidades de accesibilidad y para aumentar los programas de administración de cambios. Puede pedir a ADI que le dé respuestas, consejos e información sobre cómo usar las características de accesibilidad dentro de Microsoft Teams, puede aprender sobre las discapacidades ocultas y situacionales y qué herramientas y consejos pueden ayudar. ADI le responderá con una combinación de respuestas conversacionales basadas en texto, vídeos de tamaño byte y vínculos conceptuales de una variedad de fuentes. |
| Ubicación de la sede central de la empresa | Reino Unido de Gran Bretaña e Irlanda del Norte (el) |
| Página de información de la aplicación | [https://akari.io/adi](https://akari.io/adi) |
...
Esta información ha sido proporcionada por Akari Solutions Limited sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
