---
title: Información de la aplicación para Timewax por Timewax
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/21/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Timewax, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0d3bddff-8ca4-4f41-ae48-5aad1ef26e0d" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004428" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Timewax a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Timewax |
| ID | WA200004428 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Timewax |
| Sitio web de la empresa | [https://www.timewax.com](https://www.timewax.com) |
| Términos de uso de la aplicación | [https://www.timewax.com/tc/](https://www.timewax.com/tc/) |
| Funcionalidad básica de la aplicación | Obtenga notificaciones de la plataforma Timewax directamente en Teams. |
| Ubicación de la sede central de la empresa | Países Bajos (el) |
| Página de información de la aplicación | [https://www.docs.timewax.com/en/knowledgebase/microsoft-tea...](https://www.docs.timewax.com/en/knowledgebase/microsoft-teams/) |
...
Timewax ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://www.timewax.com/privacynotice/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Delegado | Se necesita para capturar los eventos de calendario de un usuario para determinar si se han sincronizado mediante nuestra integración de Outlook, de modo que podamos mostrarlos en la pestaña. | [c6557591-6b74-430d-b25e-87ab28766f32](../azure/c6557591-6b74-430d-b25e-87ab28766f32.md) |
>| User.Read | Delegado | Lo necesita para personalizar la integración de los equipos. | [c6557591-6b74-430d-b25e-87ab28766f32](../azure/c6557591-6b74-430d-b25e-87ab28766f32.md) |
