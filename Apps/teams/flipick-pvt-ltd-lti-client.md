...
| Sitio web de la compañía | [https://flipick.com](https://flipick.com) |
| Términos de uso de la aplicación | [https://flipick.com/terms-of-use/](https://flipick.com/terms-of-use/) |
| Funcionalidad principal de la aplicación | La aplicación proporciona un inicio de sesión único (SSO) con un servidor LTI (Learning Tools Interoperability) para iniciar cursos. Es un consumidor de herramientas de LTI y es compatible con LTI básico (BLTI). |
