...
description: Toda la información de seguridad y cumplimiento disponible para el cliente LTI, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro de CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/bfed1af2-2c16-4536-9780-8e21d7fc7d79" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003313" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Flipick Pvt Ltd |
| Sitio web de la empresa | [https://flipick.com](https://flipick.com) |
| Términos de uso de la aplicación | [https://flipick.com/terms-of-use/](https://flipick.com/terms-of-use/) |
| Funcionalidad básica de la aplicación | La aplicación proporciona un inicio de sesión único (SSO) con un servidor LTI (interoperabilidad de herramientas de Learning) para iniciar los cursos. Es un consumidor de herramientas LTI y admite LTI básico (BLTI). |
...
Flipick Pvt Ltd ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
