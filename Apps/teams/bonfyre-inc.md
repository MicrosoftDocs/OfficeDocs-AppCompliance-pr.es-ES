---
title: Información de la aplicación para Bonfyre by Bonfyre, Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/07/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Bonfyre, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66547218"
---
# <a name="bonfyre"></a>Bonfyre

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 30 de marzo de 2022</p>

* <a href="https://teams.microsoft.com/l/app/829fa155-8058-4b1e-b43a-86efb74da5d4" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004185" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Bonfyre, Inc a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Bonfyre |
| ID | WA200004185 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Bonfyre, Inc. |
| Sitio web de la empresa | [https://bonfyreapp.com](https://bonfyreapp.com) |
| Términos de uso de la aplicación | [https://bonfyreapp.com/terms-of-use-teams](https://bonfyreapp.com/terms-of-use-teams) |
| Funcionalidad básica de la aplicación | Incorpore el poder de las funcionalidades de compromiso de Bonfyre en el canal de trabajo que los empleados usan todos los días. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://bonfyreapp.com/blog/bonfyre-now-integrates-with-mic...](https://bonfyreapp.com/blog/bonfyre-now-integrates-with-microsoft-teams) |
...
Bonfyre, Inc ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Contenido enviado por el usuario y datos de perfil de usuario. |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Nombres de usuario, direcciones de correo electrónico e imágenes de perfil.  Esta información puede compartirse previamente durante la incorporación de clientes, pero nos sincronizamos con perfiles de usuario para mantener actualizada la información. |
...
| Dirección URL de la directiva de privacidad | https://bonfyreapp.com/privacy-policy-teams |
