---
title: Información de la aplicación para CodeStream by CodeStream
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2021
...
description: Toda la información de seguridad y cumplimiento disponible para CodeStream, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64880257"
---
# <a name="codestream"></a>CodeStream

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 28 de mayo de 2021</p>

* <a href="https://teams.microsoft.com/l/app/7cf49ab7-8b65-4407-b494-f02b525eef2b" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001475" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | CodeStream |
| Sitio web de la empresa | [https://www.codestream.com](https://www.codestream.com) |
| Términos de uso de la aplicación | [https://www.codestream.com/terms](https://www.codestream.com/terms) |
| Funcionalidad básica de la aplicación | CodeStream le permite revisar &amp; el código de discusión justo dentro del IDE. |
...
CodeStream ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
