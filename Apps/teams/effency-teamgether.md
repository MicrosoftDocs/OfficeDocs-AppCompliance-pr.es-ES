---
title: Información de la aplicación para TeamGether de EFFENCY
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/12/2021
...
description: Toda la información de seguridad y cumplimiento disponible para TeamGether, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/5a0547cc-ea63-4425-acc8-08b89a8fc1a1" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002660" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | EFFENCY |
| Sitio web de la empresa | [https://www.effency.fr](https://www.effency.fr) |
| Términos de uso de la aplicación | [https://www.effency.fr/conditions-generales/](https://www.effency.fr/conditions-generales/) |
| Funcionalidad básica de la aplicación | TeamGether es la aplicación líder en formación digital en eficiencia colectiva desarrollada por EFFENCY |
| Ubicación de la sede central de la empresa | Francia |
| Página de información de la aplicación | [https://www.effency.fr/teams/](https://www.effency.fr/teams/) |
...
EFFENCY ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
