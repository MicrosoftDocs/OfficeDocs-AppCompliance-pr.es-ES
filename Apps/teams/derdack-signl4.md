---
title: Información de la aplicación para SIGNL4 by Derdack SIGNL4
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/18/2022
...
description: Toda la información de seguridad y cumplimiento disponible para SIGNL4, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66845022"
---
# <a name="signl4"></a>SIGNL4

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 15 de julio de 2022</p>

* <a href="https://teams.microsoft.com/l/app/bd19c878-00b7-47cd-9b65-74a2def84427" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001239" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://www.derdack.com](https://www.derdack.com) |
| Términos de uso de la aplicación | [https://www.signl4.com/terms_of_use/](https://www.signl4.com/terms_of_use/) |
| Funcionalidad básica de la aplicación | Derdack SIGNL4 permite alertas móviles y respuesta a incidentes en cualquier lugar para la infraestructura crítica operativa. Admite operaciones y equipos de llamada. |
| Ubicación de la sede central de la empresa | Alemania |
| Página de información de la aplicación | [https://www.signl4.com](https://www.signl4.com) |
...
Derdack SIGNL4 ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | dirección de correo electrónico |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | dirección de correo electrónico |
