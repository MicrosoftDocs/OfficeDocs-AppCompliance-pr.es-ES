...
description: Toda la información de seguridad y cumplimiento disponible para Bulletin Board - NextSet, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/44ec3ee3-d45b-4b17-9223-4f5c1c1ce576" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002122" target="_blank">Vista en AppSource</a>
...
| Funcionalidad básica de la aplicación | Los privilegios de acceso se pueden establecer para cada publicación. La forma de entrada de post se puede personalizar dinámicamente. La visualización de la lista de publicaciones se puede personalizar dinámicamente. Se puede especificar la fecha de inicio y finalización de la publicación, ponerse en contacto con los usuarios por correo electrónico cuando se publique la publicación, administrar las publicaciones no leídas o leerlas, enviar correo a usuarios no leídos y escribir comentarios en las publicaciones. |
