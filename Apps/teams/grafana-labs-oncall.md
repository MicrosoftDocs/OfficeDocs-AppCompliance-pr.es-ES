---
title: Información de la aplicación para Grafana OnCall de Grafana Labs
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Grafana OnCall, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ed13a4a6-7d9c-4904-913c-402dbca12d1e" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004307" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Grafana Labs a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Grafana OnCall |
| ID | WA200004307 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Grafana Labs |
| Sitio web de la empresa | [https://grafana.com](https://grafana.com) |
| Términos de uso de la aplicación | [https://grafana.com/legal/terms/](https://grafana.com/legal/terms/) |
| Funcionalidad básica de la aplicación | La manera más fácil de realizar la administración en llamada |
...
Grafana Labs ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2021-10-31 |
...
| Dirección URL de la directiva de privacidad | https://grafana.com/legal/terms |
...
| ¿Se proporciona a las personas una opción para oponerse al procesamiento? | No |
