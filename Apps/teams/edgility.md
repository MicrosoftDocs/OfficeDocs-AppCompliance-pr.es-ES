---
title: Información de la aplicación para Edgility por Edgility
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/14/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Edgility, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/fe2f94eb-7164-4fcd-a2c7-16db90307caa" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003970" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Edgility |
| Id. | WA200003970 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Edgility |
| Sitio web de la empresa | [https://edgility.com.au](https://edgility.com.au) |
| Términos de uso de la aplicación | [https://www.edgility.com.au/legal/](https://www.edgility.com.au/legal/) |
| Funcionalidad básica de la aplicación | Edgility es líder en el desarrollo de herramientas de comunicación empresariales integradas. Estas soluciones SMS permiten a las organizaciones simplificar el proceso de recordar, promover, alertar y notificar a las personas que importan a su negocio, utilizando las plataformas en las que ya dependen. Estos incluyen productos de Microsoft, como Excel, Outlook y Teams. Los usuarios pueden aprovechar esta eficaz herramienta de conversación mediante la recepción de SMS en Microsoft Outlook y Teams. |
| Ubicación de la sede central de la empresa | Australia |
| Página de información de la aplicación | [https://www.edgility.com.au/microsoft/teams/](https://www.edgility.com.au/microsoft/teams/) |
