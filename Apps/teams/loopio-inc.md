---
title: Información de la aplicación para Loopio by Loopio Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Loopio, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66139740"
---
# <a name="loopio"></a>Bucle
...
* <a href="https://teams.microsoft.com/l/app/c2f87ddb-d2e0-4268-851f-88d57ac6e0a0" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004103" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Loopio Inc. a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Bucle |
| ID | WA200004103 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Loopio Inc. |
| Sitio web de la empresa | [https://www.loopio.com](https://www.loopio.com) |
| Términos de uso de la aplicación | [https://loopio.com/terms/](https://loopio.com/terms/) |
| Funcionalidad básica de la aplicación | Busque y comparta el contenido de la biblioteca de Loopio mientras se mantiene al tanto de las tareas con las notificaciones de Loopio. |
...
Loopio Inc. ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Identificadores de Teams de usuario |
...
| Dirección URL de la directiva de privacidad | https://loopio.com/privacy/ |
