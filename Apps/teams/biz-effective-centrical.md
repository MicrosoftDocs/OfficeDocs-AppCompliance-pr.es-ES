...
description: Toda la información de seguridad y cumplimiento disponible para Centrical, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/7a70b8e4-43ca-46a7-b7c3-eb31b33de397" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001531" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://centrical.com](https://centrical.com) |
| Términos de uso de la aplicación | [https://centrical.com/terms](https://centrical.com/terms) |
| Funcionalidad básica de la aplicación | La plataforma centrada obtiene y mantiene a los empleados centrados en el trabajo que hay que realizar y, lo que es más importante, en cómo hacerlo. Usa datos del trabajo medido para solicitar microaprendizaje que genera competencia. Utiliza inteligencia artificial para mejorar la participación de los empleados, el rendimiento y el microlearning. La plataforma Centrical está disponible a través de una aplicación web, aplicaciones móviles, aplicaciones Microsoft Teams, aplicaciones de Salesforce y SuccessFactors. |
...
Esta información ha sido proporcionada por Biz-Effective sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2020-02-03 |
