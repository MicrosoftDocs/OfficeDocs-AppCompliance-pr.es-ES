...
description: Toda la información de seguridad y cumplimiento disponible para Centrical, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security y la información de seguridad y cumplimiento en el Registro CSA STAR.
...
| Nombre de la compañía asociada | Biz-Effective |
| Sitio web de la compañía | [https://centrical.com](https://centrical.com) |
| Términos de uso de la aplicación | [https://centrical.com/terms](https://centrical.com/terms) |
| Funcionalidad principal de la aplicación | La plataforma centrada obtiene y mantiene a los empleados centrados en el trabajo que debe realizarse y, lo que es más importante, sobre cómo hacerlo. Usa datos del trabajo medido para solicitar microaprendizaciones que generen competencia. Usa inteligencia artificial para mejorar la participación de los empleados, el rendimiento y el microaprendizamiento. La plataforma Centrical está disponible a través de una aplicación web, aplicaciones móviles, aplicaciones Microsoft Teams, aplicaciones de Salesforce y SuccessFactors. |
| Ubicación central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://centrical.com/solutions/solutions-by-use-case-2/mic...](https://centrical.com/solutions/solutions-by-use-case-2/microsoft-teams-gamification/) |
...
Esta información ha sido proporcionada por Biz-Effective acerca de cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación SOC2 más reciente |  2020-02-03 |
