---
title: Información de la aplicación para Lumio by SMART Technologies ULC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Lumio, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65619459"
---
# <a name="lumio"></a>Lumio

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 19 de abril de 2021</p>

* <a href="https://teams.microsoft.com/l/app/e0ffcbc7-f3f2-46b7-a189-afd01c545782" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001874" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por SMART Technologies ULC a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Lumio |
| ID | WA200001874 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | SMART Technologies ULC |
| Sitio web de la empresa | [https://smarttech.com](https://smarttech.com) |
| Términos de uso de la aplicación | [https://www.smarttech.com/legal/sls-terms](https://www.smarttech.com/legal/sls-terms) |
| Funcionalidad básica de la aplicación | Transforme sus lecciones con actividades, evaluaciones y colaboración de los alumnos. |
| Ubicación de la sede central de la empresa | Canadá |
| Página de información de la aplicación | [https://www.smarttech.com/smart-learning-suite/](https://www.smarttech.com/smart-learning-suite/) |
...
SMART Technologies ULC ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Delegado | Los datos se usan para comprobar los permisos de grupo que no se recopilan datos.  | [14cf575a-fae2-48e2-af39-e3448d3a48bb](../azure/14cf575a-fae2-48e2-af39-e3448d3a48bb.md) |
>| Group.Read.All | Delegado | de qué grupo son appart, esto se usa para comprobar que forman parte del grupo de alumnos o profesores para determinar la funcionalidad. No se recopilan datos.  | [14cf575a-fae2-48e2-af39-e3448d3a48bb](../azure/14cf575a-fae2-48e2-af39-e3448d3a48bb.md) |
