...
Información proporcionada por la aplicación InVision a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Freehand by InVision |
| ID | WA104381362 |
...
| DIRECCIÓN URL de términos de uso | [https://www.invisionapp.com/terms](https://www.invisionapp.com/terms) |
...
Esta información ha sido proporcionada por la aplicación InVision sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
Esta información ha sido proporcionada por la aplicación InVision sobre cómo esta aplicación controla la autenticación, autorización, procedimientos recomendados de registro de aplicaciones y otros criterios de identidad.
