---
title: Información de la aplicación para Commander by Nimbella
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Commander, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/be4751a5-db56-4e45-bb27-397e0aa614b1" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002015" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Nimbella |
| Sitio web de la empresa | [https://www.nimbella.com](https://www.nimbella.com) |
| Términos de uso de la aplicación | [https://nimbella.com/terms](https://nimbella.com/terms) |
| Funcionalidad básica de la aplicación | Compile, ejecute y comparta comandos personalizados. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://nimbella.com/integrations/commander/microsoft-teams](https://nimbella.com/integrations/commander/microsoft-teams) |
| ¿Cuál es el entorno de hospedaje o el modelo de servicio que se usa para ejecutar la aplicación? |  |
| ¿Qué proveedores de nube de hospedaje usa la aplicación? | Azure, GCP, DigitalOcean |
...
Nimbella ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
