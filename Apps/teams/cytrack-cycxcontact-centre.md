---
title: Información de la aplicación para CyCX Contact Centre by CyTrack
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: Toda la información de seguridad y cumplimiento disponible para CyCX Contact Centre, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66656418"
---
# <a name="cycx--contact-centre"></a>Centro de contacto de CyCX

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 27 de mayo de 2022</p>

* <a href="https://teams.microsoft.com/l/app/4d7b80a9-d64d-4b54-a1db-259cc204b15d" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004350" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por CyTrack a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Centro de contacto de CyCX |
| ID | WA200004350 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | CyTrack |
| Sitio web de la empresa | [https://web.cytrack.com](https://web.cytrack.com) |
| Términos de uso de la aplicación | [https://web.cytrack.com/subscription-service-software-agree...](https://web.cytrack.com/subscription-service-software-agreement/) |
| Funcionalidad básica de la aplicación | CyCX está dirigido a los usuarios empresariales que necesitan mejorar la experiencia del cliente con las capacidades de llamadas de voz y centro de contactos más allá de reuniones, chat y colaboración.  CyCX es una plataforma de comunicaciones y colaboración para Microsoft Teams.  Conozca a sus clientes en el canal que prefieran en Microsoft Teams, CyTrack CyCX proporciona a los agentes una única interfaz unificada con una vista holística de los clientes para permitir interacciones más profundas. |
| Ubicación de la sede central de la empresa | Australia |
| Página de información de la aplicación | [https://web.cytrack.com/microsoft-teams/contact-centre-for-...](https://web.cytrack.com/microsoft-teams/contact-centre-for-microsoft-teams/) |
...
CyTrack ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Datos de llamada de Teams |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Datos de llamada de Teams |
| Si la inestructura subyacente procesa o almacena datos de clientes de Microsoft, ¿dónde se almacenan geográficamente estos datos? | Australia, Nueva Zelanda, Reino Unido de Gran Bretaña e Irlanda del Norte (el) |
...
| Dirección URL de la directiva de privacidad | https://web.cytrack.com/privacy-policy-teams/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppRoleAssignment.ReadWrite.All | Delegado | Necesitamos esto para crear servicePrincipal para conceder permisos de API en la aplicación de Azure AD en el inquilino de los clientes. | [acafd8f7-a6d3-420e-89d7-7729751b7c04](../azure/acafd8f7-a6d3-420e-89d7-7729751b7c04.md) |
>| Application.ReadWrite.All | Delegado | Necesitamos este permiso para crear una aplicación de Azure AD en el inquilino de los clientes que usamos para suscribirnos a los servicios de notificación de cambios para obtener metadatos relacionados con las llamadas de teams. | [acafd8f7-a6d3-420e-89d7-7729751b7c04](../azure/acafd8f7-a6d3-420e-89d7-7729751b7c04.md) |
