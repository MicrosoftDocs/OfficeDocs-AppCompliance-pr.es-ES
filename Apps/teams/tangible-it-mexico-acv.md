---
title: Información de la aplicación para ACV de Tangible IT México
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2022
...
description: Toda la información de seguridad y cumplimiento disponible para ACV, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro de CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0a3b1cc0-1cda-4373-90b9-7740e604c5e3" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004237" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Tangible IT México a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | ACV |
| ID | WA200004237 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Tangible IT Mexico |
| Sitio web de la empresa | [https://www.tangibleit.com](https://www.tangibleit.com) |
| Términos de uso de la aplicación | [https://www.acv.app/terms](https://www.acv.app/terms) |
| Funcionalidad básica de la aplicación | Administrar el control de asistencia, proporcionar visibilidad ejecutiva a través de paneles y facilitar la experiencia de enseñanza mediante el uso de pizarras. Todo en una solución que refleja tu escuela. |
| Ubicación de la sede central de la empresa | México |
| Página de información de la aplicación | [https://www.acv.app](https://www.acv.app) |
...
Esta información ha sido proporcionada por Tangible IT México sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Datos de perfil de usuario, datos de correo electrónico de usuario para la autenticación. |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Nombre de usuario, correo electrónico de usuario, rol de usuario, teléfono escolar, dirección educativa, nombre de la escuela, temas, clases, lecciones. |
...
| Dirección URL de la directiva de privacidad | https://www.acv.app/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | ambas | Para publicar el vínculo colaboración de pizarra (Nuestra característica) en el canal. | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| Group.ReadWrite.All | ambas | Para publicar el vínculo colaboración de pizarra (Nuestra característica) en el canal. | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| User.Read | ambas | Los procesos de autenticación se llevan a cabo y se obtienen datos en el perfil de los alumnos que pertenecen a un grupo. | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| correo electrónico | ambas | Los procesos de autenticación se llevan a cabo y se obtienen datos en el perfil de los alumnos que pertenecen a un grupo. | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| OpenID | ambas | Los procesos de autenticación se llevan a cabo y se obtienen datos en el perfil de los alumnos que pertenecen a un grupo. | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| perfil | ambas | Los procesos de autenticación se llevan a cabo y se obtienen datos en el perfil de los alumnos que pertenecen a un grupo. | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
