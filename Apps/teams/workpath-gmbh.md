---
title: Información de la aplicación para Workpath by Workpath GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/07/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Workpath, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro de CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/8562f79a-0ba8-4555-a967-6e34bdfecca9" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003898" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Workpath GmbH a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Workpath |
| ID | WA200003898 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Workpath GmbH |
| Sitio web de la empresa | [https://www.workpath.com/en/home](https://www.workpath.com/en/home) |
| Términos de uso de la aplicación | [https://www.workpath.com/en/workpath-ms](https://www.workpath.com/en/workpath-ms) |
| Funcionalidad básica de la aplicación | Manténgase al tanto de sus objetivos estratégicos con OKR de Workpath. |
| Ubicación de la sede central de la empresa | Alemania |
| Página de información de la aplicación | [https://workpath.zendesk.com/hc/en-us/articles/455508104360...](https://workpath.zendesk.com/hc/en-us/articles/4555081043602-Using-the-MS-Teams-integration) |
...
Esta información ha sido proporcionada por Workpath GmbH sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Id. de inquilino,  |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Id. de inquilino,  |
...
| Dirección URL de la directiva de privacidad | https://www.workpath.com/en/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | Para leer el inquilino del usuario que ha iniciado sesión | [dc8facfc-c606-44b4-a0ad-04f81446845c](../azure/dc8facfc-c606-44b4-a0ad-04f81446845c.md) |
