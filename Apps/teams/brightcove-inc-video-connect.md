...
description: Toda la información de seguridad y cumplimiento disponible para Brightcove Video Conectar, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/af7b350c-9e21-49a2-98b8-679327ed31c3" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003247" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Brightcove Inc. |
| Sitio web de la empresa | [https://www.brightcove.com/en/](https://www.brightcove.com/en/) |
| Términos de uso de la aplicación | [https://www.brightcove.com/en/terms-and-conditions/](https://www.brightcove.com/en/terms-and-conditions/) |
| Funcionalidad básica de la aplicación | Brightcove Video Conectar admite opciones de colaboración en torno a los recursos multimedia y de vídeo directamente dentro de Microsoft Teams |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://integrations.support.brightcove.com/teams/installat...](https://integrations.support.brightcove.com/teams/installation.html) |
...
Brightcove Inc. ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
