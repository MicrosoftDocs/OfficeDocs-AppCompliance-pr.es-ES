...
Información proporcionada por Cultify, Lda a Microsoft:
...
Esta información ha sido proporcionada por Cultify, Lda sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Nombres de cliente y, si se proporcionan, correos electrónicos. |
...
| Dirección URL de la directiva de privacidad | https://www.skoach.com/privacy-policy |
