---
title: Información de la aplicación para Pandos by Pandos Intelligence Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/10/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Pandos, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0e777926-2ab4-4e40-9fe5-80dc68e5044f" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003534" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Pandos Intelligence Inc a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Pandos |
| ID | WA200003534 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Pandos Intelligence Inc |
| Sitio web de la empresa | [https://pandos.io](https://pandos.io) |
| Términos de uso de la aplicación | [https://app.pandos.io/terms-of-use](https://app.pandos.io/terms-of-use) |
| Funcionalidad básica de la aplicación | Pandos es una plataforma de aprendizaje y desarrollo integral para administradores de equipos y personas, líderes de proyectos, instructores e instructores educativos. Admite características fundamentales, como la formación de equipos en función de criterios (incluida la disponibilidad, la personalidad, las aptitudes o cualquier criterio personalizado), la administración de tareas del equipo y la evaluación del mismo nivel. La plataforma genera automáticamente un perfil para las aptitudes temporales de los miembros, comprobado por los compañeros.  |
| Ubicación de la sede central de la empresa | Canadá |
| Página de información de la aplicación | [https://pandos.io](https://pandos.io) |
...
Pandos Intelligence Inc ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://pandos.io/gdpr/ |
