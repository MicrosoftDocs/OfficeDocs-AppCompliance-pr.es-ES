---
title: Información de la aplicación para UserVoice de UserVoice
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toda la información de seguridad y cumplimiento disponible para UserVoice, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/1a2efc96-5f06-4b76-ad90-00ce6c1ac74d" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001944" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | UserVoice |
| Sitio web de la empresa | [https://www.uservoice.com](https://www.uservoice.com) |
| Términos de uso de la aplicación | [https://www.uservoice.com/tos](https://www.uservoice.com/tos) |
| Funcionalidad básica de la aplicación | Obtenga actualizaciones en tiempo real en el programa de comentarios del producto dentro de Microsoft Teams. |
...
UserVoice ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC1 más reciente | 2020-12-31 |
