---
title: Información de la aplicación para Chronoscope Time Tracking by Chrono Innovation
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Chronoscope Time Tracking, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/5b3ded07-fa1a-4fd8-a323-e5fe3f8cf740" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003095" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Chrono Innovation |
| Sitio web de la empresa | [https://www.chronoinnovation.com](https://www.chronoinnovation.com) |
| Términos de uso de la aplicación | [https://www.chronoscope.app/terms-of-service](https://www.chronoscope.app/terms-of-service) |
| Funcionalidad básica de la aplicación | Chronoscope es una plataforma inteligente de administración del tiempo que aumenta la precisión de los datos y reduce los errores de entrada de tiempo. A través de un asistente inteligente que se integra con su ecosistema existente, Chronoscope facilita la entrada de tiempo y proporciona visibilidad sobre los datos para tomar mejores decisiones empresariales. |
| Ubicación de la sede central de la empresa | Canadá |
| Página de información de la aplicación | [https://www.chronoscope.app](https://www.chronoscope.app) |
...
Chrono Innovation ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AccessReview.Read.All | aplicación | tenantId de teams, teams addObjectId e información de la cuenta de usuario de teams. Al vincular usuarios de Chronoscope, estamos validando que el correo electrónico coincida con una cuenta de Teams para que podamos vincular la cuenta sin paso manual del usuario. | [9bc8244d-a186-4b12-809e-c47b3eee73c6](../azure/9bc8244d-a186-4b12-809e-c47b3eee73c6.md) |
