---
title: Información de la aplicación para TeamConnect para Sitecore de Subramanian Ramanathan
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/24/2022
...
description: Toda la información de seguridad y cumplimiento disponible para TeamConnect para Sitecore, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66656328"
---
# <a name="teamconnect-for-sitecore"></a>TeamConnect para Sitecore
...
* <a href="https://teams.microsoft.com/l/app/a87fd06b-7e73-4374-ba75-4545b2470706" target="_blank">Visualización en el almacén de Teams</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | TeamConnect para Sitecore |
| ID | WA200003274 |
