---
title: Información de la aplicación para KangoGift by KangoGift, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/03/2022
...
description: Toda la información de seguridad y cumplimiento disponible para KangoGift, sus directivas de control de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el registro CSA STAR.
...
<p>Última actualización del desarrollador: 13 de mayo de 2022</p>

* <a href="https://teams.microsoft.com/l/app/a19a36e4-c33d-4988-a706-5c740ccab0eb" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004174" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por KangoGift, Inc. a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | KangoGift |
| Id. | WA200004174 |
| Clientes de Office 365 admitidos | Microsoft Teams |
| Nombre de la empresa asociada | KangoGift, Inc. |
| Sitio web de la empresa | [https://www.kangogift.com](https://www.kangogift.com) |
| Términos de uso de la aplicación | [https://www.kangogift.com/app_terms](https://www.kangogift.com/app_terms) |
| Funcionalidad básica de la aplicación | Enviar reconocimiento y elogios. |
...
KangoGift, Inc. ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Información básica sobre los usuarios: nombre, correo electrónico. Esto se controla en un contrato independiente que tenemos con los clientes.  |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Información básica sobre los usuarios: nombre, correo electrónico. Esto se controla en un contrato independiente que tenemos con los clientes.  |
...
| Dirección URL de la directiva de privacidad | https://www.kangogift.com/privacy |
