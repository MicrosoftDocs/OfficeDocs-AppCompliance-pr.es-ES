---
title: Información de la aplicación para Process Street por Process Street
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/13/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Process Street, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64838819"
---
# <a name="process-street"></a>Process Street

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador el 4 de marzo de 2022</p>

* <a href="https://teams.microsoft.com/l/app/6910821c-1244-4a0b-9d64-f0fc396b8e7c" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003933" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Process Street a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Process Street |
| ID | WA200003933 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Process Street |
| Sitio web de la empresa | [https://www.process.st](https://www.process.st) |
| Términos de uso de la aplicación | [https://www.process.st/terms/](https://www.process.st/terms/) |
| Funcionalidad básica de la aplicación | Una plataforma moderna de administración de procesos para crear, compartir y automatizar los procesos principales. |
...
Process Street ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://www.process.st/help/docs/gdpr-statement/ |
