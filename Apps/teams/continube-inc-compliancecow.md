---
title: Información de la aplicación para cumplimientoCow de ContiNube Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/17/2022
...
description: Toda la información de seguridad y cumplimiento disponible para ComplianceCow, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66249770"
---
# <a name="compliancecow"></a>ComplianceCow

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 12 de mayo de 2022</p>

* <a href="https://teams.microsoft.com/l/app/be1720d1-f7ae-4f6e-ab02-e6911a51bc92" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004247" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por ContiNube Inc a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | ComplianceCow |
| Id. | WA200004247 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | ContiNube Inc |
| Sitio web de la empresa | [https://compliancecow.com](https://compliancecow.com) |
| Términos de uso de la aplicación | [https://compliancecow.com/trust/termsandconditions](https://compliancecow.com/trust/termsandconditions) |
| Funcionalidad básica de la aplicación | Flujos de trabajo minimalistas para SECURITY GRC y Assurance |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://compliancecow.com/docs#compliancecow-chat-applicati...](https://compliancecow.com/docs#compliancecow-chat-applications) |
...
Esta información ha sido proporcionada por ContiNube Inc sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Datos de cumplimiento |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Datos de cumplimiento |
