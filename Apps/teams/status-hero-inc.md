---
title: Información de la aplicación para el héroe de estado por Status Hero, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/10/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Status Hero, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/7917afd4-9825-4c1d-b683-ce1fcb77d5b4" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004205" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Status Hero, Inc. a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Status Hero |
| ID | WA200004205 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Status Hero, Inc. |
| Sitio web de la empresa | [https://statushero.com](https://statushero.com) |
| Términos de uso de la aplicación | [https://statushero.com/terms](https://statushero.com/terms) |
| Funcionalidad básica de la aplicación | Status Hero convierte los datos y las verificaciones asincrónicas de las herramientas de su equipo en informes concisos y detallados. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://statushero.com/integrations/microsoft-teams](https://statushero.com/integrations/microsoft-teams) |
...
Esta información ha sido proporcionada por Status Hero, Inc. sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2021-11-01 |
...
| Dirección URL de la directiva de privacidad | https://statushero.com/privacy |
