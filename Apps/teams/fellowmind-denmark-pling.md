---
title: Información de la aplicación para pling por Fellowmind Dinamarca
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Pling, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66656329"
---
# <a name="pling"></a>Pling

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 27 de junio de 2022</p>

* <a href="https://teams.microsoft.com/l/app/9ca359c6-8466-4519-b3b9-29573ebe39ca" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004294" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Fellowmind Denmark a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Pling |
| ID | WA200004294 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Fellowmind Denmark |
| Sitio web de la empresa | [https://intraactive.net](https://intraactive.net) |
| Términos de uso de la aplicación | [https://intraactive.net/terms-of-use-pling](https://intraactive.net/terms-of-use-pling) |
| Funcionalidad básica de la aplicación | Notificaciones de aplicaciones integradas o con Logic Apps o Power Automate |
...
Fellowmind Dinamarca ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | UPN |
...
| Dirección URL de la directiva de privacidad | https://intraactive.net/privacy-policy-play |
...
| Enumerar los tipos de directivas admitidas | Se admiten todas las directivas, ya que nuestro esquema de autenticación es nativo de Microsoft Teams. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | Delegado | Compruebe si la aplicación ya está instalada | [78472101-8565-4ebe-a478-fbeb5ac8b1e0](../azure/78472101-8565-4ebe-a478-fbeb5ac8b1e0.md) |
>| Group.Read.All | Delegado | Buscar todos los grupos para permitir que el usuario elija quién debe recibir un mensaje pling | [78472101-8565-4ebe-a478-fbeb5ac8b1e0](../azure/78472101-8565-4ebe-a478-fbeb5ac8b1e0.md) |
>| People.Read | Delegado | Obtener información sobre los usuarios con el fin de garantizar la segmentación adecuada al enviar mensajes de pling | [78472101-8565-4ebe-a478-fbeb5ac8b1e0](../azure/78472101-8565-4ebe-a478-fbeb5ac8b1e0.md) |
>| User.Read | Delegado | Obtenga información sobre el usuario actual para comprobar quién es y si ya está registrado en Pling. | [78472101-8565-4ebe-a478-fbeb5ac8b1e0](../azure/78472101-8565-4ebe-a478-fbeb5ac8b1e0.md) |
>| User.ReadBasic.All | Delegado | Buscar usuarios basados en grupos seleccionados para obtener listas de usuarios a los que enviar mensajes | [78472101-8565-4ebe-a478-fbeb5ac8b1e0](../azure/78472101-8565-4ebe-a478-fbeb5ac8b1e0.md) |
>| Group.Read.All | aplicación | Al enviar mensajes a grupos, esto es necesario para buscar y buscar cada grupo. | [83797eec-6657-4fda-a566-d1ac05bfe874](../azure/83797eec-6657-4fda-a566-d1ac05bfe874.md) |
>| Organization.Read.All | aplicación | Obtener información sobre la organización actual que descargó Pling con el fin de automatizar la incorporación | [83797eec-6657-4fda-a566-d1ac05bfe874](../azure/83797eec-6657-4fda-a566-d1ac05bfe874.md) |
>| TeamsAppInstallation.ReadWriteForUser.All | aplicación | Necesario para la mensajería proactiva donde Pling se instala automáticamente cuando un usuario recibe un mensaje | [83797eec-6657-4fda-a566-d1ac05bfe874](../azure/83797eec-6657-4fda-a566-d1ac05bfe874.md) |
