...
| Funcionalidad básica de la aplicación | ZeroTime Bot permite a los usuarios rellenar directamente sus partes de horas de Replicon mediante el chat con el bot. |
