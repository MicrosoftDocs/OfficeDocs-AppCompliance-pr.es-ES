...
description: Toda la información de seguridad y cumplimiento disponible para WorkInSync, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64879677"
---
# <a name="workinsync"></a>WorkInSync

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 1 de septiembre de 2021</p>

* <a href="https://teams.microsoft.com/l/app/4e00663a-be72-4de1-a163-269a477a7a6e" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002974" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | MoveInSync |
| Sitio web de la empresa | [https://www.workinsync.io](https://www.workinsync.io) |
| Términos de uso de la aplicación | [https://www.workinsync.io/terms-and-condition/](https://www.workinsync.io/terms-and-condition/) |
| Funcionalidad básica de la aplicación | WorkInSync permite a las organizaciones planear &amp; fácilmente la ejecución de un modelo de reserva de escritorio flexible para su oficina.  Como empleado, puede hacer lo siguiente: - Crear y administrar reservas de escritorio- Horario de entrada cuando se trabaja desde el reloj de inicio &amp; al final del día Como administrador - Se le notifica a los miembros del equipo planes de reloj &amp; en la pestaña Actividad del equipo que puede instalar en un contexto de canal, puede ver dónde está trabajando todo el equipo desde &amp; su presencia- Buscar un compañero específico en toda la organización |
| Ubicación de la sede central de la empresa | India |
| Página de información de la aplicación | [https://www.workinsync.io/teams-app-for-workinsync/](https://www.workinsync.io/teams-app-for-workinsync/) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Delegado | 1. Para obtener detalles transitivos de los miembros del grupo. Se usan en la pestaña "Actividad de equipo" cuando se instalan en el contexto del canal. 2. Para obtener la lista de detalles &amp;  del perfil de usuario que ha iniciado sesión de los usuarios de la organización. Se usan cuando la pestaña Actividad de equipo se instala en contexto personal, como una reserva para mostrar la vista previa de los compañeros de equipo en caso de que se produzca un error en la API de personas (usuarios que no son de Outlook). | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| People.Read | Delegado | Para que las personas más relacionadas con el usuario que ha iniciado sesión se muestren en la pestaña Actividad de equipo se instala en contexto personal. | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| Presence.Read | Delegado | Para obtener información de presencia de una lista de usuarios en la pestaña Actividad del equipo en el contexto personal y del canal | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| Presence.Read.All | Delegado | Para obtener información de presencia de una lista de usuarios en la pestaña Actividad del equipo en el contexto personal y del canal | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| User.Read.All | aplicación | Se usa para obtener información del administrador de informes de cualquier usuario para enviar notificaciones de reserva y checkin/checkout al administrador. | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| User.ReadBasic.All | Delegado | Se usa para leer la foto de perfil del empleado | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| correo electrónico | Delegado | Necesario para obtener el token de SSO mediante Teams biblioteca cliente | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| offline_access | Delegado | Necesario para obtener el token de SSO mediante Teams biblioteca cliente | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| OpenID | Delegado | Necesario para obtener el token de SSO mediante Teams biblioteca cliente | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| perfil | Delegado | Necesario para obtener el token de SSO mediante Teams biblioteca cliente | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
