...
* <a href="https://teams.microsoft.com/l/app/ba4eda44-cd55-4e15-855c-0debafb0490b" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002859" target="_blank">Vista en AppSource</a>
...
| Términos de uso de la aplicación | [https://www.esri.com/en-us/legal/terms/master-agreement-pro...](https://www.esri.com/en-us/legal/terms/master-agreement-product) |
| Funcionalidad básica de la aplicación | ArcGIS Online incluye un conjunto de aplicaciones, mapas autoritativos y datos sobre miles de temas, herramientas de asignación modernas que necesita para visualizar los datos, análisis para detectar y comunicar patrones significativos en los datos y las herramientas administrativas para administrar fácilmente personas y contenido y capacitar a todos para crear y compartir mapas. ArcGIS ofrece a todos los usuarios de su organización la capacidad de detectar, usar, crear y compartir mapas desde cualquier dispositivo, en cualquier lugar y en cualquier momento. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.esri.com/en-us/about/esri-partner-network/our-p...](https://www.esri.com/en-us/about/esri-partner-network/our-partners/global-alliances/microsoft-esri/overview) |
...
Esri ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
