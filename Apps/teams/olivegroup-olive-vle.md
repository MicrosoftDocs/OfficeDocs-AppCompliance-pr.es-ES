---
title: Información de la aplicación para OLIVE VLE de OliveGroup
ms.author: elmalova
author: elenamalova
ms.date: 07/12/2021
ms.topic: article
...
description: Toda la información de seguridad y cumplimiento disponible para OLIVE VLE, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ccb8561b-4f4a-496f-898f-b27e681c3a62" target="_blank">Ver en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003331" target="_blank">Ver en AppSource</a>
...
| Nombre de la compañía asociada | OliveGroup |
| Sitio web de la compañía | [https://www.olivegroup.io](https://www.olivegroup.io) |
| Términos de uso de la aplicación | [https://vle.olivegroup.io/termsofuse](https://vle.olivegroup.io/termsofuse) |
| Funcionalidad principal de la aplicación | Olive VLE ayuda a los tutores y proveedores de educación a crear y administrar cursos, programas de aprendizaje y alumnos. Los administradores de proveedores de educación pueden crear sus propios cursos en línea, pruebas, asignaciones, programas y asignarlos a los alumnos. Microsoft Teams se integra mediante la API Graph para que los administradores también puedan crear aulas de vídeo dentro de Teams e invitar a los alumnos a la clase de vídeo. Los alumnos pueden ver y tomar sus cursos, programas y administrar evidencias de cartera. Los administradores también pueden publicar fuentes de noticias. |
...
OliveGroup ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
