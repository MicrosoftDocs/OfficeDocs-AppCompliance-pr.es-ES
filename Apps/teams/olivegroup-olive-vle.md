---
title: Información de la aplicación para OLIVE VLE by OliveGroup
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/12/2021
...
description: Toda la información de seguridad y cumplimiento disponible para OLIVE VLE, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64877617"
---
# <a name="olive-vle"></a>OLIVE VLE

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 12 de julio de 2021</p>

* <a href="https://teams.microsoft.com/l/app/ccb8561b-4f4a-496f-898f-b27e681c3a62" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003331" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por OliveGroup a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | OLIVE VLE |
| Id. | WA200003331 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | OliveGroup |
| Sitio web de la empresa | [https://www.olivegroup.io](https://www.olivegroup.io) |
| Términos de uso de la aplicación | [https://vle.olivegroup.io/termsofuse](https://vle.olivegroup.io/termsofuse) |
| Funcionalidad básica de la aplicación | Olive VLE ayuda a los proveedores de tutores y educación a crear y administrar cursos, programas de aprendizaje y aprendices. Los administradores de proveedores de educación pueden crear sus propios cursos en línea, pruebas, asignaciones, programas y asignarlos a los aprendices. Microsoft Teams se integra mediante Graph API para que los administradores también puedan crear aulas de vídeo dentro de Teams e invitar a los alumnos a la clase de vídeo. Los estudiantes pueden ver y tomar sus cursos, programas y administrar pruebas de cartera. Los administradores también pueden publicar fuentes de noticias. |
...
OliveGroup ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
