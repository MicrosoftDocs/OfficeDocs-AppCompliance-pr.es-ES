---
title: Información de la aplicación para OfficeAmp by Anaek Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: Toda la información de seguridad y cumplimiento disponible para OfficeAmp, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66704179"
---
# <a name="officeamp"></a>OfficeAmp

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 22 de junio de 2022</p>

* <a href="https://teams.microsoft.com/l/app/b3f65e46-d08c-4ab9-a11d-20836a9dcdda" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381756" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Anaek Inc |
| Sitio web de la empresa | [https://www.harmonizehq.com](https://www.harmonizehq.com) |
| Términos de uso de la aplicación | [https://www.officeamp.com/adminbot/tos/](https://www.officeamp.com/adminbot/tos/) |
| Funcionalidad básica de la aplicación | Bot interno del departamento de soporte técnico, sistema ITSM sólido dentro de Microsoft Teams y proporciona un panel Kanban para realizar un seguimiento, asignar y resolver incidencias. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.officeamp.com](https://www.officeamp.com) |
...
Anaek Inc ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://www.officeamp.com/adminbot/privacy/ |
