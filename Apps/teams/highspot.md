---
title: Información de la aplicación para Highspot de Highspot
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Highspot, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/55b7c78e-4768-47e0-97be-e6b953e6a0d0" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002894" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Highspot a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Highspot |
| Id. | WA200002894 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Highspot |
| Sitio web de la empresa | [https://www.highspot.com](https://www.highspot.com) |
| Términos de uso de la aplicación | [https://www.highspot.com/terms/](https://www.highspot.com/terms/) |
| Funcionalidad básica de la aplicación | Highspot es la plataforma de habilitación de ventas que a los representantes les encanta. Capacitamos a las empresas para elevar las conversaciones con los clientes que impulsan el crecimiento estratégico. Nuestra plataforma intuitiva combina la administración inteligente de contenido, el entrenamiento, la guía contextual, la participación del cliente y el análisis accionable. Los equipos de comercialización usan Highspot para ofrecer una experiencia de compra unificada que aumenta los ingresos, la satisfacción del cliente y la retención. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.highspot.com/overview/](https://www.highspot.com/overview/) |
...
Highspot ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2020-08-20 |
