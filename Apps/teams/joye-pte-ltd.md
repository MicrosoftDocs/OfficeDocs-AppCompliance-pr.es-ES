---
title: Información de la aplicación para Joye por Joye Pte Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Joye, sus directivas de tratamiento de datos, su Microsoft Cloud App Security de catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/6c75be83-05a8-4515-9c7b-b5f759b99b7f" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003413" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Joye Pte Ltd a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Joye |
| ID | WA200003413 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | Joye Pte Ltd |
| Sitio web de la compañía | [https://www.joye.ai](https://www.joye.ai) |
| Términos de uso de la aplicación | [https://www.joye.ai/terms](https://www.joye.ai/terms) |
| Funcionalidad principal de la aplicación | Imagine después de una llamada estresante, Joye te pide que recargues y aumentes tu productividad de nuevo. Bienvenido a Joye. Es&#8217;tan fácil como 1-2-3.  1: Hable de su mente en un espacio seguro y anónimo. Puede hablar, escribir o seguir nuestra reflexión guiada.  2: Joye le comprenderá y le dará buenos consejos, tal como le hubiera guiado su tutor o un amigo. Ahora puedes administrar el nivel de alegría diario. 3: ¡Enhorabuena! Estás listo para asumir el resto del día.  |
| Ubicación central de la empresa | Singapur |
| Página de información de la aplicación | [https://www.joye.ai](https://www.joye.ai) |
...
Joye Pte Ltd ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Perfil de usuario, programación de calendario de disponibilidad. Otra entrada que el usuario proporciona en la aplicación |
| Si la infastructure subyacente procesa o almacena datos de clientes de Microsoft, ¿dónde se almacenan geográficamente estos datos? | Estados Unidos de América, Singapur |
...
| Dirección URL de la directiva de privacidad | https://joye.ai/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | aplicación | Para leer el patrón de tiempo de disponibilidad en el calendario y pedir al usuario que tome un descanso de bienestar mental en el momento adecuado | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| MailboxSettings.Read | delegado | información del usuario para obtener zona horaria | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| User.Read | delegado | inicio de sesión e información del usuario | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| User.Read.All | aplicación | Leer información de todos los usuarios y, en paralelo, para que el administrador de Teams instale automáticamente la aplicación para todos los usuarios | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| correo electrónico | delegado | información del usuario para poder leer el calendario get.calendar | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| offline_access | delegado | usar información | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| OpenID | delegado | información del usuario | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
>| perfil | delegado | información del usuario | [42f7cf35-98e6-417e-b5da-8913a5bbec79](../azure/42f7cf35-98e6-417e-b5da-8913a5bbec79.md) |
