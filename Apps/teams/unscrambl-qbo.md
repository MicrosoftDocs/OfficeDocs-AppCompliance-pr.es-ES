---
title: Información de la aplicación para qbo by Unscrambl
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: Toda la información de seguridad y cumplimiento disponible para qbo, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65688565"
---
# <a name="qbo"></a>qbo

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 25 de noviembre de 2021</p>

* <a href="https://teams.microsoft.com/l/app/834c6939-152c-450b-a305-c65b4dd5d1c7" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001708" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://unscrambl.com](https://unscrambl.com) |
| Términos de uso de la aplicación | [https://unscrambl.com/service-agreement](https://unscrambl.com/service-agreement) |
| Funcionalidad básica de la aplicación | qbo, con tecnología de Unscrambl qbo Insights, hace que el análisis sea conversacional con el mejor NLP de su clase. Los usuarios escriben una pregunta y qbo muestra las conclusiones y visualizaciones más relevantes en un ajuste. Los usuarios pueden colaborar activamente con compañeros, tomar decisiones y capturar conclusiones en paneles listos para la presentación. qbo permite a todos los usuarios de la organización tomar decisiones basadas en datos. qbo se conecta directamente a una variedad de orígenes locales o en la nube y se puede acceder a ellos a través de Microsoft Teams o un explorador. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://qbo.ai](https://qbo.ai) |
...
Unscrambl ha proporcionado esta información sobre cómo recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | nombre y dirección de correo electrónico se usan para la creación de cuentas |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | nombre y dirección de correo electrónico |
...
| Dirección URL de la directiva de privacidad | https://qbo.ai/legal/ |
