---
title: Información de la aplicación para freehand de InVision por InVisionApp, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/06/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Freehand by InVision, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64879707"
---
# <a name="freehand-by-invision"></a>Freehand by InVision

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 6 de mayo de 2021</p>

* <a href="https://teams.microsoft.com/l/app/67cf2c5a-db0e-4256-a423-14010cbeafdd" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381362" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | InVisionApp, Inc. |
| Sitio web de la empresa | [https://www.invisionapp.com](https://www.invisionapp.com) |
| Términos de uso de la aplicación | [https://www.invisionapp.com/legal/terms-of-service](https://www.invisionapp.com/legal/terms-of-service) |
| Funcionalidad básica de la aplicación | Colabore en tiempo real con una pizarra en línea. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.invisionapp.com/freehand](https://www.invisionapp.com/freehand) |
...
InVisionApp, Inc. ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2020-05-13 |
| ¿La aplicación cumple con los controles de organización de servicio (SOC 3)? | Sí |
| Fecha de certificación de SOC3 más reciente | 2020-06-12 |
