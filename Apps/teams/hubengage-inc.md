---
title: Información de la aplicación para HubEngage by HubEngage, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/17/2022
...
description: Toda la información de seguridad y cumplimiento disponible para HubEngage, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66549598"
---
# <a name="hubengage"></a>HubEngage

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 12 de enero de 2022</p>

* <a href="https://teams.microsoft.com/l/app/d96b4f99-e4b8-4af8-ba3d-36675f9a5353" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003668" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por HubEngage, Inc. a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | HubEngage |
| ID | WA200003668 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | HubEngage, Inc. |
| Sitio web de la empresa | [https://www.hubengage.com](https://www.hubengage.com) |
| Términos de uso de la aplicación | [https://www.hubengage.com/privacy-policy/](https://www.hubengage.com/privacy-policy/) |
| Funcionalidad básica de la aplicación | HubEngage Teams App le permite acceder a las comunicaciones de su organización y a otra información relevante desde Teams. También puedes enviar tus propias publicaciones y me gusta y comentar sobre otras publicaciones. |
...
HubEngage, Inc. ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2022-05-20 |
...
| Dirección URL de la directiva de privacidad | https://www.hubengage.com/platform-privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | ambas | Conocer al usuario | [63e17eec-6b5f-476b-a26b-54fde8bd2c83](../azure/63e17eec-6b5f-476b-a26b-54fde8bd2c83.md) |
