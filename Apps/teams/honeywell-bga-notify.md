---
title: Información de la aplicación para BGA Notify by Honeywell
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/11/2022
...
description: Toda la información de seguridad y cumplimiento disponible para BGA Notify, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security y la información de seguridad y cumplimiento en el Registro CSA STAR.
...
ms.locfileid: "63459832"
---
# <a name="bga-notify"></a>Notificación BGA

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: September 29, 2021</p>

* <a href="https://teams.microsoft.com/l/app/33f1ff9f-5910-4036-9927-e09b90c64518" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003820" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Honeywell a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Notificación BGA |
| ID | WA200003820 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | Honeywell |
| Sitio web de la compañía | [https://bga.honeywellforge.com](https://bga.honeywellforge.com) |
| Términos de uso de la aplicación | [https://www.honeywell.com/us/en/terms-and-conditions](https://www.honeywell.com/us/en/terms-and-conditions) |
| Funcionalidad principal de la aplicación | Este bot es principalmente para la mensajería proactiva para los clientes de aviación empresarial de Honeywell según sus preferencias y eventos de su avión |
| Ubicación central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://bga.honeywellforge.com](https://bga.honeywellforge.com) |
...
Esta información ha sido proporcionada por Honeywell sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Autenticación multifactor (MFA) habilitada para: | Credential, DNSManagement, CodeRepositories |
...
| Dirección URL de la directiva de privacidad | https://www.honeywell.com/us/en/privacy-statement |
