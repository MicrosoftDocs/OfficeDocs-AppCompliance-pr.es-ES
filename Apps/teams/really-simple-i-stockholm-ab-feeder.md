---
title: Información de la aplicación para feeder de Really Simple i Stockholm AB
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/17/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Feeder, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66246050"
---
# <a name="feeder"></a>Alimentador

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 8 de junio de 2022</p>

* <a href="https://teams.microsoft.com/l/app/6810f6a8-1f9a-4504-a916-e2d9814062e0" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004254" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Really Simple i Stockholm AB a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Alimentador |
| Id. | WA200004254 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Realmente simple i Stockholm AB |
| Sitio web de la empresa | [https://feeder.co](https://feeder.co) |
| Términos de uso de la aplicación | [https://feeder.co/teams-license](https://feeder.co/teams-license) |
| Funcionalidad básica de la aplicación | Obtener actualizaciones de noticias de fuentes RSS y otras fuentes digitales |
...
| ¿Qué proveedores de nube de hospedaje usa la aplicación? | OVH, DigitalOcean, Aws |
...
Esta información ha sido proporcionada por Really Simple i Stockholm AB sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Correo electrónico, dirección IP, identificador de inquilino |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Correo electrónico, identificador de inquilino |
| Si la inestructura subyacente procesa o almacena datos de clientes de Microsoft, ¿dónde se almacenan geográficamente estos datos? | Canadá, Francia |
...
| Dirección URL de la directiva de privacidad | https://feeder.co/help/legal/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | ambas | Autenticación de usuario e inicio de sesión | [d6286bf8-c566-4451-a252-fc96ac6d8787](../azure/d6286bf8-c566-4451-a252-fc96ac6d8787.md) |
>| correo electrónico | Delegado | Autenticación de usuario e inicio de sesión | [d6286bf8-c566-4451-a252-fc96ac6d8787](../azure/d6286bf8-c566-4451-a252-fc96ac6d8787.md) |
>| OpenID | ambas | Autenticación de usuario e inicio de sesión | [d6286bf8-c566-4451-a252-fc96ac6d8787](../azure/d6286bf8-c566-4451-a252-fc96ac6d8787.md) |
>| perfil | ambas | Autenticación de usuario e inicio de sesión | [d6286bf8-c566-4451-a252-fc96ac6d8787](../azure/d6286bf8-c566-4451-a252-fc96ac6d8787.md) |
