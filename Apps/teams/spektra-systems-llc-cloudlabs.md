---
title: Información de la aplicación para CloudLabs por Spektra Systems LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/18/2021
...
description: Toda la información de seguridad y cumplimiento disponible para CloudLabs, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64879177"
---
# <a name="cloudlabs"></a>CloudLabs

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 14 de octubre de 2021</p>

* <a href="https://teams.microsoft.com/l/app/ec483835-4185-4229-a976-32a20138ff9d" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003273" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Spektra Systems LLC a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | CloudLabs |
| Id. | WA200003273 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Spektra Systems LLC |
| Sitio web de la empresa | [https://cloudlabs.ai](https://cloudlabs.ai) |
| Términos de uso de la aplicación | [https://cloudlabs.ai/terms-of-use/](https://cloudlabs.ai/terms-of-use/) |
| Funcionalidad básica de la aplicación | Preparación para las certificaciones de conceptos básicos de la nube de Microsoft mediante la práctica con las pruebas de práctica de CloudLabs |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://cloudlabs.ai/cloudlabs-teams-app](https://cloudlabs.ai/cloudlabs-teams-app) |
...
Spektra Systems LLC ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Enumerar los tipos de directivas admitidas | Todas las directivas de CA para aplicaciones en la nube |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | Nombre, Correo electrónico, - Para poder proporcionar experiencia y soporte técnico personalizados | [539ffd4e-15ba-4d18-b136-0d73b67d05f0](../azure/539ffd4e-15ba-4d18-b136-0d73b67d05f0.md) |
