---
title: Información de la aplicación para Quadra Thankz by Quadrasystems.net
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Quadra Thankz, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64880607"
---
# <a name="quadra-thankz"></a>Quadra Thankz

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 19 de enero de 2022</p>

* <a href="https://teams.microsoft.com/l/app/a013c4a4-0683-4125-8c05-4004c2c3cc6f" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003671" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Quadrasystems.net a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Quadra Thankz |
| Id. | WA200003671 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Quadrasystems.net |
| Sitio web de la empresa | [https://www.quadrasystems.net](https://www.quadrasystems.net) |
| Términos de uso de la aplicación | [https://www.quadrasystems.net/tou](https://www.quadrasystems.net/tou) |
| Funcionalidad básica de la aplicación | Gracias es la clave para crear empresas más felices. Basado en la conocida interfaz de Microsoft Teams, es una forma completamente nueva de conectarse con las personas con las que trabaja cada día.  Thankz es una herramienta para ayudar a las personas a reconocerse entre sí de una manera divertida.&#160; Proporciona características enriquecidas para el usuario final y la empresa, que permite funciones como tablas de clasificación, presupuestos y controles. Thankz ayuda a sus empleados a sentirse conectados, apreciados y recompensados. |
| Ubicación de la sede central de la empresa | India |
| Página de información de la aplicación | [https://www.quadrasystems.net/what-we-do/intelligent-ip-sol...](https://www.quadrasystems.net/what-we-do/intelligent-ip-solution/thankz) |
...
Esta información la ha proporcionado Quadrasystems.net sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| Enumerar los tipos de directivas admitidas | Todas las directivas de acceso condicional AAD  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | aplicación | Para obtener información del administrador de un usuario  | [5d8eb1a9-2188-4292-86f6-f4964d49e8b3](../azure/5d8eb1a9-2188-4292-86f6-f4964d49e8b3.md) |
