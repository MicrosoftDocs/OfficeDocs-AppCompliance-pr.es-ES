---
title: Información de la aplicación check.it por TI de cloud cover
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
description: Toda la información de seguridad y cumplimiento disponible para check.it, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b5107b74-70ca-443e-be2a-61b14ba5341d" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003604" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por CLOUD Cover IT a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | check.it |
| ID | WA200003604 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | IT de cobertura en la nube |
| Sitio web de la compañía | [https://www.cloudcoverit.co.uk](https://www.cloudcoverit.co.uk) |
| Términos de uso de la aplicación | [https://www.cloudcoverit.co.uk/terms](https://www.cloudcoverit.co.uk/terms) |
| Funcionalidad principal de la aplicación | Cree y comparta listas de comprobación con plantillas a un grupo, equipo o incluso a usted mismo. |
...
Esta información ha sido proporcionada por Cloud Cover IT acerca de cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Identificador de inquilino, canal y conversación |
...
| Dirección URL de la directiva de privacidad | https://www.cloudcoverit.co.uk/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegado | Access Active Directory ID | [898cccfe-ed44-4140-ad2f-c5dd98a12820](../azure/898cccfe-ed44-4140-ad2f-c5dd98a12820.md) |
