...
description: Toda la información de seguridad y cumplimiento disponible para Broadcast, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/cfdaef91-3bae-4545-a571-b86b1685857f" target="_blank">Ver en Teams tienda</a>
...
| Sitio web de la compañía | [https://cerkl.com](https://cerkl.com) |
| Términos de uso de la aplicación | [https://cerkl.com/terms](https://cerkl.com/terms) |
| Funcionalidad principal de la aplicación | Cerkl Broadcast conecta las audiencias de los empleados con su&#8217;comunicaciones importantes. Mediante la personalización basada en el comportamiento, Broadcast entrega el mensaje correcto al empleado correcto en el momento adecuado en el canal correcto. Ese&#8217;es donde realmente nos diferenciamos de nuestra competencia: permitimos que los comunicadores expertos se comuniquen a través de canales sin duplicación de esfuerzos. Broadcast también proporciona métricas líderes del sector que ayudan a nuestros clientes a saber qué&#8217;funciona para su audiencia. |
...
| Fecha de certificación SOC2 más reciente |  2020-07-01 |
