---
title: Información de la aplicación para difusión por Cerkl
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/08/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Broadcast, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro de CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/cfdaef91-3bae-4545-a571-b86b1685857f" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002697" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Cerkl |
| Sitio web de la empresa | [https://cerkl.com](https://cerkl.com) |
| Términos de uso de la aplicación | [https://cerkl.com/terms](https://cerkl.com/terms) |
| Funcionalidad básica de la aplicación | Cerkl Broadcast conecta el público de los empleados con su organización&#8217;comunicaciones importantes. Mediante la personalización basada en comportamiento, Broadcast entrega el mensaje adecuado al empleado adecuado en el momento adecuado en el canal adecuado. Ese&#8217;es donde realmente nos diferenciamos de nuestra competencia: permitimos que los comunicadores expertos se comuniquen entre canales sin duplicación de esfuerzo. Broadcast también proporciona métricas líderes del sector que ayudan a nuestros clientes a saber qué&#8217;funciona para su audiencia. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://cerkl.com/broadcast/microsoft-teams/](https://cerkl.com/broadcast/microsoft-teams/) |
...
Cerkl ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2020-07-01 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | El correo electrónico del usuario se recopila y se usa para ver si el usuario está actualmente en nuestro sistema y lo ha agregado una organización. | [74ef25ab-3685-446c-aa43-4e9cc251ed62](../azure/74ef25ab-3685-446c-aa43-4e9cc251ed62.md) |
