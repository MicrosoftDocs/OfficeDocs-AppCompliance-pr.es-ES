---
title: Información de la aplicación para Financial Times by Financial Times
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/06/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Financial Times, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65357165"
---
# <a name="financial-times"></a>Financial Times

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 25 de marzo de 2022</p>

* <a href="https://teams.microsoft.com/l/app/53992bb2-b879-45ef-99de-68fc094f7bbf" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004054" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Financial Times a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Financial Times |
| ID | WA200004054 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Financial Times |
| Sitio web de la empresa | [https://www.ft.com](https://www.ft.com) |
| Términos de uso de la aplicación | [https://help.ft.com/legal-privacy/terms-and-conditions/](https://help.ft.com/legal-privacy/terms-and-conditions/) |
| Funcionalidad básica de la aplicación | Descubra, guarde y comparta noticias de Financial Times en Microsoft Teams. |
| Ubicación de la sede central de la empresa | Reino Unido de Gran Bretaña e Irlanda del Norte (el) |
| Página de información de la aplicación | |
| ¿Cuál es el entorno de hospedaje o el modelo de servicio que se usa para ejecutar la aplicación? | Paas |
| ¿Qué proveedores de nube de hospedaje usa la aplicación? | Aws, otros |
...
Financial Times ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | userId, tenantId |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | userId |
...
| Dirección URL de la directiva de privacidad | https://help.ft.com/legal-privacy/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | Necesario para el inicio de sesión único | [50bff4f3-8dcf-4f58-bf77-180988c2dc3d](../azure/50bff4f3-8dcf-4f58-bf77-180988c2dc3d.md) |
>| correo electrónico | Delegado | Necesario para el inicio de sesión único | [50bff4f3-8dcf-4f58-bf77-180988c2dc3d](../azure/50bff4f3-8dcf-4f58-bf77-180988c2dc3d.md) |
>| offline_access | Delegado | Necesario para el inicio de sesión único | [50bff4f3-8dcf-4f58-bf77-180988c2dc3d](../azure/50bff4f3-8dcf-4f58-bf77-180988c2dc3d.md) |
>| OpenID | Delegado | Necesario para el inicio de sesión único | [50bff4f3-8dcf-4f58-bf77-180988c2dc3d](../azure/50bff4f3-8dcf-4f58-bf77-180988c2dc3d.md) |
>| perfil | Delegado | Necesario para el inicio de sesión único | [50bff4f3-8dcf-4f58-bf77-180988c2dc3d](../azure/50bff4f3-8dcf-4f58-bf77-180988c2dc3d.md) |
