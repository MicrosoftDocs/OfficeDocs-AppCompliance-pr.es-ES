---
title: Información de la aplicación para agile task board by Agile-IS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/08/2022
...
description: Toda la información de seguridad y cumplimiento disponible para agile Task Board, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
---
# <a name="agile-task-board"></a>Panel de tareas ágil

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador el 8 de abril de 2022</p>

* <a href="https://teams.microsoft.com/l/app/6021779f-643c-48c0-9f80-8e41ea801be7" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002162" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Agile-IS a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Panel de tareas ágil |
| ID | WA200002162 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Agile-IS |
| Sitio web de la empresa | [https://www.agile-is.de](https://www.agile-is.de) |
| Términos de uso de la aplicación | [https://www.agile-is.de/en/termsofuse](https://www.agile-is.de/en/termsofuse) |
| Funcionalidad básica de la aplicación | El Panel de tareas de Agile le ayuda a usted y a su equipo a obtener una mejor visión general de su proyecto ágil. Convierta su placa física en una versión digital. Puede asignar el proceso con características como columnas para mostrar el estado, cualquier número de swimlanes, coloreado controlado por metadatos de mapas, asignación de responsabilidades, edición de arrastrar y colocar, y muchas otras configuraciones. Todos los datos permanecerán dentro de su inquilino de M365. |
| Ubicación de la sede central de la empresa | Alemania |
| Página de información de la aplicación | [https://www.agile-is.de/en/agiletaskboard](https://www.agile-is.de/en/agiletaskboard) |
...
| ¿Qué datos se almacenan en las bases de datos? | Zur Lizenzverwaltung de UPN; Unternehmensdaten zur Rechnungslegung |
...
| Dirección URL de la directiva de privacidad | https://www.agile-is.de/en/telemetry |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | Delegado | Permite que la aplicación consulte el verion de la aplicación instalada actualmente. Se usa para proporcionar los recursos de aplicación adecuados. | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| GroupMember.Read.All | Delegado | Lee los miembros del grupo para asignar las tareas de Planner.  | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| Tasks.ReadWrite | Delegado | Trabajar con el plan y las tareas de Planner   | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| TeamsActivity.Send | Delegado | Envío de mensajes a la actividad de teams | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| TeamsAppInstallation.ReadForTeam | Delegado | Permite que la aplicación consulte el verion de la aplicación instalada actualmente. Se usa para proporcionar los recursos de aplicación adecuados. | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| User.Read | Delegado | Permite al usuario iniciar sesión y leer la información básica del perfil | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| User.ReadBasic.All | Delegado | Permite al usuario leer la información básica del perfil de otros usuarios | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
