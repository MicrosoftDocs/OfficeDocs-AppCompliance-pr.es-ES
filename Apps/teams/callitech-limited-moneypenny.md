---
title: Información de la aplicación para Moneypenny de CALLITECH LIMITED
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/08/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Moneypenny, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ff5b7b81-ef94-441d-bc7c-eb04e53a188f" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003396" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por CALLITECH LIMITED a Microsoft:
...
| Nombre de la empresa asociada | CALLITECH LIMITED |
| Sitio web de la empresa | [https://www.moneypenny.com](https://www.moneypenny.com) |
| Términos de uso de la aplicación | [https://www.moneypenny.com/uk/microsoft-teams-terms-and-con...](https://www.moneypenny.com/uk/microsoft-teams-terms-and-conditions/) |
| Funcionalidad básica de la aplicación | La funcionalidad principal de la aplicación es que Teams usuarios incorporen a sus organizaciones para recibir llamadas de Moneypenny a través de un bot |
...
CALLITECH LIMITED ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Identificador de inquilino de Microsoft, Id. de objeto de Microsoft |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Identificador de inquilino de Microsoft, Id. de objeto de Microsoft |
...
| Si la aplicación no usa una de las bibliotecas anteriores, ¿qué biblioteca o bibliotecas de autenticación usa? | Microsoft Identity Web |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.AccessMedia.All | aplicación | Para transmitir medios desde el bot al usuario Teams | [8277a51c-3ad6-446c-9b7e-e3f6e27257c1](../azure/8277a51c-3ad6-446c-9b7e-e3f6e27257c1.md) |
