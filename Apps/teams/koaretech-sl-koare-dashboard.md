---
title: Información de la aplicación para el panel de Koare de KoareTech S.L.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Toda la información de seguridad y cumplimiento disponible para el panel de Koare, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66817714"
---
# <a name="koare-dashboard"></a>Panel de Koare

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 4 de junio de 2022</p>

* <a href="https://teams.microsoft.com/l/app/08a78d62-ec3b-4800-b51a-9ffd823273cd" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004403" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por KoareTech S.L. a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Panel de Koare |
| ID | WA200004403 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | KoareTech S.L. |
| Sitio web de la empresa | [https://koaretech.com](https://koaretech.com) |
| Términos de uso de la aplicación | [https://koaretech.com/termsofuse.php](https://koaretech.com/termsofuse.php) |
| Funcionalidad básica de la aplicación | La administración de inventario es la herramienta para registrar y realizar el seguimiento de los recursos de hardware y software y el inventario de TI en una organización. Ideal para deparmentos y administración de TI. Los informes proporcionados por la herramienta de administración de inventario de KoareTech muestran información detallada sobre el estado y el uso de los elementos asignados a cada empleado. Compatible con Microsoft Teams y SharePoint. Requisito: Asociar al grupo o canal de Microsoft Teams y suscribirse a Azure Marketplace. |
...
Esta información ha sido proporcionada por KoareTech S.L. acerca de cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.AccessAsUser.All | Delegado | acceso a listas de SharePoint | [45aa6c59-3764-4c2f-abef-178757957e62](../azure/45aa6c59-3764-4c2f-abef-178757957e62.md) |
>| Group.ReadWrite.All | Delegado | acceso a listas de SharePoint | [45aa6c59-3764-4c2f-abef-178757957e62](../azure/45aa6c59-3764-4c2f-abef-178757957e62.md) |
>| Sites.Manage.All | Delegado | crear listas de sharepoint | [45aa6c59-3764-4c2f-abef-178757957e62](../azure/45aa6c59-3764-4c2f-abef-178757957e62.md) |
>| User.Read.All | Delegado | acceso a listas de SharePoint | [45aa6c59-3764-4c2f-abef-178757957e62](../azure/45aa6c59-3764-4c2f-abef-178757957e62.md) |
