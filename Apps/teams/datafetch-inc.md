---
title: Información de la aplicación para DataFetch by DataFetch, Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/18/2022
...
description: Toda la información de seguridad y cumplimiento disponible para DataFetch, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/d6756140-a823-11ea-94d9-ddbe638eaf6b" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003961" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por DataFetch, Inc a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | DataFetch |
| Id. | WA200003961 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | DataFetch, Inc |
| Sitio web de la empresa | [https://datafetch.io](https://datafetch.io) |
| Términos de uso de la aplicación | [https://datafetch.io/terms](https://datafetch.io/terms) |
| Funcionalidad básica de la aplicación | Buscar orígenes de datos conectados |
...
DataFetch, Inc ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | id, name, tenantId, tenantName |
...
| Dirección URL de la directiva de privacidad | https://datafetch.io/privacy-policy |
...
| Enumerar los tipos de directivas admitidas | Los usuarios que están suscritos a orígenes de datos en lugar de poseerlos no pueden eliminarlos. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser | Delegado | Administrar aplicaciones de Teams instaladas del usuario | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser | Delegado | Permitir que la aplicación Teams se administre por sí misma para un usuario | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| User.Read | Delegado | Iniciar sesión y leer el perfil del usuario | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| correo electrónico | Delegado | Ver la dirección de correo electrónico de los usuarios | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| offline_access | Delegado | Mantener el acceso a los datos a los que se le ha concedido acceso | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| OpenID | Delegado | Firma de la identificación de usuarios | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| perfil | Delegado | Ver el perfil básico de los usuarios | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
