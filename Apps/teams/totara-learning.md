...
description: Toda la información de seguridad y cumplimiento disponible para Totara, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/5022e09d-d2f9-499f-8925-554c324ad23a" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003222" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Totara Learning |
| Sitio web de la empresa | [https://www.totaralearning.com](https://www.totaralearning.com) |
...
| Funcionalidad básica de la aplicación | La aplicación Totara para Microsoft Teams ofrece a los suscriptores de Totara Cloud la capacidad de acceder al aprendizaje y colaborar con otros usuarios dentro de Microsoft Teams. Esta aplicación permite a los usuarios acceder al aprendizaje asignado, explorar el contenido de aprendizaje y crear, interactuar con listas de reproducción y recursos y compartirlos, todo ello dentro de Microsoft Teams. |
...
Totara ha proporcionado esta información Learning sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
