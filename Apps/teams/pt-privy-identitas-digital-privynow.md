---
title: Información de la aplicación para PrivyNow por PT Privy Identitas Digital
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2022
...
description: Toda la información de seguridad y cumplimiento disponible para PrivyNow, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66547259"
---
# <a name="privynow"></a>PrivyNow

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 2 de marzo de 2022</p>

* <a href="https://teams.microsoft.com/l/app/00e595af-26e4-46b9-97d1-46e0831b1f02" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004229" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por PT Privy Identitas Digital to Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | PrivyNow |
| ID | WA200004229 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | PT Privy Identitas Digital |
| Sitio web de la empresa | [https://privynow.com/about-us/](https://privynow.com/about-us/) |
| Términos de uso de la aplicación | [https://privynow.com/terms-of-use/](https://privynow.com/terms-of-use/) |
| Funcionalidad básica de la aplicación | La firma de todo tipo de documentos es una parte esencial de su vida cotidiana, y retraso cambiar todo. Cierre sus ofertas rápidamente con PrivyNow. Cargue y comparta un documento en 1 minuto.   Para poder usar esta aplicación, los usuarios deben tener una cuenta de PrivyNow activa, regístrese a través de PrivyNow.com o póngase en contacto con nuestro equipo de soporte técnico para obtener más información. |
| Ubicación de la sede central de la empresa | Indonesia |
| Página de información de la aplicación | [https://privynow.com/guide/](https://privynow.com/guide/) |
...
Pt Privy Identitas Digital ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Nombre completo, correos electrónicos |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Nombre completo, correos electrónicos |
| Si la inestructura subyacente procesa o almacena datos de clientes de Microsoft, ¿dónde se almacenan geográficamente estos datos? | Indonesia |
...
| Dirección URL de la directiva de privacidad | https://privynow.com/terms-of-use/ |
