---
title: Información de la aplicación para Panopto por Panopto
ms.author: elmalova
author: elenamalova
ms.date: 03/07/2022
ms.topic: article
...
description: Toda la información de seguridad y cumplimiento disponible para Panopto, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el Registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/adb3c870-c01c-11eb-a2cc-4dbd838985a1" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003801" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Panopto a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Panopto |
| Id. | WA200003801 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | Panopto |
| Sitio web de la compañía | [https://www.panopto.com](https://www.panopto.com) |
| Términos de uso de la aplicación | [https://www.panopto.com/terms-of-service/](https://www.panopto.com/terms-of-service/) |
| Funcionalidad principal de la aplicación | Exporte Teams a Panopto y busque, comparta y vea vídeos de Panopto sin salir de Teams.  Agrega características como un índice visual de cada reunión y subtítulos cerrados comprobados por el usuario. Acceder a las características de Panopto sin salir de Teams: crear una nueva pestaña de canal asignada a una carpeta de Panopto; buscar y compartir vídeos de Panopto; presentar vídeos de Panopto en reuniones programadas y recibir notificaciones cuando esté listo un nuevo vídeo de Panopto. ¿Necesita un sitio de Panopto? Visite www.panopto.com/plans para empezar. |
...
Panopto ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que tendrá su organización sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Metadatos en Teams grabaciones de reuniones y Teams canales. |
...
| Fecha de certificación SOC2 más reciente |  2021-08-19 |
| ¿La aplicación cumple con los controles de organización de servicio (SOC 3)? | Sí |
| Fecha de certificación SOC3 más reciente |  2021-10-13 |
...
| Dirección URL de la directiva de privacidad | https://www.panopto.com/privacy/ |
