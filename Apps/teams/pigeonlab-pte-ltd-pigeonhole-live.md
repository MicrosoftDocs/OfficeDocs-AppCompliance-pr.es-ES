---
title: Información de la aplicación para Pigeonhole Live by PigeonLab Pte Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/26/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Pigeonhole Live, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/96ecd0d3-9351-4fcb-ac50-08c85e36ab26" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001472" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por PigeonLab Pte Ltd a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Pigeonhole Live |
| ID | WA200001472 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | PigeonLab Pte Ltd |
| Sitio web de la empresa | [https://pigeonholelive.com](https://pigeonholelive.com) |
| Términos de uso de la aplicación | [https://pigeonholelive.com/terms](https://pigeonholelive.com/terms) |
| Funcionalidad básica de la aplicación | Aumentar la interactividad en las reuniones con Q&amp;As, Polls y Quizzes |
| Ubicación de la sede central de la empresa | Singapur |
| Página de información de la aplicación | [https://pigeonholelive.com/microsoft-teams-meetings/](https://pigeonholelive.com/microsoft-teams-meetings/) |
...
Esta información ha sido proporcionada por PigeonLab Pte Ltd sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Correo electrónico y nombre, otros datos capturados como parte del uso de la interactividad del público de Pigeonhole Live |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Correo electrónico y nombre, otros datos capturados como parte del uso de la interactividad del público de Pigeonhole Live |
...
| Dirección URL de la directiva de privacidad | https://www.pigeonholelive.com/privacy |
