...
description: Toda la información de seguridad y cumplimiento disponible para JobPts, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64879637"
---
# <a name="jobpts"></a>JobPts

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 7 de julio de 2021</p>

* <a href="https://teams.microsoft.com/l/app/601a47bc-f201-4398-a0cb-593ea081f265" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001849" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Semos Cloud Soultions |
| Sitio web de la empresa | [https://semoscloud.com](https://semoscloud.com) |
| Términos de uso de la aplicación | [https://semoscloud.com/terms-of-use/](https://semoscloud.com/terms-of-use/) |
| Funcionalidad básica de la aplicación | Reconocer a sus compañeros fácilmente por un trabajo bien hecho sin salir de MsTeams |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://semoscloud.com/product/jobpts](https://semoscloud.com/product/jobpts) |
...
Semos Cloud Soultions ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | Leer información básica de la empresa | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| correo electrónico | Delegado | Esto se usa para asignar usuarios de AzureAD con usuarios en la herramienta JobPts | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| offline_access | Delegado | Mantener el acceso a los datos | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| OpenID | Delegado | Para que los usuarios puedan iniciar sesión con su cuenta profesional | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| perfil | Delegado | Para poder ver jobpts para ver información básica del usuario (nombre de usuario) | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
