---
title: Información de la aplicación para el motor de trivia de EnableUC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/09/2021
...
description: Toda la información de seguridad y cumplimiento disponible para el motor de Trivia, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/3bd813fa-a19a-4c06-b130-450b24b8ee08" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003412" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por EnableUC a Microsoft:
...
| Nombre de la empresa asociada | HabilitarUC |
| Sitio web de la empresa | [https://www.triviaengine.com](https://www.triviaengine.com) |
| Términos de uso de la aplicación | [https://www.triviaengine.com/termsofuse.html](https://www.triviaengine.com/termsofuse.html) |
| Funcionalidad básica de la aplicación | Mejore el entrenamiento existente y mejore la retención de conocimiento mediante &#8220;&#8221; de gamificación. |
...
EnableUC ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Si la aplicación no usa una de las bibliotecas anteriores, ¿qué biblioteca o bibliotecas de autenticación usa? | N/A: se utiliza la versión más reciente de MSAL. |
