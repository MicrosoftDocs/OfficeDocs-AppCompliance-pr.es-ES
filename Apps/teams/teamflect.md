---
title: Información de la aplicación para Teamflect by Teamflect
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Teamflect, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/e46015e9-f2ae-4dbc-be6b-f05043192e62" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001860" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Teamflect a Microsoft:
...
| Nombre de la empresa asociada | Teamflect |
| Sitio web de la empresa | [https://teamflect.com](https://teamflect.com) |
| Términos de uso de la aplicación | [https://teamflect.com/terms](https://teamflect.com/terms) |
| Funcionalidad básica de la aplicación | Teamflect es una solución todo en uno de administración del rendimiento y compromiso de los empleados creada para Microsoft Teams. Hace que las personas sean más productivas y se involucre más con sus módulos 1-on-1 Meeting, Goal/OKR, Feedback, Recognition and Tasks |
...
Teamflect ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | aplicación | Usamos este permiso para acceder a calendarios de usuario para identificar las reuniones 1 a 1 | [c5da92a9-873e-4ea1-86c7-03ec9c1384f0](../azure/c5da92a9-873e-4ea1-86c7-03ec9c1384f0.md) |
>| Directory.Read.All | Delegado | Directorio de empresa: usamos este permiso para mostrar a los usuarios finales una lista de sus compañeros cuando realizan una búsqueda | [c5da92a9-873e-4ea1-86c7-03ec9c1384f0](../azure/c5da92a9-873e-4ea1-86c7-03ec9c1384f0.md) |
