---
title: Información de la aplicación para Heedify de Heedify
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/24/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Heedify, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64877277"
---
# <a name="heedify"></a>Heedify

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 2 de agosto de 2021</p>

* <a href="https://teams.microsoft.com/l/app/0587c0da-1445-4875-a9f3-2b8083b7338f" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003512" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Heedify a Microsoft:
...
| Nombre de la empresa asociada | Heedify |
| Sitio web de la empresa | [https://heedify.io](https://heedify.io) |
| Términos de uso de la aplicación | [https://heedify.io/terms](https://heedify.io/terms) |
| Funcionalidad básica de la aplicación | Operador de recepcionista nativo y agente del centro de llamadas para Microsoft Teams. |
...
Heedify ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Información de presencia y detalles de llamadas (desde el centro de llamadas)  |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Información de presencia y detalles de llamadas (desde el centro de llamadas)  |
...
| Dirección URL de la directiva de privacidad | https://heedify.io/privacy |
...
| Si la aplicación no usa una de las bibliotecas anteriores, ¿qué biblioteca o bibliotecas de autenticación usa? | Usamos ADAL (Javascript) porque MSAL aún no admite la autenticación con ADFS  |
...
>| Contacts.ReadWrite | Delegado | La aplicación debe poder agregar contactos al usuario (agente) y leer también sus contactos.  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| Contacts.ReadWrite.Shared | Delegado | la aplicación debe poder agregar contacto compartido con otros usuarios (agente) y leer también sus contactos compartidos.  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| Presence.Read.All | Delegado | La información de presencia es necesaria para que el agente del centro de contactos administre mejor las llamadas y el contacto, especialmente en el caso de la transferencia de llamadas.  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| User.Read.All | Delegado | para administrar el contacto, el usuario registrado debe poder examinar a los usuarios y leer su información, incluidos su departamento y administrador (en el caso de un recepcionista)  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
