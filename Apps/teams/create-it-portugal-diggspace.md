---
title: Información de la aplicación para Diggspace by Create IT Portugal
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Diggspace, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66656419"
---
# <a name="diggspace"></a>Diggspace

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 17 de junio de 2022</p>

* <a href="https://teams.microsoft.com/l/app/661a0fd1-38d6-4a93-8450-1dd493d9974d" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004347" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Create IT Portugal to Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Diggspace |
| ID | WA200004347 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Creación de TI en Portugal |
| Sitio web de la empresa | [https://www.create.pt](https://www.create.pt) |
| Términos de uso de la aplicación | [https://www.diggspace.com/en/terms-of-use](https://www.diggspace.com/en/terms-of-use) |
| Funcionalidad básica de la aplicación | Diggspace es una plataforma lista para usar y personalizable que le permite crear la intranet. |
| Ubicación de la sede central de la empresa | Portugal |
| Página de información de la aplicación | [https://www.diggspace.com](https://www.diggspace.com) |
...
Create IT Portugal ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿La aplicación realiza la toma de decisiones automatizada, incluida la generación de perfiles que podría tener un efecto legal o un impacto similar? | Sí |
| ¿Se proporciona a las personas una opción para oponerse al procesamiento? | Sí |
...
| Si la aplicación no usa una de las bibliotecas anteriores, ¿qué biblioteca o bibliotecas de autenticación usa? | ADAL |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.AccessAsUser.All | Delegado | Autenticación | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| Mail.ReadBasic | Delegado | Mostrar el recuento de correo electrónico de Outlook | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| Tasks.Read | Delegado | Mostrar tareas de usuario | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| User.Read | Delegado | Autenticación e información de perfil | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| User.Read.All | aplicación | Sincronizar datos de perfil | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| correo electrónico | Delegado | Autenticación | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| offline_access | Delegado | Autenticación | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| perfil | Delegado | Autenticación | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
