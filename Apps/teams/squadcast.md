---
title: Información de la aplicación para Squadcast by Squadcast
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/19/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Squadcast, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66892078"
---
# <a name="squadcast"></a>Squadcast

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 10 de enero de 2022</p>

* <a href="https://teams.microsoft.com/l/app/7792759a-43e8-4dc8-9f55-e7b0382c4a67" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004390" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Squadcast a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Squadcast |
| ID | WA200004390 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Squadcast |
| Sitio web de la empresa | [https://www.squadcast.com](https://www.squadcast.com) |
| Términos de uso de la aplicación | [https://www.squadcast.com/terms](https://www.squadcast.com/terms) |
| Funcionalidad básica de la aplicación | Administración eficaz de incidentes directamente desde MS Teams. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://support.squadcast.com/docs/msteams](https://support.squadcast.com/docs/msteams) |
...
Squadcast ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Datos de perfil de usuario: solo nombre de usuario, Email |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Id. de equipo, Nombre del equipo, Id. de canal, Nombre del canal, Id. de inquilino |
...
| Dirección URL de la directiva de privacidad | https://www.squadcast.com/privacy |
