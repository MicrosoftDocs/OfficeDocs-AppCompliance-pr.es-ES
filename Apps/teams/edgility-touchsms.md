---
title: Información de la aplicación para touchSMS by Edgility
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/12/2022
...
description: Toda la información de seguridad y cumplimiento disponible para touchSMS, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/d4275409-72a2-423e-9557-e088f0e68f20" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003655" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Edgility a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | touchSMS |
| Id. | WA200003655 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Edgility |
| Sitio web de la empresa | [https://touchsms.com.au](https://touchsms.com.au) |
| Términos de uso de la aplicación | [https://www.touchsms.com.au/legal/](https://www.touchsms.com.au/legal/) |
| Funcionalidad básica de la aplicación | En touchSMS, nos centramos en el desarrollo de soluciones de comunicación integradas para las herramientas empresariales diarias. Estas soluciones permiten a los usuarios enviar recordatorios, promociones, alertas y notificaciones a través de SMS, directamente desde productos de Microsoft como Excel, Outlook y Teams. Los usuarios pueden aprovechar las ventajas de la conversación bidireccional mediante la recepción de respuestas SMS en Microsoft Outlook y Teams. |
| Ubicación de la sede central de la empresa | Australia |
| Página de información de la aplicación | [https://www.touchsms.com.au/sms-integrations/microsoft-365/](https://www.touchsms.com.au/sms-integrations/microsoft-365/) |
...
Edgility ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Names |
