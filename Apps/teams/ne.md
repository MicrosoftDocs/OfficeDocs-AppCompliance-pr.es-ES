...
description: Toda la información de seguridad y cumplimiento disponible para NE, sus directivas de tratamiento de datos, su Microsoft Cloud App Security de catálogo de aplicaciones e información de seguridad y cumplimiento en el Registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/bd4bd4f6-ec6c-42b3-b296-bf39b8b758b3" target="_blank">Ver en Teams tienda</a>
...
| Sitio web de la compañía | [https://www.ne.se](https://www.ne.se) |
...
| Funcionalidad principal de la aplicación | Una aplicación de teams que permite a los clientes ne acceder a sus servicios de contenido desde dentro de los equipos. También agrega una extensión de mensaje de teams que permite a los usuarios buscar en la enciclopedia NE escribiendo @ne en un chat. |
