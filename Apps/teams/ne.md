...
description: Toda la información de seguridad y cumplimiento disponible para NE, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro de CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/bd4bd4f6-ec6c-42b3-b296-bf39b8b758b3" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000840" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | NE |
| Sitio web de la empresa | [https://www.ne.se](https://www.ne.se) |
| Términos de uso de la aplicación | [https://www.ne.se/info/hj%c3%a4lp/allm%c3%a4nna-avtalsvillk...](https://www.ne.se/info/hj%c3%a4lp/allm%c3%a4nna-avtalsvillkor/fleranv%c3%a4ndare/) |
| Funcionalidad básica de la aplicación | Una aplicación de teams que permite a los clientes de NE acceder a sus servicios de contenido desde dentro de teams. También agrega una extensión de mensaje de teams que permite a los usuarios buscar en la enciclopedia ne escribiendo @ne en un chat. |
| Ubicación de la sede central de la empresa | Suecia |
| Página de información de la aplicación | [https://www.ne.se/info/om-oss/](https://www.ne.se/info/om-oss/) |
...
Ne ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
