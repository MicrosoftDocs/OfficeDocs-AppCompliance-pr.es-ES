---
title: Información de la aplicación para TaskCall by TaskCall Cloud Services, S.L.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Toda la información de seguridad y cumplimiento disponible para TaskCall, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/eea91208-6850-4a61-8508-64b6c45d23a1" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003914" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por TaskCall Cloud Services, S.L. a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | TaskCall |
| Id. | WA200003914 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | TaskCall Cloud Services, S. L. |
| Sitio web de la empresa | [https://taskcallapp.com](https://taskcallapp.com) |
| Términos de uso de la aplicación | [https://www.taskcallapp.com/terms-of-service](https://www.taskcallapp.com/terms-of-service) |
| Funcionalidad básica de la aplicación | La integración bidireccional Microsoft Teams de TaskCall simplifica la comunicación y la colaboración IT-Ops al permitir que los incidentes se controlen desde Microsoft Teams. |
| Ubicación de la sede central de la empresa | España |
| Página de información de la aplicación | [https://docs.taskcallapp.com/integrations/v1/microsoft-team...](https://docs.taskcallapp.com/integrations/v1/microsoft-teams-integration-guide) |
...
Esta información ha sido proporcionada por TaskCall Cloud Services, S.L. acerca de cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
