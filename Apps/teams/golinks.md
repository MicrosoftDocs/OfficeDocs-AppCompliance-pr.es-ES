---
title: Información de la aplicación para GoLinks por GoLinks
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/18/2022
...
description: Toda la información de seguridad y cumplimiento disponible para GoLinks, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el Registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c1abaf93-e823-4e9a-a810-34a47e77ef71" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003853" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por GoLinks a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | GoLinks |
| ID | WA200003853 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | GoLinks |
| Sitio web de la compañía | [https://www.golinks.io](https://www.golinks.io) |
| Términos de uso de la aplicación | [https://www.golinks.io/terms.php](https://www.golinks.io/terms.php) |
| Funcionalidad principal de la aplicación | Los goLinks, conocidos como go links, golinks, go/links o go-links, son vínculos cortos intuitivos y fáciles de recordar, compartidos por equipos. Transforma las direcciones URL largas y feas en vínculos go legibles para humanos que se pueden usar directamente en exploradores, correos electrónicos, chats y conversaciones. GoLinks permite a las empresas acceder de forma eficaz y eficiente a la información y los recursos de trabajo a escala. |
| Ubicación central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.golinks.io/golinks.php](https://www.golinks.io/golinks.php) |
...
GoLinks ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Solo almacenamos el identificador de inquilino de Microsoft. |
...
| Fecha de certificación SOC2 más reciente |  2021-10-31 |
...
| Dirección URL de la directiva de privacidad | https://www.golinks.io/privacy.php |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.Group | aplicación | Necesitamos acceso a los mensajes en canales públicos para comprobar si el mensaje contiene un go/link. | [c1abaf93-e823-4e9a-a810-34a47e77ef71](../azure/c1abaf93-e823-4e9a-a810-34a47e77ef71.md) |
