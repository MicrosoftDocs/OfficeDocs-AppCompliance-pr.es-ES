...
description: Toda la información de seguridad y cumplimiento disponible para MyWorkDrive, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64878607"
---
# <a name="myworkdrive"></a>MyWorkDrive

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 3 de febrero de 2022</p>

* <a href="https://teams.microsoft.com/l/app/f4170c12-ec5c-47b9-834a-a4186cf27ec1" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002325" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | MyWorkDrive |
| Sitio web de la empresa | [https://www.myworkdrive.com](https://www.myworkdrive.com) |
| Términos de uso de la aplicación | [https://www.myworkdrive.com/terms-of-service/](https://www.myworkdrive.com/terms-of-service/) |
| Funcionalidad básica de la aplicación | La aplicación MyWorkDrive le permite acceder a carpetas de recursos compartidos de archivos en Microsoft Teams con la capacidad de editar, compartir y acceder a archivos de empresa almacenados en recursos compartidos de archivos de forma remota.   |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.myworkdrive.com/support/myworkdrive-teams-integ...](https://www.myworkdrive.com/support/myworkdrive-teams-integration/) |
| ¿Cuál es el entorno de hospedaje o el modelo de servicio que se usa para ejecutar la aplicación? | Híbrido |
| ¿Qué proveedores de nube de hospedaje usa la aplicación? | Azure, Aws, otros |
...
MyWorkDrive ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Enumerar los tipos de directivas admitidas | Directivas de dispositivo |
