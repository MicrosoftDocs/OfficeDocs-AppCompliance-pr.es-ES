---
title: Información de la aplicación para Rezolve.ai por ciencia accionable
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Rezolve.ai, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/762a660d-9fa5-461b-be81-310c102ba820" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002724" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Paso que se puede accionar |
| Sitio web de la empresa | [https://www.rezolve.ai](https://www.rezolve.ai) |
| Términos de uso de la aplicación | [https://www.rezolve.ai/generalTerms](https://www.rezolve.ai/generalTerms) |
| Funcionalidad básica de la aplicación | La aplicación proporciona una funcionalidad completa de Employee Service Desk, incluida la capacidad de a) Crear y actualizar vales b) Responder preguntas rutinarias c) Automatizar tareas comunes como el aprovisionamiento o la incorporación  |
...
Esta información ha sido proporcionada por Actionable Science sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC1 más reciente | 2019-12-31 |
| ¿La aplicación cumple con los controles de organización de servicio (SOC 2)? | Sí |
| Fecha de certificación de SOC2 más reciente | 2019-12-31 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | Iniciar sesión y leer el perfil del usuario | [eb628055-f790-4ef0-9fce-ac95b4c61466](../azure/eb628055-f790-4ef0-9fce-ac95b4c61466.md) |
