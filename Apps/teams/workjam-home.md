---
title: Información de la aplicación para WorkJam Home by WorkJam
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toda la información de seguridad y cumplimiento disponible para WorkJam Home, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64876137"
---
# <a name="workjam-home"></a>WorkJam Home

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 29 de junio de 2021</p>

* <a href="https://teams.microsoft.com/l/app/f80b33b4-695d-423f-a5e7-d464ad6893d1" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003060" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | WorkJam Home |
| Id. | WA200003060 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | WorkJam |
| Sitio web de la empresa | [https://www.workjam.com](https://www.workjam.com) |
| Términos de uso de la aplicación | [https://appcontent.workjam.com/en/terms-of-use/](https://appcontent.workjam.com/en/terms-of-use/) |
| Funcionalidad básica de la aplicación | WorkJam es el líder de la industria de soluciones de Digital Workplace que decide organizar sus empleados de primera línea &#8212; como plataforma de productividad de primera línea o dentro de la solución de empleados de primera línea. Disponible en más de 37 idiomas e implementado en más de 38 países, WorkJam ofrece orquestación total de la fuerza de trabajo a través de herramientas líderes en el mercado de administración de tareas, administración de turnos, encuestas y microaprendizaciones.  |
| Ubicación de la sede central de la empresa | Canadá |
| Página de información de la aplicación | [https://www.workjam.com/portfolio-items/workjam-microsoft-t...](https://www.workjam.com/portfolio-items/workjam-microsoft-teams/) |
...
WorkJam ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2020-08-01 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | aplicación | Enviar notificaciones a los usuarios finales. | [0b87cb84-073e-4cf6-a1ef-45d864ef2918](../azure/0b87cb84-073e-4cf6-a1ef-45d864ef2918.md) |
>| User.Read | Delegado | Para la identificación y autenticación | [0b87cb84-073e-4cf6-a1ef-45d864ef2918](../azure/0b87cb84-073e-4cf6-a1ef-45d864ef2918.md) |
