---
title: Información de la aplicación para CLIPr de CLIPr Co
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/21/2022
...
description: Toda la información de seguridad y cumplimiento disponible para CLIPr, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66952619"
---
# <a name="clipr"></a>CLIPr

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 3 de diciembre de 2021</p>

* <a href="https://teams.microsoft.com/l/app/2d6b2a6d-a20d-4206-a11c-e01d34d0d3a0" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003612" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por CLIPr Co a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | CLIPr |
| ID | WA200003612 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | CLIPr Co |
| Sitio web de la empresa | [https://www.clipr.ai](https://www.clipr.ai) |
| Términos de uso de la aplicación | [https://www.clipr.ai/terms-of-use](https://www.clipr.ai/terms-of-use) |
| Funcionalidad básica de la aplicación | CLIPr usa inteligencia artificial o aprendizaje automático para hacer que el contenido de vídeo se pueda buscar y que sea accionable. |
...
CliPr Co ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Recopilamos el nombre y la dirección de correo electrónico del usuario. |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Nombre de usuario, dirección de correo electrónico y nombre de empresa adjunto a su identificador de inquilino.  |
...
| Dirección URL de la directiva de privacidad | https://www.clipr.ai/privacy-policy |
