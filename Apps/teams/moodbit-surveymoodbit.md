---
title: Información de la aplicación para SurveyMoodbit de Moodbit
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: Toda la información de seguridad y cumplimiento disponible para SurveyMoodbit, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/86425243-0129-41f7-bf74-971bee7ff3d3" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003925" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Moodbit a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | SurveyMoodbit |
| ID | WA200003925 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Moodbit |
| Sitio web de la empresa | [https://mymoodbit.com](https://mymoodbit.com) |
| Términos de uso de la aplicación | [https://mymoodbit.com/terms](https://mymoodbit.com/terms) |
| Funcionalidad básica de la aplicación | Obtenga rápidamente comentarios &amp; para aprovechar People Analytics justo dentro de Microsoft Teams |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://mymoodbit.com](https://mymoodbit.com) |
...
Moodbit ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Autenticación multifactor (MFA) habilitada para: | Credenciales, repositorios de código, DNSManagement |
...
| Dirección URL de la directiva de privacidad | https://mymoodbit.com/terms |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | Para obtener información del usuario con el fin de mostrarla en la aplicación de la interfaz de usuario y proporcionar una experiencia de usuario personalizada | [bed944b9-c7f5-459a-b7af-53c421248893](../azure/bed944b9-c7f5-459a-b7af-53c421248893.md) |
>| correo electrónico | Delegado | Autenticación de Msal | [bed944b9-c7f5-459a-b7af-53c421248893](../azure/bed944b9-c7f5-459a-b7af-53c421248893.md) |
>| OpenID | Delegado | Autenticación de Msal | [bed944b9-c7f5-459a-b7af-53c421248893](../azure/bed944b9-c7f5-459a-b7af-53c421248893.md) |
>| perfil | Delegado | Autenticación de Msal | [bed944b9-c7f5-459a-b7af-53c421248893](../azure/bed944b9-c7f5-459a-b7af-53c421248893.md) |
