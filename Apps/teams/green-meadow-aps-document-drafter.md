---
title: Información de solicitud para el borrador de documentos por Green Meadow ApS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/06/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Document Drafter, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65357145"
---
# <a name="document-drafter"></a>Borrador de documentos

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador el 2 de febrero de 2022</p>

* <a href="https://teams.microsoft.com/l/app/6b96e77c-08d1-432e-819f-7dc7b6585a1a" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004059" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Green Meadow ApS a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Borrador de documentos |
| ID | WA200004059 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Green Meadow ApS |
| Sitio web de la empresa | [https://gmeadow.com](https://gmeadow.com) |
| Términos de uso de la aplicación | [https://tinyurl.com/2p9dw3tm](https://tinyurl.com/2p9dw3tm) |
| Funcionalidad básica de la aplicación | Use y colabore en los documentos automatizados dentro de Microsoft Teams. |
| Ubicación de la sede central de la empresa | Dinamarca |
| Página de información de la aplicación | [https://gmeadow.com/document-drafter-inside-microsoft-teams/](https://gmeadow.com/document-drafter-inside-microsoft-teams/) |
...
Esta información ha sido proporcionada por Green Meadow ApS sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Id. de correo electrónico, nombre y grupo de seguridad. |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Id. de correo electrónico, nombre y grupo de seguridad. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | ambas | Para leer las bibliotecas de personas en los canales necesarios para que los usuarios examinen las carpetas al almacenar los documentos generados en nuestra aplicación. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| Files.ReadWrite.All | Delegado | Para que los usuarios examinen o creen carpetas que almacenen documentos generados en nuestra aplicación. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| Group.ReadWrite.All | Delegado | Para identificar Teams miembros con fines de administración de acceso. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| TeamsActivity.Send | Delegado | Para enviar mensajes sobre cuestionarios o actualización de cuestionarios, etc. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| User.Read.All | Delegado | Para leer el perfil completo para saber qué usuario de pertenencia a grupos tiene: se usa para enviar mensajes a Teams fuente de actividad. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| correo electrónico | Delegado | Usamos el identificador de correo electrónico para identificar usuarios en nuestro sistema back-end. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| OpenID | Delegado | Autenticación de usuario. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| perfil | Delegado | Para mejorar la experiencia del usuario mediante la obtención de avatares o fotos de los usuarios, si existe. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
