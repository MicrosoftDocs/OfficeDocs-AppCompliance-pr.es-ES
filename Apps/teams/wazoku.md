---
title: Información de la aplicación para Wazoku de Wazoku
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Wazoku, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f060d814-1813-4135-bbef-4cda4251abec" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003384" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Wazoku a Microsoft:
...
| Nombre de la empresa asociada | Wazoku |
| Sitio web de la empresa | [https://www.wazoku.com](https://www.wazoku.com) |
| Términos de uso de la aplicación | [https://www.wazoku.com/terms-of-use/](https://www.wazoku.com/terms-of-use/) |
| Funcionalidad básica de la aplicación | Plataforma de administración de ideas de Wazoku |
...
Wazoku ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://www.wazoku.com/privacy-policy/ |
...
| Si la aplicación no usa una de las bibliotecas anteriores, ¿qué biblioteca o bibliotecas de autenticación usa? | SSO |
