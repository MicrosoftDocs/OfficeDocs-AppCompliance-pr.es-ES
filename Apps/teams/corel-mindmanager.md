...
* <a href="https://teams.microsoft.com/l/app/cebe4a59-b076-47f3-a7bf-79148daf82f7" target="_blank">Ver en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002261" target="_blank">Ver en AppSource</a>
...
| Sitio web de la compañía | [https://www.mindmanager.com](https://www.mindmanager.com) |
| Términos de uso de la aplicación | [https://www.mindjet.com/go/mmcloudterms](https://www.mindjet.com/go/mmcloudterms) |
| Funcionalidad principal de la aplicación | Coedir mapas, administrar paneles de equipo, crear diagramas de flujo y mantener los proyectos a la vista. |
...
Esta información ha sido proporcionada por Corel acerca de cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación SOC2 más reciente |  2020-08-31 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | delegado | Información sobre los cambios realizados en un archivo MindManager que luego se pueden publicar como mensaje | [51e2b67d-9854-446a-8da1-cdd89ef0b987](https://docs.microsoft.com/microsoft-365-app-certification/azure/51e2b67d-9854-446a-8da1-cdd89ef0b987) |
>| Chat.Send | delegado | Información sobre los cambios realizados en un archivo MindManager que luego se pueden publicar como mensaje | [51e2b67d-9854-446a-8da1-cdd89ef0b987](https://docs.microsoft.com/microsoft-365-app-certification/azure/51e2b67d-9854-446a-8da1-cdd89ef0b987) |
>| Files.ReadWrite | delegado | lista de sitios, lista de carpetas, metadatos de archivo, contenido de archivos: para el explorador de archivos, el usuario puede examinar sus archivos para abrir un archivo MindManager (.mmap). | [51e2b67d-9854-446a-8da1-cdd89ef0b987](https://docs.microsoft.com/microsoft-365-app-certification/azure/51e2b67d-9854-446a-8da1-cdd89ef0b987) |
>| Sites.ReadWrite.All | delegado | lista de sitios, lista de carpetas, metadatos de archivo, contenido de archivos: para el explorador de archivos, el usuario puede examinar sus archivos para abrir un archivo MindManager (.mmap). | [51e2b67d-9854-446a-8da1-cdd89ef0b987](https://docs.microsoft.com/microsoft-365-app-certification/azure/51e2b67d-9854-446a-8da1-cdd89ef0b987) |
>| User.Read | delegado | datos de perfil: para identificar al usuario y mostrar su perfil | [51e2b67d-9854-446a-8da1-cdd89ef0b987](https://docs.microsoft.com/microsoft-365-app-certification/azure/51e2b67d-9854-446a-8da1-cdd89ef0b987) |
>| offline_access | delegado | Esto nos permite guardar un archivo en su ubicación original en nombre del usuario más adelante si es necesario. | [51e2b67d-9854-446a-8da1-cdd89ef0b987](https://docs.microsoft.com/microsoft-365-app-certification/azure/51e2b67d-9854-446a-8da1-cdd89ef0b987) |
