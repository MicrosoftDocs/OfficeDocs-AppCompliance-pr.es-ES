---
title: Información de la aplicación para MindManager by Corel
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Toda la información de seguridad y cumplimiento disponible para MindManager, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/cebe4a59-b076-47f3-a7bf-79148daf82f7" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002261" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Corel a Microsoft:
...
| Nombre de la empresa asociada | Corel |
| Sitio web de la empresa | [https://www.mindmanager.com](https://www.mindmanager.com) |
| Términos de uso de la aplicación | [https://www.mindjet.com/go/mmcloudterms](https://www.mindjet.com/go/mmcloudterms) |
| Funcionalidad básica de la aplicación | Edite mapas de forma conjunta, administre paneles de equipo, cree diagramas de flujo y mantenga los proyectos en vista. |
...
Corel ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2020-08-31 |
| ¿La aplicación cumple con los controles de organización de servicio (SOC 3)? | Sí |
| Fecha de certificación de SOC3 más reciente | 2021-10-15 |
...
| Dirección URL de la directiva de privacidad | https://www.corel.com/en/corel-privacy-policy/ |
...
| Si la aplicación no usa una de las bibliotecas anteriores, ¿qué biblioteca o bibliotecas de autenticación usa? | SDK de JavaScript de MS Teams para la autenticación |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | Delegado | La aplicación (MindManager) delega permisos al usuario para realizar operaciones de archivo.   | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| Chat.Send | Delegado | La aplicación (MindManager) delega permisos al usuario para realizar operaciones de archivo.   | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| Files.ReadWrite | Delegado | La aplicación (MindManager) delega permisos al usuario para realizar operaciones de archivo.   | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| Sites.ReadWrite.All | Delegado | La aplicación (MindManager) delega permisos al usuario para realizar operaciones de archivo.   | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| User.Read | Delegado | La aplicación (MindManager) delega permisos al usuario para realizar operaciones de archivo.   | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| offline_access | Delegado | La aplicación (MindManager) delega permisos al usuario para realizar operaciones de archivo.   | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
