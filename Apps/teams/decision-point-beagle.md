...
description: Toda la información de seguridad y cumplimiento disponible para Beagle, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/a0f836a9-178e-4407-9c26-4579dcd17bd1" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002687" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Decision Point a Microsoft:
...
| Nombre de la empresa asociada | Decision Point |
| Sitio web de la empresa | [https://decisionpoint.ai](https://decisionpoint.ai) |
...
| Funcionalidad básica de la aplicación | Beagle es una herramienta de BI basada en chat que se integra con plataformas como MS Teams. Beagle reduce las barreras de adopción y elimina la necesidad de formación (de individuos) mediante la toma de datos a las personas a través de una aplicación de colaboración.  Beagle muestra los datos relevantes para un usuario en forma de tarjetas de información y le permite profundizar en ellos mediante filtros y ayuda a tomar decisiones más rápidas.  |
...
Esta información la ha proporcionado Decision Point sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
