---
title: Información de la aplicación para Klett de Ernst Klett Verlag GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/11/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Klett, sus directivas de tratamiento de datos, su Microsoft Cloud App Security de catálogo de aplicaciones e información de seguridad y cumplimiento en el Registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/e52ef0da-a602-479b-8ac4-f3e0398009e6" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003716" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Ernst Klett Verlag GmbH a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Klett |
| ID | WA200003716 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | Ernst Klett Verlag GmbH |
| Sitio web de la compañía | [https://www.klett.de/index/](https://www.klett.de/index/) |
| Términos de uso de la aplicación | [https://www.klett.de/inhalt/rechtliches/nutzungsbedingungen...](https://www.klett.de/inhalt/rechtliches/nutzungsbedingungen-fuer-digitale-inhalte-und-online-services/6931) |
| Funcionalidad principal de la aplicación | Bequemer Zugriff auf die digitalen Produkte passend zum Schulbuch |
| Ubicación central de la empresa | Alemania |
| Página de información de la aplicación | [https://www.klett.de/inhalt/217167](https://www.klett.de/inhalt/217167) |
...
Esta información ha sido proporcionada por Ernst Klett Verlag GmbH sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://www.klett.de/datenschutz |
