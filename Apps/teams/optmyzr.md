---
title: Información de la aplicación para Optmyzr por Optmyzr
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/26/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Optmyzr, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el Registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/a8aefb12-8635-4f30-9759-e889fee14d28" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003395" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Optmyzr a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Optmyzr |
| ID | WA200003395 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | Optmyzr |
| Sitio web de la compañía | [https://www.optmyzr.com](https://www.optmyzr.com) |
| Términos de uso de la aplicación | [https://www.optmyzr.com/information/terms-of-use/](https://www.optmyzr.com/information/terms-of-use/) |
| Funcionalidad principal de la aplicación | https://www.optmyzr.com/information/terms-of-use/ |
| Ubicación central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.optmyzr.com/capabilities/reporting/](https://www.optmyzr.com/capabilities/reporting/) |
...
Optmyzr ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Perfil de usuario: dirección de correo electrónico usada como identificador |
...
| Dirección URL de la directiva de privacidad | https://www.optmyzr.com/information/privacy-policy/ |
