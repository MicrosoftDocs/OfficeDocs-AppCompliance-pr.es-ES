---
title: Información de la aplicación para B12 de Apprentx
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/11/2022
...
description: Toda la información de seguridad y cumplimiento disponible para B12, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65548893"
---
# <a name="b12"></a>B12

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 4 de abril de 2022</p>

* <a href="https://teams.microsoft.com/l/app/a4a2213d-2466-473b-8772-021094c5f013" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004073" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Apprentx a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | B12 |
| ID | WA200004073 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Apprentx |
| Sitio web de la empresa | [https://apprentx.rocks](https://apprentx.rocks) |
| Términos de uso de la aplicación | [https://blogue.apprentx.rocks/terms-and-conditions](https://blogue.apprentx.rocks/terms-and-conditions) |
| Funcionalidad básica de la aplicación | B12 combina el refuerzo de conocimiento y la práctica para maximizar el impacto. |
| Ubicación de la sede central de la empresa | Canadá |
| Página de información de la aplicación | [https://apprentx.rocks/en/nos-solutions](https://apprentx.rocks/en/nos-solutions) |
...
Apprentx ha proporcionado esta información sobre cómo recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Procesamos tokens de identificador que contienen el nombre y el correo electrónico de los usuarios para la característica opcional sso |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Almacenamos tokens de acceso para la característica de sincronización de calendario opcional |
...
| Dirección URL de la directiva de privacidad | https://blogue.apprentx.rocks/en/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | inicio de sesión único de Teams | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| correo electrónico | Delegado | inicio de sesión único de Teams | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| offline_access | Delegado | inicio de sesión único de Teams | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| OpenID | Delegado | inicio de sesión único de Teams | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| perfil | Delegado | inicio de sesión único de Teams | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| Calendars.ReadWrite | Delegado | Sincronización del calendario | [75932bb9-5e71-449a-b584-b5cc01c2d118](../azure/75932bb9-5e71-449a-b584-b5cc01c2d118.md) |
>| User.Read | Delegado | Sincronización del calendario | [75932bb9-5e71-449a-b584-b5cc01c2d118](../azure/75932bb9-5e71-449a-b584-b5cc01c2d118.md) |
