---
title: Información de la aplicación para COR por COR Global Ltd.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2022
...
description: Toda la información de seguridad y cumplimiento disponible para COR, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66248858"
---
# <a name="cor"></a>COR

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 6 de septiembre de 2021</p>

* <a href="https://teams.microsoft.com/l/app/1ff72075-1e25-4b42-bd88-3fdbc9d6d34e" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004235" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por COR Global Ltd. a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | COR |
| Id. | WA200004235 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | COR Global Ltd. |
| Sitio web de la empresa | [https://projectcor.com](https://projectcor.com) |
| Términos de uso de la aplicación | [https://projectcor.com/cor-terms-of-service/](https://projectcor.com/cor-terms-of-service/) |
| Funcionalidad básica de la aplicación | Visibilidad en tiempo real. COR es la solución de administración dirigida a profesionales y equipos creativos que sugiere inteligentemente cómo administrar proyectos, equipos y finanzas con inteligencia artificial. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://cor.zendesk.com/hc/en-us](https://cor.zendesk.com/hc/en-us) |
...
COR Global Ltd. ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://projectcor.com/cor-privacy-and-personal-data/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read.All | aplicación | Integración con One Drive | [e73458d3-c732-4460-bfb2-9da9086fc714](../azure/e73458d3-c732-4460-bfb2-9da9086fc714.md) |
