---
title: Información de la aplicación para bucle por flujos descriptivos
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/18/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Loop, sus directivas de control de datos, su Microsoft Cloud App Security de catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/5dcf4bd7-eccd-4f6d-b5f0-a4e04aab4ff9" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003480" target="_blank">Ver en AppSource</a>
...
| Nombre de la compañía asociada | Flujos descriptivos |
| Sitio web de la compañía | [https://friendlyflows.com](https://friendlyflows.com) |
| Términos de uso de la aplicación | [https://friendlyflows.com/terms-of-use/](https://friendlyflows.com/terms-of-use/) |
| Funcionalidad principal de la aplicación | Reunir a personas en el momento adecuado para trabajar en proyectos. |
...
Esta información ha sido proporcionada por Friendly Flows acerca de cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
