---
title: Información de la aplicación para Loop por flujos descriptivos
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/18/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Loop, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64879757"
---
# <a name="loop"></a>Loop

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 10 de noviembre de 2021</p>

* <a href="https://teams.microsoft.com/l/app/5dcf4bd7-eccd-4f6d-b5f0-a4e04aab4ff9" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003480" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Flujos descriptivos a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Loop |
| Id. | WA200003480 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Flujos descriptivos |
| Sitio web de la empresa | [https://friendlyflows.com](https://friendlyflows.com) |
| Términos de uso de la aplicación | [https://friendlyflows.com/terms-of-use/](https://friendlyflows.com/terms-of-use/) |
| Funcionalidad básica de la aplicación | Reunir a personas en el momento adecuado para trabajar en proyectos. |
| Ubicación de la sede central de la empresa | Países Bajos (el) |
| Página de información de la aplicación | [https://friendlyflows.com/loop/](https://friendlyflows.com/loop/) |
...
Esta información ha sido proporcionada por Flujos descriptivos sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | perfil de usuario, entrada de usuario |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | perfil de usuario, entrada de usuario |
...
| Dirección URL de la directiva de privacidad | https://friendlyflows.com/privacy-policy/ |
...
| Si la aplicación no usa una de las bibliotecas anteriores, ¿qué biblioteca o bibliotecas de autenticación usa? | Ninguno |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | Autenticación | [95a2eca4-fb4b-4488-8ba8-6bacf3812c76](../azure/95a2eca4-fb4b-4488-8ba8-6bacf3812c76.md) |
>| correo electrónico | Delegado | Registro | [95a2eca4-fb4b-4488-8ba8-6bacf3812c76](../azure/95a2eca4-fb4b-4488-8ba8-6bacf3812c76.md) |
>| perfil | Delegado | Autenticación | [95a2eca4-fb4b-4488-8ba8-6bacf3812c76](../azure/95a2eca4-fb4b-4488-8ba8-6bacf3812c76.md) |
