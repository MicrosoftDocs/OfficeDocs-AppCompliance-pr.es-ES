---
title: Información de la aplicación para delibera por Dontknow Internet S.L.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Toda la información de seguridad y cumplimiento disponible para deliberación, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66656522"
---
# <a name="delibera"></a>deliberación

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 29 de junio de 2022</p>

* <a href="https://teams.microsoft.com/l/app/0c914e60-f699-11ea-b068-b9aff13273d5" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003380" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Dontknow Internet S.L. a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | deliberación |
| ID | WA200003380 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | No lo sepa Internet S.L. |
| Sitio web de la empresa | [https://www.delibera.com](https://www.delibera.com) |
| Términos de uso de la aplicación | [https://www.delibera.com/terms](https://www.delibera.com/terms) |
| Funcionalidad básica de la aplicación | Delibera mejora la calidad de las conversaciones clave en las organizaciones, ayudando a los líderes a comprender, decidir y ejecutar mejor |
| Ubicación de la sede central de la empresa | España |
| Página de información de la aplicación | [https://www.delibera.com](https://www.delibera.com) |
...
Esta información ha sido proporcionada por Dontknow Internet S.L. acerca de cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2022-03-09 |
...
| Dirección URL de la directiva de privacidad | https://www.delibera.com/privacy |
