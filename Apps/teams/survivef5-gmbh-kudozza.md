...
| URL del sitio web de socios | [https://www.kudozza.com](https://www.kudozza.com) |
| URL de Teams página de información de la aplicación | [https://kudozza.com](https://kudozza.com) |
| URL de la Política de Privacidad | [https://www.kudozza.com/privacy](https://www.kudozza.com/privacy) |
| URL de los Términos de uso | [https://www.kudozza.com/terms](https://www.kudozza.com/terms) |
...
SurviveF5 GmbH ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos organizativos y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:-------------------|:--------------------------|:--------------------------|
>| AWS | userId, teamId, tenantId, nombre de usuario | El servicio y la base de datos se alojan en AWS.  |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| Los felicitaciones se envían a otras personas y el mensaje debe ser resentido con frecuencia. También se proporciona una clasificación que hace necesario almacenar los nombres e identificadores de los usuarios que utilizan la aplicación Kudozza. | userid, nombre de usuario | Los felicitaciones se envían a otras personas y el mensaje debe ser resentido con frecuencia. También se proporciona una clasificación que hace necesario almacenar los nombres e identificadores de los usuarios que utilizan la aplicación Kudozza. |
...
>Por DPA. Auditoría y políticas de usuario ent.
...
SurviveF5 GmbH ha proporcionado esta información sobre cómo esta aplicación gestiona la autenticación, la autorización, las prácticas recomendadas de registro de aplicaciones y otros criterios de identidad.
