...
description: Toda la información de seguridad y cumplimiento disponible para Kudozza, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/61a58a9f-3474-4d14-bda6-6547194a7381" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002599" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | surviveF5 GmbH |
| Sitio web de la empresa | [https://surviveF5.com](https://surviveF5.com) |
| Términos de uso de la aplicación | [https://kudozza.com/terms](https://kudozza.com/terms) |
| Funcionalidad básica de la aplicación | Kudozza permite dar Kudos a otros miembros del equipo para mostrarles su aprecio. Ofrece diversas herramientas como las participación de emojis, categorías o clasificaciones para motivar la entrega de Kudos. |
...
Esta información ha sido proporcionada por surviveF5 GmbH sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Datos de perfil de usuario, datos de mensaje (se desvía al bot) |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | userid, teamid, teamname, username, tenantid, messageid, messagetext |
...
| Dirección URL de la directiva de privacidad | https://www.kudozza.com/privacy/ |
...
| Si la aplicación no usa una de las bibliotecas anteriores, ¿qué biblioteca o bibliotecas de autenticación usa? | MSAL, pero todavía tenemos que actualizar a la versión más reciente para Teams |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Delegado | Leer los canales de un equipo para dar al usuario la posibilidad de seleccionar un canal donde quiera publicar los kudos | [69e59100-2fb7-4f6e-a311-987f52b3007b](../azure/69e59100-2fb7-4f6e-a311-987f52b3007b.md) |
>| Teams.ReadBasic.All | Delegado | El usuario puede seleccionar un equipo y un canal donde quiere que se publiquen los kudos. Se necesitan permisos de lectura de equipo para leer equipos. | [69e59100-2fb7-4f6e-a311-987f52b3007b](../azure/69e59100-2fb7-4f6e-a311-987f52b3007b.md) |
