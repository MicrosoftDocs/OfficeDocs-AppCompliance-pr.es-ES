---
title: Información de la aplicación para Workday Peakon Employee Voice by Workday
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/26/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Workday Peakon Employee Voice, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65125364"
---
# <a name="workday-peakon-employee-voice"></a>Voz del empleado de Workday Peakon

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 20 de julio de 2021</p>

* <a href="https://teams.microsoft.com/l/app/1c37bec0-d522-4cba-9643-ddc79d841729" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003453" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Voz del empleado de Workday Peakon |
| Id. | WA200003453 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Workday |
| Sitio web de la empresa | [https://www.workday.com/en-us/homepage.html](https://www.workday.com/en-us/homepage.html) |
| Términos de uso de la aplicación | [https://nw.myworkday.com/workdaypeakonemployeevoiceforteams...](https://nw.myworkday.com/workdaypeakonemployeevoiceforteams/post-license/) |
| Funcionalidad básica de la aplicación | Obtenga notificaciones sobre las nuevas encuestas Envíe respuestas de encuesta directamente a través de Microsoft Teams Recuerde las encuestas que aún no ha completado. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://nw.myworkday.com/workdaypeakonemployeevoiceforteams](https://nw.myworkday.com/workdaypeakonemployeevoiceforteams) |
| ¿Cuál es el entorno de hospedaje o el modelo de servicio que se usa para ejecutar la aplicación? | Híbrido |
| ¿Qué proveedores de nube de hospedaje usa la aplicación? | Otros |
...
Workday ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Correo electrónico y el identificador de Azure Active Director: la aplicación Peakon para MS Teams no procesa directamente los datos.  |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | identificador de empresa, registros de aplicación |
...
| Fecha de certificación de SOC2 más reciente | 2021-03-03 |
...
| Dirección URL de la directiva de privacidad | https://www.workday.com/en-us/privacy.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser.All | aplicación | Instalación de la aplicación y búsqueda del usuario en Azure Database   | [075a01db-a69f-4975-a713-aa85d004f3b5](../azure/075a01db-a69f-4975-a713-aa85d004f3b5.md) |
