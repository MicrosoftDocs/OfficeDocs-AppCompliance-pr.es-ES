---
title: Información de la aplicación para Startgrid por Startgrid
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/09/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Startgrid, sus directivas de tratamiento de datos, su Microsoft Cloud App Security de catálogo de aplicaciones e información de seguridad y cumplimiento en el Registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/6624420b-7199-41d2-98ff-90d745e039a7" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003838" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Startgrid a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Startgrid |
| ID | WA200003838 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | Startgrid |
| Sitio web de la compañía | [https://app.startgrid.com](https://app.startgrid.com) |
| Términos de uso de la aplicación | [https://corp.startgrid.com/terms-of-use](https://corp.startgrid.com/terms-of-use) |
| Funcionalidad principal de la aplicación | Busque, comparta y evalúe soluciones tecnológicas para resolver los desafíos con mayor rapidez. |
| Ubicación central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://corp.startgrid.com/platform](https://corp.startgrid.com/platform) |
...
Startgrid ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://corp.startgrid.com/privacy-policy |
