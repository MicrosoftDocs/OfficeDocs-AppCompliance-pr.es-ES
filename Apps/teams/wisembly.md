...
description: Toda la información de seguridad y cumplimiento disponible para Wisembly, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b63d5c73-8c76-4d8b-b0dc-ca35c6e37a90" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001554" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Wisembly |
| Sitio web de la empresa | [https://wisembly.com](https://wisembly.com) |
| Términos de uso de la aplicación | [https://wisembly.com/en/condition-of-sale.html](https://wisembly.com/en/condition-of-sale.html) |
| Funcionalidad básica de la aplicación | Crear eventos virtuales e híbridos sencillos e interesantes, seminarios, conferencias, talleres... Wisembly le guía a través de su proyecto de evento, de principio a fin, cualquiera que sea su necesidad: página principal personalizable, registro, organización de talleres y sesiones plenarias, herramientas de vídeo, características interactivas y mucho más. |
| Ubicación de la sede central de la empresa | Francia |
| Página de información de la aplicación | [https://wisembly.com](https://wisembly.com) |
...
Wisembly ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
