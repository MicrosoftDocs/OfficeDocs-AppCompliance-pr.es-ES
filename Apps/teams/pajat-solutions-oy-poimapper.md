---
title: Información de la aplicación para Poimapper de Pajat Solutions Oy.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Poimapper, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66656340"
---
# <a name="poimapper"></a>Poimapper

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 30 de junio de 2022</p>

* <a href="https://teams.microsoft.com/l/app/f2dac71d-b558-496b-be58-b28980e2cfd9" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004353" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Pajat Solutions Oy. a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Poimapper |
| ID | WA200004353 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Pajat Solutions Oy. |
| Sitio web de la empresa | [https://poimapper.com](https://poimapper.com) |
| Términos de uso de la aplicación | [https://portal.poimapper.com/termofservice.jsp](https://portal.poimapper.com/termofservice.jsp) |
| Funcionalidad básica de la aplicación | Poimapper cambia la forma en que las organizaciones recopilan y analizan datos de campo. |
...
Esta información ha sido proporcionada por Pajat Solutions Oy. acerca de cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://portal.poimapper.com/privacy.jsp |
