---
title: Información de la aplicación para Hero de Happyforce by Happyforce
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/26/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Hero by Happyforce, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65749443"
---
# <a name="hero-by-happyforce"></a>Hero de Happyforce
...
* <a href="https://teams.microsoft.com/l/app/de22bf49-b60e-44e7-a583-050a6e1918b5" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002078" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Happyforce a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Hero de Happyforce |
| ID | WA200002078 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Happyforce |
| Sitio web de la empresa | [https://www.myhappyforce.com](https://www.myhappyforce.com) |
| Términos de uso de la aplicación | [https://www.myhappyforce.com/en/terms-conditions](https://www.myhappyforce.com/en/terms-conditions) |
| Funcionalidad básica de la aplicación | Escuche a sus personas y haga que prosperen al transformar su organización a través de comentarios. |
| Ubicación de la sede central de la empresa | España |
| Página de información de la aplicación | [https://www.myhappyforce.com](https://www.myhappyforce.com) |
...
Happyforce ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://myhappyforce.com/es/politica-de-privacidad/ |
