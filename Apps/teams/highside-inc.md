---
title: Información de la aplicación para HighSide by HighSide, Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Toda la información de seguridad y cumplimiento disponible para HighSide, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/d4460828-ddde-4619-b40b-39412667f7a3" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003916" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://highside.io](https://highside.io) |
| Términos de uso de la aplicación | [https://highside.io/terms-of-service](https://highside.io/terms-of-service) |
| Funcionalidad básica de la aplicación | Archivos de mensajería &amp; cifrados E2E para Microsoft Teams. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://highside.io/secureteams](https://highside.io/secureteams) |
...
HighSide, Inc ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | UUID de Microsoft de usuario, nombre de usuario, dirección de correo electrónico de usuario |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | UUID de Microsoft de usuario, nombre de usuario, dirección de correo electrónico de usuario |
...
| Dirección URL de la directiva de privacidad | https://highside.io/privacy-policy |
