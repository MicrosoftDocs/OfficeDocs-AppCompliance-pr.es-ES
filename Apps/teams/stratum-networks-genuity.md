---
title: Información de la aplicación para Genuity de Stratum Networks
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Genuity, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/1d37e38f-7513-4239-8251-208a749bba7e" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004008" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Stratum Networks a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Genuity |
| ID | WA200004008 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Stratum Networks |
| Sitio web de la empresa | [https://secure.gogenuity.com](https://secure.gogenuity.com) |
| Términos de uso de la aplicación | [https://gogenuity.com/terms](https://gogenuity.com/terms) |
| Funcionalidad básica de la aplicación | Administre el departamento de soporte técnico de Genuity en el Microsoft Teams |
...
Stratum Networks ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
