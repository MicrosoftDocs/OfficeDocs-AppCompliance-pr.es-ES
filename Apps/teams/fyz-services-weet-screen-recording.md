...
description: Toda la información de seguridad y cumplimiento disponible para Weet Screen Recording, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64878657"
---
# <a name="weet-screen-recording"></a>Weet Screen Recording

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 23 de septiembre de 2021</p>

* <a href="https://teams.microsoft.com/l/app/f0c0f156-329e-4083-a1a7-89649407a31b" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003284" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | FYZ SERVICES |
| Sitio web de la empresa | [https://weet.co](https://weet.co) |
| Términos de uso de la aplicación | [https://weet.co/terms-of-service/](https://weet.co/terms-of-service/) |
| Funcionalidad básica de la aplicación | Weet, la 1ª grabadora de vídeo de pantalla &amp; colaborativa grabación de pantalla simple, gratuita e ilimitada |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://weet.co/weet-teams-integration/](https://weet.co/weet-teams-integration/) |
...
FYZ SERVICES ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2020-12-15 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteSelfForUser.All | Delegado | Permitir detectar si la aplicación weet ya está instalada | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| User.Read | Delegado | No recopilamos datos, pero usamos el correo electrónico solo para ayudar al usuario con la característica de autocompletar | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| User.ReadBasic.All | Delegado | No recopilamos datos, pero usamos el correo electrónico solo para ayudar al usuario con la característica de autocompletar | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| offline_access | Delegado | No recopilamos datos, pero usamos el correo electrónico solo para ayudar al usuario con la característica de autocompletar | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| OpenID | Delegado | No recopilamos datos, pero usamos el correo electrónico solo para ayudar al usuario con la característica de autocompletar | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| perfil | Delegado | No recopilamos datos, pero usamos el correo electrónico solo para ayudar al usuario con la característica de autocompletar | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
