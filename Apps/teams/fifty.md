...
description: Toda la información de seguridad y cumplimiento disponible para Fifty, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64875427"
---
# <a name="fifty"></a>Fifty

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 7 de junio de 2021</p>

* <a href="https://teams.microsoft.com/l/app/383cc171-22d5-4df5-87d0-6c656ddcff32" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002393" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Fifty a Microsoft:
...
| Nombre de la empresa asociada | Fifty |
| Sitio web de la empresa | [https://app.fifty.do](https://app.fifty.do) |
| Términos de uso de la aplicación | [https://app.fifty.do/CGUV.pdf](https://app.fifty.do/CGUV.pdf) |
| Funcionalidad básica de la aplicación | Cincuenta ayuda a pasar del conocimiento a la acción al dar sus desafíos personalizados. Esos desafíos ayudarán a consolidar o mejorar algunas de sus habilidades principales. |
| Ubicación de la sede central de la empresa | Francia |
| Página de información de la aplicación | [https://www.fifty.do](https://www.fifty.do) |
...
Cincuenta personas han proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
