---
title: Información de la aplicación para FireHydrant by FireHydrant
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: Toda la información de seguridad y cumplimiento disponible para FireHydrant, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c18f3920-4098-4907-bc92-43c8559b5e18" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003794" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por FireHydrant a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | FireHydrant |
| Id. | WA200003794 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | FireHydrant |
| Sitio web de la empresa | [https://firehydrant.io](https://firehydrant.io) |
| Términos de uso de la aplicación | [https://app.firehydrant.io/legal/ssa](https://app.firehydrant.io/legal/ssa) |
| Funcionalidad básica de la aplicación | Administre los incidentes con FireHydrant.io. |
...
FireHydrant ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Identidad de usuario (nombre, correo electrónico), datos de incidentes de canales de teams |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | id. de equipo, id. de inquilino, mensajes, nombre de usuario |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | Delegado | FireHydrant crea canales en nombre de nuestros usuarios para administrar incidentes | [00485db5-81b3-4299-833a-8d6c366d0ac0](../azure/00485db5-81b3-4299-833a-8d6c366d0ac0.md) |
