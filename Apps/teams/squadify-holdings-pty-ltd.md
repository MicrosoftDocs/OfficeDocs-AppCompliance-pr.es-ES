---
title: Información de la aplicación para Squadify de Squadify Holdings Pty Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Squadify, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro de CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/110107b9-4326-43d8-bf43-bf10fcdce8ad" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004349" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Squadify Holdings Pty Ltd a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Squadify |
| ID | WA200004349 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Squadify Holdings Pty Ltd |
| Sitio web de la empresa | [https://www.squadify.net](https://www.squadify.net) |
| Términos de uso de la aplicación | [https://www.squadify.net/mst-terms-of-use](https://www.squadify.net/mst-terms-of-use) |
| Funcionalidad básica de la aplicación | Squadify para Microsoft Teams le permite recopilar comentarios de su equipo, dialogar y generar información útil. Con Squadify para Microsoft Teams, puede configurar una plantilla de creación con 1 clic y combinarla con su equipo en Microsoft Teams. También puede iniciar Squadifys, realizar un seguimiento de su progreso y generar información sobre el rendimiento del equipo para empezar a crear las conversaciones adecuadas. |
| Ubicación de la sede central de la empresa | Australia |
| Página de información de la aplicación | [https://www.squadify.net/our-product](https://www.squadify.net/our-product) |
...
Esta información ha sido proporcionada por Squadify Holdings Pty Ltd sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Nombre completo del usuario y dirección de correo electrónico |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Nombre completo del usuario y dirección de correo electrónico |
...
| Dirección URL de la directiva de privacidad | https://www.squadify.net/privacy-policy |
