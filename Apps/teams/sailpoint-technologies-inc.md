---
title: Información de la aplicación para Sailpoint de SailPoint Technologies, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Sailpoint, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ceca14aa-4fd9-4a8b-b51f-ee05bf98accc" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002761" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por SailPoint Technologies, Inc. a Microsoft:
...
| Nombre de la empresa asociada | SailPoint Technologies, Inc. |
| Sitio web de la empresa | [https://sailpoint.com](https://sailpoint.com) |
| Términos de uso de la aplicación | [https://www.sailpoint.com/legal/customer-agreements/](https://www.sailpoint.com/legal/customer-agreements/) |
| Funcionalidad básica de la aplicación | La solución de seguridad de identidad de SailPoint acopla la administración de acceso con seguridad de identidad, lo que garantiza que los trabajadores tengan el acceso adecuado para realizar su trabajo&#8211;ya no más, ni menos. |
...
SailPoint Technologies, Inc. ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC1 más reciente | 2020-10-31 |
