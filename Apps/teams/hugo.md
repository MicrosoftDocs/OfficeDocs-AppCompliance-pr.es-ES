---
title: Información de la aplicación para Hugo de Hugo
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/10/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Hugo, sus directivas de tratamiento de datos, su Microsoft Cloud App Security del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/e14ce411-84d7-4bb5-94e9-92536320f0b1" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003616" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Hugo a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Hugo |
| ID | WA200003616 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | Hugo |
| Sitio web de la compañía | [https://www.hugo.team](https://www.hugo.team) |
| Términos de uso de la aplicación | [https://www.hugo.team/terms](https://www.hugo.team/terms) |
| Funcionalidad principal de la aplicación | Hugo es un lugar para reuniones, notas y tareas &#8211; diseñadas para equipos que usan Microsoft Teams. La plataforma de toma de notas centrada en el calendario de Hugo te ofrece a ti y a tu equipo un lugar central para las agendas de reuniones y las notas, las tareas y las acciones &#8211; todas las organizadas automáticamente por los contactos y empresas que conozcas y conectadas a las más de 20 aplicaciones que usas todos los días. |
| Ubicación central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.hugo.team/teams](https://www.hugo.team/teams) |
...
Esta información ha sido proporcionada por Hugo sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Datos del calendario y del documento de reunión |
...
| Dirección URL de la directiva de privacidad | https://www.hugo.team/privacy |
