---
title: Información de la aplicación para iManage by iManage
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
description: Toda la información de seguridad y cumplimiento disponible para iManage, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c941fa60-c3a3-4bc6-b846-a63406009c15" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003178" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | iManage |
| Sitio web de la empresa | [https://imanage.com](https://imanage.com) |
| Términos de uso de la aplicación | [https://support.imanage.com/worksite/iManage_Cloud_Services...](https://support.imanage.com/worksite/iManage_Cloud_Services_Agreement.pdf) |
| Funcionalidad básica de la aplicación | Colabore libremente mientras el contenido se guarda y se rige en iManage. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://imanage.com/products/work/](https://imanage.com/products/work/) |
...
iManage ha proporcionado esta información sobre cómo recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2021-04-16 |
| ¿La aplicación cumple con los controles de organización de servicio (SOC 3)? | Sí |
| Fecha de certificación de SOC3 más reciente | 2021-04-16 |
