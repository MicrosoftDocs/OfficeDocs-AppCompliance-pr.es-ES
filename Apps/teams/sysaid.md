...
description: Toda la información de seguridad y cumplimiento disponible para SysAid, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64880519"
---
# <a name="sysaid"></a>SysAid

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 3 de enero de 2022</p>

* <a href="https://teams.microsoft.com/l/app/932c8be4-fac6-4df3-9e15-bc542f4ef88e" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003221" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | SysAid |
| Sitio web de la empresa | [https://www.sysaid.com](https://www.sysaid.com) |
| Términos de uso de la aplicación | [https://www.sysaid.com/wp-content/uploads/service-agreement...](https://www.sysaid.com/wp-content/uploads/service-agreement-cloud.pdf) |
| Funcionalidad básica de la aplicación | Use el bot para crear vales de SysAid en Microsoft Teams |
...
SysAid ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
