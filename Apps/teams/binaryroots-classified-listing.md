---
title: Información de la aplicación para la lista clasificada por BinaryRoots
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2022
...
description: Toda la información de seguridad y cumplimiento disponible para la descripción clasificada, sus directivas de control de datos, su información del catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el registro CSA STAR.
...
---
# <a name="classified-listing"></a>Descripción clasificada
...
* <a href="https://teams.microsoft.com/l/app/0c824060-9c8c-11ec-a1de-3143e9005d6a" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004155" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por BinaryRoots a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Descripción clasificada |
| Id. | WA200004155 |
| Clientes de Office 365 admitidos | Microsoft Teams |
| Nombre de la empresa asociada | BinaryRoots |
| Sitio web de la empresa | [https://binaryroots.com](https://binaryroots.com) |
| Términos de uso de la aplicación | [https://binaryroots.com/classifiedapp-terms-and-conditions](https://binaryroots.com/classifiedapp-terms-and-conditions) |
| Funcionalidad básica de la aplicación | Una aplicación de teams para crear o hospedar marketplace interno de compra/venta para su organización...  |
...
BinaryRoots ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Solo los identificadores: identificador de inquilino, identificadores de usuario de administradores, dirección URL del sitio e id. de sitio, id. de lista o biblioteca |
...
| Dirección URL de la directiva de privacidad | https://binaryroots.com/classified-app-privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Delegado | Para mostrar el canal mientras se usa la funcionalidad de recurso compartido | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| ChannelMessage.Send | Delegado | Para enviar mensajes al usuario o canal en nombre del usuario cuando se usa la funcionalidad de recurso compartido | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| Chat.ReadWrite | Delegado | Para enviar mensajes al usuario o canal en nombre del usuario cuando se usa la funcionalidad de recurso compartido | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| ChatMessage.Send | Delegado | Para enviar mensajes al usuario o canal en nombre del usuario cuando se usa la funcionalidad de recurso compartido | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| Sites.FullControl.All | Delegado | Creación de bibliotecas de lista necesarias en la colección de sitios de destino, esto solo es necesario para la primera instalación para administradores de inquilinos | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| Sites.Manage.All | Delegado | Creación de bibliotecas de lista necesarias en la colección de sitios de destino, esto solo es necesario para la primera instalación para administradores de inquilinos | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| Team.ReadBasic.All | Delegado | Para rellenar la lista desplegable de equipos y canales cuando se usa la funcionalidad de recurso compartido. | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| TeamsActivity.Send | Delegado | Para enviar una notificación de fuente de actividad al administrador y al creador de publicaciones para una funcionalidad de marca inapropiada  | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| User.Read | Delegado | Lea la información básica del usuario para mostrar el administrador o quién ha publicado, sus fotos, el correo electrónico de nombre en la tarjeta de lista. | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| User.ReadBasic.All | Delegado | Lea la información básica del usuario para mostrar el administrador o quién ha publicado, sus fotos, el correo electrónico de nombre en la tarjeta de lista. | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
