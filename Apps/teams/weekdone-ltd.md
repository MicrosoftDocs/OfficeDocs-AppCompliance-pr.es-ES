---
title: Información de la aplicación para Weekdone by Weekdone Ltd
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/28/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Weekdone, sus directivas de tratamiento de datos, su Microsoft Cloud App Security de catálogo de aplicaciones e información de seguridad y cumplimiento en el Registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/fa662fca-9224-49e3-9566-f66d2a6949af" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003399" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Weekdone Ltd a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Weekdone |
| ID | WA200003399 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | Weekdone Ltd |
| Sitio web de la compañía | [https://weekdone.com](https://weekdone.com) |
| Términos de uso de la aplicación | [https://weekdone.com/terms-of-service](https://weekdone.com/terms-of-service) |
| Funcionalidad principal de la aplicación | Ver y actualizar los check-ins semanales y okrs, y recibir notificaciones sobre las actualizaciones |
| Ubicación central de la empresa | Estonia |
| Página de información de la aplicación | [https://weekdone.com/integrations/microsoft-teams](https://weekdone.com/integrations/microsoft-teams) |
...
Weekdone Ltd ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Dirección IP del dispositivo. Nombre y dirección de correo electrónico del cliente. |
...
| Dirección URL de la directiva de privacidad | https://weekdone.com/privacy |
