...
| ¿Qué datos procesa la aplicación? | Datos de usuario, datos de inicio de sesión, datos de autenticación, datos de inquilino, datos de servicio de Azure, Graph, datos de Office 365 administración |
