---
title: Información de la aplicación para Smartsheet de Smartsheet
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Smartsheet, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f4d81e8e-4500-44c2-8328-9e06cbe037c5" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA104380975" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://www.smartsheet.com](https://www.smartsheet.com) |
| Términos de uso de la aplicación | [https://pinpointprod.blob.core.windows.net/marketing/Partne...](https://pinpointprod.blob.core.windows.net/marketing/Partner_21474843641/Product_42949680935/Asset_06f25ae6-b277-42aa-b769-38e17926ebb4/SmartsheetUserAgreementSmartsh.pdf) |
| Funcionalidad básica de la aplicación | Smartsheet es una plataforma líder basada en la nube para el logro de la organización, lo que permite a los equipos y organizaciones planear, capturar, administrar, automatizar e informar sobre el trabajo a escala, lo que resulta en procesos más eficaces y mejores resultados empresariales. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://help.smartsheet.com/articles/2476201-interact-with-...](https://help.smartsheet.com/articles/2476201-interact-with-smartsheet-items-in-microsoft-teams) |
...
Smartsheet ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2021-12-06 |
| ¿La aplicación cumple con los controles de organización de servicio (SOC 3)? | Sí |
| Fecha de certificación de SOC3 más reciente | 2021-12-06 |
...
| Dirección URL de la directiva de privacidad | https://www.smartsheet.com/legal/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | aplicación | Para permitir que la aplicación Smartsheet Tabs pueda leer los miembros del canal para compartir recursos de Smartsheet. | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| Directory.Read.All | Delegado | Para permitir que la aplicación lea datos de su organización, como usuarios y grupos. | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| Group.Read.All | Delegado | Se usa para leer los miembros del grupo. | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| Group.ReadWrite.All | Delegado | Para enviar notificaciones a un grupo. | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| User.Read.All | Delegado | Se usa para enviar notificaciones basadas en la dirección de correo electrónico del usuario. | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| offline_access | Delegado | Para permitir el uso sin conexión. | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
