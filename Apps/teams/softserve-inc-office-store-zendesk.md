---
title: Información de la aplicación para Zendesk by SoftServe Inc. Office Store
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Zendesk, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66817725"
---
# <a name="zendesk"></a>Zendesk

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 11 de enero de 2022</p>

* <a href="https://teams.microsoft.com/l/app/f36c0433-ea87-4102-bea7-0a8456fa8a2e" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003782" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por SoftServe Inc. Office Store a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Zendesk |
| ID | WA200003782 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | SoftServe Inc. Tienda Office |
| Sitio web de la empresa | [https://www.softserveinc.com](https://www.softserveinc.com) |
| Términos de uso de la aplicación | [https://zendeskforteams.com/terms-and-conditions](https://zendeskforteams.com/terms-and-conditions) |
| Funcionalidad básica de la aplicación | Cree, vea y actualice vales de Zendesk directamente desde Microsoft Teams. Agregue notas internas o respuestas públicas a los vales desde Microsoft Teams. Obtenga notificaciones en tiempo real sobre los vales en función del estado, la prioridad, el tipo o las actualizaciones dentro de cualquier canal o DM de Teams. Implemente el bot de respuesta en Microsoft Teams para responder a las preguntas más frecuentes. Vea todos los vales personales abiertos y cerrados en una sola vista de lista e importe las vistas de vales de Zendesk como pestañas en un único área de trabajo de Microsoft Teams. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://zendeskforteams.com](https://zendeskforteams.com) |
