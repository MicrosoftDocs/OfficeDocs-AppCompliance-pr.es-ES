---
title: Información de la aplicación para EducationHUB Lesmateriaal by Smartersoft B.V.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Toda la información de seguridad y cumplimiento disponible para EducationHUB Lesmateriaal, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f5558ae7-a166-41bd-997b-f8cc1eddebac" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004326" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Smartersoft B.V. a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | EducationHUB Lesmateriaal |
| ID | WA200004326 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Smartersoft B.V. |
| Sitio web de la empresa | [https://smartersoft.nl](https://smartersoft.nl) |
| Términos de uso de la aplicación | [https://content.educationhub.nl/terms](https://content.educationhub.nl/terms) |
| Funcionalidad básica de la aplicación | Permitir que las escuelas proporcionen acceso directo a contenido digital proporcionado por la escuela en lugar de forzar a los alumnos a otro sitio web. |
| Ubicación de la sede central de la empresa | Países Bajos (el) |
| Página de información de la aplicación | [https://content.educationhub.nl](https://content.educationhub.nl) |
...
Esta información ha sido proporcionada por Smartersoft B.V. acerca de cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Id. de usuario, Pertenencia a grupos, Contenido personal agregado a la aplicación |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Id. de usuario, Id. de grupo, vínculos proporcionados por el usuario al contenido de la escuela digital |
...
| Enumerar los tipos de directivas admitidas | Todo, la plataforma de Microsoft es responsable de proporcionarnos un token para un usuario. El administrador decide cómo se valida o se obliga al usuario a usar MFA |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | Delegado | Información de acceso guardada en atributos de extensión de grupo | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
>| Team.ReadBasic.All | Delegado | Información sobre los equipos de usuarios | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
>| User.Read | Delegado | Inicio de sesión | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
