---
title: Información de la aplicación para Stylebot by Stylebot Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/07/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Stylebot, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64880537"
---
# <a name="stylebot"></a>Stylebot

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 7 de diciembre de 2021</p>

* <a href="https://teams.microsoft.com/l/app/db9c0532-d5d9-4e1b-839f-3952c88c8ee2" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003177" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Stylebot Inc |
| Sitio web de la empresa | [https://www.stylebot.app](https://www.stylebot.app) |
| Términos de uso de la aplicación | [https://www.stylebot.app/apptermsofservice](https://www.stylebot.app/apptermsofservice) |
| Funcionalidad básica de la aplicación | Stylebot mejora su escritura al poner un manual de estilo y lenguaje moderno al alcance de su mano. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.stylebot.app/msteamshelp](https://www.stylebot.app/msteamshelp) |
...
Stylebot Inc ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
