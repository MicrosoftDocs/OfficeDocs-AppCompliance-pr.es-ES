...
description: Toda la información de seguridad y cumplimiento disponible para DBit, sus directivas de tratamiento de datos, su Microsoft Cloud App Security del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
| Sitio web de la compañía | [https://www.diamondsoftsolutions.com](https://www.diamondsoftsolutions.com) |
| Términos de uso de la aplicación | [https://www.dbit.io/termsofuse.html](https://www.dbit.io/termsofuse.html) |
| Funcionalidad principal de la aplicación | Soluciones de administración de contraseñas DBit con menos complicaciones. DBit es una herramienta de administración de contraseñas para equipos pequeños o grandes. Con DBit, puedes compartir contraseñas de forma segura entre los miembros del equipo. Las contraseñas y contraseñas compartidas generadas expirarán automáticamente después de una duración establecida de minutos. Las contraseñas se cifran en la memoria de nuestros servidores y nunca se almacenan en el almacenamiento en disco. Una vez que las contraseñas expiran, se quitan de la memoria de nuestro servidor. Esta aplicación está desarrollada por Diamondsoft Solutions, LLC |
