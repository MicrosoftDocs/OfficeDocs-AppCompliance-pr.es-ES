...
description: Toda la información de seguridad y cumplimiento disponible para DBit, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64876437"
---
# <a name="dbit"></a>DBit

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 24 de noviembre de 2021</p>

* <a href="https://teams.microsoft.com/l/app/b28bb657-8edd-47ae-a912-c5fc11b3e89e" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001536" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://www.diamondsoftsolutions.com](https://www.diamondsoftsolutions.com) |
| Términos de uso de la aplicación | [https://www.dbit.io/termsofuse.html](https://www.dbit.io/termsofuse.html) |
| Funcionalidad básica de la aplicación | Soluciones de administración de contraseñas de DBit con menos molestias. DBit es una herramienta de administración de contraseñas para equipos pequeños y grandes. Con DBit, puede compartir contraseñas de forma segura entre miembros del equipo. Las contraseñas y contraseñas compartidas generadas expirarán automáticamente después de una duración establecida de minutos. Las contraseñas se cifran en memoria en nuestros servidores y nunca se almacenan en el almacenamiento en disco. Una vez que las contraseñas expiran, se quitan de la memoria del servidor. Esta aplicación es desarrollada por Diamondsoft Solutions, LLC |
...
Diamondsoft Solutions, LLC ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | TenantId |
