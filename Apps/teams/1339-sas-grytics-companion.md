---
title: Información de la aplicación para Grytics Companion by 1339 SAS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Grytics Companion, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66547476"
---
# <a name="grytics-companion"></a>Grytics Companion

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 3 de junio de 2022</p>

* <a href="https://teams.microsoft.com/l/app/54ab7c02-a92f-4a87-9f59-764e42009fbc" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004217" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por 1339 SAS a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Grytics Companion |
| ID | WA200004217 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | 1339 SAS |
| Sitio web de la empresa | [https://grytics.com](https://grytics.com) |
| Términos de uso de la aplicación | [https://grytics.com/terms](https://grytics.com/terms) |
| Funcionalidad básica de la aplicación | Los usuarios pueden comparar &amp; análisis de la actividad de tendencias &amp; de las redes sociales empresariales que se han agregado a sus cuentas de Grytics |
...
1339 SAS ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Correo electrónico, nombre |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Nombre, Correo electrónico para los usuarios de la aplicación.  |
| Si la inestructura subyacente procesa o almacena datos de clientes de Microsoft, ¿dónde se almacenan geográficamente estos datos? | Irlanda, Francia |
...
| Dirección URL de la directiva de privacidad | https://grytics.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | aplicación | Necesario para permitir que los administradores de Grytics autoricen a sus usuarios de Grytics a usar la aplicación en Teams y que coincidan con su identificador de usuario en AAD. | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| User.Read | Delegado | Necesario para el flujo de autenticación de SSO | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| User.Read.All | aplicación | Necesario para permitir que los administradores de Grytics autoricen a sus usuarios de Grytics a usar la aplicación en Teams y que coincidan con su identificador de usuario en AAD. | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| correo electrónico | Delegado | Necesario para el flujo de autenticación de SSO | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| offline_access | Delegado | Necesario para el flujo de autenticación de SSO | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| perfil | Delegado | Necesario para el flujo de autenticación de SSO | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
