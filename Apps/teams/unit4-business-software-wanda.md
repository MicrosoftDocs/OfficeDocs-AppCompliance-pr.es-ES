---
title: Información de la aplicación para Wanda by Unit4 Business Software
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Wanda, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/73642721-0f64-4d3a-ab6c-2c1fe053aa80" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004038" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Unit4 Business Software a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Wanda |
| ID | WA200004038 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Unit4 Business Software |
| Sitio web de la empresa | [https://www.unit4.com](https://www.unit4.com) |
| Términos de uso de la aplicación | [https://www.unit4.com/terms-and-conditions](https://www.unit4.com/terms-and-conditions) |
| Funcionalidad básica de la aplicación | Wanda le ayuda a ocuparse de sus tareas ERP más rutinarias. |
| Ubicación de la sede central de la empresa | Países Bajos (el) |
| Página de información de la aplicación | [https://get-wanda-help.u4pp.com](https://get-wanda-help.u4pp.com) |
...
Unit4 Business Software ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Id. de usuario Microsoft Teams específico del bot |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Id. de usuario Microsoft Teams específico del bot |
...
| Dirección URL de la directiva de privacidad | https://info.unit4.com/rs/400-HYB-295/images/Unit4-People-Platform-Service-Description-v.1.1-September-2021-%28EN%29-%281%29.pdf |
