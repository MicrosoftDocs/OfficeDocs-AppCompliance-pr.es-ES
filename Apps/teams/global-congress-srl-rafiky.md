...
description: Toda la información de seguridad y cumplimiento disponible para Rafiky, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c4661f80-2c9c-42d4-aec5-5ed6d64adb4d" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003263" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | GLOBAL CONGRESS SRL |
| Sitio web de la empresa | [https://rafiky.net/en/](https://rafiky.net/en/) |
| Términos de uso de la aplicación | [https://rafiky.net/en/terms-conditions/](https://rafiky.net/en/terms-conditions/) |
| Funcionalidad básica de la aplicación | Rafiky es una solución de plataforma en la nube extremadamente flexible y accesible diseñada para realizar interpretaciones simultáneas remotas para sus eventos en línea. &#8217;es una visión única e innovadora de la interpretación remota; permite a los intérpretes profesionales trabajar desde cualquier lugar en cualquier momento. |
...
Global CONGRESS SRL ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
