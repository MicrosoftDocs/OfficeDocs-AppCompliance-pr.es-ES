---
title: Información de la aplicación para Zoho Notebook de Zoho Corporation Private Limited
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/11/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Zoho Notebook, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/fc4f087a-a781-4f19-be85-86977bf45c95" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001616" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Zoho Notebook |
| ID | WA200001616 |
...
| Términos de uso de la aplicación | [https://www.zoho.com/terms.html](https://www.zoho.com/terms.html) |
| Funcionalidad básica de la aplicación | Tanto si&#8217;capturar un pensamiento, crear una lista de comprobación, grabar una idea o ajustar un momento, tomar notas puede ser divertido con Notebook. Está disponible en iOS, Android, Mac, Windows y Linux. La aplicación está optimizada para smartphones y tabletas.  Las tarjetas de nota se pueden organizar en cuadernos. Puede apilar tarjetas de nota relacionadas como grupos.  Todas las notas se sincronizan sin problemas en varios dispositivos y en la nube de Zoho. Independientemente del dispositivo que use, las notas siempre están actualizadas. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://help.zoho.com/portal/en/kb/notebook](https://help.zoho.com/portal/en/kb/notebook) |
...
>Esta aplicación no recopila y almacena datos organizacionales incluyendo EUII y OII.
...
>Todos los datos tomados con esta aplicación se almacenan de forma segura en los servidores de Zoho Notebook. Todos los datos son EAR. Por lo tanto, nadie excepto el usuario puede ver los datos.
...
| ¿Qué datos procesa la aplicación? | Datos de perfil, webhook de conversación personal. |
...
| Si la inestructura subyacente procesa o almacena datos de clientes de Microsoft, ¿dónde se almacenan geográficamente estos datos? | Estados Unidos de América, Irlanda, Países Bajos (el), China, Japón, India, Australia |
...
<iframe height='1020' title='información de Microsoft Cloud App Security' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/21298' frameborder='no'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/21298" target="_blank">Ver en una nueva</a> 
...
| Dirección URL de la directiva de privacidad | https://www.zoho.com/terms.html |
...
| Enumerar los tipos de directivas admitidas | Multi-Factor Authentication, Requerir dispositivos administrados por la organización para aplicaciones específicas, Bloquear comportamientos de inicio de sesión de riesgo, Limitar el acceso dado a personas distintas de los roles administrativos  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Delegado | Leer los nombres y descripciones de los canales | [9944c8e1-fc22-4546-8023-9459b75c472a](../azure/9944c8e1-fc22-4546-8023-9459b75c472a.md) |
>| ChannelMessage.Send | Delegado | Enviar mensajes de canal | [9944c8e1-fc22-4546-8023-9459b75c472a](../azure/9944c8e1-fc22-4546-8023-9459b75c472a.md) |
>| ChatMessage.Send | Delegado | Enviar mensajes de chat de usuario | [9944c8e1-fc22-4546-8023-9459b75c472a](../azure/9944c8e1-fc22-4546-8023-9459b75c472a.md) |
>| Team.ReadBasic.All | Delegado | Leer los nombres y descripciones de los equipos | [9944c8e1-fc22-4546-8023-9459b75c472a](../azure/9944c8e1-fc22-4546-8023-9459b75c472a.md) |
>| User.Read | Delegado | Iniciar sesión y leer el perfil del usuario | [9944c8e1-fc22-4546-8023-9459b75c472a](../azure/9944c8e1-fc22-4546-8023-9459b75c472a.md) |
>| offline_access | Delegado | Mantener el acceso a los datos a los que se le ha concedido acceso | [9944c8e1-fc22-4546-8023-9459b75c472a](../azure/9944c8e1-fc22-4546-8023-9459b75c472a.md) |
