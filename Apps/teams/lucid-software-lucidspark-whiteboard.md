---
title: Información de la aplicación para la pizarra de Lucidspark de Software Lúcido
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2021
...
description: Toda la información de seguridad y cumplimiento disponible para la pizarra de Lucidspark, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el Registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/e9ab21fa-5fd5-48bb-a85d-4de7ced89cd1" target="_blank">Ver en Teams tienda</a>
...
| Sitio web de la compañía | [https://lucid.co](https://lucid.co) |
| Términos de uso de la aplicación | [https://lucid.co/tos](https://lucid.co/tos) |
| Funcionalidad principal de la aplicación | Lucidspark es una pizarra virtual basada en la nube en la que los equipos pueden sacar a la luz sus mejores ideas. Haga una lluvia de ideas y colabore como equipo en tiempo real, ya sea que&#8217;trabaje de forma remota o en persona. Lucidspark ayuda a las personas a organizar notas y garabatos y convertirlas en conceptos listos para la presentación. Cuando se&#8217;para los siguientes pasos, los equipos pueden desarrollar flujos de trabajo y procesar documentos para convertir ideas en realidad. |
