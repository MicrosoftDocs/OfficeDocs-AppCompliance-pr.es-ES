---
title: Información de la aplicación para la funtividad de Hermis por Hermis, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Funtivity by Hermis, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66242302"
---
# <a name="funtivity-by-hermis"></a>Funtivity de Hermis

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 19 de junio de 2022</p>

* <a href="https://teams.microsoft.com/l/app/d75e14a9-9bfd-43b4-8430-7264da3b6995" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004244" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Hermis, Inc. a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Funtivity de Hermis |
| Id. | WA200004244 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Hermis, Inc. |
| Sitio web de la empresa | [https://www.herm.is](https://www.herm.is) |
| Términos de uso de la aplicación | [https://www.herm.is/terms](https://www.herm.is/terms) |
| Funcionalidad básica de la aplicación | Funtivity by Hermis tiene una gran cantidad de contenido de actividades &amp; para una amplia variedad de ocasiones, como la creación de equipos, sesiones de conferencias, eventos culturales y mucho más. Con más de una docena de actividades diferentes y nuevos eventos meticulosamente elaborados cada semana,&#8217;es algo para que todos disfruten. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.herm.is/integrations/funtivity-msteams](https://www.herm.is/integrations/funtivity-msteams) |
...
Hermis, Inc. ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | El id. del cliente y el correo electrónico de nombre &amp; se usan para registrar al usuario en Hermis. |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | El correo electrónico de nombre &amp; de usuario se almacena en nuestra base de datos. El correo electrónico del usuario se cifra mediante AES-256-CBC |
...
| Dirección URL de la directiva de privacidad | https://www.herm.is/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | Usamos los detalles del perfil del usuario para registrar al usuario en nuestra plataforma. | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| correo electrónico | Delegado | Usamos los detalles del perfil del usuario para registrar al usuario en nuestra plataforma. | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| OpenID | Delegado | Usamos los detalles del perfil del usuario para registrar al usuario en nuestra plataforma. | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| perfil | Delegado | Usamos los detalles del perfil del usuario para registrar al usuario en nuestra plataforma. | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
