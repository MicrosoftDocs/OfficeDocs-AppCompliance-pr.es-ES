...
description: Toda la información de seguridad y cumplimiento disponible para Qualified, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64880597"
---
# <a name="qualified"></a>Cualificado

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 5 de mayo de 2021</p>

* <a href="https://teams.microsoft.com/l/app/d9850897-f8bf-407c-878b-b0cdcbba93ff" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002720" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Qualified to Microsoft:
...
| Nombre de la empresa asociada | Cualificado |
| Sitio web de la empresa | [https://www.qualified.com](https://www.qualified.com) |
| Términos de uso de la aplicación | [https://www.qualified.com/legal/terms-of-service](https://www.qualified.com/legal/terms-of-service) |
| Funcionalidad básica de la aplicación | Alertas al instante calificadas a los representantes de ventas cuando llegan posibles clientes potenciales a su sitio |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.qualified.com/university-guide/microsoft-teams-...](https://www.qualified.com/university-guide/microsoft-teams-integration) |
| ¿Cuál es el entorno de hospedaje o el modelo de servicio que se usa para ejecutar la aplicación? |  |
| ¿Qué proveedores de nube de hospedaje usa la aplicación? | Heroku |
...
Calificado ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | aplicación | Permite seleccionar el canal para notificar | [2c951ed5-c5c6-493f-9b02-4b42e3ba536c](../azure/2c951ed5-c5c6-493f-9b02-4b42e3ba536c.md) |
>| Team.ReadBasic.All | aplicación | Nos permite encontrar todos los canales de todos los equipos, para permitirnos seleccionar canales para notificar | [2c951ed5-c5c6-493f-9b02-4b42e3ba536c](../azure/2c951ed5-c5c6-493f-9b02-4b42e3ba536c.md) |
