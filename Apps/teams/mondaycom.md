---
title: Información de la aplicación para monday.com por monday.com
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/05/2021
...
description: Toda la información de seguridad y cumplimiento disponible para monday.com, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/eab2d3ce-6d6a-4415-abc4-5f40a8317b1f" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001798" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://monday.com](https://monday.com) |
| Términos de uso de la aplicación | [https://monday.com/l/legal/tos/](https://monday.com/l/legal/tos/) |
| Funcionalidad básica de la aplicación | monday.com es un sistema operativo de trabajo versátil que impulsa el trabajo en equipo remoto para organizar, estructurar y simplificar todos los programas, proyectos y procesos.  A través de monday.com, puede usar bloques de creación &#8211; como paneles, vistas, gráficos, automatizaciones e integraciones, para crear aplicaciones de flujo de trabajo personalizadas para ejecutar procesos, proyectos y trabajo diario. Cree un nuevo panel de monday.com o agréguelo a uno existente directamente dentro de Microsoft Teams y visualice fácilmente el trabajo del equipo&#8217;en un área de trabajo colaborativa. |
...
Esta información la ha proporcionado monday.com sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC1 más reciente | 2021-05-01 |
| ¿La aplicación cumple con los controles de organización de servicio (SOC 2)? | Sí |
| Fecha de certificación de SOC2 más reciente | 2021-05-01 |
| ¿La aplicación cumple con los controles de organización de servicio (SOC 3)? | Sí |
| Fecha de certificación de SOC3 más reciente | 2021-05-01 |
