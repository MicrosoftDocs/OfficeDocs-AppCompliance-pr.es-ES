---
title: Información de la aplicación para IQ by NLSQL
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2022
...
description: Toda la información de seguridad y cumplimiento disponible para IQ, sus directivas de control de datos, su información del catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/9d0bdc38-2705-4109-835f-3c14534f923f" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004126" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por NLSQL a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | IQ |
| Id. | WA200004126 |
| Clientes de Office 365 admitidos | Microsoft Teams |
| Nombre de la empresa asociada | NLSQL |
| Sitio web de la empresa | [https://nlsql.com](https://nlsql.com) |
| Términos de uso de la aplicación | [https://www.nlsql.com/terms_of_use](https://www.nlsql.com/terms_of_use) |
| Funcionalidad básica de la aplicación | IQ apoya a los gerentes para generar preguntas de entrevista y candidatos para prepararse para la entrevista. La preparación de preguntas de la entrevista es el software de inteligencia artificial que genera una pregunta aleatoria basada en la entrada de posición, que hace una idea perfecta de cómo estar bien preparado para la entrevista. Los candidatos pueden sentirse libres de generar preguntas de entrevista para una mejor preparación. |
| Ubicación de la sede central de la empresa | Reino Unido de Gran Bretaña e Irlanda del Norte (el) |
| Página de información de la aplicación | [https://www.nlsql.com/blog/post/interview-questions-to-ask-...](https://www.nlsql.com/blog/post/interview-questions-to-ask-candidates-and-managers/) |
...
NLSQL ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | Iniciar sesión y leer el perfil del usuario | [f9555238-64f3-4ec2-a8fc-3787baa157aaa](../azure/f9555238-64f3-4ec2-a8fc-3787baa157aa.md) |
