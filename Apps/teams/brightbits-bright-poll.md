---
title: Información de la aplicación para bright poll by BrightBits
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/17/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Bright Poll, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64879817"
---
# <a name="bright-poll"></a>Sondeo claro

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 16 de noviembre de 2021</p>

* <a href="https://teams.microsoft.com/l/app/3a3156c1-b214-4d42-bc25-6d36f6aabb5e" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002562" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por BrightBits a Microsoft:
...
| Nombre de la empresa asociada | BrightBits |
| Sitio web de la empresa | [https://brightbits.app](https://brightbits.app) |
| Términos de uso de la aplicación | [https://brightbits.app/terms/](https://brightbits.app/terms/) |
| Funcionalidad básica de la aplicación | Recopile comentarios de los compañeros de equipo a través de sondeos en el chat. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://brightbits.app/bright-poll/](https://brightbits.app/bright-poll/) |
...
BrightBits ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
