...
description: Toda la información de seguridad y cumplimiento disponible para X0PA ROOM, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/d84ed1b7-cd38-42e7-8a07-56f7ae72e93a" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003028" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | X0PA AI Singapore |
| Sitio web de la empresa | [https://x0paroom.com](https://x0paroom.com) |
| Términos de uso de la aplicación | [https://x0pa.com/terms-of-use](https://x0pa.com/terms-of-use) |
| Funcionalidad básica de la aplicación | Capacidades y análisis de entrevistas de vídeo inteligentes a petición con X0PA ROOM |
| Ubicación de la sede central de la empresa | Singapur |
| Página de información de la aplicación | [https://x0paroom.com](https://x0paroom.com) |
...
X0PA AI Singapore ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
