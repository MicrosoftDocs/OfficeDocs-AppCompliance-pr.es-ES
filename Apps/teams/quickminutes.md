---
title: Información de la aplicación para QuickMinutes por QuickMinutes
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/18/2022
...
description: Toda la información de seguridad y cumplimiento disponible para QuickMinutes, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/5f60fe53-d441-4320-8c26-13fdaee9b58a" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004414" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por QuickMinutes a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | QuickMinutes |
| ID | WA200004414 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | QuickMinutes |
| Sitio web de la empresa | [https://quickminutes.com](https://quickminutes.com) |
| Términos de uso de la aplicación | [https://quickminutes.com/privacy#/terms_of_service](https://quickminutes.com/privacy#/terms_of_service) |
| Funcionalidad básica de la aplicación | Optimice sus flujos de trabajo en línea de reuniones con nuestro asistente digital inteligente. |
| Ubicación de la sede central de la empresa | Irlanda |
| Página de información de la aplicación | [https://support.quickminutes.com/portal/en-gb/kb/articles/m...](https://support.quickminutes.com/portal/en-gb/kb/articles/microsoft-teams-integration-22-4-2020-1) |
...
QuickMinutes ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Utilizamos los datos de perfil de usuario para rellenar la información de los usuarios en la base de datos QuickMinutes cuando el usuario registra una nueva cuenta con QuickMinutes mediante el inicio de sesión único de Microsoft. QuickMinutes extrae los datos del calendario de los usuarios para mostrar los eventos en la interfaz de usuario de QuickMinutes. No almacenamos esta información en la base de datos QuickMinutes, solo recuperamos la información de Graph API y la mostramos al usuario.  |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Información de perfil de usuario, por ejemplo, nombre, apellidos, Email e imagen de perfil. También almacenamos los tokens de acceso y actualización de MS de los usuarios. |
...
| Dirección URL de la directiva de privacidad | https://quickminutes.com/privacy#/privacy_policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | Delegado | QuickMinutes usa el ámbito del calendario para leer y escribir reuniones de QuickMinutes en el calendario de Microsoft del usuario. | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
>| People.Read | Delegado | QuickMinutes usa el ámbito de personas para enumerar los contactos de los usuarios de Microsoft cuando agregan usuarios a su organización o grupo quickminutes. | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
>| correo electrónico | Delegado | El ámbito de correo electrónico se usa para proporcionar a QuickMinutes acceso a la dirección de correo electrónico principal del usuario en forma de notificación de correo electrónico. | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
>| OpenID | Delegado | QuickMinutes usa el ámbito openid en el punto de conexión de token de Plataforma de identidad de Microsoft para adquirir tokens de identificador. Esto permite que QuickMinutes use los tokens para acceder a la Graph API en nombre de los usuarios. | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
>| perfil | Delegado | QuickMinutes usa el ámbito del perfil para acceder al perfil de los usuarios cuando los registramos a través del inicio de sesión único de Microsoft y creamos su cuenta de QuickMinutes. | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
