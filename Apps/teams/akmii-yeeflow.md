---
title: Información de solicitud para Yeeflow por Akmii
ms.author: elmalova
author: elenamalova
ms.date: 11/25/2020
ms.topic: article
...
description: Toda la información de seguridad y cumplimiento disponible para Yeeflow, sus políticas de control de datos, su información de catálogo de aplicaciones Microsoft Cloud App Security e información de seguridad/cumplimiento en el registro CSA STAR.
...
<p>Última actualización por el desarrollador el: 25 de noviembre de 2020</p>
...
| Nombre de la empresa asociada | Akmii |
| URL del sitio web de socios | [https://www.yeeflow.com](https://www.yeeflow.com) |
| URL de Teams página de información de la aplicación | [www.yeeflow.com](www.yeeflow.com) |
| URL de la Política de Privacidad | [https://www.yeeflow.com/privacy](https://www.yeeflow.com/privacy) |
| URL de los Términos de uso | [https://www.yeeflow.com/terms](https://www.yeeflow.com/terms) |
...
Akmii ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos organizativos y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:--------------------------------|:---------------------|:--------------------------|
>| Enviar mensaje fácil de usar e identificar al usuario. | correo electrónico y nombre del usuario | para enviar la notificación del usuario y mostrar el nombre de usuario |
...
>Los datos de la aplicación se almacenan en la base de datos. Solo los administradores de operaciones autorizados pueden acceder a los datos en la oficina (restringidos por intervalos ip)
...
Akmii ha proporcionado esta información sobre cómo esta aplicación controla la autenticación, la autorización, las prácticas recomendadas de registro de aplicaciones y otros criterios de identidad.
