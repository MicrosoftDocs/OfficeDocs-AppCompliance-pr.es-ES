...
description: Toda la información de seguridad y cumplimiento disponible para el Asistente de Self-Service Deleaciones, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el Registro CSA STAR.
...
ms.locfileid: "61176955"
---
# <a name="alloy-self-service-assistant"></a>Asistente para Self-Service de Self-Service de aleación

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: July 17, 2021</p>

* <a href="https://teams.microsoft.com/l/app/da84bd82-1002-4487-be1a-ebec71d9a61a" target="_blank">Ver en Teams almacén</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | Asistente para Self-Service de Self-Service de aleación |
| Id. | WA200003492 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | Software de la aleación |
