---
title: Información de la aplicación para El Self-Service Deleaciones por software de la aleación
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/19/2021
...
description: Toda la información de seguridad y cumplimiento disponible para el Asistente de Self-Service de Alloy, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el Registro CSA STAR.
...
---
# <a name="alloy-self-service-assistant"></a>Asistente de autoservicio de aleación

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: July 17, 2021</p>

* <a href="https://teams.microsoft.com/l/app/da84bd82-1002-4487-be1a-ebec71d9a61a" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003492" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por El software de la aleación a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Asistente de autoservicio de aleación |
| ID | WA200003492 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | Alloy Software |
| Sitio web de la compañía | [https://alloysoftware.com](https://alloysoftware.com) |
| Términos de uso de la aplicación | [https://www.alloysoftware.com/resources/eula/](https://www.alloysoftware.com/resources/eula/) |
| Funcionalidad principal de la aplicación | Cree vales de servicio, busque en knowledge base y apruebe solicitudes. |
| Ubicación central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://docs.alloysoftware.com/alloynavigator/2021/docs/int...](https://docs.alloysoftware.com/alloynavigator/2021/docs/integrations/topics/microsoft-teams-bot.htm) |
...
Esta información ha sido proporcionada por El software de la aleación acerca de cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | direcciones de correo electrónico de usuario, inquilinos de clientes |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | inquilinos de clientes |
...
| Fecha de certificación SOC2 más reciente |  2021-11-15 |
| ¿La aplicación cumple con los controles de organización de servicio (SOC 3)? | Sí |
| Fecha de certificación SOC3 más reciente |  2021-11-09 |
...
| Dirección URL de la directiva de privacidad | https://www.alloysoftware.com/resources/privacy/ |
