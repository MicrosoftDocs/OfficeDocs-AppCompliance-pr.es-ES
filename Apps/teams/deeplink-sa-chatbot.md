---
title: Información de la aplicación para el bot de chat de Deeplink de Deeplink SA
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Deeplink Chatbot, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66547368"
---
# <a name="deeplink-chatbot"></a>Bot de chat de Deeplink
...
* <a href="https://teams.microsoft.com/l/app/9f859fc4-0b17-4bf7-abff-f50a73cbe5ab" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004200" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Deeplink SA a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Bot de chat de Deeplink |
| ID | WA200004200 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Deeplink SA |
| Sitio web de la empresa | [https://www.deeplink.ai](https://www.deeplink.ai) |
| Términos de uso de la aplicación | [https://www.deeplink.ai/en/terms/](https://www.deeplink.ai/en/terms/) |
| Funcionalidad básica de la aplicación | Deeplink le permite configurar un bot de chat totalmente personalizable, también denominado agente conversacional, con tecnología de inteligencia artificial y acceder a él en Microsoft Teams, en el centro de sus interacciones diarias. Con Teams, se agrega un nuevo punto de contacto a un asistente existente y se proporciona acceso directo a servicios mejorados, como un departamento de soporte técnico de TI, un bot de tutorial o un agente de configuración. |
| Ubicación de la sede central de la empresa | Suiza |
| Página de información de la aplicación | [https://www.deeplink.ai/en/integrations/msteams/](https://www.deeplink.ai/en/integrations/msteams/) |
...
Deeplink SA ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
