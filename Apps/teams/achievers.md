---
title: Información de la aplicación para achievers by Achievers
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/20/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Achievers, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro de CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/76903584-359f-4e1e-9f6e-741f48322709" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000573" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Achievers a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Achievers |
| ID | WA200000573 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Achievers |
| Sitio web de la empresa | [https://www.achievers.com](https://www.achievers.com) |
| Términos de uso de la aplicación | [https://developer.achievers.com/docs/achievers-terms-of-use](https://developer.achievers.com/docs/achievers-terms-of-use) |
| Funcionalidad básica de la aplicación | Cree reconocimiento para sus compañeros en la plataforma Achievers con menos fricción dentro del ecosistema de Microsoft. |
| Ubicación de la sede central de la empresa | Canadá |
| Página de información de la aplicación | [https://www.achievers.com/connect/teams/](https://www.achievers.com/connect/teams/) |
...
Los achievers han proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Id. de inquilino, Id. de usuario, Correo electrónico de usuario, Configuración regional del usuario, Id. de bot, Nombre del bot, Dirección URL de Bot Service |
...
| Fecha de certificación de SOC2 más reciente | 2021-12-25 |
...
| Dirección URL de la directiva de privacidad | https://over.achievers.com/ilr_privacy_policy |
