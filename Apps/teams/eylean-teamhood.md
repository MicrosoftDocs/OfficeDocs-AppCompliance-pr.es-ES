---
title: Información de la aplicación para Teamhood de Eylean
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Teamhood, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro de CSA STAR.
...
ms.locfileid: "64877687"
---
# <a name="teamhood"></a>Teamhood

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 27 de abril de 2021</p>

* <a href="https://teams.microsoft.com/l/app/22372c30-c5de-483e-85b4-8d51db246eda" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002568" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Eylean a Microsoft:
...
| Nombre de la empresa asociada | Eylean |
| Sitio web de la empresa | [https://teamhood.com](https://teamhood.com) |
| Términos de uso de la aplicación | [https://teamhood.com/terms-of-use/](https://teamhood.com/terms-of-use/) |
| Funcionalidad básica de la aplicación | Teamhood es un software todo en uno de administración de proyectos y tareas para una colaboración diaria eficaz. Teamhood proporciona las características necesarias para que cada jefe de proyecto y miembro del equipo planee, ejecute e informe sobre los datos de trabajo. |
| Ubicación de la sede central de la empresa | Lituania |
| Página de información de la aplicación | [https://teamhood.com/features/teamhood-and-microsoft-teams-...](https://teamhood.com/features/teamhood-and-microsoft-teams-integration/) |
...
Eylean ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
