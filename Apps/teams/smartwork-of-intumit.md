...
description: Toda la información de seguridad y cumplimiento disponible para SmartWork, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el registro CSA STAR.
...
| Sitio web de la compañía | [https://www.intumit.com/english/](https://www.intumit.com/english/) |
...
| Funcionalidad principal de la aplicación | SmartWork es un robot de diálogo que puede responder preguntas relacionadas con Microsoft Office 365 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegado | Uso de userPrincipalName para identificar si el correo del usuario procede de una AAD o no | [a938ae1e-a791-4751-9e6a-178c991fa0fa](../azure/a938ae1e-a791-4751-9e6a-178c991fa0fa.md) |
