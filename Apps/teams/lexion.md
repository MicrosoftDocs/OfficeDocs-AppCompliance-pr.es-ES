---
title: Información de la aplicación para Lexion by Lexion
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/20/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Lexion, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/e2b7f512-12eb-4ba7-8705-b512fb3c05ee" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003176" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Lexion |
| Sitio web de la empresa | [https://lexion.ai](https://lexion.ai) |
| Términos de uso de la aplicación | [https://lexion.ai/terms](https://lexion.ai/terms) |
| Funcionalidad básica de la aplicación | Microsoft Teams bot para la administración del ciclo de vida de contratos con tecnología de inteligencia artificial de Lexion.  |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://lexion.ai](https://lexion.ai) |
...
Lexion ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
