---
title: Información de la aplicación para xMatters by xMatters Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/30/2021
...
description: Toda la información de seguridad y cumplimiento disponible para xMatters, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ccfe5256-29b8-4cc2-95ed-6612c0e1b10d" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA104382013" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | xMatters Inc. |
| Sitio web de la empresa | [https://www.xmatters.com](https://www.xmatters.com) |
| Términos de uso de la aplicación | [https://www.xmatters.com/policy/terms-conditions](https://www.xmatters.com/policy/terms-conditions) |
| Funcionalidad básica de la aplicación | Prevención, administración y resolución de problemas de TI mediante la automatización de la comunicación entre las cadenas de herramientas |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://help.xmatters.com/integrations/socialchat/microsoft...](https://help.xmatters.com/integrations/socialchat/microsoftteams.htm) |
...
XMatters Inc. ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC3 más reciente | 2020-09-30 |
