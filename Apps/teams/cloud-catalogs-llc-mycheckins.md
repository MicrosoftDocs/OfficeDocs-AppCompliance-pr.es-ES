---
title: Información de la aplicación para MyCheckins by Cloud Catalogs LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Toda la información de seguridad y cumplimiento disponible para MyCheckins, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/6f74dbb7-cd5c-48ac-b3f4-082eabef3808" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004375" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Cloud Catalogs LLC a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | MyCheckins |
| ID | WA200004375 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Catálogos en la nube LLC |
| Sitio web de la empresa | [https://mycheckins.io](https://mycheckins.io) |
| Términos de uso de la aplicación | [https://mycheckins.io/terms-and-conditions](https://mycheckins.io/terms-and-conditions) |
| Funcionalidad básica de la aplicación | Ejecute stand-ups asincrónicos, retrospectivas y mucho más en Microsoft Teams. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://mycheckins.io](https://mycheckins.io) |
...
Cloud Catalogs LLC ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Datos de perfil de usuario, Email de usuario, mensajes de usuario enviados al bot |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Datos de perfil de usuario, Email de usuario, mensajes de usuario enviados al bot |
...
| Dirección URL de la directiva de privacidad | https://mycheckins.io/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | aplicación | Obtención de detalles de usuario, como el nombre, el apellido y la dirección de correo electrónico | [8f43fc50-571c-4eab-b6ea-675d55e1755e](../azure/8f43fc50-571c-4eab-b6ea-675d55e1755e.md) |
