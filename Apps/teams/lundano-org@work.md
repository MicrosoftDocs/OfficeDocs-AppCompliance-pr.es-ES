---
title: Información de la aplicación para Org@Work por Lundano
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Org@Work, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64878647"
---
# <a name="orgwork"></a>Org@Work

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador el 10 de agosto de 2021</p>

* <a href="https://teams.microsoft.com/l/app/b9f5d3b0-424e-473d-bcbe-dd01f17f9a41" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002461" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://www.lundano.com/en/](https://www.lundano.com/en/) |
| Términos de uso de la aplicación | [https://cp.lundano.com/Terms_en.html](https://cp.lundano.com/Terms_en.html) |
| Funcionalidad básica de la aplicación | Administrar la organización del trabajo y la ocupación de la oficina con planeamientos de colaboración |
| Ubicación de la sede central de la empresa | Francia |
| Página de información de la aplicación | [https://www.lundano.com/orgatwork/index.html#](https://www.lundano.com/orgatwork/index.html#) |
...
Lundano ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Enumerar los tipos de directivas admitidas | Empleado, Administrador de planificación y Administrador |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | Estamos almacenando datos. Solo usamos los datos para iniciar sesión en el usuario en Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| correo electrónico | Delegado | Estamos almacenando datos. Solo usamos los datos para iniciar sesión en el usuario en Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| offline_access | Delegado | Estamos almacenando datos. Solo usamos los datos para iniciar sesión en el usuario en Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| OpenID | Delegado | Estamos almacenando datos. Solo usamos los datos para iniciar sesión en el usuario en Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| perfil | Delegado | Estamos almacenando datos. Solo usamos los datos para iniciar sesión en el usuario en Org@work | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
