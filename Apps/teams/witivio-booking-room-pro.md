...
|:----------------|:-------------|
| Nombre de la aplicación | Sala de reserva Pro |
| Id. | WA200003337 |
...
| Funcionalidad principal de la aplicación | Booking Room Pro es una aplicación Microsoft Teams que ayuda a administrar la ocupación de la sala y los lugares de asiento en la oficina. |
...
| ¿Qué datos se almacenan en las bases de datos? | Recursos para reservar y planear |
