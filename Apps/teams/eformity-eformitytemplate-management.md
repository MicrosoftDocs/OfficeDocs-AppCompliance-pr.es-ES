---
title: Información de la aplicación para la | de eformidad Administración de plantillas por eformidad
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/11/2022
...
description: Toda la información de seguridad y cumplimiento disponible para la eformidad | Administración de plantillas, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64771455"
---
# <a name="eformity--template-management"></a>eformity | Administración de plantillas

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 19 de noviembre de 2021</p>

* <a href="https://teams.microsoft.com/l/app/74843469-2e76-45e6-acdc-b755a4a4adf0" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003519" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por eformity a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | eformity: administración de plantillas |
| ID | WA200003519 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | eformidad |
| Sitio web de la empresa | [https://eformity.nl](https://eformity.nl) |
| Términos de uso de la aplicación | [https://eformity.net/policies/terms-of-use](https://eformity.net/policies/terms-of-use) |
| Funcionalidad básica de la aplicación | Use plantillas administradas centralmente para crear documentos y presentaciones a partir de Microsoft Teams. |
...
Esta información ha sido proporcionada por eformidad sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Correo de usuario, Nombre de usuario, Nombre de usuario, Apellidos de usuario |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Correo de usuario, Nombre de usuario, Nombre de usuario, Apellidos de usuario |
...
| Dirección URL de la directiva de privacidad | https://eformity.net/policies/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | Delegado | Guardar plantillas generadas | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| User.Read | Delegado | Recopilación de datos para actualizar el perfil de usuario en nuestra plataforma | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| OpenID | Delegado | Inicio de sesión de un usuario | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| perfil | Delegado | Inicio de sesión de un usuario | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
