---
title: Información de la aplicación para Expensya de Expensya
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Expensya, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/acbc0cba-5e0a-4bb5-a15c-21bce2863f01" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003924" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Expensya a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Expensya |
| ID | WA200003924 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Expensya |
| Sitio web de la empresa | [https://www.expensya.com](https://www.expensya.com) |
| Términos de uso de la aplicación | [https://www.expensya.com/en/tou](https://www.expensya.com/en/tou) |
| Funcionalidad básica de la aplicación | Expensya automatiza el gasto empresarial, de un extremo a otro, desde el procesamiento de facturas hasta las tarjetas corporativas. |
...
Expensya ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Perfil de empresa, perfiles de usuario (empleados) y elementos de gasto empresarial |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Tokens de Microsoft Graph (a medida que se integran en Teams!) |
...
| Dirección URL de la directiva de privacidad | https://www.expensya.com/en/legal |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | aplicación | Necesitamos el nombre completo del usuario y el correo electrónico | [6ce7c411-d7c9-4c4f-882e-164447c9b44a](../azure/6ce7c411-d7c9-4c4f-882e-164447c9b44a.md) |
