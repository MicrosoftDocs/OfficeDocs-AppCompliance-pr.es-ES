...
description: Toda la información de seguridad y cumplimiento disponible para Asana, sus directivas de tratamiento de datos, su Microsoft Cloud App Security de catálogo de aplicaciones e información de seguridad y cumplimiento en el Registro CSA STAR.
...
| Sitio web de la compañía | [https://asana.com](https://asana.com) |
| Términos de uso de la aplicación | [https://asana.com/terms#terms-of-service](https://asana.com/terms#terms-of-service) |
| Funcionalidad principal de la aplicación | Siga el trabajo traduciendo conversaciones Teams en elementos de acción en Asana, incluidas las reuniones |
| Ubicación central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://asana.com/apps/microsoft](https://asana.com/apps/microsoft) |
...
| Fecha de certificación SOC2 más reciente |  2021-03-15 |
| ¿La aplicación cumple con los controles de organización de servicio (SOC 3)? | Sí |
| Fecha de certificación SOC3 más reciente |  2021-03-15 |
...
| Dirección URL de la directiva de privacidad | https://asana.com/terms |
