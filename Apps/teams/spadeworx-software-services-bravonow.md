---
title: Información de la aplicación para BravoNow by SpadeWorx Software Services
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Toda la información de seguridad y cumplimiento disponible para BravoNow, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/272032ad-0c2e-4928-910e-5d52b19f70d5" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000157" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por SpadeWorx Software Services a Microsoft:
...
| Nombre de la empresa asociada | SpadeWorx Software Services |
| Sitio web de la empresa | [https://www.spadeworx.com](https://www.spadeworx.com) |
| Términos de uso de la aplicación | [https://docs.pozitive.io/BRAVO_TermsOfService.pdf](https://docs.pozitive.io/BRAVO_TermsOfService.pdf) |
| Funcionalidad básica de la aplicación | Bravo es una plataforma de reconocimiento de empleados punto a punto. |
| Ubicación de la sede central de la empresa | India |
| Página de información de la aplicación | [https://bravo.pozitive.io](https://bravo.pozitive.io) |
...
SpadeWorx Software Services ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | Dirección de correo electrónico de los usuarios. | [272032ad-0c2e-4928-910e-5d52b19f70d5](../azure/272032ad-0c2e-4928-910e-5d52b19f70d5.md) |
