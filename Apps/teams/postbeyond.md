---
title: Información de la aplicación para PostBeyond by PostBeyond
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toda la información de seguridad y cumplimiento disponible para PostBeyond, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/6e588f9e-5271-4583-b373-7991497deaec" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002658" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por PostBeyond a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | PostBeyond |
| Id. | WA200002658 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | PostBeyond |
| Sitio web de la empresa | [https://www.postbeyond.com](https://www.postbeyond.com) |
| Términos de uso de la aplicación | [https://www.postbeyond.com/terms-of-use/](https://www.postbeyond.com/terms-of-use/) |
| Funcionalidad básica de la aplicación | Active a sus promotores de redes sociales para aumentar la visibilidad de la marca, el compromiso y los resultados medibles con la promoción de los empleados con tecnología de PostBeyond. Amplía tu mejor contenido a través de las redes sociales de tus empleados, dando a tu marca la atención que merece. Hacemos que el escalado de la promoción de los empleados sea eficaz para los vendedores y fácil para los empleados.  |
| Ubicación de la sede central de la empresa | Canadá |
| Página de información de la aplicación | [https://www.postbeyond.com/product/](https://www.postbeyond.com/product/) |
...
PostBeyond ha proporcionado esta información sobre cómo recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
