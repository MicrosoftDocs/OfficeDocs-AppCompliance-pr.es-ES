---
title: Información de la solicitud para el día de la escuela por día escolar Helsinki Oy
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/12/2021
...
description: Toda la información de seguridad y cumplimiento disponible para School Day, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro de CSA STAR.
...
ms.locfileid: "64879217"
---
# <a name="school-day"></a>Día escolar

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 12 de octubre de 2021</p>

* <a href="https://teams.microsoft.com/l/app/7caaa66b-34b0-4c15-a65d-dba6edf0c8fd" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001430" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Día escolar Helsinki Oy |
| Sitio web de la empresa | [https://www.schoolday.com](https://www.schoolday.com) |
| Términos de uso de la aplicación | [https://www.schoolday.com/eula](https://www.schoolday.com/eula) |
| Funcionalidad básica de la aplicación | Mejorar el bienestar de los estudiantes y Social-Emotional Learning (SEL) con día escolar en Microsoft Teams! |
| Ubicación de la sede central de la empresa | Finlandia |
| Página de información de la aplicación | [https://www.schoolday.com/en/resources/faq](https://www.schoolday.com/en/resources/faq) |
...
Esta información ha sido proporcionada por School Day Helsinki Oy sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| GroupMember.Read.All | Delegado | Nombre de grupo y pertenencias a grupos. El usuario que es profesor, puede agregar alumnos al día escolar desde sus grupos. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| Team.ReadBasic.All | Delegado | El nombre del equipo se usa cuando el usuario maestro quiere agregar alumnos de sus equipos y grupos. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| User.Read | Delegado | El correo electrónico de usuario, el nombre y el token de identificador se usan para la administración y autenticación de usuarios. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| User.ReadBasic.All | Delegado | Imágenes de perfil de usuario que se usarán en avatares de usuario. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| correo electrónico | Delegado | El correo electrónico del usuario se recopila para la autenticación de la cuenta. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| offline_access | Delegado | Autenticación: actualización del token de acceso. Experiencia de usuario más fluida. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| OpenID | Delegado | Identificador único del usuario para el inicio de sesión de OpenID.  | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| perfil | Delegado | Nombre de usuario y identificador de objeto preferidos con fines de administración y autenticación de usuarios. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
