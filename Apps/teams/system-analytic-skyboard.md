---
title: Información de la aplicación para SkyBoard by System Analytic
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/10/2022
...
description: Toda la información de seguridad y cumplimiento disponible para SkyBoard, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/9322b063-9069-45fc-aaad-e3a0f9a2462a" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004162" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por System Analytic a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | SkyBoard |
| ID | WA200004162 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Análisis del sistema |
| Sitio web de la empresa | [https://www.systemanalytic.com](https://www.systemanalytic.com) |
| Términos de uso de la aplicación | [https://www.systemanalytic.com/eula.html](https://www.systemanalytic.com/eula.html) |
| Funcionalidad básica de la aplicación | Un consejo asesor digital completo. |
...
System Analytics ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://vmlyr-digitalsolutions.com/privacy.html |
