---
title: Información de la aplicación para Laduma by Laduma Ltd.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/11/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Laduma, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/3bcb0d8a-5ec8-4637-a946-958e5c0277fd" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003907" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Laduma Ltd. a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Laduma |
| ID | WA200003907 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Laduma Ltd. |
| Sitio web de la empresa | [https://laduma.com](https://laduma.com) |
| Términos de uso de la aplicación | [https://laduma.com/terms-of-service/](https://laduma.com/terms-of-service/) |
| Funcionalidad básica de la aplicación | Pizarra, documento y uso compartido de aplicaciones ilimitados para Microsoft Teams |
...
Esta información ha sido proporcionada por Laduma Ltd. sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Datos de perfil de usuario, datos de eventos de usuario, tokens de acceso de GraphAPI, canales de Microsoft Teams, recursos de calendario y sala |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Datos de perfil de usuario, datos de eventos de usuario, tokens de acceso de GraphAPI, canales de Microsoft Teams, recursos de calendario y sala |
...
| Dirección URL de la directiva de privacidad | https://laduma.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Application.Read.All | aplicación | Asegúrese de que tiene instalada la aplicación cuando intentamos agregar una reunión a su calendario. | [21759f96-a64d-450b-bf2a-b5e932d6ea01](../azure/21759f96-a64d-450b-bf2a-b5e932d6ea01.md) |
>| Calendars.Read | Ambos | Es necesario agregar reuniones al calendario del usuario. | [21759f96-a64d-450b-bf2a-b5e932d6ea01](../azure/21759f96-a64d-450b-bf2a-b5e932d6ea01.md) |
