---
title: Información de la aplicación para la administración de formación de empleados por SharePoint| Sapiens
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: La información de esta página se basa en un informe de autoevaluación proporcionado por el desarrollador de la aplicación sobre las prácticas de seguridad, cumplimiento y control de datos seguidas de esta aplicación.
...
<p>Última actualización del desarrollador: 22 de marzo de 2022</p>

* <a href="https://teams.microsoft.com/l/app/17b6b751-7463-4afd-a3ae-ad26a20c8904" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001512" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | \|SharePoint Sapiens |
| Sitio web de la empresa | [https://www.sharepointsapiens.com](https://www.sharepointsapiens.com) |
| Términos de uso de la aplicación | [https://addins.sharepointsapiens.com/licensing/services-agr...](https://addins.sharepointsapiens.com/licensing/services-agreement.html) |
| Funcionalidad básica de la aplicación | El complemento Employee Training Management facilita la organización y administración del desarrollo profesional continuo de los empleados para todos. Desde la configuración y programación de eventos de entrenamiento, la administración de aprendices y sus asignaciones e inscripciones, hasta el seguimiento de logros y comentarios, todo está cubierto. El complemento le ayuda a cumplir las normas de cumplimiento y las directivas de seguridad. Le permite asignar el entrenamiento necesario, realizar un seguimiento de los logros, administrar las expiraciones y mucho más. |
| Ubicación de la sede central de la empresa | Austria |
| Página de información de la aplicación | [https://www.sharepointsapiens.com/employee-training-managem...](https://www.sharepointsapiens.com/employee-training-management-office365/documentation/teams/) |
...
Esta información la ha proporcionado SharePoint| Sapiens acerca de cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://addins.sharepointsapiens.com/licensing/data-processing-agreement.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadBasic.All | Delegado | Lea la información básica del usuario para habilitar Exchange reserva de habitaciones. | [9e8e113c-8a08-4606-b08a-de4decc7252f](../azure/9e8e113c-8a08-4606-b08a-de4decc7252f.md) |
