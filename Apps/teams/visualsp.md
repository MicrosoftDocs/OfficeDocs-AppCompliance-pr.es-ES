...
description: Toda la información de seguridad y cumplimiento disponible para VisualSP, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f656b280-46c5-11ea-9317-4db94d176db2" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001426" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://visualsp.com](https://visualsp.com) |
| Términos de uso de la aplicación | [https://www.visualsp.com/terms-of-service](https://www.visualsp.com/terms-of-service) |
| Funcionalidad básica de la aplicación | Proporcionar acceso instantáneo a Microsoft 365 contenido de entrenamiento del usuario final y a su propio entrenamiento personalizado |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.visualsp.com/products/microsoft-teams-training/](https://www.visualsp.com/products/microsoft-teams-training/) |
...
VisualSP ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Dirección de correo electrónico del usuario. |
| ¿La aplicación admite TLS 1.1 o posterior? | No |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | nombre de usuario y dirección de correo electrónico |
