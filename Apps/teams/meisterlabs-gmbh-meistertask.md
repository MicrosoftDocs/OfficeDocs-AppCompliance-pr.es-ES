...
>Todos los EUII y OII mencionados anteriormente pueden terminar en archivos de registro usados para fines de depuración. Todos los datos de registro se eliminan automáticamente después de 6 meses como máximo.

#### <a name="organizational-controls-for-data-stored-by-partner"></a>Controles organizativos para los datos almacenados por el partner

Describir cómo los administradores de la organización pueden controlar su información en sistemas asociados. Por ejemplo, eliminación, retención, auditoría, archivado, directiva de usuario final, etc.

>Los administradores del cliente pueden eliminar sus datos y cerrar sus cuentas. El período de retención no es personalizable. La auditoría no está disponible actualmente. Los datos generados por el usuario se pueden archivar manualmente o tener acceso a través de la API pública ( https://developers.meistertask.com/) . Las directivas de usuario final están disponibles en https://www.meistertask.com/privacy y https://www.meistertask.com/terms .
