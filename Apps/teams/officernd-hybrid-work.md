---
title: Información de la aplicación para el trabajo híbrido de OfficeRnD por OfficeRnD
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/11/2021
...
description: Toda la información de seguridad y cumplimiento disponible para officeRnD Hybrid Work, sus directivas de control de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "63552049"
---
# <a name="officernd-hybrid-work"></a>Trabajo híbrido de OfficeRnD

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: September 21, 2021</p>

* <a href="https://teams.microsoft.com/l/app/ff19eb3c-6afa-4f33-acfd-df1338289524" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003460" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por OfficeRnD a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Trabajo híbrido de OfficeRnD |
| ID | WA200003460 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | OfficeRnD |
| Sitio web de la compañía | [https://officernd.com](https://officernd.com) |
| Términos de uso de la aplicación | [https://officernd.com/terms](https://officernd.com/terms) |
| Funcionalidad principal de la aplicación | Permite a los empleados buscar y reservar rápidamente escritorios, salas de reuniones y otros espacios. |
| Ubicación central de la empresa | Reino Unido de Gran Bretaña e Irlanda del Norte (el) |
| Página de información de la aplicación | [https://www.officernd.com/hybrid-workplace-management-softw...](https://www.officernd.com/hybrid-workplace-management-software/) |
...
OfficeRnD ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://officernd.com/privacy |
