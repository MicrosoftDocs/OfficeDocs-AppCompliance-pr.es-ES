---
title: Información de la aplicación para Zavvy by Zavvy GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Zavvy, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/15562290-1f82-4829-9638-452633a217d8" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003965" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Zavvy GmbH a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Zavvy |
| ID | WA200003965 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Zavvy GmbH |
| Sitio web de la empresa | [https://www.zavvy.io](https://www.zavvy.io) |
| Términos de uso de la aplicación | [https://www.zavvy.io/terms-conditions](https://www.zavvy.io/terms-conditions) |
| Funcionalidad básica de la aplicación | Incorpore, desarrolle y conecte a sus usuarios, directamente en Microsoft Teams. |
...
Zavvy GmbH ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Información del perfil de usuario, información del equipo |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Identificadores de los usuarios, identificador de inquilino, nombre e identificador del equipo en el que está instalada la aplicación. |
...
| Dirección URL de la directiva de privacidad | https://www.zavvy.io/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | Delegado | Para poder comprobar si la aplicación ya está instalada en un equipo | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| Channel.Create | aplicación | Para poder crear canales en caso de que tengamos que enviar mensajes de grupo a los usuarios de una organización. | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| ChannelMember.ReadWrite.All | aplicación | Para enviar mensajes a usuarios y canales  | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| Group.Read.All | aplicación | Para enumerar todos los equipos de un inquilino para que el administrador pueda elegir un equipo en el que instalar la aplicación. | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| TeamMember.Read.All | aplicación | Para buscar un usuario y su identificador de bot framework de un equipo determinado después de instalar la aplicación en un equipo. | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| TeamsAppInstallation.ReadWriteForTeam.All | aplicación | Para instalar la aplicación Zavvy Microsoft Teams en un equipo. | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
