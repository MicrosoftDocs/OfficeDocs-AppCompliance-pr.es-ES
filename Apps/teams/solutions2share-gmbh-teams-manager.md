---
title: Información de la aplicación para Teams Manager by Solutions2Share GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/27/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Teams Manager, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
<p>Última actualización del desarrollador: 24 de septiembre de 2021</p>

* <a href="https://teams.microsoft.com/l/app/87000000-3db9-bb44-5015-0b4a327a6597" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000764" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://teams-manager.com](https://teams-manager.com) |
| Términos de uso de la aplicación | [https://www.teams-manager.com/terms-of-use/](https://www.teams-manager.com/terms-of-use/) |
| Funcionalidad básica de la aplicación | Cree nuevas Teams basadas en plantillas complejas y personalizables con el flujo de trabajo de aprobación. Teams Manager ayuda a las empresas a mantener el control sobre sus Microsoft Teams y a detener el crecimiento incontrolado con características de gobernanza, a la vez que permite a los usuarios crear nuevos Teams. |
...
Esta información ha sido proporcionada por Solutions2Share GmbH sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.ReadWrite.All | Ambos | Estamos almacenando TenantID y TeamId para asignar las plantillas.  | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
...
>| User.Read.All | Ambos | Guardamos el identificador del usuario que se escribe en la sección aprobador/administrador. | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
