...
| Nombre de la empresa asociada | Workboard Inc. |
| Sitio web de la empresa | [https://www.workboard.com](https://www.workboard.com) |
...
| Funcionalidad básica de la aplicación | Alinee las prioridades estratégicas a través de la organización y localice los objetivos y los resultados clave (OKR) con los equipos y los individuos multifuncionales. Gráfico, cálculo y uso compartido del progreso en resultados clave y métricas correctas.  |
...
Workboard Inc. ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC1 más reciente | 2020-07-31 |
| ¿La aplicación cumple con los controles de organización de servicio (SOC 2)? | Sí |
| Fecha de certificación de SOC2 más reciente | 2020-10-30 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | dirección de correo electrónico y los identificadores de los usuarios.  Se usa para asignar el usuario al identificador de usuario de WorkBoard | [](../azure/.md) |
