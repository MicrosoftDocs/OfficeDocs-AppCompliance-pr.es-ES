...
description: Toda la información de seguridad y cumplimiento disponible para Link Spotter, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64878337"
---
# <a name="link-spotter"></a>Link Spotter

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 27 de julio de 2021</p>

* <a href="https://teams.microsoft.com/l/app/9e486bb8-9633-48ba-8416-71da1d30cd08" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003092" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Communardo Products |
| Sitio web de la empresa | [https://www.communardo.com](https://www.communardo.com) |
| Términos de uso de la aplicación | [https://www.communardo.com/customer-agreement/](https://www.communardo.com/customer-agreement/) |
| Funcionalidad básica de la aplicación | Link Spotter le ayuda a encontrar todos los vínculos compartidos en canales Microsoft Teams más rápido. |
| Ubicación de la sede central de la empresa | Alemania |
| Página de información de la aplicación | [https://communardo.atlassian.net/wiki/spaces/LINK/overview](https://communardo.atlassian.net/wiki/spaces/LINK/overview) |
...
Esta información la ha proporcionado Communardo Products sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Delegado | Comprobación de la pertenencia al canal del usuario actual | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
>| ChannelMessage.Read.All | aplicación | Direcciones URL dentro de mensajes, messageid, id. de mensaje de respuesta, id. de canal, id. de autor... Esta información es necesaria porque Graph no proporciona una manera eficaz de recuperar todos los vínculos publicados en los mensajes de un canal. Por lo tanto, los mensajes deben analizarse activamente para proporcionar la funcionalidad de vínculo en nuestra pestaña Teams. | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
>| User.Read | Delegado | Iniciar sesión y leer el perfil del usuario | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
>| User.Read.All | aplicación | Determine cuántos usuarios tienen una licencia de Teams. Se usa para actualizar el tamaño del asiento de la suscripción de origen de aplicación de pago para el inquilino del cliente. | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
>| User.ReadBasic.All | Delegado | mostrar la imagen de perfil y el nombre del autor del mensaje dentro de la aplicación | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
>| correo electrónico | Delegado | OpenID Connect | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
>| offline_access | Delegado | OpenID Connect | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
>| OpenID | Delegado | OpenID Connect | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
>| perfil | Delegado | OpenID Connect | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
