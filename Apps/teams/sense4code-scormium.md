---
title: Información de la aplicación para Scormium by Sense4code
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Scormium, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66656436"
---
# <a name="scormium"></a>Puntuación
...
* <a href="https://teams.microsoft.com/l/app/ad42b2ed-c5ad-4f2c-99e3-5da268a9c967" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004358" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Sense4code a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Puntuación |
| ID | WA200004358 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Sense4code |
| Sitio web de la empresa | [https://en.scormium.com](https://en.scormium.com) |
| Términos de uso de la aplicación | [https://en.scormium.com/podminky-a-pravidla-uziti](https://en.scormium.com/podminky-a-pravidla-uziti) |
| Funcionalidad básica de la aplicación | Disfrute de la eficacia del aprendizaje electrónico, los eventos y las rutas de estudio con Scormium.  |
...
Sense4code ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Correo electrónico del usuario   |
| ¿La aplicación admite TLS 1.1 o posterior? | No |
...
| Dirección URL de la directiva de privacidad | https://en.scormium.com/zasady-ochrany-soukromi |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | Iniciar sesión y leer el perfil del usuario | [ffdbe361-6168-42f7-beef-d1931b7922da](../azure/ffdbe361-6168-42f7-beef-d1931b7922da.md) |
