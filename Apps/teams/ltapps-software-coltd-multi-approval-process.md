---
title: Información de la aplicación para LTAPPs de proceso de aprobación múltiple por LTAPPs SOFTWARE CO.,LTD
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/31/2021
...
description: Toda la información de seguridad y cumplimiento disponible para los LTAPP de procesos de aprobación múltiple, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c1ab19ab-6a95-4f02-b42f-c1df3415e8a8" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003188" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | LTAPPs SOFTWARE CO.,LTD |
| Sitio web de la empresa | [https://ltaddins.com](https://ltaddins.com) |
| Términos de uso de la aplicación | [https://ltaddins.com/terms.html](https://ltaddins.com/terms.html) |
| Funcionalidad básica de la aplicación | El proceso de aprobación múltiple es una aplicación fácil de usar que permite a los usuarios finales realizar la solicitud. La aplicación es totalmente personalizable, lo que permite a los administradores mantener la coherencia con las especificaciones de sus organizaciones. |
| Ubicación de la sede central de la empresa | Vietnam |
...
Esta información ha sido proporcionada por LTAPPs SOFTWARE CO.,LTD sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | Identificador de inquilino de información &amp; de usuario | [d2682b2a-2037-4545-94b6-3e7216ecca5f](../azure/d2682b2a-2037-4545-94b6-3e7216ecca5f.md) |
