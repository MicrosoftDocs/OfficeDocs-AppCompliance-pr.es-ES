---
title: Información de la aplicación para Amplify by Hootsuite by Hootsuite Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/07/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Amplify by Hootsuite, sus directivas de control de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/08d9aab9-a8f3-4f65-91e2-a33ef9bad6bb" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003153" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Hootsuite Inc. a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Amplify de Hootsuite |
| Id. | WA200003153 |
| Clientes de Office 365 admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Hootsuite Inc. |
| Sitio web de la empresa | [https://www.hootsuite.com](https://www.hootsuite.com) |
| Términos de uso de la aplicación | [https://www.hootsuite.com/legal/eula](https://www.hootsuite.com/legal/eula) |
| Funcionalidad básica de la aplicación | Comparta contenido de Microsoft Teams con los canales sociales de sus equipos, con tecnología de Hootsuite Amplify. |
| Ubicación de la sede central de la empresa | Canadá |
| Página de información de la aplicación | [https://www.hootsuite.com/about/contact-us](https://www.hootsuite.com/about/contact-us) |
...
Esta información ha sido proporcionada por Hootsuite Inc. sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | Delegado | Para acceder a la fuente de notificaciones de actividad de los usuarios | [e308040f-41b5-4b8c-8f08-c2c38056f7e2](../azure/e308040f-41b5-4b8c-8f08-c2c38056f7e2.md) |
