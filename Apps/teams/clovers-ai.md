---
title: Información de la aplicación para Clovers by Clovers AI
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/22/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Clovers, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/1356036b-5fa7-42ce-8079-5741f2acfc5f" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003795" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Clovers AI a Microsoft:
...
| Nombre de la empresa asociada | IA de Clovers |
| Sitio web de la empresa | [https://clovers.ai](https://clovers.ai) |
| Términos de uso de la aplicación | [https://clovers.ai/terms-of-use/](https://clovers.ai/terms-of-use/) |
| Funcionalidad básica de la aplicación | Clovers: la guía de entrevistas para ayudar a los equipos a contratar de forma más eficiente |
...
Clovers AI ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2021-10-25 |
