---
title: Información de la aplicación para CyRecord de CyTrack
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2022
...
description: Toda la información de seguridad y cumplimiento disponible para CyRecord, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro de CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/4073224c-6e1d-4e72-a754-510d91279b3b" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004280" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | CyRecord |
| ID | WA200004280 |
...
| Funcionalidad básica de la aplicación | CyRecord está dirigido a usuarios empresariales que requieren funcionalidad avanzada para la grabación de voz de las llamadas telefónicas externas de Microsoft Teams.   La grabación de llamadas proporciona hechos indiscutibles sobre llamadas telefónicas que dan lugar a una resolución de disputas más rápida. Mejore el servicio al cliente a través de la escucha y la formación y cumpla los requisitos normativos. |
| Ubicación de la sede central de la empresa | Australia |
| Página de información de la aplicación | [https://web.cytrack.com/microsoft-teams/call-recording-for-...](https://web.cytrack.com/microsoft-teams/call-recording-for-microsoft-teams/) |
