...
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read | delegado | Para autorizar usuarios en el producto |
>| MailboxSettings.Read | aplicación | Para enviar informes sobre la zona horaria individual de los usuarios |
