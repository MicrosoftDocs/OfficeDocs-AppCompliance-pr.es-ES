---
title: Información de la aplicación para Standuply by Standuply Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/24/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Standuply, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/1250b735-e9df-4d5b-ae82-da96c55c64e4" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003001" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Standuply Inc. a Microsoft:
...
| Nombre de la empresa asociada | Standuply Inc. |
| Sitio web de la empresa | [https://standuply.com](https://standuply.com) |
| Términos de uso de la aplicación | [https://standuply.com/terms](https://standuply.com/terms) |
| Funcionalidad básica de la aplicación | Automatiza de forma independiente los procesos de administración y proporciona un sistema de QA&amp; interno para aumentar la productividad de su equipo. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://standuply.com](https://standuply.com) |
...
Esta información ha sido proporcionada por Standuply Inc. sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | P.3 de https://standuply.com/privacy-policy |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | P.3 de https://standuply.com/privacy-policy |
...
| Dirección URL de la directiva de privacidad | https://standuply.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| MailboxSettings.Read | aplicación | Para enviar informes sobre la zona horaria individual de los usuarios | [e9f5cb58-89eb-4f80-9a6c-b73823b62176](../azure/e9f5cb58-89eb-4f80-9a6c-b73823b62176.md) |
>| User.Read | Delegado | Para autorizar a los usuarios en el producto | [e9f5cb58-89eb-4f80-9a6c-b73823b62176](../azure/e9f5cb58-89eb-4f80-9a6c-b73823b62176.md) |
