---
title: Información de la aplicación para File Fabric por Storage fácil
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toda la información de seguridad y cumplimiento disponible para File Fabric, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/bd063a87-1e4d-42cf-baea-8cab71839e35" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003017" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Storage fácil de usar para Microsoft:
...
| Nombre de la empresa asociada | Storage Made Easy |
| Sitio web de la empresa | [https://storagemadeeasy.com](https://storagemadeeasy.com) |
| Términos de uso de la aplicación | [https://www.storagemadeeasy.com/terms](https://www.storagemadeeasy.com/terms) |
| Funcionalidad básica de la aplicación | Busque, examine, edite y comparta archivos almacenados en Azure Files, Azure Blob Storage y otro almacenamiento. |
| Ubicación de la sede central de la empresa | Reino Unido de Gran Bretaña e Irlanda del Norte (el) |
| Página de información de la aplicación | [https://docs.storagemadeeasy.com/microsoft-teams](https://docs.storagemadeeasy.com/microsoft-teams) |
| ¿Cuál es el entorno de hospedaje o el modelo de servicio que se usa para ejecutar la aplicación? |  |
| ¿Qué proveedores de nube de hospedaje usa la aplicación? | SelfHosted, Azure, AWS, GCP, IBMCloud, Users pueden conectarse con los servicios Wasabi, Backblaze, Cloudian, Dropbox, Box.com, Salesforce, S3-Compatible, FTP y WebDAV. |
...
Esta información ha sido proporcionada por Storage Made Easy sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite | aplicación | Los datos de archivo se leen o escriben cuando el usuario descarga, carga o edita archivos especificados a través de la aplicación. | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
>| Sites.ReadWrite.All | aplicación | Metadatos recopilados para todos los archivos y carpetas de&#8217;de usuario que proporcionan una vista federada en todos los servicios de archivos. | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
