...
ms.locfileid: "52250977"
---
# <a name="cai-adoption-bot"></a>C.AI bot de adopción
...
|:----------------|:-------------|
| Nombre de la aplicación | C.AI bot de adopción |
| ID | WA200002633 |
| Capacidades | Bot, pestaña |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | contexxt.ai |
| Dirección URL del sitio web de partners | [https://www.contexxt.ai](https://www.contexxt.ai) |
| Dirección URL de Teams de información de la aplicación | [https://contexxt.ai/sphere/cai-adoption-bot](https://contexxt.ai/sphere/cai-adoption-bot) |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| No se puede evitar técnicamente, Microsoft Teams la envía automáticamente (id. de usuario) | No |  |
...
>No tenemos acceso ni control sobre datos en sistemas de nuestros partners
