---
title: Información de la aplicación para Infor Coleman by INFOR (US), INC.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/06/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Infor Coleman, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b9a120c7-9103-4e04-90b8-91c9db422a6e" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003314" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | INFOR (US), INC. |
| Sitio web de la empresa | [https://www.infor.com](https://www.infor.com) |
| Términos de uso de la aplicación | [https://www.infor.com/about/legal](https://www.infor.com/about/legal) |
| Funcionalidad básica de la aplicación | Infor Coleman Digital Assistant proporciona una interfaz conversacional para maximizar el potencial de trabajo humano, ya que permite la extensibilidad y accesibilidad del lenguaje natural a Infor Cloudsuites. |
...
Esta información ha sido proporcionada por INFOR (US), INC. acerca de cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
