---
title: Información de la aplicación para Infor Coleman por INFOR (US), INC.
ms.author: elmalova
author: elenamalova
ms.date: 10/06/2021
ms.topic: article
...
description: Toda la información de seguridad y cumplimiento disponible para Infor Coleman, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b9a120c7-9103-4e04-90b8-91c9db422a6e" target="_blank">Ver en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003314" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por INFOR (US), INC. a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Infor Coleman |
| Id. | WA200003314 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | INFOR (US), INC. |
| Sitio web de la compañía | [https://www.infor.com](https://www.infor.com) |
| Términos de uso de la aplicación | [https://www.infor.com/about/legal](https://www.infor.com/about/legal) |
| Funcionalidad principal de la aplicación | El Asistente digital de Infor Coleman proporciona una interfaz conversacional para maximizar el potencial del trabajo humano al permitir la extensibilidad del lenguaje natural y la accesibilidad a Infor Cloudsuites. |
...
Esta información ha sido proporcionada por INFOR (US), INC. acerca de cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
