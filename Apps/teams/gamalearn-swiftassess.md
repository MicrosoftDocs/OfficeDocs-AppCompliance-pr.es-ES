---
title: Información de la aplicación para SwiftAssess de GamaLearn
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
description: Toda la información de seguridad y cumplimiento disponible para SwiftAssess, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0cd07157-f297-4c2c-a23b-64577bceea6c" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001973" target="_blank">Ver en AppSource</a>
...
| Nombre de la compañía asociada | GamaLearn |
| Sitio web de la compañía | [https://gamalearn.com](https://gamalearn.com) |
| Términos de uso de la aplicación | [https://swiftassess.com/terms-and-conditions](https://swiftassess.com/terms-and-conditions) |
| Funcionalidad principal de la aplicación | Una tienda integral para todas las necesidades de evaluación, que van desde metodologías y características probadas y verdaderas que guían su viaje a través de la creación, entrega y seguimiento de su estrategia de transformación de evaluación en todos los niveles de su organización. SwiftAssess ofrece varias soluciones, características y flujos de trabajo clave que simplifican y automatizan procesos de evaluación reales en diferentes instituciones. Esto abarca los estándares del sector cuando se trata de seguridad, accesibilidad, análisis, banca de elementos y más |
| Ubicación central de la empresa | Emiratos Árabes Unidos (el) |
...
GamaLearn ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
