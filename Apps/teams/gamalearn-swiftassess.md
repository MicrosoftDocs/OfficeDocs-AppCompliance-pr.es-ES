---
title: Información de la aplicación para SwiftAssess by GamaLearn
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
description: Toda la información de seguridad y cumplimiento disponible para SwiftAssess, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/0cd07157-f297-4c2c-a23b-64577bceea6c" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001973" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por GamaLearn a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | SwiftAssess |
| Id. | WA200001973 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | GamaLearn |
| Sitio web de la empresa | [https://gamalearn.com](https://gamalearn.com) |
| Términos de uso de la aplicación | [https://swiftassess.com/terms-and-conditions](https://swiftassess.com/terms-and-conditions) |
| Funcionalidad básica de la aplicación | Una tienda integral para todas las necesidades de evaluación, que va desde metodologías y características probadas y verdaderas que guían su recorrido por la creación, entrega y seguimiento de la estrategia de transformación de evaluación en todos los niveles de su organización. SwiftAssess ofrece varias soluciones, características y flujos de trabajo clave que simplifican y automatizan procesos de evaluación reales en diferentes instituciones. Esto cubre los estándares del sector en lo que respecta a seguridad, accesibilidad, análisis, banca de artículos y mucho más |
| Ubicación de la sede central de la empresa | Emiratos Árabes Unidos (el) |
| Página de información de la aplicación | [https://swiftassess.com/about/partners/microsoft#Teams](https://swiftassess.com/about/partners/microsoft#Teams) |
...
GamaLearn ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
