---
title: Información de la aplicación para SurveySparrow por SurveySparrow inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Toda la información de seguridad y cumplimiento disponible para SurveySparrow, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/1b923c85-b04c-43d4-b2c2-0fdc0f598658" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002257" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por SurveySparrow inc. a Microsoft:
...
| Nombre de la empresa asociada | SurveySparrow Inc. |
| Sitio web de la empresa | [https://surveysparrow.com](https://surveysparrow.com) |
| Términos de uso de la aplicación | [https://surveysparrow.com/legal/terms-of-service/](https://surveysparrow.com/legal/terms-of-service/) |
| Funcionalidad básica de la aplicación | Realice stand-ups diarios, felicidad mensual y mida el pulso de los empleados fácilmente. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://surveysparrow.com/apps/microsoft-teams-survey-integ...](https://surveysparrow.com/apps/microsoft-teams-survey-integration/) |
...
SurveySparrow inc. ha proporcionado esta información sobre cómo recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
