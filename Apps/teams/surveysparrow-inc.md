...
description: Toda la información de seguridad y cumplimiento disponible para SurveySparrow, sus directivas de control de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security y la información de seguridad y cumplimiento en el registro CSA STAR.
...
| Nombre de la compañía asociada | SurveySparrow Inc. |
| Sitio web de la compañía | [https://surveysparrow.com](https://surveysparrow.com) |
...
| Funcionalidad principal de la aplicación | Realice los stand-ups diarios, la felicidad mensual y mida el impulso de los empleados fácilmente. |
...
SurveySparrow inc. ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
