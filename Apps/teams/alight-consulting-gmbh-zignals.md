---
title: Información de la aplicación para Zignals by Alight Consulting GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/31/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Zignals, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65357157"
---
# <a name="zignals"></a>Zignals

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 17 de agosto de 2021</p>

* <a href="https://teams.microsoft.com/l/app/a0b58ca7-958d-4343-a2dc-a75f2eeb0953" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003201" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Alight Consulting GmbH a Microsoft:
...
| Nombre de la empresa asociada | Alight Consulting GmbH |
| Sitio web de la empresa | [https://www.alight.eu](https://www.alight.eu) |
| Términos de uso de la aplicación | [https://zignals.eu/terms](https://zignals.eu/terms) |
| Funcionalidad básica de la aplicación | Lleve la colaboración en las organizaciones al siguiente nivel agregando contenido y mostrando a los empleados lo que es importante. |
| Ubicación de la sede central de la empresa | Alemania |
| Página de información de la aplicación | [https://zignals.eu/zignals-support/](https://zignals.eu/zignals-support/) |
...
Esta información ha sido proporcionada por Alight Consulting GmbH sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Delegado | Para el área &quot;Mis reuniones&quot; , se obtienen las reuniones del usuario hoy y mañana. | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](../azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953.md) |
>| Sites.ReadWrite.All | Delegado | Obtenemos todos los sitios de SharePoint seguidos del usuario y los mostraremos en el área &quot;Mi trabajo&quot; en equipo y obtenemos todas las tareas de SharePoint del usuario y las mostraremos en el área &quot;Mis tareas&quot;. | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](../azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953.md) |
>| Tasks.ReadWrite | Delegado | Leemos las tareas planner y To Do del usuario y las mostramos en el área &quot;Mis tareas&quot;. | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](../azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953.md) |
>| Team.ReadBasic.All | Delegado | Obtenemos los equipos unidos al usuario y los mostramos en el &quot;área Mi trabajo en equipo&quot; . | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](../azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953.md) |
>| User.ReadBasic.All | Delegado | En el &quot;área Mis documentos&quot; , se muestra el usuario que ha colaborado | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](../azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953.md) |
>| User.ReadWrite | Delegado | Los documentos recientes del usuario se muestran en el área &quot;Mis documentos&quot;. Las aplicaciones favoritas del usuario se almacenan como una extensión de esquema en la Graph MS. Este nivel de permiso es necesario para leer y escribir datos en el gráfico. | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](../azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953.md) |
>| correo electrónico | Delegado | Obtener correo electrónico de los usuarios (ámbito de Teams de MS estándar) | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](../azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953.md) |
>| offline_access | Delegado | Ámbito de Teams estándar de MS | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](../azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953.md) |
>| OpenID | Delegado | Usuarios de inicio de sesión. | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](../azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953.md) |
>| perfil | Delegado | Proceso de inicio de sesión de MS Teams | [a0b58ca7-958d-4343-a2dc-a75f2eeb0953](../azure/a0b58ca7-958d-4343-a2dc-a75f2eeb0953.md) |
