...
description: Toda la información de seguridad y cumplimiento disponible para SkyPoint Cloud, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security y la información de seguridad y cumplimiento en el Registro CSA STAR.
...
| Sitio web de la compañía | [https://skypointcloud.com](https://skypointcloud.com) |
| Términos de uso de la aplicación | [https://skypointcloud.com/terms/](https://skypointcloud.com/terms/) |
| Funcionalidad principal de la aplicación | SkyPoint ayuda a las marcas a conocer a sus clientes, tomar decisiones estratégicas y tomar de forma coherente el curso correcto de acción para servir mejor a sus consumidores y seguir creciendo sus empresas. Somos una plataforma de datos de clientes que proporciona capacidades inteligentes en la administración y unificación de datos, cumplimiento de privacidad, análisis e información y activación.  |
