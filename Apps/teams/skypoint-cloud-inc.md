---
title: Información de la aplicación para SkyPoint Cloud by SkyPoint Cloud Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/21/2022
...
description: Toda la información de seguridad y cumplimiento disponible para SkyPoint Cloud, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64880567"
---
# <a name="skypoint-cloud"></a>SkyPoint Cloud

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 21 de febrero de 2022</p>

* <a href="https://teams.microsoft.com/l/app/9637dd07-ec2d-48f7-83cd-bccad3be9fd4" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002580" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://skypointcloud.com](https://skypointcloud.com) |
| Términos de uso de la aplicación | [https://skypointcloud.com/terms/](https://skypointcloud.com/terms/) |
| Funcionalidad básica de la aplicación | SkyPoint ayuda a las marcas a conocer a sus clientes, a tomar decisiones estratégicas y a tomar constantemente el curso de acción adecuado para servir mejor a sus consumidores y seguir creciendo sus negocios. Somos una plataforma de datos de clientes que proporciona funcionalidades inteligentes en la administración y unificación de datos, el cumplimiento de la privacidad, el análisis y la información y la activación.  |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://skypointcloud.com/platform/](https://skypointcloud.com/platform/) |
...
SkyPoint Cloud Inc. ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
