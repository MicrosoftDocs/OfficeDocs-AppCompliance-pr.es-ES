---
title: Información de la aplicación para Koan by Koan, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/18/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Koan, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64877217"
---
# <a name="koan"></a>Koan

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 1 de junio de 2021</p>

* <a href="https://teams.microsoft.com/l/app/dae2b2c3-b014-4188-a887-c87c3ca4a227" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002936" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Koan, Inc. |
| Sitio web de la empresa | [https://www.koan.co](https://www.koan.co) |
| Términos de uso de la aplicación | [https://www.koan.co/terms-of-service](https://www.koan.co/terms-of-service) |
| Funcionalidad básica de la aplicación | Incorpore la administración de objetivos y el seguimiento de estado directamente en Microsoft Teams para ver el progreso y mantener los equipos alineados. La integración de Koan&#8217;permite a los empleados mantenerse centrados en el trabajo que más importa sin tener que abandonar Microsoft Teams. Cree fácilmente hábitos positivos de equipo para compartir el estado, reconocer los triunfos e identificar las preocupaciones pronto, lo que eleva el listón para todos los demás. |
...
Koan, Inc. ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2021-01-15 |
...
>| Team.ReadBasic.All | Ambos | El identificador de equipo y el nombre del equipo se recopilan y usan. Usamos los datos para que los usuarios puedan seleccionar dónde quieren que se entreguen las notificaciones de reflexión. | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
>| User.Read | Delegado | Se usan el nombre de usuario, el identificador de usuario y la dirección de correo electrónico de usuario. Usamos los datos para vincular cuentas de usuario entre Microsoft Teams y Koan. Solo se aplicó para las menciones. | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
