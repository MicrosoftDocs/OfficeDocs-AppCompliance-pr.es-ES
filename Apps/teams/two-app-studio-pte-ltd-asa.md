---
title: Información de la aplicación para Asa por Two App Studio Pte Ltd.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/09/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Asa, sus directivas de tratamiento de datos, su Microsoft Cloud App Security de catálogo de aplicaciones e información de seguridad y cumplimiento en el Registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/2973405f-6e3b-45a3-a3a4-7c85d8d3be88" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003449" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Two App Studio Pte Ltd. a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | ASA |
| ID | WA200003449 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | Dos App Studio Pte Ltd. |
| Sitio web de la compañía | [https://asa.team](https://asa.team) |
| Términos de uso de la aplicación | [https://asa.team/terms](https://asa.team/terms) |
| Funcionalidad principal de la aplicación | Herramienta de administración del área de trabajo remota |
| Ubicación central de la empresa | Singapur |
| Página de información de la aplicación | [https://asa.team](https://asa.team) |
...
Esta información ha sido proporcionada por Two App Studio Pte Ltd. acerca de cómo esta aplicación recopila y almacena datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | microsoft tenantId para los usuarios y el grupo desde el que envían los mensajes del bot |
...
| Dirección URL de la directiva de privacidad | https://asa.team/privacypolicy |
