...
description: Toda la información de seguridad y cumplimiento disponible para Text, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64880994"
---
# <a name="text"></a>Texto

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 10 de mayo de 2021</p>

* <a href="https://teams.microsoft.com/l/app/a622ceb4-b6e2-4557-8218-e22e80975ba4" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000383" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://www.approvedcontact.com](https://www.approvedcontact.com) |
| Términos de uso de la aplicación | [https://approvedcontact.com/Terms%20of%20use.pdf](https://approvedcontact.com/Terms%20of%20use.pdf) |
| Funcionalidad básica de la aplicación | El contacto aprobado le permite compartir fácilmente calendarios con cualquier persona. Los cambios realizados en el calendario se actualizan automáticamente en Contacto aprobado. El uso de Contacto aprobado le permite conectar su calendario a sitios web, texto, correo electrónico, móvil, reconocimiento de voz y sistemas telefónicos. |
...
El contacto aprobado ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.ReadWrite.All | Delegado | Para bot de texto, capturamos el identificador de equipo para crear canales futuros para los mensajes de texto entrantes. | [a622ceb4-b6e2-4557-8218-e22e80975ba4](../azure/a622ceb4-b6e2-4557-8218-e22e80975ba4.md) |
>| correo electrónico | Delegado | direcciones de correo electrónico | [a622ceb4-b6e2-4557-8218-e22e80975ba4](../azure/a622ceb4-b6e2-4557-8218-e22e80975ba4.md) |
>| offline_access | Delegado | Los tokens de actualización se almacenan en nuestra base de datos. | [a622ceb4-b6e2-4557-8218-e22e80975ba4](../azure/a622ceb4-b6e2-4557-8218-e22e80975ba4.md) |
>| OpenID | Delegado | Credenciales de inicio de sesión | [a622ceb4-b6e2-4557-8218-e22e80975ba4](../azure/a622ceb4-b6e2-4557-8218-e22e80975ba4.md) |
>| perfil | Delegado | direcciones de correo electrónico | [a622ceb4-b6e2-4557-8218-e22e80975ba4](../azure/a622ceb4-b6e2-4557-8218-e22e80975ba4.md) |
