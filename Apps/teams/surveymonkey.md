...
| Sitio web de la compañía | [https://www.surveymonkey.com](https://www.surveymonkey.com) |
| Términos de uso de la aplicación | [https://www.surveymonkey.com/mp/legal/terms-of-use/](https://www.surveymonkey.com/mp/legal/terms-of-use/) |
| Funcionalidad principal de la aplicación | Colaborar y capturar opiniones y opiniones de los empleados a través de encuestas y sondeos rápidos. Capture los resultados en un solo lugar para mantener el equipo actualizado con nuevas respuestas. |
| Ubicación central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://help.surveymonkey.com/articles/en_US/kb/Microsoft-T...](https://help.surveymonkey.com/articles/en_US/kb/Microsoft-Teams-Integration) |
