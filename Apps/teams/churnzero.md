...
description: Toda la información de seguridad y cumplimiento disponible para ChurnZero, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el Registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c2e66b59-725d-4c56-8a0e-ee2587031d9f" target="_blank">Ver en Teams tienda</a>
...
| Sitio web de la compañía | [https://churnzero.net](https://churnzero.net) |
| Términos de uso de la aplicación | [https://churnzero.net/terms-of-use](https://churnzero.net/terms-of-use) |
| Funcionalidad principal de la aplicación | ChurnZero es una plataforma de éxito del cliente en tiempo real que ayuda a las empresas de suscripción a combatir la renovación, expandir cuentas actuales, aumentar la adopción de productos y optimizar la experiencia del cliente. |
...
| Fecha de certificación SOC2 más reciente |  2020-11-18 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegado | El identificador de objeto de Azure del usuario delegado para correlacionarse con un usuario de ChurnZero, con el fin de identificar y autorizar ese usuario durante una sesión de bot futura. | [c2e66b59-725d-4c56-8a0e-ee2587031d9f](../azure/c2e66b59-725d-4c56-8a0e-ee2587031d9f.md) |
