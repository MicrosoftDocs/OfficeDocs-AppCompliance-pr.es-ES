---
title: Información de la aplicación para ChurnZero by ChurnZero
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/08/2021
...
description: Toda la información de seguridad y cumplimiento disponible para ChurnZero, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/c2e66b59-725d-4c56-8a0e-ee2587031d9f" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002581" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | ChurnZero |
| Sitio web de la empresa | [https://churnzero.net](https://churnzero.net) |
| Términos de uso de la aplicación | [https://churnzero.net/terms-of-use](https://churnzero.net/terms-of-use) |
| Funcionalidad básica de la aplicación | ChurnZero es una plataforma de éxito del cliente en tiempo real que ayuda a las empresas de suscripción a luchar contra el abandono, expandir las cuentas actuales, aumentar la adopción de productos y optimizar la experiencia del cliente. |
...
ChurnZero ha proporcionado esta información sobre cómo recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2020-11-18 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | El identificador de objeto de Azure del usuario delegado para correlacionar con un usuario de ChurnZero, con el fin de identificar y autorizar a ese usuario durante una sesión futura del bot. | [c2e66b59-725d-4c56-8a0e-ee2587031d9f](../azure/c2e66b59-725d-4c56-8a0e-ee2587031d9f.md) |
