---
title: Información de la aplicación para BrowserStack by BrowserStack Inc
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Toda la información de seguridad y cumplimiento disponible para BrowserStack, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/180f19aa-1b79-4b4a-b716-068b81cfb145" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004404" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por BrowserStack Inc a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | BrowserStack |
| ID | WA200004404 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | BrowserStack Inc |
| Sitio web de la empresa | [https://www.browserstack.com](https://www.browserstack.com) |
| Términos de uso de la aplicación | [https://www.browserstack.com/terms](https://www.browserstack.com/terms) |
| Funcionalidad básica de la aplicación | ¡Traiga la información de BrowserStack directamente a Microsoft Teams! |
| Ubicación de la sede central de la empresa | India |
| Página de información de la aplicación | [https://www.browserstack.com/docs/automate/selenium/microso...](https://www.browserstack.com/docs/automate/selenium/microsoft-teams) |
...
BrowserStack Inc ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2021-06-14 |
...
| Dirección URL de la directiva de privacidad | https://www.browserstack.com/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | Inicio de sesión y lectura del perfil de usuario con fines de autenticación | [180f19aa-1b79-4b4a-b716-068b81cfb145](../azure/180f19aa-1b79-4b4a-b716-068b81cfb145.md) |
