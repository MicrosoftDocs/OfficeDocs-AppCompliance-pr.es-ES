---
title: Información de la aplicación para Berry by Berryworks.ai
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Berry, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/3694c470-c14b-11ec-97bc-6b8526f20a81" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004138" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Berryworks.ai a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Uva |
| ID | WA200004138 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Berryworks.ai |
| Sitio web de la empresa | [https://berryworks.ai](https://berryworks.ai) |
| Términos de uso de la aplicación | [https://www.berryworks.ai/tnc/](https://www.berryworks.ai/tnc/) |
| Funcionalidad básica de la aplicación | Interactuar con los empleados, interpretar sentimientos en tiempo real e impulsar la responsabilidad |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://berryworks.ai/teams-integration/](https://berryworks.ai/teams-integration/) |
...
Esta información ha sido proporcionada por Berryworks.ai sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Información del inquilino, como el identificador de inquilino, el identificador de comunicación de usuario |
