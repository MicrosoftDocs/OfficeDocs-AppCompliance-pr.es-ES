---
title: Información de la aplicación para isolved by isolved
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Toda la información de seguridad y cumplimiento disponible para isolved, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66819059"
---
# <a name="isolved"></a>resuelto
...
* <a href="https://teams.microsoft.com/l/app/287fab70-2e10-4bc3-9049-8991d7796d81" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004410" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por isolved a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | resuelto |
| ID | WA200004410 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | resuelto |
| Sitio web de la empresa | [https://www.isolvedhcm.com](https://www.isolvedhcm.com) |
| Términos de uso de la aplicación | [https://www.isolvedhcm.com/legal/agreements/employee-terms-...](https://www.isolvedhcm.com/legal/agreements/employee-terms-and-conditions-for-use) |
| Funcionalidad básica de la aplicación | Capacitar a los usuarios para obtener respuestas a preguntas de RR. HH. rápidamente, dentro de Microsoft Teams |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.isolvedhcm.com/platform/enhancements/conversati...](https://www.isolvedhcm.com/platform/enhancements/conversational-virtual-assistant) |
...
Esta información ha sido proporcionada por isolved acerca de cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Identificador de inquilino de Microsoft Azure, Id. de usuario de Microsoft Azure  |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Identificador de inquilino de Microsoft Azure, Id. de usuario de Microsoft Azure  |
