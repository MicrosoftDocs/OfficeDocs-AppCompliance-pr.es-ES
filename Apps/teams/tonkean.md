---
title: Información de la aplicación para Tonkean por Tonkean
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/17/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Tonkean, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b7391d00-e8e4-4dc9-970e-ba3386144114" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381749" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Tonkean a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Tonkean |
| ID | WA104381749 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Tonkean |
| Sitio web de la empresa | [https://tonkean.com](https://tonkean.com) |
| Términos de uso de la aplicación | [https://tonkean.com/terms/](https://tonkean.com/terms/) |
| Funcionalidad básica de la aplicación | Tonkean permite a las organizaciones y los equipos de operaciones automatizar procesos empresariales complejos, rápidamente. Tonkean proporciona los bloques de creación para ejecutar, supervisar y administrar cualquier proceso empresarial integrado en solution Studio totalmente sin código.  |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://tonkean.com](https://tonkean.com) |
...
Tonkean ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Nombre, Correo electrónico, Id. de usuario. Es posible que otros datos se almacenen cuando el usuario lo solicite o se choise. |
...
| Dirección URL de la directiva de privacidad | https://tonkean.com/privacy |
