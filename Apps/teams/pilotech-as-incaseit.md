...
description: Toda la información de seguridad y cumplimiento disponible para InCaseIT, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64875387"
---
# <a name="incaseit"></a>InCaseIT

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador el 3 de agosto de 2021</p>

* <a href="https://teams.microsoft.com/l/app/4420b597-c1d5-4d40-ba81-2b2a78575c81" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003265" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Pilotech AS |
| Sitio web de la empresa | [https://incaseit.com](https://incaseit.com) |
| Términos de uso de la aplicación | [https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/t...](https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/topic/1-4-terms-of-use) |
| Funcionalidad básica de la aplicación | Sistema de gestión de crisis. Sistema de preparación y control de crisis e incidentes. |
| Ubicación de la sede central de la empresa | Noruega |
| Página de información de la aplicación | [https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/t...](https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/topic/introduction-to-incaseit-version-2-0) |
...
Pilotech AS ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | Delegado | Los únicos datos utilizados son la confirmación explícita por parte de los usuarios para permitir que la aplicación use un token de acceso para llamar al Graph API. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| OnlineMeetings.ReadWrite | Delegado | Los únicos datos utilizados son la confirmación explícita por parte de los usuarios para permitir que la aplicación use un token de acceso para llamar al Graph API. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| User.Read | Delegado | Los únicos datos utilizados son la confirmación explícita por parte de los usuarios para permitir que la aplicación use un token de acceso para llamar al Graph API. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
