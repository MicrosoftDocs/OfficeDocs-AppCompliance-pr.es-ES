---
title: Información de la aplicación para Orca por ORCA SECURITY LTD
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Orca, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/50423b81-408b-4699-a850-9a0514ee42c3" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004132" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por ORCA SECURITY LTD a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Orca |
| ID | WA200004132 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | ORCA SECURITY LTD |
| Sitio web de la empresa | [https://orca.security](https://orca.security) |
| Términos de uso de la aplicación | [https://orca.security/terms-of-use](https://orca.security/terms-of-use) |
| Funcionalidad básica de la aplicación | La seguridad de Orca para Microsoft Teams proporciona una imagen en tiempo real del estado de seguridad del entorno en la nube. Con ambas herramientas combinadas en una vista, los usuarios pueden crear una discusión productiva sobre los problemas de seguridad en su entorno en la nube Las alertas de Orca detallan un riesgo específico en la nube que incluye los resultados del riesgo de seguridad y el recurso en la nube conectado que plantea el riesgo. |
...
ORCA SECURITY LTD ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Teams Id. de usuario, Id. de equipo, Nombre del equipo |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Teams Id. de usuario, Id. de equipo, Nombre del equipo |
...
| Fecha de certificación de SOC2 más reciente | 2022-04-01 |
...
| Dirección URL de la directiva de privacidad | https://orca.security/privacy-policy/ |
