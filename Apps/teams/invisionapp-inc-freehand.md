...
Información proporcionada por InVisionApp Inc. a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Freehand |
| Id. | WA104381362 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | InVisionApp Inc. |
...
| DIRECCIÓN URL de términos de uso | [https://www.invisionapp.com/legal/terms-of-service](https://www.invisionapp.com/legal/terms-of-service) |
...
InVisionApp Inc. proporciona esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
>Los registros de sistemas y aplicaciones se recopilan tanto en un sistema de administración de registros centralizado como en SIEM con acceso altamente restringido para modificar o eliminar datos. Siem también supervisa la intrusión, integridad, reputación de red y correlaciona esta información con eventos de cloudtrail. El sistema es supervisado por un equipo de seguridad dedicado y las alertas están configuradas para paginar al ingeniero de oncall 24/7. Los registros de ambos sistemas se mantienen durante un período de 1 año.

#### <a name="organizational-controls-for-data-stored-by-partner"></a>Controles organizativos para los datos almacenados por el partner

Describir cómo los administradores de la organización pueden controlar su información en sistemas asociados. Por ejemplo, eliminación, retención, auditoría, archivado, directiva de usuario final, etc.

>Las evaluaciones de riesgos de terceros se realizan en proveedores que procesan información personal. Las cláusulas se han agregado contractualmente para incluir el &#8220;derecho de auditoría&#8221; y la diligencia debida se vuelve a producir anualmente en función de factores de crítica y riesgo. Legal ha implementado addendums de protección de datos que se agregarán contractualmente cuando corresponda, así como estándares aceptables que cumplan los requisitos de InVision. (Tenga en cuenta que los subprocesadores no tendrían acceso a los datos del proyecto del cliente en formato no cifrado).
...
<iframe height='1020' title='Microsoft Cloud App Security Información' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/20788' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/20788" target="_blank">Ver en una pestaña nueva</a>
...
InVisionApp Inc. ha proporcionado esta información sobre cómo esta aplicación controla la autenticación, la autorización, los procedimientos recomendados de registro de aplicaciones y otros criterios de identidad.
