---
title: Información de la aplicación para DailyBot de DailyBot
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/20/2022
...
description: Toda la información de seguridad y cumplimiento disponible para DailyBot, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro de CSA STAR.
...
ms.locfileid: "66915662"
---
# <a name="dailybot"></a>DailyBot

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 27 de abril de 2022</p>

* <a href="https://teams.microsoft.com/l/app/82bfb2e1-cad3-4e99-8995-5d140f295ef2" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001492" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por DailyBot a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | DailyBot |
| ID | WA200001492 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | DailyBot |
| Sitio web de la empresa | [https://www.dailybot.com](https://www.dailybot.com) |
| Términos de uso de la aplicación | [https://www.dailybot.com/legal/terms-and-conditions](https://www.dailybot.com/legal/terms-and-conditions) |
| Funcionalidad básica de la aplicación | DailyBot reduce la necesidad de reuniones mediante la automatización de standups, informes de estado diarios, retrospectivas y revisiones periódicas. Realiza un seguimiento de la motivación del equipo y promueve comentarios positivos con kudos y apreciación. DailyBot incluye características adicionales para crear accesos directos o comandos y automatizar los flujos de trabajo de chat. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.dailybot.com/integrations/msteams](https://www.dailybot.com/integrations/msteams) |
...
DailyBot ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | User Email, Tenant ID, MS Team resource ID and name,, Team Channel IDs |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | User Email, Tenant ID, MS Team Resource Ids and Names, Team Channel IDs, Content of user responses collected by DailyBot's features and workflows, such as: Check-Ins, Surveys, Forms o Kudos. |
...
| Dirección URL de la directiva de privacidad | https://www.dailybot.com/legal/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | DailyBot requiere leer información básica de los usuarios de los equipos, esto se usa para proporcionar una buena experiencia de usuario en los procesos de incorporación y facilitar el proceso de invitación de miembros. | [82bfb2e1-cad3-4e99-8995-5d140f295ef2](../azure/82bfb2e1-cad3-4e99-8995-5d140f295ef2.md) |
