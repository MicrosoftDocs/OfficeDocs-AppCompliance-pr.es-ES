---
title: Información de la aplicación para contactos unificados por glueckkanja-gab AG
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Toda la información de seguridad y cumplimiento disponible para los contactos unificados, sus directivas de tratamiento de datos, su Microsoft Cloud App Security de catálogo de aplicaciones e información de seguridad y cumplimiento en el Registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/085251c0-aef3-11ea-bccf-6fc12269b243" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003877" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por glueckkanja-gab AG a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Contactos unificados |
| Id. | WA200003877 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | glueckkanja-gab AG |
| Sitio web de la compañía | [https://www.glueckkanja-gab.com/en](https://www.glueckkanja-gab.com/en) |
| Términos de uso de la aplicación | [https://www.glueckkanja-gab.com/en/products/unified-contact...](https://www.glueckkanja-gab.com/en/products/unified-contacts/terms-and-conditions) |
| Funcionalidad principal de la aplicación | Búsqueda unificada para Azure AD, sus contactos corporativos, Exchange Online y sus contactos personales. |
| Ubicación central de la empresa | Alemania |
| Página de información de la aplicación | [https://www.glueckkanja-gab.com/en/products/unified-contacts](https://www.glueckkanja-gab.com/en/products/unified-contacts) |
...
Glueckkanja-gab AG ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://www.glueckkanja-gab.com/en/products/unified-contacts/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Contacts.Read.Shared | delegado | Los contactos unificados requieren acceso a los datos de contacto en el inquilino del cliente para proporcionar funcionalidad básica. | [83ff0fe1-a544-4390-bd72-3aaaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |
>| Directory.Read.All | delegado | Los contactos unificados requieren acceso a los datos de contacto en el inquilino del cliente para proporcionar funcionalidad básica. | [83ff0fe1-a544-4390-bd72-3aaaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |
>| User.Read | delegado | Los contactos unificados requieren acceso a los datos de contacto en el inquilino del cliente para proporcionar funcionalidad básica. | [83ff0fe1-a544-4390-bd72-3aaaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |
