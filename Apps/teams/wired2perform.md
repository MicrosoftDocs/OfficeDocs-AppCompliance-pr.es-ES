---
title: Información de la aplicación para Wired2Perform by Wired2Perform
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Wired2Perform, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b08f369e-4927-4c66-b997-e1086df7970d" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002935" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Wired2Perform |
| Sitio web de la empresa | [https://wired2perform.com](https://wired2perform.com) |
| Términos de uso de la aplicación | [https://wired2perform.com/terms-conditions](https://wired2perform.com/terms-conditions) |
| Funcionalidad básica de la aplicación | Wired2Perform&#174;, una empresa orientada a propósito, combina la ciencia del comportamiento y el análisis avanzado para sincronizar a las personas con las mejores oportunidades disponibles y ayudar a los líderes de talento a crecer, optimizar y acceder a una fuerza de trabajo más adaptable. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://wired2perform.com](https://wired2perform.com) |
...
Wired2Perform ha proporcionado esta información sobre cómo recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
