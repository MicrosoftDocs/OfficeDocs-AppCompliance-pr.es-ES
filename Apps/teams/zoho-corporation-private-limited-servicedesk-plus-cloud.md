...
| Sitio web de la compañía | [https://www.manageengine.com/products/service-desk](https://www.manageengine.com/products/service-desk) |
| Términos de uso de la aplicación | [https://ondemand.manageengine.com/terms.html](https://ondemand.manageengine.com/terms.html) |
| Funcionalidad principal de la aplicación | ServiceDesk Plus es un software de administración del servicio de asistencia de TI saas. Con la gran cantidad de características para la administración de servicios de TI, ayuda a los administradores de TI a organizar eficazmente las operaciones de asistencia en la organización. De forma predeterminada, ServiceDesk Plus (nube) funciona con Azure AD. Para empezar, regístrate en ServiceDesk Plus (Nube) con una cuenta en la instancia de Azure AD. |
