---
title: Información de la aplicación para ServiceDesk Plus Cloud by Zoho Corporation Private Limited
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/10/2022
...
description: Toda la información de seguridad y cumplimiento disponible para ServiceDesk Plus Cloud, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/04fdcea1-3511-499c-966d-099d59aef45f" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000037" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://www.manageengine.com/products/service-desk](https://www.manageengine.com/products/service-desk) |
| Términos de uso de la aplicación | [https://ondemand.manageengine.com/terms.html](https://ondemand.manageengine.com/terms.html) |
| Funcionalidad básica de la aplicación | ServiceDesk Plus es un software de administración del departamento de soporte técnico de TI de SaaS. Con la gran cantidad de características para la administración de servicios de TI, ayuda a los administradores de TI a organizar eficazmente las operaciones del departamento de soporte técnico dentro de la organización. De forma predeterminada, ServiceDesk Plus (Cloud) funciona con Azure AD. Para empezar, regístrese en ServiceDesk Plus (nube) mediante una cuenta en la instancia de Azure AD. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | Delegado | Iniciar sesión y leer el perfil del usuario | [127e5be9-da2c-4335-a284-da367379428a](/microsoft-365-app-certification/azure/39cb9f28-b9d0-4bf7-a4f4-d9e38508a0db) |
>| offline_access | Delegado | Mantener el acceso a los datos a los que se le ha concedido acceso | [127e5be9-da2c-4335-a284-da367379428a](/microsoft-365-app-certification/azure/39cb9f28-b9d0-4bf7-a4f4-d9e38508a0db) |
