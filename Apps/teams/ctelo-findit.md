---
title: Información de la aplicación para Findit por CTELO
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Findit, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64881374"
---
# <a name="findit"></a>Findit

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 25 de enero de 2022</p>

* <a href="https://teams.microsoft.com/l/app/ccb8d21c-9c7b-492f-b372-438621384db8" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003849" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por CTELO a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Findit |
| Id. | WA200003849 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | CTELO |
| Sitio web de la empresa | [https://www.ctelo.com](https://www.ctelo.com) |
| Términos de uso de la aplicación | [https://www.ctelo.com/terms-conditions](https://www.ctelo.com/terms-conditions) |
| Funcionalidad básica de la aplicación | Busque espacios de calendario gratuitos para compañeros, Teams estado e información de contacto. |
...
CTELO ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Entradas de calendario e información de contacto. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | Delegado | Permitir que la aplicación lea eventos en calendarios de usuario. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| Contacts.Read | Delegado | Permitir que la aplicación lea los contactos del usuario. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| Group.Read.All | Delegado | Permitir que la aplicación lea grupos de usuarios. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| Presence.Read.All | Delegado | Permitir que la aplicación lea la información de presencia de todos los usuarios. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| User.Read | Delegado | Permitir que la aplicación lea el perfil de usuario. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| User.Read.All | Delegado | Permitir que la aplicación lea todos los perfiles de usuario. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
