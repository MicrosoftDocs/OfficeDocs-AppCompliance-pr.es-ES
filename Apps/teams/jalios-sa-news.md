---
title: 'Información de la aplicación para noticias : Jalios por Jalios SA'
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: 'Toda la información de seguridad y cumplimiento disponible para Noticias: Jalios, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el Registro CSA STAR.'
...
ms.locfileid: "64602663"
---
# <a name="news---jalios"></a>Noticias - Jalios

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: December 21, 2021</p>

* <a href="https://teams.microsoft.com/l/app/a8662bd0-31c6-4254-b48f-0f54d0b92fcb" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003889" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Jalios SA a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Noticias - Jalios |
| ID | WA200003889 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | Jalios SA |
| Sitio web de la compañía | [https://www.jalios.com](https://www.jalios.com) |
| Términos de uso de la aplicación | [https://jalios.com/msteams-app/termsofuse](https://jalios.com/msteams-app/termsofuse) |
| Funcionalidad principal de la aplicación | Periódico de la empresa digital dinámico y personalizable
 |
...
Esta información ha sido proporcionada por Jalios SA sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿El entorno tiene algún software o sistemas operativos no compatibles? | Sí |
...
| Dirección URL de la directiva de privacidad | https://jalios.com/msteams-app/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | delegado | Leer una propiedad de extensión de esquema personalizada  | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
>| User.Read | delegado | Leer datos de usuario para iniciar sesión en el centro de trabajo de Jalios | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
>| offline_access | delegado | SSO: mantener el acceso a los datos | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
>| OpenID | delegado | Inicio de sesión de los usuarios | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
