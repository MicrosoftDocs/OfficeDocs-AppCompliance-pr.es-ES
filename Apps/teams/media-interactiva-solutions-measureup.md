---
title: Información de la aplicación para MeasureUp by Media Interactiva Solutions
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toda la información de seguridad y cumplimiento disponible para MeasureUp, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/bb1f94be-57aa-452c-9073-7fbb6b8b1797" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003111" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Media Interactiva Solutions |
| Sitio web de la empresa | [https://www.measureup.com](https://www.measureup.com) |
| Términos de uso de la aplicación | [https://www.measureup.com/legal-notice](https://www.measureup.com/legal-notice) |
| Funcionalidad básica de la aplicación | Evalúe las aptitudes de su equipo de forma más eficaz con MeasureUp. |
| Ubicación de la sede central de la empresa | España |
| Página de información de la aplicación | [https://docs.measureup.com](https://docs.measureup.com) |
...
Media Interactiva Solutions ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
