...
* <a href="https://teams.microsoft.com/l/app/bed170ee-dbd7-4efa-b48e-b0937ded1689" target="_blank">Ver en Teams tienda</a>
...
| Sitio web de la compañía | [https://www.neelix.team](https://www.neelix.team) |
| Términos de uso de la aplicación | [https://www.neelix.io/terms-of-use-en](https://www.neelix.io/terms-of-use-en) |
| Funcionalidad principal de la aplicación | La plataforma Neelix administra el bucle de comentarios como un ciclo completo. Los usuarios pueden canalizar experiencias continuas, comentarios retroactivos y opiniones en el diario de su equipo. |
...
Esta información ha sido proporcionada por Neelix.IO sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | delegado | la aplicación usa identificadores de canal y nombres para proporcionar comodidad a los usuarios para administrar sus preferencias predeterminadas al enviar comentarios de MS Treams | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| Team.ReadBasic.All | delegado | la aplicación usa identificadores de equipo y nombres para proporcionar comodidad a los usuarios para administrar sus preferencias predeterminadas al enviar comentarios de MS Treams | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| correo electrónico | delegado | el correo electrónico se usa como parte del registro del usuario dentro de Neelix. Después del registro inicial, el correo electrónico se usa para las notificaciones.  | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
...
>| User.Read | delegado | Bot app uses user.read in order to be able to send information user so that Neelix core platform can identify the user | [bed170ee-dbd7-4efa-b48e-b0937ded1689](../azure/bed170ee-dbd7-4efa-b48e-b0937ded1689.md) |
