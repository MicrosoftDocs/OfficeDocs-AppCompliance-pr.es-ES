...
description: Toda la información de seguridad y cumplimiento disponible para Neelix.Team, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64876297"
---
# <a name="neelixteam"></a>Neelix.Team

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 10 de julio de 2021</p>

* <a href="https://teams.microsoft.com/l/app/bed170ee-dbd7-4efa-b48e-b0937ded1689" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003047" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Neelix.IO |
| Sitio web de la empresa | [https://www.neelix.team](https://www.neelix.team) |
| Términos de uso de la aplicación | [https://www.neelix.io/terms-of-use-en](https://www.neelix.io/terms-of-use-en) |
| Funcionalidad básica de la aplicación | La plataforma Neelix administra el bucle de comentarios como un ciclo completo. Los usuarios pueden canalizar experiencias continuas, comentarios retrospectivos y opiniones en el diario de su equipo. |
| Ubicación de la sede central de la empresa | Australia |
| Página de información de la aplicación | [https://www.neelix.team](https://www.neelix.team) |
...
Esta información ha sido proporcionada por Neelix.IO sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Delegado | la aplicación usa nombres y identificadores de canal para proporcionar comodidad a los usuarios para administrar sus preferencias predeterminadas al enviar comentarios de MS Treams | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| Team.ReadBasic.All | Delegado | la aplicación usa nombres y identificadores de equipo para proporcionar comodidad a los usuarios para administrar sus preferencias predeterminadas al enviar comentarios de MS Treams | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| correo electrónico | Delegado | el correo electrónico se usa como parte del registro de usuario dentro de Neelix. Después del registro inicial, se usa el correo electrónico para las notificaciones.  | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| offline_access | Delegado | Esto se usa para obtener el token de actualización | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| perfil | Delegado | El nombre de usuario se usa para crear una cuenta de usuario al registrarse con Neelix.  | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| User.Read | Delegado | La aplicación bot usa user.read para poder enviar información al usuario para que la plataforma principal de Neelix pueda identificar al usuario. | [bed170ee-dbd7-4efa-b48e-b0937ded1689](../azure/bed170ee-dbd7-4efa-b48e-b0937ded1689.md) |
