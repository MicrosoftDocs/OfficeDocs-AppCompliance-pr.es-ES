---
title: Información de la aplicación para Ideanote por Ideanote ApS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Ideanote, sus directivas de tratamiento de datos, su Microsoft Cloud App Security de catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b18682e5-87f8-413a-9af4-be50bcee1049" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003876" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Ideanote ApS a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Ideanote |
| Id. | WA200003876 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | Ideanote ApS |
| Sitio web de la compañía | [https://ideanote.io](https://ideanote.io) |
| Términos de uso de la aplicación | [https://ideanote.io/legal/terms](https://ideanote.io/legal/terms) |
| Funcionalidad principal de la aplicación | Recopilar, desarrollar y administrar ideas con innovación basada en objetivos. |
| Ubicación central de la empresa | Dinamarca |
| Página de información de la aplicación | [https://ideanote.io](https://ideanote.io) |
...
Ideanote ApS ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Información sobre el token JWT obtenido del usuario. Nombre de usuario, Correo electrónico de usuario. |
...
| Dirección URL de la directiva de privacidad | https://ideanote.io/legal/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegado | Necesitamos información sobre el usuario para iniciar sesión automáticamente en la persona en su cuenta de Ideanote. | [d7db1079-6f45-4373-bb2b-ae5d71169b31](../azure/d7db1079-6f45-4373-bb2b-ae5d71169b31.md) |
