---
title: Información de la aplicación para el grupo de disponibilidad por adelantado
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/10/2022
...
description: Toda la información de seguridad y cumplimiento disponible para el futuro, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66549629"
---
# <a name="ahead"></a>ahead

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 20 de mayo de 2022</p>

* <a href="https://teams.microsoft.com/l/app/53360535-c93f-497f-b2a1-95bd9aa34283" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004202" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por el grupo de disponibilidad anticipada a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | ahead |
| ID | WA200004202 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | ahead AG |
| Sitio web de la empresa | [https://www.aheadintranet.com](https://www.aheadintranet.com) |
| Términos de uso de la aplicación | [https://www.aheadintranet.com/terms-and-conditions](https://www.aheadintranet.com/terms-and-conditions) |
| Funcionalidad básica de la aplicación | Aplicación de compromiso de empleados para mantener informados y comprometidos a los empleados. |
...
Este grupo de disponibilidad ha proporcionado esta información por adelantado sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Datos que son pertinentes para el correcto funcionamiento del producto de intranet futuro. Esto incluye, entre otros, noticias, historias, información relacionada con el contenido de destino a grupos de usuarios específicos, navegación y notificaciones. |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Datos que son pertinentes para el correcto funcionamiento del producto de intranet futuro. Esto incluye, entre otros, noticias, historias, información relacionada con el contenido de destino a grupos de usuarios específicos, navegación y notificaciones. Los datos relacionados con el usuario son copias de solo lectura de Azure AD. Esto está restringido al identificador y el nombre del usuario y su pertenencia a grupos de Azure AD que se han marcado como pertinentes por adelantado. |
...
| Dirección URL de la directiva de privacidad | https://www.aheadintranet.com/data-security |
...
| Enumerar los tipos de directivas admitidas | Aplicación cliente |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | Delegado | Noticias de destino según grupos de AD | [53360535-c93f-497f-b2a1-95bd9aaa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| Directory.Read.All | aplicación | Noticias de destino según grupos de AD, para inserción | [53360535-c93f-497f-b2a1-95bd9aaa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| ExternalItem.Read.All | Delegado | Buscar contenido de orígenes de terceros (ServiceNow) | [53360535-c93f-497f-b2a1-95bd9aaa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| Sites.Read.All | Delegado | Buscar contenido en sitios de SharePoint | [53360535-c93f-497f-b2a1-95bd9aaa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| User.Read | Delegado | Leer perfil de usuario | [53360535-c93f-497f-b2a1-95bd9aaa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| User.Read | Delegado | Leer perfil de usuario (imagen, etc.) | [53360535-c93f-497f-b2a1-95bd9aaa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| User.Read.All | Delegado | Leer perfil de usuario | [53360535-c93f-497f-b2a1-95bd9aaa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| User.Read.All | aplicación | Leer información de perfil en la búsqueda | [53360535-c93f-497f-b2a1-95bd9aaa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
