...
* <a href="https://teams.microsoft.com/l/app/b9370833-f71b-4f99-8343-adc3c29c74b1" target="_blank">Ver en Teams tienda</a>
...
| Sitio web de la compañía | [https://www.oktopost.com](https://www.oktopost.com) |
| Términos de uso de la aplicación | [https://www.oktopost.com/terms](https://www.oktopost.com/terms) |
| Funcionalidad principal de la aplicación | Oktopost es una plataforma de promoción de empleados y administración de redes sociales para B2B. Con Oktopost, puede administrar, supervisar y medir todas las actividades de redes sociales en un solo lugar. Oktopost tiene dos soluciones principales: 1) administración de redes sociales, incluida publicación, supervisión, análisis, participación y 2) promoción de empleados, lo que permite a los comercializadores administrar programas de uso compartido social para los empleados. La propuesta de valor único de Oktopost también permite a los comercializadores integrar datos sociales con la pila de marketing. |
| Ubicación central de la empresa | Israel |
| Página de información de la aplicación | [https://www.oktopost.com](https://www.oktopost.com) |
...
| Dirección URL de la directiva de privacidad | https://www.oktopost.com/privacy |
