---
title: Información de la aplicación de Offishall Planning by Offishall
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/17/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Offishall Planning, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65455080"
---
# <a name="offishall-planning"></a>Offishall Planning

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 31 de marzo de 2022</p>

* <a href="https://teams.microsoft.com/l/app/cbdfe641-3e2e-449d-b4f7-7e377c7060aa" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004048" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Offishall a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Offishall Planning |
| ID | WA200004048 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Offishall |
| Sitio web de la empresa | [https://www.offishall.io](https://www.offishall.io) |
| Términos de uso de la aplicación | [https://en.offishall.io/conditions-generales-dutilisation-d...](https://en.offishall.io/conditions-generales-dutilisation-du-compte) |
| Funcionalidad básica de la aplicación | Una solución flexible de planificación, programación y administración del lugar de trabajo para la oficina híbrida |
...
Offishall ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Eventos de calendario (si. el administrador elige habilitar Offishall - Calendario de Outlook Integration) ; Teams miembros del chat ; Correos electrónicos de usuario ; Nombres de usuario |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | correos electrónicos de usuario, nombres de usuario |
| Si la inestructura subyacente procesa o almacena datos de clientes de Microsoft, ¿dónde se almacenan geográficamente estos datos? | Alemania, Países Bajos (el), Francia |
...
| Dirección URL de la directiva de privacidad | https://www.offishall.io/politique-de-confidentialite |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | aplicación | Usamos los miembros de un canal para 1: aprovisionarlos si aún no son 2: capturar y mostrar su información de modo de trabajo  | [cbdfe641-3e2e-449d-b4f7-7e377c7060aaa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |
>| Directory.Read.All | aplicación | En caso de que no se establezca un correo electrónico de usuario, es necesario acceder a la lista de identidades para capturarlo. | [cbdfe641-3e2e-449d-b4f7-7e377c7060aaa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |
>| User.Read | Delegado | igual que anteriormente | [cbdfe641-3e2e-449d-b4f7-7e377c7060aaa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |
>| correo electrónico | Delegado | identificamos usuarios en función de su correo electrónico principal  | [cbdfe641-3e2e-449d-b4f7-7e377c7060aaa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |
>| offline_access | Delegado | es posible que deseemos capturar datos de los usuarios mientras está sin conexión | [cbdfe641-3e2e-449d-b4f7-7e377c7060aaa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |
>| OpenID | aplicación | para iniciar sesión de los usuarios | [cbdfe641-3e2e-449d-b4f7-7e377c7060aaa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |
>| perfil | Delegado | capturamos la información básica del perfil del usuario, solo almacenamos el correo electrónico y el nombre | [cbdfe641-3e2e-449d-b4f7-7e377c7060aaa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |
