---
title: Información de la aplicación para 365Projects by 365Apps
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/03/2022
...
description: Toda la información de seguridad y cumplimiento disponible para 365Projects, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/a9c31598-b014-4e20-b3bd-3d275fa738d3" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002160" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://365apps.com.au](https://365apps.com.au) |
| Términos de uso de la aplicación | [https://365projects.app/eula](https://365projects.app/eula) |
| Funcionalidad básica de la aplicación | Reunir los proyectos &amp; Microsoft Teams crear Project, conectarlo al canal existente o nuevo |
| Ubicación de la sede central de la empresa | Australia |
| Página de información de la aplicación | [https://365projects.app](https://365projects.app) |
...
365Apps ha proporcionado esta información sobre cómo recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | dirección de correo electrónico del cliente |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Tasks.ReadWrite | Delegado | tareas de planificador de lectura y actualización | [99a0a9b1-5d28-45df-9f99-792aaa32795f4](../azure/99a0a9b1-5d28-45df-9f99-792aa32795f4.md) |
>| User.Read | Delegado | leer el correo electrónico del usuario | [99a0a9b1-5d28-45df-9f99-792aaa32795f4](../azure/99a0a9b1-5d28-45df-9f99-792aa32795f4.md) |
