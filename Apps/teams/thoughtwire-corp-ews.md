...
| Términos de uso de la aplicación | [https://www.thoughtwire.com/end-user-license-agreement/](https://www.thoughtwire.com/end-user-license-agreement/) |
| Funcionalidad principal de la aplicación | La aplicación ThoughtWire admite EarlyWarning, una herramienta avanzada de detección e intervención que ha demostrado reducir los eventos azules de código en un 61 %. La solución de advertencia temprana está diseñada para detectar el deterioro del paciente en función de los signos vitales del paciente, notificar a los médicos de eventos de salud adversos y permitirles tomar medidas. El personal del equipo de respuesta tiene acceso al contexto del paciente y es consciente del estado y la disponibilidad del equipo que responde, lo que permite flujos de trabajo de respuesta y atención al paciente simplificados. |
