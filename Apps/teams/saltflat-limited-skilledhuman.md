---
title: Información de la aplicación para SkilledHuman de SaltFlat Limited
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2021
...
description: Toda la información de seguridad y cumplimiento disponible para SkilledHuman, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro de CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/7c44d518-b820-461c-bbbd-2cbbd83aa3bc" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002603" target="_blank">Vista en AppSource</a>
...
|:----------------|:-------------|
| Nombre de la aplicación | SkilledHuman |
| Id. | WA200002603 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | SaltFlat Limited |
| Sitio web de la empresa | [https://skilledhuman.org](https://skilledhuman.org) |
| Términos de uso de la aplicación | [https://skilledhuman.org/terms](https://skilledhuman.org/terms) |
| Funcionalidad básica de la aplicación | Professional Skills Framework |
| Ubicación de la sede central de la empresa | Reino Unido de Gran Bretaña e Irlanda del Norte (el) |
| Página de información de la aplicación | [https://skilledhuman.org/teamsapp](https://skilledhuman.org/teamsapp) |
...
SaltFlat Limited ha proporcionado esta información sobre cómo recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
