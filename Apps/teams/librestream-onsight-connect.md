...
description: Toda la información de seguridad y cumplimiento disponible para Onsight Conectar, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64876337"
---
# <a name="onsight-connect"></a>Onsight Connect

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 13 de abril de 2021</p>

* <a href="https://teams.microsoft.com/l/app/c01f5608-4ade-4749-aafa-9e5449a5bcb4" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002769" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Librestream a Microsoft:
...
| Nombre de la empresa asociada | Librestream |
| Sitio web de la empresa | [https://librestream.com](https://librestream.com) |
| Términos de uso de la aplicación | [https://librestream.com/support-archives/software-eula/](https://librestream.com/support-archives/software-eula/) |
| Funcionalidad básica de la aplicación | Mejore su estrategia de transformación digital para capacitar a sus trabajadores y clientes con acceso inmediato al contenido, las personas, los datos inteligentes y las instrucciones necesarias para inspeccionar y resolver problemas rápidamente. Implementada globalmente, la Plataforma de Realidad Aumentada de Onsight aumenta la eficiencia operativa en sectores como la fabricación, aviación, energía, equipos pesados y servicio de campo. |
...
Librestream ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
