...
description: Toda la información de seguridad y cumplimiento disponible para Kaptain Charlie, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/1f36eaf6-30a3-4488-a73f-4754b91e865d" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001583" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://en.askr.ai](https://en.askr.ai) |
| Términos de uso de la aplicación | [https://en.askr.ai/terms-of-use-askr-ai](https://en.askr.ai/terms-of-use-askr-ai) |
| Funcionalidad básica de la aplicación | Chatear con sus datos ! askR.ai es su asistente de datos personales Tiene datos pero no le gusta el proceso técnico para acceder a ellos? Use un asistente de datos para responder a sus preguntas y ayudarle a explorar ! ¿Qué askR.ai, el primer asistente de datos en Microsoft Teams? - Asistente para datos personales con tecnología de inteligencia artificial: proporciona KPI y viz de datos instantáneos: comprende el vocabulario empresarial específico- Enviar alertas- Sugerirle análisis adicionales |
| Ubicación de la sede central de la empresa | Francia |
| Página de información de la aplicación | [https://en.askr.ai](https://en.askr.ai) |
...
Esta información la ha proporcionado askR.ai sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://en.askr.ai/terms-of-use-askr-ai |
...
| Si la aplicación no usa una de las bibliotecas anteriores, ¿qué biblioteca o bibliotecas de autenticación usa? | Biblioteca de OAuth |
