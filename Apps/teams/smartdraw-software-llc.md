---
title: Información de la aplicación para SmartDraw por SmartDraw Software, LLC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: Toda la información de seguridad y cumplimiento disponible para SmartDraw, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b1879f1f-dba8-49d6-81a1-21ec15e4f94b" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003505" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por SmartDraw Software, LLC a Microsoft:
...
| Nombre de la empresa asociada | SmartDraw Software, LLC |
| Sitio web de la empresa | [https://www.smartdraw.com](https://www.smartdraw.com) |
...
| Funcionalidad básica de la aplicación | Herramienta sencilla &amp; y eficaz para crear diagramas de flujo, UML, ERD, diagramas técnicos y mucho más. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.smartdraw.com/features](https://www.smartdraw.com/features) |
...
Esta información ha sido proporcionada por SmartDraw Software, LLC sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | metadatos de autenticación de sso, token de oauth  |
...
| Fecha de certificación de SOC2 más reciente | 2020-11-30 |
