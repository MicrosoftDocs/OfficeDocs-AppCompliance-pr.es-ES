---
title: Información de la aplicación para asistente de Aros Cloud ApS
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
description: 'Toda la información de seguridad y cumplimiento disponible para Attender, sus directivas de tratamiento de datos, su Microsoft Cloud App Security del catálogo de aplicaciones e información de seguridad y cumplimiento en el Registro CSA STAR.'
...
* <a href="https://teams.microsoft.com/l/app/30b8d518-2535-4919-ab8b-d0fab193380f" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003856" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Aros Cloud ApS a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Attender |
| ID | WA200003856 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | Aros Cloud ApS |
| Sitio web de la compañía | [https://www.attender.uk](https://www.attender.uk) |
| Términos de uso de la aplicación | [https://www.attender.uk/wp-content/uploads/2022/02/Terms-of...](https://www.attender.uk/wp-content/uploads/2022/02/Terms-of-use.pdf) |
| Funcionalidad principal de la aplicación | Registro de asistencia rápida para la escuela que reduce la deserción de alumnos y ahorra tiempo de enseñanza. |
| Ubicación central de la empresa | Dinamarca |
| Página de información de la aplicación | [https://www.attender.uk](https://www.attender.uk) |
...
Aros Cloud ApS ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Nombre UPN de usuarios, Nombre para mostrar de usuarios, Datos de asistencia de estudiantes, Imágenes de perfil de alumnos, Profesores y datos de horarios de alumnos |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Nombre UPN de usuarios, Nombre para mostrar de usuarios, Datos de asistencia de estudiantes, Imágenes de perfil de alumnos, Profesores y datos de horarios de alumnos |
| Si la infastructure subyacente procesa o almacena datos de clientes de Microsoft, ¿dónde se almacenan geográficamente estos datos? | Dinamarca |
...
| Dirección URL de la directiva de privacidad | https://www.attender.uk/wp-content/uploads/2022/02/Privacy-Statement.pdf |
...
| Enumerar los tipos de directivas admitidas | Todos los admitidos por Azure AD |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | delegado | Determinar el rol de usuario | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| GroupMember.Read.All | delegado | Determinar el rol de usuario | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| User.Read | delegado | Inicio de sesión | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| correo electrónico | delegado | Obtener el nombre de inicio de sesión de los usuarios. | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| OpenID | delegado | Inicio de sesión único | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| perfil | delegado | Información de usuario | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
