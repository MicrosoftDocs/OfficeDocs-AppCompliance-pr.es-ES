---
title: Información de la aplicación para la administración de servicios efecte por Efecte Oyj
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
description: Toda la información de seguridad y cumplimiento disponible para efecte Service Management, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "63553609"
---
# <a name="efecte-service-management"></a>Administración de servicios de Efecte

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: January 24, 2022</p>

* <a href="https://teams.microsoft.com/l/app/1c20b1ea-7f9f-496a-a577-8b1bb1a28228" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003830" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Efecte Oyj a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Administración de servicios de Efecte |
| ID | WA200003830 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | Efecte Oyj |
| Sitio web de la compañía | [https://www.efecte.com](https://www.efecte.com) |
| Términos de uso de la aplicación | [https://www.efecte.com/terms-of-service](https://www.efecte.com/terms-of-service) |
| Funcionalidad principal de la aplicación | Recibir notificaciones sobre nuevos vales en Efecte Service Management (ESM) |
| Ubicación central de la empresa | Finlandia |
| Página de información de la aplicación | [https://www.efecte.com/ms-teams-integration](https://www.efecte.com/ms-teams-integration) |
| ¿Cuál es el entorno de hospedaje o el modelo de servicio que se usa para ejecutar la aplicación? | Paas |
| ¿Qué proveedores de nube de hospedaje usa la aplicación? | Azure, Other |
...
Efecte Oyj ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://www.efecte.com/privacy-policy |
