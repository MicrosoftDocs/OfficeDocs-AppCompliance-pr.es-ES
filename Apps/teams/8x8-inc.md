...
description: Toda la información de seguridad y cumplimiento disponible para 8x8, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
<p>Última actualización del desarrollador: 10 de junio de 2021</p>

* <a href="https://teams.microsoft.com/l/app/bab6487a-dbe6-426f-b329-b7ef0d0fd5ba" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002665" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por 8x8, Inc a Microsoft:
...
| Nombre de la empresa asociada | 8x8, Inc. |
| Sitio web de la empresa | [https://www.8x8.com](https://www.8x8.com) |
| Términos de uso de la aplicación | [https://www.8x8.com/terms-and-conditions](https://www.8x8.com/terms-and-conditions) |
| Funcionalidad básica de la aplicación | 8x8 Voice es un servicio de enrutamiento directo basado en la nube para realizar o recibir llamadas RTC. Una experiencia nativa con funcionalidades de telefonía de nivel empresarial y centro de contactos. Planes de llamadas ilimitados en 47 países + servicio de reemplazo RTC en 43 países, Análisis, SMS, MMS y Fax. Obtenga planes de llamada económicos de forma local o internacional y amplíe las llamadas RTC a los países donde Microsoft no&#8217;aún no ofrece planes, para sacar el máximo partido de Microsoft 365. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.8x8.com/products/integrations/8x8-voice-for-mic...](https://www.8x8.com/products/integrations/8x8-voice-for-microsoft-teams) |
| ¿Cuál es el entorno de hospedaje o el modelo de servicio que se usa para ejecutar la aplicación? |  |
| ¿Qué proveedores de nube de hospedaje usa la aplicación? | AWS, OracleCloud |
...
Esta información ha sido proporcionada por 8x8, Inc sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
