---
title: Información de la aplicación para el bot RFPIO de RFPIO
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: Toda la información de seguridad y cumplimiento disponible para el bot RFPIO, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/77c23de0-bcf9-4f27-91c9-135a82ee2543" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001880" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | RFPIO |
| Sitio web de la empresa | [https://www.rfpio.com](https://www.rfpio.com) |
| Términos de uso de la aplicación | [https://www.rfpio.com/terms-of-service/](https://www.rfpio.com/terms-of-service/) |
| Funcionalidad básica de la aplicación | RFPIO es la solución líder de administración de respuestas RFP y el primer software RFP habilitado para IA del sector, en el que confían algunas de las empresas más inteligentes del mundo para administrar respuestas a RFP, RFIs, cuestionarios de seguridad y DDQs.  |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.rfpio.com/product/](https://www.rfpio.com/product/) |
| ¿Cuál es el entorno de hospedaje o el modelo de servicio que se usa para ejecutar la aplicación? |  |
| ¿Qué proveedores de nube de hospedaje usa la aplicación? | Azure, AWS, GCP |
...
RFPIO ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2021-05-17 |
...
| Enumerar los tipos de directivas admitidas | Multifactor, restricción de IP |
