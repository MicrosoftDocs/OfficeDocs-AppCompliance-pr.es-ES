---
title: Información de la aplicación para Wurqi por Wurqi
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Wurqi, sus directivas de control de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65938809"
---
# <a name="wurqi"></a>Wurqi

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 11 de febrero de 2022</p>

* <a href="https://teams.microsoft.com/l/app/5173558d-bfb0-40dd-b75c-3cfac117ce72" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004161" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Wurqi a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Wurqi |
| Id. | WA200004161 |
| Clientes de Office 365 admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Wurqi |
| Sitio web de la empresa | [https://wurqi.com](https://wurqi.com) |
| Términos de uso de la aplicación | [https://wurqi.com/terms/](https://wurqi.com/terms/) |
| Funcionalidad básica de la aplicación | Wurqi es una plataforma de gestión del trabajo que integra todo su trabajo, proyectos y comunicación. La aplicación Teams proporciona a los usuarios una página de solo vista que mostrará toda la información sobre el proyecto en el que están trabajando, lo que permite a todos los usuarios del equipo ver cómo progresan las cosas.  |
...
Wurqi ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Autenticación multifactor (MFA) habilitada para: | DNSManagement, CodeRepositories |
...
| Dirección URL de la directiva de privacidad | https://wurqi.com/privacy-policy/ |
