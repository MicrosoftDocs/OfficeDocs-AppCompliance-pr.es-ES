...
* <a href="https://teams.microsoft.com/l/app/273e3385-93c3-4054-8c03-328b8c3fd9af" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002623" target="_blank">Ver en AppSource</a>
...
| Nombre de la compañía asociada | SmileBack |
| Sitio web de la compañía | [https://smileback.com](https://smileback.com) |
| Términos de uso de la aplicación | [https://smileback.com/terms](https://smileback.com/terms) |
| Funcionalidad principal de la aplicación | SmileBack es una plataforma de satisfacción del cliente diseñada para proveedores de servicios administrados, soporte técnico y equipos de soporte técnico de TI. Nuestras herramientas de&#174; CSAT + NPS ayudan a los profesionales de IT a recopilar, informar y actuar en función de los comentarios de los clientes. CSAT (Encuesta de satisfacción del cliente) le ayuda a comprender la tasa de satisfacción del cliente actual, lo que le proporciona una medida instantánea y directa de cada interacción del cliente (vales de soporte técnico). El&#174; NPS (Puntuación neta de patrocinador) te ofrece información sobre la relación general del cliente. |
...
SmileBack ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
