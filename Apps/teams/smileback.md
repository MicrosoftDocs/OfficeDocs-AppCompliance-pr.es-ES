...
description: Toda la información de seguridad y cumplimiento disponible para SmileBack, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64880565"
---
# <a name="smileback"></a>SmileBack

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 12 de abril de 2021</p>

* <a href="https://teams.microsoft.com/l/app/273e3385-93c3-4054-8c03-328b8c3fd9af" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002623" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por SmileBack a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | SmileBack |
| Id. | WA200002623 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | SmileBack |
| Sitio web de la empresa | [https://smileback.com](https://smileback.com) |
| Términos de uso de la aplicación | [https://smileback.com/terms](https://smileback.com/terms) |
| Funcionalidad básica de la aplicación | SmileBack es una plataforma de satisfacción del cliente diseñada para proveedores de servicios administrados, soporte técnico y equipos de soporte técnico de TI. Nuestras herramientas de&#174; CSAT + NPS ayudan a los profesionales de TI a recopilar, informar y actuar sobre los comentarios de los clientes. CSAT (Encuesta de satisfacción del cliente) le ayuda a comprender su tasa actual de satisfacción del cliente, lo que le proporciona una medida instantánea y directa de cada interacción del cliente (vales de soporte técnico). NPS&#174; (Net Promoter Score) le proporciona información sobre la relación general con el cliente. |
...
| ¿Qué proveedores de nube de hospedaje usa la aplicación? | AWS, Heroku |
...
SmileBack ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
