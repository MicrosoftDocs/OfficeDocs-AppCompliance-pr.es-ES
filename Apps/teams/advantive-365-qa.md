---
title: Información de la aplicación para 365-QA by Advantive
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/03/2022
...
description: Toda la información de seguridad y cumplimiento disponible para 365-QA, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64881027"
---
# <a name="365-qa"></a>365-QA

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 28 de diciembre de 2021</p>

* <a href="https://teams.microsoft.com/l/app/03e51569-33a8-4000-abb6-9a825e33ece2" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001394" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Advantive a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | 365-QA |
| Id. | WA200001394 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Advantive |
| Sitio web de la empresa | [https://www.advantive.be](https://www.advantive.be) |
| Términos de uso de la aplicación | [https://www.advantive.be/terms-of-service-en/](https://www.advantive.be/terms-of-service-en/) |
| Funcionalidad básica de la aplicación | Advantive es un equipo entusiasta de profesionales de TIC, que usan la tecnología de Microsoft para desarrollar e implementar soluciones de TIC innovadoras. Ofrecemos asesoramiento, productos y servicios de alta calidad basados en la funcionalidad estándar de Microsoft. Esto permite a los clientes de Adventive&#8217;aumentar su eficiencia y aprovechar las circunstancias que cambian rápidamente. Nuestro negocio principal es proporcionar servicios que incluyen asesoramiento, desarrollo, implementación, soporte técnico y mantenimiento de proyectos. |
| Ubicación de la sede central de la empresa | Bélgica |
| Página de información de la aplicación | [https://www.advantive.be/365-qa-how-to/](https://www.advantive.be/365-qa-how-to/) |
...
Advantive ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
