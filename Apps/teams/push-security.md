---
title: Información de la aplicación para la seguridad de inserción mediante la seguridad de inserción
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Push Security, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "66817733"
---
# <a name="push-security"></a>Inserción de seguridad
...
* <a href="https://teams.microsoft.com/l/app/db06ca6c-96a2-48ef-804e-54295b5c035a" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002833" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Push Security a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Inserción de seguridad |
| ID | WA200002833 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Inserción de seguridad |
| Sitio web de la empresa | [https://pushsecurity.com](https://pushsecurity.com) |
| Términos de uso de la aplicación | [https://pushsecurity.com/legal/terms/](https://pushsecurity.com/legal/terms/) |
| Funcionalidad básica de la aplicación | Ayudamos a las empresas a ser más productivas con SaaS al equipar a los empleados para que usen aplicaciones de forma segura. |
| Ubicación de la sede central de la empresa | Reino Unido de Gran Bretaña e Irlanda del Norte (el) |
| Página de información de la aplicación | [https://pushsecurity.com/kb/10004/](https://pushsecurity.com/kb/10004/) |
...
Push Security ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Push procesa el horario laboral del cliente para proporcionar alertas cuando el cliente está trabajando.  |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Push almacena el horario laboral del cliente para proporcionar alertas cuando el cliente está trabajando.  |
...
| Dirección URL de la directiva de privacidad | https://pushsecurity.com/legal/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | aplicación | Enumerar canales para facilitar la instalación del bot  | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| MailboxSettings.Read | aplicación | Consultar las horas de trabajo del cliente para que no se les haga un mensaje después del horario laboral | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| Team.ReadBasic.All | aplicación | Enumerar los equipos para facilitar la instalación del bot  | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| TeamsAppInstallation.ReadWriteSelfForTeam.All | aplicación | Permitir que el bot se instale por sí mismo para un equipo | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | aplicación | Permitir que el bot se instale por sí mismo para un usuario | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| User.Read.All | aplicación | Enumeración de usuarios para que podamos enviarles un mensaje | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
