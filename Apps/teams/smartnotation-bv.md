---
title: Información de la aplicación para Smartnotation de Smartnotation B.V.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/09/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Smartnotation, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/424b1333-fbf0-4941-acbe-336bf1f316ae" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000681" target="_blank">Vista en AppSource</a>
...
| Sitio web de la empresa | [https://www.smartnotation.com/landing/](https://www.smartnotation.com/landing/) |
| Términos de uso de la aplicación | [https://www.smartnotation.com/public/tos.pdf](https://www.smartnotation.com/public/tos.pdf) |
| Funcionalidad básica de la aplicación | Smartnotation es una solución de minutos de reunión habilitada para voz y fácil de usar. Sus notas, acciones y decisiones son fáciles de administrar y su información siempre está disponible. Sobre todo, elimina la sobrecarga innecesaria que le permite a usted y a su equipo centrarse en su negocio principal. Puede integrar Smartnotation completamente con MS Teams. Agregue un conector para recibir notificaciones de todas las actualizaciones importantes, nuevas notas, acciones y decisiones de un proyecto específico, configure una pestaña o use Smartnotation directamente. |
| Ubicación de la sede central de la empresa | Países Bajos (el) |
| Página de información de la aplicación | [https://www.smartnotation.com/landing/integrations/](https://www.smartnotation.com/landing/integrations/) |
| ¿Cuál es el entorno de hospedaje o el modelo de servicio que se usa para ejecutar la aplicación? |  |
| ¿Qué proveedores de nube de hospedaje usa la aplicación? | Totaaldomein B.V. |
...
Esta información ha sido proporcionada por Smartnotation B.V. acerca de cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
