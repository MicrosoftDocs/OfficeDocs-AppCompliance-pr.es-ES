---
title: Información de la aplicación para FactSet por FactSet Research Systems Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/24/2021
...
description: Toda la información de seguridad y cumplimiento disponible para FactSet, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/95fb5da0-6ced-4247-9d62-294f8fcb75df" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002146" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | FactSet Research Systems Inc. |
| Sitio web de la empresa | [https://www.factset.com](https://www.factset.com) |
| Términos de uso de la aplicación | [https://www.factset.com/hubfs/Misc/FactSet%20Teams%20Terms%...](https://www.factset.com/hubfs/Misc/FactSet%20Teams%20Terms%20of%20Use.pdf) |
| Funcionalidad básica de la aplicación | Con FactSet para Microsoft Teams, recibirá resúmenes de noticias seleccionadas de StreetAccount para que pueda mantenerse al tanto de las historias clave que afectan a los mercados globales. Puede consultar factSet&#8217;contenido líder del sector para obtener información detallada de la empresa y compartirla con compañeros y grupos, lo que permite una colaboración sin esfuerzo sin cambiar entre aplicaciones. |
...
Esta información ha sido proporcionada por FactSet Research Systems Inc. sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | aplicación | Nombre y correo electrónico para la verificación y el registro, identificador de conversación para el envío de mensajes proactivo | [95fb5da0-6ced-4247-9d62-294f8fcb75df](../azure/95fb5da0-6ced-4247-9d62-294f8fcb75df.md) |
