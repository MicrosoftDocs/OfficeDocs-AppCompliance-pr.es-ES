---
title: Información de solicitud para Passport 360 by Passport 360
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Passport 360, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/585570bb-e996-4b0b-89cf-0b5d610ecb65" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004322" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Passport 360 a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Passport 360 |
| ID | WA200004322 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Passport 360 |
| Sitio web de la empresa | [https://www.passport360.com](https://www.passport360.com) |
| Términos de uso de la aplicación | [https://www.passport360.com/privacy-policy/](https://www.passport360.com/privacy-policy/) |
| Funcionalidad básica de la aplicación | Solución SaaS para digitalizar los procesos de salud y seguridad entre proveedores |
...
Passport 360 ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Id. de inquilino; nombre de principio de usuario |
| Si la inestructura subyacente procesa o almacena datos de clientes de Microsoft, ¿dónde se almacenan geográficamente estos datos? | Australia, Sudáfrica, Canadá |
...
| Dirección URL de la directiva de privacidad | https://www.passport360.com/privacy-policy-2/ |
