...
| Sitio web de la compañía | [https://www.zoho.com](https://www.zoho.com) |
| Términos de uso de la aplicación | [https://www.zoho.com/terms.html](https://www.zoho.com/terms.html) |
| Funcionalidad principal de la aplicación | Zoho Sign es una aplicación de firma digital segura basada en la nube que te permite firmar, enviar y administrar los documentos de tu empresa de forma legal y electrónica. Puede crear flujos de trabajo de firma electrónica sin esfuerzo para recopilar firmas, autenticar firmantes, desencadenar avisos y realizar un seguimiento del estado de firma y aprobación en tiempo real. Zoho Sign también te permite administrar todos los documentos directamente desde aplicaciones de Microsoft desde el explorador web y en cualquier lugar con aplicaciones móviles. |
| Ubicación central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.zoho.com/sign/help/teams-extension.html](https://www.zoho.com/sign/help/teams-extension.html) |
...
| Si la infastructure subyacente procesa o almacena datos de clientes de Microsoft, ¿dónde se almacenan geográficamente estos datos? | India, Japón, Australia, China, Países Bajos (el), Irlanda, Estados Unidos de América |
...
| Fecha de certificación SOC2 más reciente |  2021-11-30 |
...
| Enumerar los tipos de directivas admitidas | Multi-Factor Authentication, Requiring organization-managed devices for specific applications, Blocking risky sign-in behaviors, Limiting the access given to people other than the administrative roles  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | delegado | Iniciar sesión y leer el perfil del usuario | [a67ee0a9-b008-4e90-986d-1eb8d55a81d6](../azure/a67ee0a9-b008-4e90-986d-1eb8d55a81d6.md) |
