...
Información proporcionada por Sangoma a Microsoft:
...
Sangoma ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Registros de historial de llamadas (incluido el número, el nombre, el correo electrónico de contacto) para las llamadas iniciadas a través de la aplicación |
...
| Dirección URL de la directiva de privacidad | https://cdn.sangoma.com/wp-content/uploads/Privacy-Policy.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read.All | delegado | Realizar búsqueda de contactos de directorio |
>| Group.Read.All | delegado | Realizar la resolución de miembros del grupo |
>| Chat.Read | delegado | Realizar resolución de miembros de chat |
