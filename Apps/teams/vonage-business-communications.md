---
title: Información de la aplicación para las comunicaciones empresariales de Vonage de Vonage
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/05/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Vonage Business Communications, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/47c6b242-a067-426c-9a02-0f680a42c488" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002988" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Vonage |
| Sitio web de la empresa | [https://www.vonage.com](https://www.vonage.com) |
| Términos de uso de la aplicación | [https://www.vonage.com/legal/unified-communications/tos/glo...](https://www.vonage.com/legal/unified-communications/tos/global-vbc-tos/) |
| Funcionalidad básica de la aplicación | Vonage Business Communications para Teams permite llamadas, SMS y MMS con enrutamiento directo de Vonage. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.vonage.com/unified-communications/](https://www.vonage.com/unified-communications/) |
...
Vonage ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2021-01-01 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | aplicación | No se almacenan datos con este permiso | [1d8a304e-ea67-4aa2-9345-2793419cf83f](../azure/1d8a304e-ea67-4aa2-9345-2793419cf83f.md) |
>| User.Read | Delegado | Obtener el identificador de usuario y el identificador de inquilino de Azure, para que podamos enviar notificaciones más adelante a este usuario. | [1d8a304e-ea67-4aa2-9345-2793419cf83f](../azure/1d8a304e-ea67-4aa2-9345-2793419cf83f.md) |
