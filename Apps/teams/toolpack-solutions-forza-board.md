---
title: Información de la aplicación para Forza Board by Toolpack Solutions
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Forza Board, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/b4db3055-5e98-4935-862e-7ffd42761eaa" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004274" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Toolpack Solutions a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Forza Board |
| ID | WA200004274 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Soluciones de Toolpack |
| Sitio web de la empresa | [https://www.toolpack365.com](https://www.toolpack365.com) |
| Términos de uso de la aplicación | [https://www.toolpack365.com/kontakt-og-vilkaar](https://www.toolpack365.com/kontakt-og-vilkaar) |
| Funcionalidad básica de la aplicación | Libere su potencial con un KPI inteligente e informes para una mejor colaboración. |
...
Esta información ha sido proporcionada por Toolpack Solutions sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | correo electrónico y nombre |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | correo electrónico y nombre |
...
| Dirección URL de la directiva de privacidad | https://www.toolpack365.com/cookie-og-privatlivspolitik |
