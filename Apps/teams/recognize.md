---
title: Información de la aplicación para reconocer por reconocimiento
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/11/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Recognize, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
---
# <a name="recognize"></a>Reconocer

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 11 de mayo de 2022</p>

* <a href="https://teams.microsoft.com/l/app/bbcb7b0c-c687-4be0-91e3-362afebbbcd0" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001519" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Recognize to Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Reconocer |
| ID | WA200001519 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Reconocer |
| Sitio web de la empresa | [https://recognizeapp.com](https://recognizeapp.com) |
| Términos de uso de la aplicación | [https://recognizeapp.com/terms](https://recognizeapp.com/terms) |
| Funcionalidad básica de la aplicación | Una plataforma de compromiso de empleados con reconocimiento del mismo nivel, nominaciones, recompensas, &amp; certificados de premio. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://recognizeapp.com](https://recognizeapp.com) |
...
Recognize ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://recognizeapp.com/privacy |
