---
title: Información de la aplicación para GitHub por Microsoft Corporation
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2021
...
description: Toda la información de seguridad y cumplimiento disponible para GitHub, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/ca9e26b7-dce5-44a0-b2b7-a70a3d65ce25" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002077" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Microsoft Corporation |
| Sitio web de la empresa | [https://github.com](https://github.com) |
| Términos de uso de la aplicación | [https://github.com/site/terms](https://github.com/site/terms) |
| Funcionalidad básica de la aplicación | GitHub es una plataforma de hospedaje de código para la colaboración y el control de versiones. Permite a los desarrolladores trabajar juntos en sus proyectos, desde la planificación y codificación hasta el envío del software. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://teams.github.com](https://teams.github.com) |
...
Microsoft Corporation ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
