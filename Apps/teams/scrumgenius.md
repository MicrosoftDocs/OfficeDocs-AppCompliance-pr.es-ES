...
>| User.Read | delegado | Nombre del usuario y dirección de correo electrónico. | Para permitir que el usuario inicie sesión con Inicio de sesión de Microsoft. |  |
