---
title: Información de la aplicación para Sift by Sift
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/26/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Sift, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65125374"
---
# <a name="sift"></a>Sift

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 25 de abril de 2022</p>

* <a href="https://teams.microsoft.com/l/app/d2a1ed44-6cca-44d2-9b9c-1c9c1d597093" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002545" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Sift a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Sift |
| Id. | WA200002545 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Sift |
| Sitio web de la empresa | [https://www.justsift.com](https://www.justsift.com) |
| Términos de uso de la aplicación | [https://www.justsift.com/sift-msteams-eula](https://www.justsift.com/sift-msteams-eula) |
| Funcionalidad básica de la aplicación | Búsqueda, detección y conexión con los usuarios de la organización |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.justsift.com/integrating-sift/with-microsoft-te...](https://www.justsift.com/integrating-sift/with-microsoft-teams) |
...
Sift ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Nuestra aplicación Teams solicita información básica del perfil y consentimiento para ver los datos de reunión de los usuarios de Azure AD. También recopila voluntariamente información adicional del perfil de los usuarios para mejorar sus perfiles dentro de nuestra plataforma. |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | La información de perfil de usuario de Microsoft Graph se recopila si un usuario administrativo concede el consentimiento. |
...
| **Information** | **Respuesta** |
|:----------------|:-------------|
| ¿La aplicación cumple con la Ley de portabilidad y contabilidad de seguros de salud (HIPAA)? | No aplicable |
...
| Fecha de certificación de SOC2 más reciente | 2022-04-25 |
...
| Dirección URL de la directiva de privacidad | https://www.justsift.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | Delegado | Recuperamos información de grupo de Graph con el fin de filtrar los usuarios recuperados por grupo | [270b510a-7cfb-4a9a-8071-5ceab03cf357](../azure/270b510a-7cfb-4a9a-8071-5ceab03cf357.md) |
>| User.Read.All | Delegado | Recuperamos objetos User de Graph con el fin de aprovisionar y actualizar de forma coherente los perfiles de los empleados en nuestro producto. | [270b510a-7cfb-4a9a-8071-5ceab03cf357](../azure/270b510a-7cfb-4a9a-8071-5ceab03cf357.md) |
>| OnlineMeetingArtifact.Read.All | Delegado | Para nuestra extensión de reuniones en nuestra aplicación de Teams, necesitamos el permiso para recuperar información sobre los participantes de la reunión. | [d2a1ed44-6cca-44d2-9b9c-1c9c1d597093](../azure/d2a1ed44-6cca-44d2-9b9c-1c9c1d597093.md) |
>| OnlineMeetings.Read | Delegado | Para nuestra extensión de reuniones en nuestra aplicación de Teams, necesitamos el permiso para recuperar información sobre los participantes de la reunión. | [d2a1ed44-6cca-44d2-9b9c-1c9c1d597093](../azure/d2a1ed44-6cca-44d2-9b9c-1c9c1d597093.md) |
