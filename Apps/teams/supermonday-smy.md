---
title: Información de la aplicación para Smy by Supermonday
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Smy, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro de CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/2858d81b-9eb1-4ba1-a79b-b42390bb0015" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004190" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Supermonday a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Smy |
| ID | WA200004190 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Supermonday |
| Sitio web de la empresa | [https://supermonday.io](https://supermonday.io) |
| Términos de uso de la aplicación | [https://supermonday.io/conditions-generales-de-vente](https://supermonday.io/conditions-generales-de-vente) |
| Funcionalidad básica de la aplicación | Smy l'application de Supermonday pour Microsoft Teams |
...
Supermonday ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | usuario de Microsoft, grupos de Microsoft, disponibilidad del calendario de Outlook |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | microsoft user, microsoft group |
...
| Dirección URL de la directiva de privacidad | https://supermonday.io/politique-de-confidentialite |
