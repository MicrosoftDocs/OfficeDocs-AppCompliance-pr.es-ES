---
title: Información de la aplicación para el Asistente de TI de Avaamo por Avaamo
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/01/2021
...
description: Toda la información de seguridad y cumplimiento disponible para el Asistente de TI de Avaamo, sus directivas de tratamiento de datos, su información de catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el Registro CSA STAR.
...
ms.locfileid: "63538288"
---
# <a name="avaamo-it-assistant"></a>Asistente de IT de Avaamo

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: August 25, 2021</p>

* <a href="https://teams.microsoft.com/l/app/ed016582-bd1f-4994-ba97-49daab163b19" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003362" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Avaamo a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Asistente de IT de Avaamo |
| ID | WA200003362 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | Avaamo |
| Sitio web de la compañía | [https://avaamo.ai](https://avaamo.ai) |
| Términos de uso de la aplicación | [https://avaamo.ai/tos/](https://avaamo.ai/tos/) |
| Funcionalidad principal de la aplicación | Asistente de conversación inteligente que resuelve al instante Microsoft Office 365 consultas de soporte técnico. |
| Ubicación central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.avaamo.ai/who-is-avaamo/](https://www.avaamo.ai/who-is-avaamo/) |
...
Avaamo ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos se almacenan en las bases de datos? | Correo electrónico, nombre, apellido |
...
| Dirección URL de la directiva de privacidad | https://www.avaamo.ai/privacy/ |
