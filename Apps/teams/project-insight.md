---
title: Información de la aplicación para Project Insight de Project Insight
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/22/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Project Insight, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64879267"
---
# <a name="project-insight"></a>Project Insight

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 21 de marzo de 2022</p>

* <a href="https://teams.microsoft.com/l/app/57a8236b-4ed2-453e-b785-02a887e16a5b" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003171" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Project Insight a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Project Insight |
| Id. | WA200003171 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Project Insight |
| Sitio web de la empresa | [https://projectinsight.com](https://projectinsight.com) |
| Términos de uso de la aplicación | [https://projectinsight.com/legal/license-agreement](https://projectinsight.com/legal/license-agreement) |
| Funcionalidad básica de la aplicación | Project Insight permite a su equipo administrar su trabajo, proyectos, tiempo y gastos directamente desde Teams. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://projectinsight.com/features/microsoft-teams-integra...](https://projectinsight.com/features/microsoft-teams-integration) |
...
Esta información la ha proporcionado Project Insight sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | información básica del perfil de usuario |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | id. de cuenta de usuario |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser.All | Delegado | Para permitir que nuestra aplicación se instale para los usuarios del inquilino de Microsoft Teams | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
>| User.Read.All | Delegado | Coincidencia de usuarios entre el sistema y el inquilino de Microsoft Teams | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
>| offline_access | Delegado | Se usa para solicitar un token de actualización | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
