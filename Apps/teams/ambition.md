...
description: Toda la información de seguridad y cumplimiento disponible para Ambition, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro de CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/250ef61a-9fa3-434b-ae2a-0ecbe3f8116b" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003159" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Ambition to Microsoft:
...
| Nombre de la empresa asociada | Ambition |
| Sitio web de la empresa | [https://ambition.com](https://ambition.com) |
| Términos de uso de la aplicación | [https://ambition.com/pages/terms/](https://ambition.com/pages/terms/) |
| Funcionalidad básica de la aplicación | Software de gamificación y entrenamiento para equipos de ventas. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://ambition.com](https://ambition.com) |
...
Ambición ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC2 más reciente | 2021-02-01 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | Delegado | Enviar notificaciones de ambición al canal | [24a9cf21-407c-41f9-8cc6-e7015f4e02af](../azure/24a9cf21-407c-41f9-8cc6-e7015f4e02af.md) |
>| Group.Read.All | Delegado | Configure una notificación de flujo de trabajo de Ambición en un canal determinado dentro de un equipo. | [24a9cf21-407c-41f9-8cc6-e7015f4e02af](../azure/24a9cf21-407c-41f9-8cc6-e7015f4e02af.md) |
>| User.Read | Delegado | Para identificar al administrador que autorizó la aplicación Ambition | [24a9cf21-407c-41f9-8cc6-e7015f4e02af](../azure/24a9cf21-407c-41f9-8cc6-e7015f4e02af.md) |
>| User.ReadBasic.All | Delegado | Correos electrónicos de nombres &amp; de usuario para sincronizar usuarios con sus cuentas de Ambition. | [24a9cf21-407c-41f9-8cc6-e7015f4e02af](../azure/24a9cf21-407c-41f9-8cc6-e7015f4e02af.md) |
>| offline_access | Delegado | Para sincronizar Microsoft Teams datos mientras los usuarios están sin conexión. | [24a9cf21-407c-41f9-8cc6-e7015f4e02af](../azure/24a9cf21-407c-41f9-8cc6-e7015f4e02af.md) |
>| OpenID | Delegado | Esto es necesario para usar la característica de inicio de sesión de Microsoft | [24a9cf21-407c-41f9-8cc6-e7015f4e02af](../azure/24a9cf21-407c-41f9-8cc6-e7015f4e02af.md) |
