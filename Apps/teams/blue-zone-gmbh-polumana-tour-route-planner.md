---
title: Información de la aplicación para polumana Tour Route Planner by blue-zone GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Toda la información de seguridad y cumplimiento disponible para polumana Tour Route Planner, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/4b4b3e3d-a1eb-4b52-b0b9-ba1a79b6be79" target="_blank">Visualización en el almacén de Teams</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004331" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por blue-zone GmbH a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | polumana Tour Route Planner |
| ID | WA200004331 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | blue-zone GmbH |
| Sitio web de la empresa | [https://blue-zone.de](https://blue-zone.de) |
| Términos de uso de la aplicación | [https://azaap-disp-route-planning.azurewebsites.net/#/terms...](https://azaap-disp-route-planning.azurewebsites.net/#/termsofuse) |
| Funcionalidad básica de la aplicación | Polumana Tour &amp; Route Planner para aumentar la eficiencia en las visitas de los clientes |
...
Esta información ha sido proporcionada por blue-zone GmbH sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Contactos, dirección de correo electrónico |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | Correo electrónico, direcciones de contactos |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | aplicación | Después de la optimización de rutas, es necesario crear nuevas citas y eliminar las existentes. | [d361752a-c257-474d-bb79-324fbe4898b5](../azure/d361752a-c257-474d-bb79-324fbe4898b5.md) |
>| Contacts.Read | aplicación | Tenemos que leer los contactos para crear las citas | [d361752a-c257-474d-bb79-324fbe4898b5](../azure/d361752a-c257-474d-bb79-324fbe4898b5.md) |
>| User.Read | aplicación | Necesitamos obtener el correo electrónico del usuario para conservar la configuración. | [d361752a-c257-474d-bb79-324fbe4898b5](../azure/d361752a-c257-474d-bb79-324fbe4898b5.md) |
