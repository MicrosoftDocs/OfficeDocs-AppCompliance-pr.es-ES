---
title: Información de la aplicación para Micromate by Paixon GmbH
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Micromate, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/4112cc9a-d683-4ffd-b0bc-2013af7c7497" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002981" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Paixon GmbH |
| Sitio web de la empresa | [https://paixon.ch](https://paixon.ch) |
| Términos de uso de la aplicación | [https://micromate.ai/de/nutzungsbedingungen/](https://micromate.ai/de/nutzungsbedingungen/) |
| Funcionalidad básica de la aplicación | Micromate vermittelt durch personalisierte Lerneinheiten direkt im Chat nachhaltig Wissen. Micromate setzt dabei auf Microlearning durch die Ausspielung von Quizzes en Form von Adaptive Cards. Die pers&#246;nliche Ansprache des Lernenden, ein Tutorial zur Funktionsweise der App und die Integration spannender Gamification Elemente motivieren den Lernenden zur nachhaltigen Nutzung. |
| Ubicación de la sede central de la empresa | Suiza |
| Página de información de la aplicación | [https://micromate.ai/de/produkt/](https://micromate.ai/de/produkt/) |
| ¿Cuál es el entorno de hospedaje o el modelo de servicio que se usa para ejecutar la aplicación? |  |
| ¿Qué proveedores de nube de hospedaje usa la aplicación? | Escalado en la nube |
...
Paixon GmbH ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
