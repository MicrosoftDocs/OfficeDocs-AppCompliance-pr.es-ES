---
title: Información de la aplicación para preguntar a Vizir por Vizir.co
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/25/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Ask Vizir, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65069702"
---
# <a name="ask-vizir"></a>Preguntar a Vizir

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 22 de abril de 2022</p>

* <a href="https://teams.microsoft.com/l/app/7b0641d9-8e1f-4415-99da-c80f8c175c69" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003119" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Vizir.co a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Preguntar a Vizir |
| Id. | WA200003119 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Vizir.co |
| Sitio web de la empresa | [https://www.vizir.co](https://www.vizir.co) |
| Términos de uso de la aplicación | [https://vizir.co/mentions-legales](https://vizir.co/mentions-legales) |
| Funcionalidad básica de la aplicación | Preguntar al bot de Vizir ayuda a los usuarios de los equipos de Francia a usar Microsoft Office 365 productos. Hecho en asociación con Microsoft Francia |
| Ubicación de la sede central de la empresa | Francia |
| Página de información de la aplicación | [https://www.vizir.co](https://www.vizir.co) |
| ¿Cuál es el entorno de hospedaje o el modelo de servicio que se usa para ejecutar la aplicación? | Paas |
| ¿Qué proveedores de nube de hospedaje usa la aplicación? | OVH, Aws |
...
Esta información la ha proporcionado Vizir.co sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | correo electrónico de usuario, nombre, apellidos |
| ¿La aplicación admite TLS 1.1 o posterior? | Sí |
| ¿La aplicación o la infraestructura subyacente almacenan datos de clientes de Microsoft? | Sí |
| ¿Qué datos se almacenan en las bases de datos? | correo electrónico de usuario, nombre, apellidos |
| Si la inestructura subyacente procesa o almacena datos de clientes de Microsoft, ¿dónde se almacenan geográficamente estos datos? | Francia |
...
| Dirección URL de la directiva de privacidad | https://www.vizir.co/politique-confidentialite/ |
