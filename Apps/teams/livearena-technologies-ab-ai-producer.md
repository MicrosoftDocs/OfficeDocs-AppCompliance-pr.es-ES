...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | delegado | Para detectar las ediciones realizadas en una reunión y, por lo tanto, ajustar los recursos de las aplicaciones. La aplicación también puede actualizar el texto de invitación a la reunión si el organizador decide hacerlo a través de la aplicación. | [e7fb100c-8c81-4e3f-9c78-bb1407080cdc](../azure/e7fb100c-8c81-4e3f-9c78-bb1407080cdc.md) |
>| Calls.AccessMedia.All | aplicación | El productor de IA se unirá a la reunión como participante. Si se deja entrar en la reunión, leerá el audio y el vídeo de los participantes para poder producir una difusión fuera de la reunión. | [e7fb100c-8c81-4e3f-9c78-bb1407080cdc](../azure/e7fb100c-8c81-4e3f-9c78-bb1407080cdc.md) |
>| Calls.JoinGroupCallasGuest.All | aplicación | El productor de IA debe poder unirse a reuniones para poder crear difusión fuera de ellas. El productor de IA solo puede unirse a reuniones que tenga en cuenta, lo que significa que es una reunión a la que el organizador ha agregado a la aplicación. | [e7fb100c-8c81-4e3f-9c78-bb1407080cdc](../azure/e7fb100c-8c81-4e3f-9c78-bb1407080cdc.md) |
>| Chat.ReadWrite | delegado | La aplicación puede leer y escribir mensajes de chat a los participantes en la reunión. Si no se concede este permiso, no será posible usar la característica de &#8220;Messages&#8221; del productor de IA, pero la aplicación seguirá siendo capaz de realizar una difusión. La aplicación nunca lee mensajes de chat, pero no hay permiso para escribir solo. | [e7fb100c-8c81-4e3f-9c78-bb1407080cdc](../azure/e7fb100c-8c81-4e3f-9c78-bb1407080cdc.md) |
>| OnlineMeetings.ReadWrite | delegado | La aplicación usa este permiso cuando la aplicación se agrega a una reunión para leer información sobre quién está invitado a la reunión, cuándo comienza y finaliza, y el título de la reunión. Por ejemplo, la aplicación puede leer quién se ha unido a la reunión. También puede crear eventos en directo de reuniones y equipos en nombre del usuario. La aplicación crea una suscripción para supervisar los cambios en la reunión, es decir, si la reunión se reprograma o se quita. Habilita la recopilación de orígenes de vídeo correctos en la hora de reunión programada. | [e7fb100c-8c81-4e3f-9c78-bb1407080cdc](../azure/e7fb100c-8c81-4e3f-9c78-bb1407080cdc.md) |
>| User.ReadBasic.All | delegado | Este permiso se usa para leer el nombre, el puesto de trabajo, el correo electrónico, el nombre principal del usuario y la foto de perfil del usuario en la reunión. Más información sobre cómo se usa esta información en la sección Procesamiento de datos anterior. | [e7fb100c-8c81-4e3f-9c78-bb1407080cdc](../azure/e7fb100c-8c81-4e3f-9c78-bb1407080cdc.md) |
>| correo electrónico | delegado | Permite que la aplicación vea el perfil básico de los usuarios (nombre, imagen, nombre de usuario). | [e7fb100c-8c81-4e3f-9c78-bb1407080cdc](../azure/e7fb100c-8c81-4e3f-9c78-bb1407080cdc.md) |
>| offline_access | delegado | Permite que la aplicación lea y actualice los datos del usuario, incluso cuando no están usando en ese momento la aplicación. | [e7fb100c-8c81-4e3f-9c78-bb1407080cdc](../azure/e7fb100c-8c81-4e3f-9c78-bb1407080cdc.md) |
>| OpenID | delegado | Permite a los usuarios iniciar sesión en la aplicación con sus cuentas laborales o educativas y permite que la aplicación vea información básica del perfil de usuario. | [e7fb100c-8c81-4e3f-9c78-bb1407080cdc](../azure/e7fb100c-8c81-4e3f-9c78-bb1407080cdc.md) |
>| perfil | delegado | Permite que la aplicación lea la dirección de correo electrónico principal de los usuarios. | [e7fb100c-8c81-4e3f-9c78-bb1407080cdc](../azure/e7fb100c-8c81-4e3f-9c78-bb1407080cdc.md) |
