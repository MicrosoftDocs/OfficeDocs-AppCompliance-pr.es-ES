---
title: Información de la aplicación para DELTAoverC by DELTAoverC
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/30/2021
...
description: Toda la información de seguridad y cumplimiento disponible para DELTAoverC, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64878307"
---
# <a name="deltaoverc"></a>DELTAoverC

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 15 de noviembre de 2021</p>

* <a href="https://teams.microsoft.com/l/app/01b1eb1e-cb02-4a41-bb8d-6811bc514606" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003286" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | DELTAoverC |
| Sitio web de la empresa | [https://DELTAoverC.into](https://DELTAoverC.into) |
| Términos de uso de la aplicación | [https://go.microsoft.com](https://go.microsoft.com) |
| Funcionalidad básica de la aplicación | DELTAoverC está diseñado para respaldar el cambio y la transformación de la organización proporcionando a los líderes internos datos accionables y de nivel de equipo durante la iniciativa de cambio, lo que les permite abordar eficazmente las áreas de resistencia al cambio o baja participación. Maximizar la interacción: realice un seguimiento de las puntuaciones de interacción en tiempo real para garantizar que los equipos prosperen durante la interrupción. Reducir el riesgo y el esfuerzo: analice los datos de nivel de personal para anticipar problemas antes de que estas espirales se conviertan en grandes desafíos. |
| Ubicación de la sede central de la empresa | Canadá |
| Página de información de la aplicación | [https://DELTAoverC.info/change-application](https://DELTAoverC.info/change-application) |
...
DELTAoverC ha proporcionado esta información sobre cómo recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://DELTAoverC.info/terms |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | Ambos | Leer todos los grupos | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| Group.ReadWrite.All | Ambos | Leer y escribir en todos los grupos | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| User.Read | Delegado | Iniciar sesión y leer el perfil del usuario | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| User.Read.All | aplicación | Leer todos los perfiles completos de los usuarios | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| User.ReadWrite | Delegado | Acceso al perfil del usuario para la lectura y la escritura  | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| User.ReadWrite.All | Ambos | Leer y escribir todos los perfiles completos de los usuarios | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
