---
title: Información de la aplicación para wellness coach de Meditation.live, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Wellness Coach, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro de CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/9913e2ed-5c17-4d66-b9e7-439290238f29" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003037" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | Meditation.live, Inc. |
| Sitio web de la empresa | [https://welllnesscoach.live](https://welllnesscoach.live) |
| Términos de uso de la aplicación | [https://www.wellnesscoach.live/terms-of-service](https://www.wellnesscoach.live/terms-of-service) |
| Funcionalidad básica de la aplicación | Prácticas físicas y mentales rápidas para mantenerte en movimiento y motivado durante todo el día.  |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://wellnesscoach.live/teams-app](https://wellnesscoach.live/teams-app) |
...
Esta información ha sido proporcionada por Meditation.live, Inc. sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
