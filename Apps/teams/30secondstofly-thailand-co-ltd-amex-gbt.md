...
description: Toda la información de seguridad y cumplimiento disponible para AMEX GBT, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/157b5ffb-b183-453c-b072-9c94bb6c694c" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003272" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | 30SecondsToFly (Tailandia) Co Ltd |
| Sitio web de la empresa | [https://www.amexglobalbusinesstravel.com](https://www.amexglobalbusinesstravel.com) |
| Términos de uso de la aplicación | [https://www.amexglobalbusinesstravel.com/terms-service/](https://www.amexglobalbusinesstravel.com/terms-service/) |
| Funcionalidad básica de la aplicación | Chatee con un asesor de viajes. Ya sea que necesite ayuda para encontrar un lugar para alojarse o simplemente perder un vuelo, nuestros consejeros de viaje están disponibles para chatear 24/7. |
...
30SecondsToFly (Tailandia) Co Ltd ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
