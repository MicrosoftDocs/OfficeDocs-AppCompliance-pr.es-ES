---
title: Información de la aplicación para ensamblado por CarrotHR Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/08/2021
...
description: Toda la información de seguridad y cumplimiento disponible para Assembly, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64879417"
---
# <a name="assembly"></a>Ensamblado

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 21 de mayo de 2021</p>

* <a href="https://teams.microsoft.com/l/app/3e674b5f-ba5d-41cc-8b06-e065b4394aeb" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002271" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | CarrotHR Inc. |
| Sitio web de la empresa | [https://www.joinassembly.com](https://www.joinassembly.com) |
| Términos de uso de la aplicación | [https://joinassembly.com/terms-of-service](https://joinassembly.com/terms-of-service) |
| Funcionalidad básica de la aplicación | Assembly es una plataforma de compromiso y reconocimiento de empleados. |
| Ubicación de la sede central de la empresa | Estados Unidos de América |
| Página de información de la aplicación | [https://www.joinassembly.com/about](https://www.joinassembly.com/about) |
...
Esta información ha sido proporcionada por CarrotHR Inc. sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| Fecha de certificación de SOC1 más reciente | 2020-09-01 |
| ¿La aplicación cumple con los controles de organización de servicio (SOC 2)? | Sí |
| Fecha de certificación de SOC2 más reciente | 2021-02-28 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | Delegado | Permitir al usuario asignar una aplicación a un canal recién creado desde nuestra aplicación | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| Directory.Read.All | aplicación | Mantenga nuestros perfiles sincronizados para que los miembros puedan buscar correctamente en el ensamblado. | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| Group.Read.All | Delegado | Observamos los datos para asegurarnos de que pueden asignar nuestra aplicación al grupo correcto. | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| Teams.ReadBasic.All | aplicación | Capacidad de asignar nuestra aplicación a la pestaña de equipo correcta | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| TeamsTab.Create | aplicación | Usamos esto para permitir que nuestra aplicación se anexe a un canal o equipo correctamente | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| correo electrónico | Delegado | Correo electrónico del usuario para que podamos concederle acceso a su cuenta específica | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| perfil | Delegado | Nombre de usuario para rellenar automáticamente el ensamblado y mantener la sincronización con los cambios en Microsoft Teams | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
