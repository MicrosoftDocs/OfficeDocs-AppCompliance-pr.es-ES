---
title: Información de la aplicación para el bot de tiempo cero de Replicon
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/06/2022
...
description: Toda la información de seguridad y cumplimiento disponible para Zero Time Bot, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "65269950"
---
# <a name="zero-time-bot"></a>Bot de hora cero

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 8 de diciembre de 2021</p>

* <a href="https://teams.microsoft.com/l/app/4db812e1-4d29-44e4-b72e-9654c0c91ce4" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003717" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Replicon a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | Bot de hora cero |
| ID | WA200003717 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Replicon |
| Sitio web de la empresa | [https://www.replicon.com](https://www.replicon.com) |
| Términos de uso de la aplicación | [https://www.replicon.com/terms-and-conditions/](https://www.replicon.com/terms-and-conditions/) |
| Funcionalidad básica de la aplicación | El bot de hora cero permite a los usuarios rellenar directamente sus partes de horas de Replicon mediante el chat con el bot. |
...
Replicon ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
| ¿Qué datos procesa la aplicación? | Datos de perfil de usuario, datos de tiempo |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | aplicación | obtener el correo electrónico del usuario y asignarlo al usuario en el sistema de Replicon para insertar mensajes de chat en la aplicación de Replicon | [4db812e1-4d29-44e4-b72e-9654c0c91ce4](../azure/4db812e1-4d29-44e4-b72e-9654c0c91ce4.md) |
