---
title: Información de la aplicación ¿está Caja fuerte? por Avista Technology Solutions
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
description: Toda la información de seguridad y cumplimiento disponible para ¿está Caja fuerte?, sus directivas de tratamiento de datos, su información del catálogo de aplicaciones de Microsoft Cloud App Security e información de seguridad y cumplimiento en el Registro CSA STAR.
...
ms.locfileid: "64463900"
---
# <a name="are-you-safe"></a>¿Está Caja fuerte?

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Last updated by the developer on: December 2, 2021</p>

* <a href="https://teams.microsoft.com/l/app/884e521a-dadc-41e9-a8af-fcaa907e783e" target="_blank">Ver en Teams tienda</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003863" target="_blank">Ver en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Avista Technology Solutions a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | ¿Está Caja fuerte? |
| Id. | WA200003863 |
| Office 365 clientes compatibles | Microsoft Teams |
| Nombre de la compañía asociada | Avista Technology Solutions |
| Sitio web de la compañía | [https://safetybot.in](https://safetybot.in) |
| Términos de uso de la aplicación | [https://safetybot.in/terms.html](https://safetybot.in/terms.html) |
| Funcionalidad principal de la aplicación | &quot;¿AreYouSafe?&quot; bot es el asistente personalizado de administración de crisis. Ideal para que los administradores de seguridad y el personal de recursos humanos se configuren y usen durante las emergencias.  No necesitas ningún otro software o servicio para usar esta aplicación. Nuestro bot es fácil de usar y evita tener que intercambiar entre aplicaciones Teams y externas durante toda la crisis.  Use nuestro bot para conocer el estado de los empleados afectados por un incidente importante. &quot;¿AreYouSafe?&quot; bot le ayuda a ofrecer asistencia a los necesitados proporcionando actualizaciones en tiempo real. |
| Ubicación central de la empresa | India |
| Página de información de la aplicación | [https://safetybot.in](https://safetybot.in) |
...
Avista Technology Solutions ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
