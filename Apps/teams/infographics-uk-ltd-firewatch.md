...
description: Toda la información de seguridad y cumplimiento disponible para FireWatch, sus directivas de control de datos, su Microsoft Cloud App Security de catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/822055b4-508e-49c8-b7cc-c891ccb5c4eb" target="_blank">Ver en Teams almacén</a>
...
| Funcionalidad principal de la aplicación | FireWatch Conectar los servicios de bomberos y de rescate para integrar la aplicación de FireWatch con Microsoft Teams para que los usuarios puedan completar tareas desde dentro de Microsoft Teams. Actualmente proporciona asistencia y soporte al usuario a través de un bot de Microsoft Teams para reservar el servicio desde directamente dentro del entorno Microsoft Teams usuario. Las futuras versiones incluirán compatibilidad para otras acciones a través de bots y tarjetas, incluidas las solicitudes de vacaciones de FireWatch, los avisos de tareas, etc. |
