---
title: Información de la aplicación para FireWatch de Infographics UK Ltd.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/30/2021
...
description: Toda la información de seguridad y cumplimiento disponible para FireWatch, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64879327"
---
# <a name="firewatch"></a>FireWatch

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 29 de julio de 2021</p>

* <a href="https://teams.microsoft.com/l/app/822055b4-508e-49c8-b7cc-c891ccb5c4eb" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003303" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por Infographics UK Ltd. a Microsoft:

| **Information** | **Respuesta** |
|:----------------|:-------------|
| Nombre de la aplicación | FireWatch |
| Id. | WA200003303 |
| Office 365 clientes admitidos | Microsoft Teams |
| Nombre de la empresa asociada | Infographics UK Ltd. |
| Sitio web de la empresa | [https://www.infographics.co.uk](https://www.infographics.co.uk) |
| Términos de uso de la aplicación | [https://www.infographics.co.uk/terms-and-conditions/](https://www.infographics.co.uk/terms-and-conditions/) |
| Funcionalidad básica de la aplicación | FireWatch Conectar permite a los servicios de incendios y rescate integrar la aplicación FireWatch con Microsoft Teams para que los usuarios puedan completar tareas directamente dentro de Microsoft Teams. Actualmente proporciona soporte técnico y asistencia al usuario a través de un bot de Microsoft Teams para reservar de servicio o de servicio directamente dentro del entorno de usuario Microsoft Teams. Las versiones futuras incluirán compatibilidad con otras acciones a través de bots y tarjetas, incluidas las solicitudes de vacaciones de FireWatch, los recordatorios de tareas, etc. |
| Ubicación de la sede central de la empresa | Reino Unido de Gran Bretaña e Irlanda del Norte (el) |
| Página de información de la aplicación | [https://www.firewatch.co.uk](https://www.firewatch.co.uk) |
...
Infographics UK Ltd. ha proporcionado esta información sobre cómo esta aplicación recopila y almacena datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
