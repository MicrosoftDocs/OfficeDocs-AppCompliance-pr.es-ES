---
title: Información de la aplicación para ARGUSnylar by ARGUS DATA INSIGHTS Schweiz AG
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Toda la información de seguridad y cumplimiento disponible para ARGUSnylar, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad y cumplimiento en el registro CSA STAR.
...
* <a href="https://teams.microsoft.com/l/app/f14455f8-5bbe-4da9-8df3-9c5533057569" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003186" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por ARGUS DATA INSIGHTS Schweiz AG a Microsoft:
...
| Nombre de la empresa asociada | ARGUS DATA INSIGHTS Schweiz AG |
| Sitio web de la empresa | [https://www.argusdatainsights.ch/en/](https://www.argusdatainsights.ch/en/) |
| Términos de uso de la aplicación | [https://portal.nylar.org/terms-of-use](https://portal.nylar.org/terms-of-use) |
| Funcionalidad básica de la aplicación | ARGUSnylar es la extensión útil para su cuenta. |
| Ubicación de la sede central de la empresa | Suiza |
| Página de información de la aplicación | [https://portal.nylar.org/help](https://portal.nylar.org/help) |
...
Esta información la ha proporcionado ARGUS DATA INSIGHTS Schweiz AG sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| OpenID | aplicación | / | [5c1f85d2-d744-4159-8c01-16e9a7b1207b](../azure/5c1f85d2-d744-4159-8c01-16e9a7b1207b.md) |
