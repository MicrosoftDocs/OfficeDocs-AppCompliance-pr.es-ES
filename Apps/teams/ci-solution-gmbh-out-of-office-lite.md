...
description: Toda la información de seguridad y cumplimiento disponible para CI-Out-of-Office Lite, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64876477"
---
# <a name="ci-out-of-office-lite"></a>CI-Out-of-Office Lite

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador el 2 de junio de 2021</p>

* <a href="https://teams.microsoft.com/l/app/e76af3f9-8fb6-4018-84c0-d5444ad72b4c" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002748" target="_blank">Vista en AppSource</a>

::: zone pivot="general"

### <a name="general-information"></a>Información general

Información proporcionada por ci solution GmbH a Microsoft:
...
| Nombre de la empresa asociada | ci solution GmbH |
| Sitio web de la empresa | [https://www.ci-solution.com](https://www.ci-solution.com) |
| Términos de uso de la aplicación | [https://www.ci-solution.com/agb](https://www.ci-solution.com/agb) |
| Funcionalidad básica de la aplicación | Con CI-Out-of-Office Lite, las notificaciones de ausencia se pueden estandarizar y controlar centralmente en toda la empresa. Con esta galardonada aplicación (incluido el premio de la industria, el premio a la innovación de TI) puede garantizar una administración fuera de la oficina profesional, uniforme y conforme a la identidad corporativa para su empresa dentro de Microsoft 365. |
| Ubicación de la sede central de la empresa | Alemania |
| Página de información de la aplicación | [https://www.ci-solution.com/support/en/ci-oof-lite/](https://www.ci-solution.com/support/en/ci-oof-lite/) |
...
Esta información ha sido proporcionada por ci solution GmbH sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que su organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| correo electrónico | Delegado | Ver la dirección de correo electrónico de los usuarios | [fc1e4e41-1e20-49ba-88aa-5f26fa8bc4da](../azure/fc1e4e41-1e20-49ba-88aa-5f26fa8bc4da.md) |
