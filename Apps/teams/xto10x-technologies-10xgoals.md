---
title: Información de la aplicación para 10xGoals de xto10x Technologies
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Toda la información de seguridad y cumplimiento disponible para 10xGoals, sus directivas de control de datos, su Microsoft Cloud App Security información del catálogo de aplicaciones e información de seguridad/cumplimiento en el registro CSA STAR.
...
ms.locfileid: "64877047"
---
# <a name="10xgoals"></a>10xGoals

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>Última actualización del desarrollador: 8 de julio de 2021</p>

* <a href="https://teams.microsoft.com/l/app/950aa4fb-0583-4b13-9b5f-bbc92b9cc376" target="_blank">Visualización en Teams almacén</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003122" target="_blank">Vista en AppSource</a>
...
| Nombre de la empresa asociada | xto10x Technologies |
| Sitio web de la empresa | [https://www.xto10x.com/10xgoals/](https://www.xto10x.com/10xgoals/) |
| Términos de uso de la aplicación | [https://www.xto10x.com/security/terms-of-use/](https://www.xto10x.com/security/terms-of-use/) |
| Funcionalidad básica de la aplicación | 10xGoals es una herramienta para impulsar las estrategias en la ejecución con enfoque, alineación, colaboración y visibilidad para todo el equipo. Con la integración de 10xGoals &lt;&gt; Microsoft Teams, se puede administrar toda la ejecución aquí mismo. Para empezar, los usuarios pueden aceptar / rechazar / comentarios sobre los objetivos asignados a ellos para administrar mejor su tiempo. Para poder usar esta aplicación, los usuarios deben tener una suscripción activa de 10xGoals. |
| Ubicación de la sede central de la empresa | India |
| Página de información de la aplicación | [https://www.xto10x.com/10xgoals/](https://www.xto10x.com/10xgoals/) |
...
Xto10x Technologies ha proporcionado esta información sobre cómo recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | aplicación | El correo electrónico de los usuarios y el identificador de Azure se capturan para que la aplicación pueda instalar la aplicación de forma proactiva para todos los usuarios de la organización.  | [950aa4fb-0583-4b13-9b5f-bbc92b9cc376](../azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | aplicación | Es necesario para que la aplicación pueda capturar teamsappDefinition instalados para el administrador y, a continuación, instalarse de forma proactiva para todos los usuarios de la organización.  | [950aa4fb-0583-4b13-9b5f-bbc92b9cc376](../azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376.md) |
