...
Información proporcionada por Jexet Technologies LLC a Microsoft:
...
| Nombre de la compañía asociada | Jexet Technologies LLC |
| Sitio web de la compañía | [https://mspbots.ai](https://mspbots.ai) |
| Términos de uso de la aplicación | [https://mspbots.ai/termsofuse/](https://mspbots.ai/termsofuse/) |
| Funcionalidad principal de la aplicación | Plataforma de inteligencia empresarial, automatización para las tareas repetitivas del proveedor de servicios administrados de TI mediante bots personalizables. |
...
Jexet Technologies LLC ha proporcionado esta información sobre cómo esta aplicación recopila y almacena los datos de la organización y el control que la organización tendrá sobre los datos que recopila la aplicación.
...
| Dirección URL de la directiva de privacidad | https://mspbots.ai/home/data-security/ |
...
>|:------------------------|:--------------------|:------------------------------------|
>| ChannelMessage.Send | aplicación | Enviar mensaje al canal |
>| ChatMessage.Send | aplicación | Enviar mensaje al chat |
>| perfil | aplicación | obtener información de usuario de la aplicación de uso |
